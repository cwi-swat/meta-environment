...
public abstract class VisualizationPluginController extends DefaultStudioPlugin
    ...
    public final ATerm vpIsTypeSupported(ATerm type) {
        ...
        return m_pureFactory.make("snd-value(vp-type-supported(<bool>))", new Boolean(typeSupported));
    }
    ...
    public void exportToClicked(requestType exportRequestType, int windowId) {
        ...
        ATerm term = m_studio.getATermFactory().make(
                "vp-open-file-dialog(<int>,<str>,<str>,<str>)", new Integer(windowId),
     ...
     * @author Aldert Boerhoop
     * @date 15-3-2007
     * @param windowId it the window id of the window who requested the export, String fileName thats entered in the file dialog
     */
     ...
     * @author Aldert Boerhoop
     * @date 15-3-2007
     * @param windowId is the window id of the window who requested the export
     */
