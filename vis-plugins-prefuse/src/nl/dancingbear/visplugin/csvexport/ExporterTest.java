package nl.dancingbear.visplugin.csvexport;
...
public class ExporterTest extends TestCase {
	...
	public void testExportFromRTupleStrStr() {
        ...
        String result = null;
        try{
        	result = rTupleToCsv(tupleRelStrStr, Exporter.ExportSelection.DATA_ONLY);
	...
	public void testExportFromRTupleStrInt() {
        ...
        String result1 = null;
        try{
        	result1 = rTupleToCsv(tupleRelStrInt, Exporter.ExportSelection.DATA_ONLY);
        }catch(IOException ioex){
        	throw new RuntimeException(ioex);
        }
        ...
        String result2 = null;
        try{
        	result2 = rTupleToCsv(tupleRelStrInt, Exporter.ExportSelection.DATA_WITH_HEADERS);
        }catch(IOException ioex){
        	throw new RuntimeException(ioex);
        }
	 ...
	 * @author Antoine Savelkoul
 	 * @author Chris Woolderink
  	 * @date 13-03-2007
	 */
	private String rTupleToCsv(RTuple rTuple, Exporter.ExportSelection selection) throws IOException{
