...
public class Color extends nl.cwi.sen1.graph.types.Attribute {
  public Color(nl.cwi.sen1.graph.Factory factory, aterm.ATermList annos, aterm.AFun fun, aterm.ATerm[] args) {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getGraphFactory().makeAttribute_Color(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof nl.cwi.sen1.graph.types.Color)) { 
          throw new RuntimeException("Argument 0 of a Color should have type Color");
        }
        break;
      default: throw new RuntimeException("Color does not have an argument at " + i );
    }
