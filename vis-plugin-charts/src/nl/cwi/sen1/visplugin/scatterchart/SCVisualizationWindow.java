...
/**
 * scatterChart Plugin VisualisationWindow. Shows a scatter chart.
...
public class SCVisualizationWindow extends VisualizationPluginWindow {
    ...
    public JPanel render(RTuple fact) {
        ...
        String graphTitle = "scatterChart";
        XYSeriesCollection dataset = convertRTupleToDataset(fact);
        JFreeChart chart = createscatterChart(graphTitle, dataset);
     ...
     * @date 12-03-2007
     */
private JFreeChart createscatterChart(String title, XYSeriesCollection dataset) {
	// create the chart...
     ...
     * Supports relation([int,int]) This can be extended to support multiple scatters in a chart
     * 
     * @param fact
     *            RTuple with the data
     * @return scatterChart dataset
     * @author Raymond Bergen
     * @date 12-03-2007
     */
