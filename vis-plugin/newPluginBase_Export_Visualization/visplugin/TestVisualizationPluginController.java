...
//          assertEquals(m_pluginController.vpGetName(),m_pureFactory.make("<str>","VisualisatieTestPlugin"));
    }
...
//        assertEquals(m_pluginController.vpIsTypeSupported("relation([str,int])"),m_pureFactory.make("<bool>",true));
//        assertEquals(m_pluginController.vpIsTypeSupported("relation([int,str])"),m_pureFactory.make("<bool>",false));
    }
}
