...
ASF_ASFSectionList ASF_liftSections(ASF_ASFSectionList module, ATermTable liftCache, ATermTable lowerCache);
ASF_ASFSectionList ASF_lowerSections(ASF_ASFSectionList module, ATermTable lowerCache);
ASF_ASFConditionalEquationList ASF_liftEquations(ASF_ASFConditionalEquationList list, ATermTable liftCache, ATermTable lowerCache);
