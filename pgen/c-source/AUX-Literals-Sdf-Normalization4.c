...
FUNC_EXIT ( ( * ef2 ) ( make_nf1 ( ef3sym , lf3 ( make_list ( ( * ef4 ) ( tmp [ 5 ] ) ) ) ) , lf_AUX_Literals_Sdf_Normalization4_1 ( ( * ef1 ) ( lf2 ( cons ( make_list_char ( 34 ) , cons ( make_list ( tmp [ 4 ] ) , make_list ( make_char ( 34 ) ) ) ) ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( ( * ef2 ) ( make_nf1 ( ef3sym , lf3 ( make_list ( ( * ef4 ) ( tmp [ 6 ] ) ) ) ) , lf_AUX_Literals_Sdf_Normalization4_1 ( ( * ef1 ) ( lf2 ( cons ( make_list_char ( 34 ) , cons ( make_list ( tmp [ 5 ] ) , make_list ( make_char ( 34 ) ) ) ) ) ) ) ) ) ;
}
}
}
}
...
( tmp [ 7 ] = arg_0 ( tmp [ 6 ] ) ) ;
FUNC_EXIT ( ( * ef2 ) ( make_nf1 ( ef3sym , lf3 ( make_list ( ( * ef4 ) ( tmp [ 4 ] ) ) ) ) , make_nf1 ( ef3sym , lf3 ( make_list ( tmp [ 7 ] ) ) ) ) ) ;
}
}
}
}
