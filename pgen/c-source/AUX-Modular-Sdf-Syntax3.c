...
static Symbol lf_AUX_Modular_Sdf_Syntax3_2_recursivesym ;
...
lf_AUX_Modular_Sdf_Syntax3_2_recursivesym = ATmakeSymbol ( "prod(id(\"Modular-Sdf-Syntax\"),w(\"\"),[iter(sort(\"Section\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"Sections\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Modular_Sdf_Syntax3_2_recursivesym ) ;
lf_AUX_Modular_Sdf_Syntax3_2sym = ATmakeSymbol ( "prod(id(\"Modular-Sdf-Syntax\"),w(\"\"),[iter(sort(\"Section\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"Sections\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
ATerm lf_AUX_Modular_Sdf_Syntax3_2_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 3 ] ;
FUNC_ENTRY ( lf_AUX_Modular_Sdf_Syntax3_2_recursivesym , ATmakeAppl ( lf_AUX_Modular_Sdf_Syntax3_2_recursivesym , arg0 ) ) ;
{
ATerm ltmp [ 1 ] ;
lbl_lf_AUX_Modular_Sdf_Syntax3_2_recursive : ltmp [ 0 ] = arg0 ;
( tmp [ 0 ] = ltmp [ 0 ] ) ;
{
ATerm atmp00110 ;
ATerm atmp0010 ;
...
( tmp [ 0 ] = ltmp [ 0 ] ) ;
FUNC_EXIT ( make_nf1 ( lf_AUX_Modular_Sdf_Syntax3_2_recursivesym , lf_AUX_Modular_Sdf_Syntax3_1 ( ltmp [ 0 ] ) ) ) ;
}
}
}
