...
static Symbol lf_AUX_Kernel_Sdf_Projection5_1_recursivesym ;
static ATerm lf_AUX_Kernel_Sdf_Projection5_1_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Kernel_Sdf_Projection5_1_recursivesym = ATmakeSymbol ( "prod(id(\"Kernel-Sdf-Projection\"),w(\"\"),[sort(\"Productions\"),w(\"\"),ql(\"(=\"),w(\"\"),sort(\"Productions\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Kernel_Sdf_Projection5_1_recursivesym ) ;
lf_AUX_Kernel_Sdf_Projection5_1sym = ATmakeSymbol ( "prod(id(\"Kernel-Sdf-Projection\"),w(\"\"),[sort(\"Productions\"),w(\"\"),ql(\"(=\"),w(\"\"),sort(\"Productions\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Kernel-Sdf-Projection\"),w(\"\"),[sort(\"Productions\"),w(\"\"),ql(\"(=\"),w(\"\"),sort(\"Productions\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_Kernel_Sdf_Projection5_1_recursive , lf_AUX_Kernel_Sdf_Projection5_1_recursivesym ) ;
...
ATerm lf_AUX_Kernel_Sdf_Projection5_1_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 2 ] ;
FUNC_ENTRY ( lf_AUX_Kernel_Sdf_Projection5_1_recursivesym , ATmakeAppl ( lf_AUX_Kernel_Sdf_Projection5_1_recursivesym , arg0 , arg1 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Kernel_Sdf_Projection5_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) , arg1 ) ) ;
}
}
