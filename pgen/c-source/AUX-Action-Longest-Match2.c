...
ef11 = lookup_func ( ATreadFromString ( "prod(id(\"Restrictions-Sdf-Projection\"),w(\"\"),[l(\"proj\"),w(\"\"),ql(\"_\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Restrictions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CharClass\"),w(\"\"),no-attrs)" ) ) ;
ef11sym = lookup_sym ( ATreadFromString ( "prod(id(\"Restrictions-Sdf-Projection\"),w(\"\"),[l(\"proj\"),w(\"\"),ql(\"_\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Restrictions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CharClass\"),w(\"\"),no-attrs)" ) ) ;
ef12 = lookup_func ( ATreadFromString ( "prod(id(\"Earley-Graphs\"),w(\"\"),[sort(\"Production\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Label\"),w(\"\"),no-attrs)" ) ) ;
ef12sym = lookup_sym ( ATreadFromString ( "prod(id(\"Earley-Graphs\"),w(\"\"),[sort(\"Production\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Label\"),w(\"\"),no-attrs)" ) ) ;
ef13 = lookup_func ( ATreadFromString ( "prod(id(\"Kernel-Sdf-Syntax\"),w(\"\"),[sort(\"Symbols\"),w(\"\"),ql(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),sort(\"Attributes\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Production\"),w(\"\"),no-attrs)" ) ) ;
ef13sym = lookup_sym ( ATreadFromString ( "prod(id(\"Kernel-Sdf-Syntax\"),w(\"\"),[sort(\"Symbols\"),w(\"\"),ql(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),sort(\"Attributes\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Production\"),w(\"\"),no-attrs)" ) ) ;
ef14 = lookup_func ( ATreadFromString ( "prod(id(\"Symbols\"),w(\"\"),[iter(sort(\"Symbol\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)" ) ) ;
ef14sym = lookup_sym ( ATreadFromString ( "prod(id(\"Symbols\"),w(\"\"),[iter(sort(\"Symbol\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)" ) ) ;
}
...
FUNC_EXIT ( ( * ef5 ) ( ( * ef2 ) ( lf3 ( make_list ( ( * ef3 ) ( ( * ef4 ) ( tmp [ 4 ] ) , ( * ef6 ) ( ( * ef7 ) ( lf4 ( make_list ( ( * ef4 ) ( ( * ef8 ) ( ( * ef9 ) ( ( * ef10 ) ( tmp [ 3 ] ) , tmp [ 5 ] ) ) ) ) ) ) ) ) ) ) ) , lf_AUX_Action_Longest_Match2_1 ( ( * ef1 ) ( lf2 ( make_list ( atmp000 ) ) ) , ( * ef2 ) ( lf3 ( make_list ( tmp [ 1 ] ) ) ) ) ) ) ;
}
...
FUNC_EXIT ( ( * ef5 ) ( ( * ef2 ) ( lf3 ( make_list ( ( * ef3 ) ( ( * ef12 ) ( ( * ef13 ) ( ( * ef14 ) ( lf5 ( make_list ( tmp [ 9 ] ) ) ) , tmp [ 6 ] , tmp [ 7 ] ) ) , ( * ef6 ) ( ( * ef7 ) ( lf4 ( make_list ( ( * ef4 ) ( ( * ef8 ) ( ( * ef9 ) ( ( * ef10 ) ( tmp [ 3 ] ) , tmp [ 10 ] ) ) ) ) ) ) ) ) ) ) ) , lf_AUX_Action_Longest_Match2_1 ( ( * ef1 ) ( lf2 ( make_list ( atmp000 ) ) ) , ( * ef2 ) ( lf3 ( make_list ( tmp [ 1 ] ) ) ) ) ) ) ;
}
}
}
}
