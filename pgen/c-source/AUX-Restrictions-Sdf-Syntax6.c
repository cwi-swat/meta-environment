...
FUNC_EXIT ( lf_AUX_Restrictions_Sdf_Syntax6_2_recursive ( cons ( slice ( atmp000 [ 0 ] , atmp000 [ 1 ] ) , cons ( make_list ( ( * ef1 ) ( make_nf1 ( ef2sym , lf3 ( make_list ( tmp [ 7 ] ) ) ) , ( * ef3 ) ( tmp [ 2 ] , tmp [ 9 ] ) ) ) , cons ( make_list ( ( * ef1 ) ( make_nf1 ( ef2sym , lf3 ( cons ( slice ( tmp [ 5 ] , tmp [ 6 ] ) , tmp [ 4 ] ) ) ) , tmp [ 2 ] ) ) , cons ( slice ( atmp00110 [ 0 ] , atmp00110 [ 1 ] ) , cons ( make_list ( ( * ef1 ) ( make_nf1 ( ef2sym , lf3 ( cons ( slice ( tmp [ 12 ] , tmp [ 13 ] ) , tmp [ 11 ] ) ) ) , tmp [ 9 ] ) ) , tmp [ 0 ] ) ) ) ) ) ) ) ;
}
...
( tmp [ 11 ] = list_tail ( tmp [ 11 ] ) ) ;
if ( term_equal ( tmp [ 7 ] , tmp [ 14 ] ) ) {
( arg0 = cons ( slice ( atmp000 [ 0 ] , atmp000 [ 1 ] ) , cons ( make_list ( ( * ef1 ) ( make_nf1 ( ef2sym , lf3 ( make_list ( tmp [ 7 ] ) ) ) , ( * ef3 ) ( tmp [ 2 ] , tmp [ 9 ] ) ) ) , cons ( make_list ( ( * ef1 ) ( make_nf1 ( ef2sym , lf3 ( cons ( slice ( tmp [ 5 ] , tmp [ 6 ] ) , tmp [ 4 ] ) ) ) , tmp [ 2 ] ) ) , cons ( slice ( atmp00110 [ 0 ] , atmp00110 [ 1 ] ) , cons ( make_list ( ( * ef1 ) ( make_nf1 ( ef2sym , lf3 ( cons ( slice ( tmp [ 12 ] , tmp [ 13 ] ) , tmp [ 11 ] ) ) ) , tmp [ 9 ] ) ) , tmp [ 0 ] ) ) ) ) ) ) ;
