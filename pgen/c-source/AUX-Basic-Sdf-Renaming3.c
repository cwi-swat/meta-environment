...
static Symbol lf_AUX_Basic_Sdf_Renaming3_1sym ;
static ATerm lf_AUX_Basic_Sdf_Renaming3_1 ( ATerm arg1 ) ;
...
void register_AUX_Basic_Sdf_Renaming3 ( ) {
lf_AUX_Basic_Sdf_Renaming3_1sym = ATmakeSymbol ( "prod(id(\"Basic-Sdf-Renaming\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Renamings\"),w(\"\"),ql(\"-CF\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Renamings\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Basic_Sdf_Renaming3_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Renaming\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Basic-Sdf-Renaming\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Renamings\"),w(\"\"),ql(\"-CF\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Renamings\"),w(\"\"),no-attrs)" ) , lf_AUX_Basic_Sdf_Renaming3_1 , lf_AUX_Basic_Sdf_Renaming3_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Renaming\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_Basic_Sdf_Renaming3 ( ) {
...
ef3 = lookup_func ( ATreadFromString ( "prod(id(\"Basic-Sdf-Syntax\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"-CF\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" ) ) ;
ef3sym = lookup_sym ( ATreadFromString ( "prod(id(\"Basic-Sdf-Syntax\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"-CF\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" ) ) ;
...
void init_AUX_Basic_Sdf_Renaming3 ( ) {
ATprotect ( & constant0 ) ;
}
ATerm lf_AUX_Basic_Sdf_Renaming3_1 ( ATerm arg0 ) {
{
ATerm tmp [ 3 ] ;
FUNC_ENTRY ( lf_AUX_Basic_Sdf_Renaming3_1sym , ATmakeAppl ( lf_AUX_Basic_Sdf_Renaming3_1sym , arg0 ) ) ;
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef6 ) ( lf_AUX_Basic_Sdf_Renaming3_1 ( ( * ef1 ) ( lf2 ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) ) ) , lf_AUX_Basic_Sdf_Renaming3_1 ( ( * ef1 ) ( lf2 ( tmp [ 0 ] ) ) ) ) ) ;
}
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Basic_Sdf_Renaming3_1sym , arg0 ) ) ;
}
}
