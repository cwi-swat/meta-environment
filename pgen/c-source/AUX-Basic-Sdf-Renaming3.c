...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef2 ) ( lf_AUX_Basic_Sdf_Renaming3_1 ( ( * ef1 ) ( lf2 ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) ) ) , lf_AUX_Basic_Sdf_Renaming3_1 ( ( * ef1 ) ( lf2 ( tmp [ 0 ] ) ) ) ) ) ;
}
...
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
( tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ) ;
FUNC_EXIT ( ( * ef1 ) ( lf2 ( make_list ( ( * ef5 ) ( ( * ef6 ) ( tmp [ 1 ] ) , ( * ef6 ) ( tmp [ 2 ] ) ) ) ) ) ) ;
}
if ( check_sym ( tmp [ 0 ] , ef3sym ) ) {
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
( tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ) ;
FUNC_EXIT ( ( * ef1 ) ( lf2 ( make_list ( ( * ef3 ) ( ( * ef4 ) ( tmp [ 1 ] ) , ( * ef4 ) ( tmp [ 2 ] ) ) ) ) ) ) ;
}
}
