...
ef7 = lookup_func ( ATreadFromString ( "prod(id(\"Modular-Sdf-Projection\"),w(\"\"),[ql(\"Exp\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Sections\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
ef7sym = lookup_sym ( ATreadFromString ( "prod(id(\"Modular-Sdf-Projection\"),w(\"\"),[ql(\"Exp\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Sections\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
...
( tmp [ 0 ] = ( * ef4 ) ( ( * ef5 ) ( arg2 , make_nf1 ( ef1sym , lf2 ( make_list ( atmp100 ) ) ) ) , ( * ef6 ) ( ) , ( * ef7 ) ( ( * ef8 ) ( atmp20 , arg0 ) ) ) ) ;
...
( tmp [ 0 ] = ( * ef4 ) ( ( * ef5 ) ( arg2 , make_nf1 ( ef1sym , lf2 ( make_list ( atmp100 ) ) ) ) , ( * ef6 ) ( ) , ( * ef10 ) ( ( * ef7 ) ( ( * ef8 ) ( atmp20 , arg0 ) ) , atmp21 ) ) ) ;
FUNC_EXIT ( ( * ef3 ) ( arg0 , make_nf1 ( ef1sym , lf2 ( cons ( make_list ( atmp100 ) , make_list ( arg2 ) ) ) ) , tmp [ 0 ] ) ) ;
}
}
}
