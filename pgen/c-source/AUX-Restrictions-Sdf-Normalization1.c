...
lf_AUX_Restrictions_Sdf_Normalization1_1sym = ATmakeSymbol ( "prod(id(\"Restrictions-Sdf-Normalization\"),w(\"\"),[ql(\"head\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Lookahead\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CharClass\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Restrictions_Sdf_Normalization1_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Restrictions-Sdf-Normalization\"),w(\"\"),[ql(\"head\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Lookahead\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CharClass\"),w(\"\"),no-attrs)" ) , lf_AUX_Restrictions_Sdf_Normalization1_1 , lf_AUX_Restrictions_Sdf_Normalization1_1sym ) ;
}
