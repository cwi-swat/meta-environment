...
static Symbol lf_AUX_Restrictions_Sdf_Renaming2_1_recursivesym ;
static ATerm lf_AUX_Restrictions_Sdf_Renaming2_1_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Restrictions_Sdf_Renaming2_1_recursivesym = ATmakeSymbol ( "prod(id(\"Restrictions-Sdf-Renaming\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Restrictions\"),w(\"\"),ql(\")\"),w(\"\"),sort(\"Renamings\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Restrictions\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Restrictions_Sdf_Renaming2_1_recursivesym ) ;
lf_AUX_Restrictions_Sdf_Renaming2_1sym = ATmakeSymbol ( "prod(id(\"Restrictions-Sdf-Renaming\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Restrictions\"),w(\"\"),ql(\")\"),w(\"\"),sort(\"Renamings\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Restrictions\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Restrictions-Sdf-Renaming\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Restrictions\"),w(\"\"),ql(\")\"),w(\"\"),sort(\"Renamings\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Restrictions\"),w(\"\"),no-attrs)" ) , lf_AUX_Restrictions_Sdf_Renaming2_1_recursive , lf_AUX_Restrictions_Sdf_Renaming2_1_recursivesym ) ;
...
( tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ) ;
( tmp [ 6 ] = lf_AUX_Restrictions_Sdf_Renaming2_1_recursive ( make_list ( tmp [ 1 ] ) , arg1 ) ) ;
( tmp [ 7 ] = arg_0 ( tmp [ 6 ] ) ) ;
( tmp [ 8 ] = arg_0 ( tmp [ 7 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( cons ( make_list ( ( * ef2 ) ( ( * ef4 ) ( make_nf1 ( ef3sym , lf3 ( make_list ( tmp [ 5 ] ) ) ) , arg1 ) , tmp [ 3 ] ) ) , make_list ( tmp [ 8 ] ) ) ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_Restrictions_Sdf_Renaming2_1_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 9 ] ;
FUNC_ENTRY ( lf_AUX_Restrictions_Sdf_Renaming2_1_recursivesym , ATmakeAppl ( lf_AUX_Restrictions_Sdf_Renaming2_1_recursivesym , arg0 , arg1 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Restrictions_Sdf_Renaming2_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) , arg1 ) ) ;
}
}
