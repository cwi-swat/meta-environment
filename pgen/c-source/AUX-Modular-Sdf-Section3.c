...
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( ( * ef4 ) ( ( * ef3 ) ( tmp [ 1 ] , arg1 ) ) ) ) ) ) ;
}
if ( check_sym ( tmp [ 0 ] , ef2sym ) ) {
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( ( * ef2 ) ( ( * ef3 ) ( tmp [ 1 ] , arg1 ) ) ) ) ) ) ;
}
}
}
}
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef5 ) ( lf_AUX_Modular_Sdf_Section3_1_recursive ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) , arg1 ) , lf_AUX_Modular_Sdf_Section3_1_recursive ( tmp [ 0 ] , arg1 ) ) ) ;
}
