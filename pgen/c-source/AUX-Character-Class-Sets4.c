#include  "support.h"
static Symbol lf_AUX_Character_Class_Sets4_1sym ;
static ATerm lf_AUX_Character_Class_Sets4_1 ( ATerm arg1 , ATerm arg2 ) ;
...
void register_AUX_Character_Class_Sets4 ( ) {
lf_AUX_Character_Class_Sets4_1sym = ATmakeSymbol ( "prod(id(\"Character-Class-Sets\"),w(\"\"),[sort(\"CharClassSet\"),w(\"\"),ql(\"/\"),w(\"\"),sort(\"CharClassSet\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CharClassSet\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Character_Class_Sets4_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CharClass\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Character-Class-Sets\"),w(\"\"),[sort(\"CharClassSet\"),w(\"\"),ql(\"/\"),w(\"\"),sort(\"CharClassSet\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CharClassSet\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))" ) , lf_AUX_Character_Class_Sets4_1 , lf_AUX_Character_Class_Sets4_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CharClass\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_Character_Class_Sets4 ( ) {
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Character_Class_Sets4_1 ( ( * ef1 ) ( lf2 ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) ) , arg1 ) , lf_AUX_Character_Class_Sets4_1 ( ( * ef1 ) ( lf2 ( tmp [ 0 ] ) ) , arg1 ) ) ) ;
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Character_Class_Sets4_1sym , arg0 , arg1 ) ) ;
}
}
