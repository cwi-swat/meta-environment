...
lf7sym = ATmakeSymbol ( "listtype(sort(\"Import\"))" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "listtype(sort(\"Import\"))" ) , lf7 , lf7sym ) ;
}
...
ef12 = lookup_func ( ATreadFromString ( "prod(id(\"Kernel-Sdf-Syntax\"),w(\"\"),[ql(\"syntax\"),w(\"\"),sort(\"Productions\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
ef12sym = lookup_sym ( ATreadFromString ( "prod(id(\"Kernel-Sdf-Syntax\"),w(\"\"),[ql(\"syntax\"),w(\"\"),sort(\"Productions\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
ef13 = lookup_func ( ATreadFromString ( "prod(id(\"Restrictions-Sdf-Syntax\"),w(\"\"),[ql(\"restrictions\"),w(\"\"),sort(\"Restrictions\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
ef13sym = lookup_sym ( ATreadFromString ( "prod(id(\"Restrictions-Sdf-Syntax\"),w(\"\"),[ql(\"restrictions\"),w(\"\"),sort(\"Restrictions\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
...
ef16 = lookup_func ( ATreadFromString ( "prod(id(\"Modular-Sdf-Syntax\"),w(\"\"),[sort(\"ImpSection\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
ef16sym = lookup_sym ( ATreadFromString ( "prod(id(\"Modular-Sdf-Syntax\"),w(\"\"),[sort(\"ImpSection\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
ef17 = lookup_func ( ATreadFromString ( "prod(id(\"Modular-Sdf-Syntax\"),w(\"\"),[ql(\"imports\"),w(\"\"),sort(\"Imports\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ImpSection\"),w(\"\"),no-attrs)" ) ) ;
ef17sym = lookup_sym ( ATreadFromString ( "prod(id(\"Modular-Sdf-Syntax\"),w(\"\"),[ql(\"imports\"),w(\"\"),sort(\"Imports\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ImpSection\"),w(\"\"),no-attrs)" ) ) ;
ef18 = lookup_func ( ATreadFromString ( "prod(id(\"Modular-Sdf-Syntax\"),w(\"\"),[iter(sort(\"Import\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"Imports\"),w(\"\"),no-attrs)" ) ) ;
ef18sym = lookup_sym ( ATreadFromString ( "prod(id(\"Modular-Sdf-Syntax\"),w(\"\"),[iter(sort(\"Import\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"Imports\"),w(\"\"),no-attrs)" ) ) ;
...
{
ATerm atmp1000 = arg_0 ( atmp100 ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef10 ) ( ( * ef11 ) ( lf5 ( make_list ( atmp1000 ) ) ) ) , ( * ef12 ) ( ( * ef3 ) ( lf2 ( make_list ( atmp0000 ) ) ) ) ) ) ;
}
}
}
}
...
{
ATerm atmp1000 = arg_0 ( atmp100 ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef8 ) ( ( * ef9 ) ( lf4 ( make_list ( atmp1000 ) ) ) ) , ( * ef12 ) ( ( * ef3 ) ( lf2 ( make_list ( atmp0000 ) ) ) ) ) ) ;
}
}
}
}
...
{
ATerm atmp1000 = arg_0 ( atmp100 ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef12 ) ( ( * ef3 ) ( lf2 ( cons ( make_list ( atmp0000 ) , make_list ( atmp1000 ) ) ) ) ) , ( * ef7 ) ( ) ) ) ;
}
}
}
}
...
{
ATerm atmp1000 = arg_0 ( atmp100 ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef13 ) ( ( * ef14 ) ( lf6 ( cons ( make_list ( atmp0000 ) , make_list ( atmp1000 ) ) ) ) ) , ( * ef7 ) ( ) ) ) ;
}
}
}
}
...
{
ATerm atmp1000 = arg_0 ( atmp100 ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef12 ) ( ( * ef3 ) ( lf2 ( make_list ( atmp1000 ) ) ) ) , ( * ef13 ) ( ( * ef14 ) ( lf6 ( make_list ( atmp0000 ) ) ) ) ) ) ;
}
}
}
}
...
{
ATerm atmp1000 = arg_0 ( atmp100 ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef12 ) ( ( * ef3 ) ( lf2 ( make_list ( atmp1000 ) ) ) ) , ( * ef15 ) ( ( * ef5 ) ( lf3 ( make_list ( atmp0000 ) ) ) ) ) ) ;
}
}
}
}
...
{
ATerm atmp100 = arg_0 ( atmp10 ) ;
if ( check_sym ( atmp100 , ef18sym ) ) {
{
ATerm atmp1000 = arg_0 ( atmp100 ) ;
if ( check_sym ( atmp1000 , lf7sym ) ) {
{
ATerm atmp10000 = arg_0 ( atmp1000 ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef16 ) ( ( * ef17 ) ( ( * ef18 ) ( lf7 ( cons ( make_list ( atmp00000 ) , make_list ( atmp10000 ) ) ) ) ) ) , ( * ef7 ) ( ) ) ) ;
}
}
}
}
...
{
ATerm atmp10000 = arg_0 ( atmp1000 ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef16 ) ( ( * ef17 ) ( ( * ef18 ) ( lf7 ( make_list ( atmp10000 ) ) ) ) ) , arg0 ) ) ;
}
}
}
}
