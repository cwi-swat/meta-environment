...
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
( tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ) ;
if ( term_equal ( ( * ef38 ) ( ( * ef39 ) ( ( * ef40 ) ( tmp [ 2 ] ) ) , ( constant0 ? constant0 : ( constant0 = ( * ef39 ) ( ( * ef40 ) ( ( * ef41 ) ( lf7 ( make_list ( make_char ( 50 ) ) ) ) ) ) ) ) ) , ( constant1 ? constant1 : ( constant1 = ( * ef42 ) ( ) ) ) ) ) {
...
( tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ) ;
( tmp [ 3 ] = arg_2 ( tmp [ 0 ] ) ) ;
if ( term_equal ( ( * ef38 ) ( ( * ef39 ) ( ( * ef40 ) ( tmp [ 3 ] ) ) , ( constant0 ? constant0 : ( constant0 = ( * ef39 ) ( ( * ef40 ) ( ( * ef41 ) ( lf7 ( make_list ( make_char ( 50 ) ) ) ) ) ) ) ) ) , ( constant1 ? constant1 : ( constant1 = ( * ef42 ) ( ) ) ) ) ) {
...
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
( tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ) ;
( tmp [ 3 ] = ( * ef46 ) ( ( * ef46 ) ( ( * ef1 ) ( lf2 ( make_list ( ( * ef7 ) ( ( * ef47 ) ( lf7 ( ( ATerm ) ATmakeList ( 3 , char_table [ 34 ] , char_table [ 60 ] , char_table [ 34 ] ) ) ) ) ) ) ) , ( * ef48 ) ( ( * ef45 ) ( tmp [ 1 ] , tmp [ 2 ] ) ) ) , ( * ef1 ) ( lf2 ( make_list ( ( * ef7 ) ( ( * ef47 ) ( lf7 ( ( ATerm ) ATmakeList ( 3 , char_table [ 34 ] , char_table [ 62 ] , char_table [ 34 ] ) ) ) ) ) ) ) ) ) ;
...
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
( tmp [ 2 ] = ( * ef1 ) ( lf2 ( cons ( make_list ( ( * ef7 ) ( ( * ef47 ) ( lf7 ( ( ATerm ) ATmakeList ( 3 , char_table [ 34 ] , char_table [ 123 ] , char_table [ 34 ] ) ) ) ) ) , cons ( make_list ( ( * ef35 ) ( tmp [ 1 ] , ( * ef7 ) ( ( * ef47 ) ( lf7 ( ( ATerm ) ATmakeList ( 3 , char_table [ 34 ] , char_table [ 44 ] , char_table [ 34 ] ) ) ) ) ) ) , make_list ( ( * ef7 ) ( ( * ef47 ) ( lf7 ( ( ATerm ) ATmakeList ( 3 , char_table [ 34 ] , char_table [ 125 ] , char_table [ 34 ] ) ) ) ) ) ) ) ) ) ) ;
...
if ( check_sym ( tmp [ 3 ] , lf2sym ) ) {
( tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ) ;
( tmp [ 5 ] = ( * ef19 ) ( ( * ef1 ) ( lf2 ( cons ( make_list ( ( * ef50 ) ( ( * ef1 ) ( lf2 ( make_list ( tmp [ 4 ] ) ) ) , tmp [ 2 ] ) ) , cons ( make_list ( ( * ef7 ) ( ( * ef47 ) ( lf7 ( ( ATerm ) ATmakeList ( 3 , char_table [ 34 ] , char_table [ 40 ] , char_table [ 34 ] ) ) ) ) ) , cons ( make_list ( tmp [ 4 ] ) , make_list ( ( * ef7 ) ( ( * ef47 ) ( lf7 ( ( ATerm ) ATmakeList ( 3 , char_table [ 34 ] , char_table [ 41 ] , char_table [ 34 ] ) ) ) ) ) ) ) ) ) ) , tmp [ 2 ] , ( * ef20 ) ( ) ) ) ;
