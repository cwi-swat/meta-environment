...
static Symbol lf_AUX_Earley_Items3_1sym ;
static ATerm lf_AUX_Earley_Items3_1 ( ATerm arg1 , ATerm arg2 ) ;
...
static funcptr ef3 ;
void register_AUX_Earley_Items3 ( ) {
lf_AUX_Earley_Items3_1sym = ATmakeSymbol ( "prod(id(\"Earley-Items\"),w(\"\"),[sort(\"Item\"),w(\"\"),ql(\"(-\"),w(\"\"),sort(\"ItemSet\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Earley_Items3_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Item\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Earley-Items\"),w(\"\"),[sort(\"Item\"),w(\"\"),ql(\"(-\"),w(\"\"),sort(\"ItemSet\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_Earley_Items3_1 , lf_AUX_Earley_Items3_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Item\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_Earley_Items3 ( ) {
...
void init_AUX_Earley_Items3 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_Earley_Items3_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 1 ] ;
FUNC_ENTRY ( lf_AUX_Earley_Items3_1sym , ATmakeAppl ( lf_AUX_Earley_Items3_1sym , arg0 , arg1 ) ) ;
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Earley_Items3_1sym , arg0 , arg1 ) ) ;
}
}
