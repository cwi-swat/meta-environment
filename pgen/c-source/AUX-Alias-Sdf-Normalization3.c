...
static Symbol lf_AUX_Alias_Sdf_Normalization3_1_recursivesym ;
static ATerm lf_AUX_Alias_Sdf_Normalization3_1_recursive ( ATerm arg1 ) ;
...
lf_AUX_Alias_Sdf_Normalization3_1_recursivesym = ATmakeSymbol ( "prod(id(\"Alias-Sdf-Normalization\"),w(\"\"),[ql(\"rn\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Aliases\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Renamings\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Alias_Sdf_Normalization3_1_recursivesym ) ;
lf_AUX_Alias_Sdf_Normalization3_1sym = ATmakeSymbol ( "prod(id(\"Alias-Sdf-Normalization\"),w(\"\"),[ql(\"rn\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Aliases\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Renamings\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Alias-Sdf-Normalization\"),w(\"\"),[ql(\"rn\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Aliases\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Renamings\"),w(\"\"),no-attrs)" ) , lf_AUX_Alias_Sdf_Normalization3_1 , lf_AUX_Alias_Sdf_Normalization3_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Alias-Sdf-Normalization\"),w(\"\"),[ql(\"rn\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Aliases\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Renamings\"),w(\"\"),no-attrs)" ) , lf_AUX_Alias_Sdf_Normalization3_1_recursive , lf_AUX_Alias_Sdf_Normalization3_1_recursivesym ) ;
...
ef4 = lookup_func ( ATreadFromString ( "prod(id(\"Renaming-Sdf-Syntax\"),w(\"\"),[ql(\"[\"),w(\"\"),iter(sort(\"Renaming\"),w(\"\"),l(\"*\")),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Renamings\"),w(\"\"),no-attrs)" ) ) ;
ef4sym = lookup_sym ( ATreadFromString ( "prod(id(\"Renaming-Sdf-Syntax\"),w(\"\"),[ql(\"[\"),w(\"\"),iter(sort(\"Renaming\"),w(\"\"),l(\"*\")),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Renamings\"),w(\"\"),no-attrs)" ) ) ;
...
( tmp [ 2 ] = arg_0 ( tmp [ 0 ] ) ) ;
( tmp [ 3 ] = arg_1 ( tmp [ 0 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( ( * ef4 ) ( lf3 ( make_list ( ( * ef5 ) ( tmp [ 3 ] , tmp [ 2 ] ) ) ) ) , lf_AUX_Alias_Sdf_Normalization3_1_recursive ( make_list ( tmp [ 1 ] ) ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_Alias_Sdf_Normalization3_1_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 4 ] ;
FUNC_ENTRY ( lf_AUX_Alias_Sdf_Normalization3_1_recursivesym , ATmakeAppl ( lf_AUX_Alias_Sdf_Normalization3_1_recursivesym , arg0 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Alias_Sdf_Normalization3_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) ) ) ;
}
}
