...
lf_AUX_Character_Syntax6_1sym = ATmakeSymbol ( "prod(id(\"Character-Syntax\"),w(\"\"),[ql(\"\\\\\\\\EOF\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Character\"),w(\"\"),no-attrs)"
 , 0 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Character_Syntax6_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Character-Syntax\"),w(\"\"),[ql(\"\\\\\\\\EOF\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Character\"),w(\"\"),no-attrs)" ) , lf_AUX_Character_Syntax6_1 , lf_AUX_Character_Syntax6_1sym ) ;
