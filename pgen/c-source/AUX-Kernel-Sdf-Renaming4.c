...
static Symbol lf_AUX_Kernel_Sdf_Renaming4_1_recursivesym ;
static ATerm lf_AUX_Kernel_Sdf_Renaming4_1_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Kernel_Sdf_Renaming4_1_recursivesym = ATmakeSymbol ( "prod(id(\"Kernel-Sdf-Renaming\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Symbols\"),w(\"\"),ql(\")*\"),w(\"\"),sort(\"Renamings\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Kernel_Sdf_Renaming4_1_recursivesym ) ;
lf_AUX_Kernel_Sdf_Renaming4_1sym = ATmakeSymbol ( "prod(id(\"Kernel-Sdf-Renaming\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Symbols\"),w(\"\"),ql(\")*\"),w(\"\"),sort(\"Renamings\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Kernel-Sdf-Renaming\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Symbols\"),w(\"\"),ql(\")*\"),w(\"\"),sort(\"Renamings\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)" ) , lf_AUX_Kernel_Sdf_Renaming4_1_recursive , lf_AUX_Kernel_Sdf_Renaming4_1_recursivesym ) ;
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef2 ) ( lf_AUX_Kernel_Sdf_Renaming4_1_recursive ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) , arg1 ) , lf_AUX_Kernel_Sdf_Renaming4_1_recursive ( tmp [ 0 ] , arg1 ) ) ) ;
}
...
ATerm lf_AUX_Kernel_Sdf_Renaming4_1_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 1 ] ;
FUNC_ENTRY ( lf_AUX_Kernel_Sdf_Renaming4_1_recursivesym , ATmakeAppl ( lf_AUX_Kernel_Sdf_Renaming4_1_recursivesym , arg0 , arg1 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Kernel_Sdf_Renaming4_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) , arg1 ) ) ;
}
}
