...
FUNC_EXIT_CONST ( constant1 , ( * ef2 ) ( make_nf1 ( ef3sym , lf3 ( make_list ( null ( ) ) ) ) ) ) ;
}
...
( tmp [ 2 ] = arg_0 ( tmp [ 0 ] ) ) ;
( tmp [ 3 ] = arg_1 ( tmp [ 0 ] ) ) ;
FUNC_EXIT ( ( * ef5 ) ( ( * ef2 ) ( make_nf1 ( ef3sym , lf3 ( cons ( make_list ( tmp [ 2 ] ) , make_list ( tmp [ 3 ] ) ) ) ) ) , lf_AUX_Alias_Sdf_Normalization4_1_recursive ( make_list ( tmp [ 1 ] ) ) ) ) ;
}
}
}
}
