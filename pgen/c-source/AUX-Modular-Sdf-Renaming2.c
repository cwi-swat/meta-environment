...
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
( tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( ( * ef3 ) ( tmp [ 1 ] , ( * ef4 ) ( tmp [ 2 ] , arg1 ) ) ) ) ) ) ;
}
if ( check_sym ( tmp [ 0 ] , ef2sym ) ) {
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( ( * ef3 ) ( tmp [ 1 ] , arg1 ) ) ) ) ) ;
}
}
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
( tmp [ 1 ] = lf_AUX_Modular_Sdf_Renaming2_1 ( make_nf1 ( ef1sym , lf2 ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) ) , arg1 ) ) ;
if ( check_sym ( tmp [ 1 ] , ef1sym ) ) {
( tmp [ 2 ] = arg_0 ( tmp [ 1 ] ) ) ;
if ( check_sym ( tmp [ 2 ] , lf2sym ) ) {
( tmp [ 3 ] = arg_0 ( tmp [ 2 ] ) ) ;
if ( not_empty_list ( tmp [ 3 ] ) ) {
( tmp [ 4 ] = lf_AUX_Modular_Sdf_Renaming2_1 ( make_nf1 ( ef1sym , lf2 ( tmp [ 0 ] ) ) , arg1 ) ) ;
