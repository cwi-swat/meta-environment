...
static Symbol lf_AUX_Parse_Table4_1sym ;
static ATerm lf_AUX_Parse_Table4_1 ( ATerm arg1 ) ;
static Symbol ef1sym ;
static funcptr ef1 ;
static Symbol ef2sym ;
static funcptr ef2 ;
void register_AUX_Parse_Table4 ( ) {
lf_AUX_Parse_Table4_1sym = ATmakeSymbol ( "prod(id(\"Parse-Table\"),w(\"\"),[sort(\"Parse-Table\"),w(\"\"),ql(\"[\"),w(\"\"),l(\"grammar\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Parse_Table4_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Parse-Table\"),w(\"\"),[sort(\"Parse-Table\"),w(\"\"),ql(\"[\"),w(\"\"),l(\"grammar\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) , lf_AUX_Parse_Table4_1 , lf_AUX_Parse_Table4_1sym ) ;
}
void resolve_AUX_Parse_Table4 ( ) {
...
void init_AUX_Parse_Table4 ( ) {
}
ATerm lf_AUX_Parse_Table4_1 ( ATerm arg0 ) {
FUNC_ENTRY ( lf_AUX_Parse_Table4_1sym , ATmakeAppl ( lf_AUX_Parse_Table4_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Parse_Table4_1sym , arg0 ) ) ;
}
