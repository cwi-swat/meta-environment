...
ef5 = lookup_func ( ATreadFromString ( "prod(id(\"Alias-Sdf-Projection\"),w(\"\"),[ql(\"~Al\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
ef5sym = lookup_sym ( ATreadFromString ( "prod(id(\"Alias-Sdf-Projection\"),w(\"\"),[ql(\"~Al\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
ef6 = lookup_func ( ATreadFromString ( "prod(id(\"Alias-Sdf-Normalization\"),w(\"\"),[ql(\"rn\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Aliases\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Renamings\"),w(\"\"),no-attrs)" ) ) ;
ef6sym = lookup_sym ( ATreadFromString ( "prod(id(\"Alias-Sdf-Normalization\"),w(\"\"),[ql(\"rn\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Aliases\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Renamings\"),w(\"\"),no-attrs)" ) ) ;
ef7 = lookup_func ( ATreadFromString ( "prod(id(\"Alias-Sdf-Projection\"),w(\"\"),[ql(\"Al\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Aliases\"),w(\"\"),no-attrs)" ) ) ;
ef7sym = lookup_sym ( ATreadFromString ( "prod(id(\"Alias-Sdf-Projection\"),w(\"\"),[ql(\"Al\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Aliases\"),w(\"\"),no-attrs)" ) ) ;
}
...
FUNC_EXIT ( ( * ef1 ) ( ( * ef2 ) ( make_nf1 ( ef3sym , lf2 ( make_list ( tmp [ 2 ] ) ) ) ) , ( * ef4 ) ( ( * ef5 ) ( arg0 ) , ( * ef6 ) ( make_nf1 ( ef3sym , lf2 ( make_list ( tmp [ 2 ] ) ) ) ) ) ) ) ;
}
}
}
FUNC_EXIT ( arg0 ) ;
