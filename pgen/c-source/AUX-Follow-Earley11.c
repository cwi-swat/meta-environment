#include  "support.h"
static Symbol lf_AUX_Follow_Earley11_1sym ;
static ATerm lf_AUX_Follow_Earley11_1 ( ATerm arg1 , ATerm arg2 , ATerm arg3 , ATerm arg4 ) ;
...
void register_AUX_Follow_Earley11 ( ) {
lf_AUX_Follow_Earley11_1sym = ATmakeSymbol ( "prod(id(\"Follow-Earley\"),w(\"\"),[l(\"nm-sons\"),w(\"\"),ql(\"[[\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\"]]\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Item\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"LabelSet\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol-Table\"),w(\"\"),no-attrs)"
 , 4 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Follow_Earley11_1sym ) ;
lf3sym = ATmakeSymbol ( "listtype(sort(\"STPair\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf3sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Production\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Follow-Earley\"),w(\"\"),[l(\"nm-sons\"),w(\"\"),ql(\"[[\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\"]]\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Item\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"LabelSet\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol-Table\"),w(\"\"),no-attrs)" ) , lf_AUX_Follow_Earley11_1 , lf_AUX_Follow_Earley11_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Production\"))" ) , lf2 , lf2sym ) ;
register_prod ( ATparse ( "listtype(sort(\"STPair\"))" ) , lf3 , lf3sym ) ;
}
void resolve_AUX_Follow_Earley11 ( ) {
...
void init_AUX_Follow_Earley11 ( ) {
ATprotect ( & constant0 ) ;
}
ATerm lf_AUX_Follow_Earley11_1 ( ATerm arg0 , ATerm arg1 , ATerm arg2 , ATerm arg3 ) {
{
ATerm tmp [ 2 ] ;
FUNC_ENTRY ( lf_AUX_Follow_Earley11_1sym , ATmakeAppl ( lf_AUX_Follow_Earley11_1sym , arg0 , arg1 , arg2 , arg3 ) ) ;
...
FUNC_EXIT ( ( * ef3 ) ( ( * ef4 ) ( arg0 , tmp [ 0 ] , arg2 , arg3 ) , lf_AUX_Follow_Earley11_1 ( arg0 , ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) , arg2 , arg3 ) ) ) ;
}
else {
...
FUNC_EXIT ( make_nf4 ( lf_AUX_Follow_Earley11_1sym , arg0 , arg1 , arg2 , arg3 ) ) ;
}
}
