...
static Symbol lf_AUX_Sdf2_Parse_Table6_1sym ;
static ATerm lf_AUX_Sdf2_Parse_Table6_1 ( ATerm arg1 ) ;
...
static funcptr ef5 ;
void register_AUX_Sdf2_Parse_Table6 ( ) {
lf_AUX_Sdf2_Parse_Table6_1sym = ATmakeSymbol ( "prod(id(\"Sdf2-Parse-Table\"),w(\"\"),[l(\"normalize\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"SDF\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Sdf2_Parse_Table6_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Sdf2-Parse-Table\"),w(\"\"),[l(\"normalize\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"SDF\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) , lf_AUX_Sdf2_Parse_Table6_1 , lf_AUX_Sdf2_Parse_Table6_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_Sdf2_Parse_Table6 ( ) {
...
void init_AUX_Sdf2_Parse_Table6 ( ) {
}
ATerm lf_AUX_Sdf2_Parse_Table6_1 ( ATerm arg0 ) {
FUNC_ENTRY ( lf_AUX_Sdf2_Parse_Table6_1sym , ATmakeAppl ( lf_AUX_Sdf2_Parse_Table6_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Sdf2_Parse_Table6_1sym , arg0 ) ) ;
}
