...
lf_AUX_Grammar_Projection2_1sym = ATmakeSymbol ( "prod(id(\"Grammar-Projection\"),w(\"\"),[ql(\"if\"),w(\"\"),sort(\"Bool\"),w(\"\"),ql(\"then\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\"else\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\"fi\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Grammar_Projection2_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Grammar-Projection\"),w(\"\"),[ql(\"if\"),w(\"\"),sort(\"Bool\"),w(\"\"),ql(\"then\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\"else\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\"fi\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) , lf_AUX_Grammar_Projection2_1 , lf_AUX_Grammar_Projection2_1sym ) ;
}
