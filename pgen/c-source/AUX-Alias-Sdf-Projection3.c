...
lf_AUX_Alias_Sdf_Projection3_1sym = ATmakeSymbol ( "prod(id(\"Alias-Sdf-Projection\"),w(\"\"),[ql(\"Al\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Aliases\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Alias_Sdf_Projection3_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Alias\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Alias-Sdf-Projection\"),w(\"\"),[ql(\"Al\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Aliases\"),w(\"\"),no-attrs)" ) , lf_AUX_Alias_Sdf_Projection3_1 , lf_AUX_Alias_Sdf_Projection3_1sym ) ;
...
ef3 = lookup_func ( ATreadFromString ( "prod(id(\"Alias-Sdf-Projection\"),w(\"\"),[sort(\"Aliases\"),w(\"\"),ql(\"++\"),w(\"\"),sort(\"Aliases\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Aliases\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"right\")],w(\"\"),l(\"}\")))" ) ) ;
ef3sym = lookup_sym ( ATreadFromString ( "prod(id(\"Alias-Sdf-Projection\"),w(\"\"),[sort(\"Aliases\"),w(\"\"),ql(\"++\"),w(\"\"),sort(\"Aliases\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Aliases\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"right\")],w(\"\"),l(\"}\")))" ) ) ;
ef4 = lookup_func ( ATreadFromString ( "prod(id(\"Alias-Sdf-Syntax\"),w(\"\"),[ql(\"aliases\"),w(\"\"),sort(\"Aliases\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
ef4sym = lookup_sym ( ATreadFromString ( "prod(id(\"Alias-Sdf-Syntax\"),w(\"\"),[ql(\"aliases\"),w(\"\"),sort(\"Aliases\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
}
...
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Alias_Sdf_Projection3_1 ( atmp00 ) , lf_AUX_Alias_Sdf_Projection3_1 ( atmp01 ) ) ) ;
}
}
}
