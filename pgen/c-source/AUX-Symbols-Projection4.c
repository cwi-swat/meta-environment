...
/* This file has been manually modified by Mark van den Brand */
...
lf_AUX_Symbols_Projection4_1sym = ATmakeSymbol ( "prod(id(\"Symbols-Projection\"),w(\"\"),[sort(\"Symbol\"),w(\"\"),ql(\"(-\"),w(\"\"),sort(\"Symbols\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
/*
ATerm ltmp [ 2 ] ;
lbl_lf_AUX_Symbols_Projection4_1 : ltmp [ 0 ] = arg0 ;
( ltmp [ 1 ] = arg1 ) ;
*/
...
goto lbl_lf_AUX_Symbols_Projection4_1 ;
}
else {
