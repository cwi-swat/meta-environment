...
static Symbol lf_AUX_Sdf2_Normalization7_1_recursivesym ;
static ATerm lf_AUX_Sdf2_Normalization7_1_recursive ( ATerm arg1 ) ;
...
lf_AUX_Sdf2_Normalization7_1_recursivesym = ATmakeSymbol ( "prod(id(\"Sdf2-Normalization\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\"-LEXp\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Priorities\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Sdf2_Normalization7_1_recursivesym ) ;
lf_AUX_Sdf2_Normalization7_1sym = ATmakeSymbol ( "prod(id(\"Sdf2-Normalization\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\"-LEXp\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Priorities\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Sdf2-Normalization\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\"-LEXp\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Priorities\"),w(\"\"),no-attrs)" ) , lf_AUX_Sdf2_Normalization7_1 , lf_AUX_Sdf2_Normalization7_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Sdf2-Normalization\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\"-LEXp\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Priorities\"),w(\"\"),no-attrs)" ) , lf_AUX_Sdf2_Normalization7_1_recursive , lf_AUX_Sdf2_Normalization7_1_recursivesym ) ;
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef6 ) ( lf_AUX_Sdf2_Normalization7_1_recursive ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) , lf_AUX_Sdf2_Normalization7_1_recursive ( tmp [ 0 ] ) ) ) ;
}
...
ATerm lf_AUX_Sdf2_Normalization7_1_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 8 ] ;
FUNC_ENTRY ( lf_AUX_Sdf2_Normalization7_1_recursivesym , ATmakeAppl ( lf_AUX_Sdf2_Normalization7_1_recursivesym , arg0 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Sdf2_Normalization7_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) ) ) ;
}
}
