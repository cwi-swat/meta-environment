...
static Symbol lf_AUX_Parse_Table6_1sym ;
static ATerm lf_AUX_Parse_Table6_1 ( ATerm arg1 ) ;
static Symbol ef1sym ;
static funcptr ef1 ;
static Symbol ef2sym ;
static funcptr ef2 ;
void register_AUX_Parse_Table6 ( ) {
lf_AUX_Parse_Table6_1sym = ATmakeSymbol ( "prod(id(\"Parse-Table\"),w(\"\"),[sort(\"Parse-Table\"),w(\"\"),ql(\"[\"),w(\"\"),l(\"labels\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Label-Table\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Parse_Table6_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Parse-Table\"),w(\"\"),[sort(\"Parse-Table\"),w(\"\"),ql(\"[\"),w(\"\"),l(\"labels\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Label-Table\"),w(\"\"),no-attrs)" ) , lf_AUX_Parse_Table6_1 , lf_AUX_Parse_Table6_1sym ) ;
}
void resolve_AUX_Parse_Table6 ( ) {
...
void init_AUX_Parse_Table6 ( ) {
}
ATerm lf_AUX_Parse_Table6_1 ( ATerm arg0 ) {
FUNC_ENTRY ( lf_AUX_Parse_Table6_1sym , ATmakeAppl ( lf_AUX_Parse_Table6_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Parse_Table6_1sym , arg0 ) ) ;
}
