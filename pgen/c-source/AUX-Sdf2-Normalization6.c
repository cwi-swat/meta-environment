...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef2 ) ( lf_AUX_Sdf2_Normalization6_1_recursive ( arg0 , slice ( atmp1000 [ 0 ] , atmp1000 [ 1 ] ) ) , lf_AUX_Sdf2_Normalization6_1_recursive ( arg0 , tmp [ 0 ] ) ) ) ;
}
...
FUNC_EXIT ( make_nf1 ( ef3sym , lf3 ( make_list ( ( * ef4 ) ( make_nf1 ( ef1sym , lf2 ( cons ( make_list ( ( * ef5 ) ( ( * ef6 ) ( ( * ef7 ) ( ) ) ) ) , cons ( make_list ( ( * ef5 ) ( tmp [ 0 ] ) ) , make_list ( ( * ef5 ) ( ( * ef6 ) ( ( * ef7 ) ( ) ) ) ) ) ) ) ) , arg0 , ( * ef8 ) ( ) ) ) ) ) ) ;
}
}
}
}
