...
lf_AUX_Action_Earley2_1sym = ATmakeSymbol ( "prod(id(\"Action-Earley\"),w(\"\"),[l(\"shifts\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Goto-Table\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Action-Table\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"parameter\"),w(\"\"),sep(\",\"),w(\"\"),l(\"memo\")],w(\"\"),l(\"}\")))"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Action_Earley2_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Action-Earley\"),w(\"\"),[l(\"shifts\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Goto-Table\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Action-Table\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"parameter\"),w(\"\"),sep(\",\"),w(\"\"),l(\"memo\")],w(\"\"),l(\"}\")))" ) , lf_AUX_Action_Earley2_1 , lf_AUX_Action_Earley2_1sym ) ;
}
...
static ATermTable table_lf_AUX_Action_Earley2_1 ;
void init_AUX_Action_Earley2 ( ) {
create_table ( table_lf_AUX_Action_Earley2_1 , 0 ) ;
}
ATerm lf_AUX_Action_Earley2_1 ( ATerm arg0 ) {
ATerm interm = make_tuple1 ( arg0 ) ;
ATermTable table = get_table ( table_lf_AUX_Action_Earley2_1 ) ;
