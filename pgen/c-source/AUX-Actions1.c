...
static ATerm lf_AUX_Actions1_2 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
static Symbol lf_AUX_Actions1_3sym ;
static ATerm lf_AUX_Actions1_3 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
lf_AUX_Actions1_2sym = ATmakeSymbol ( "prod(id(\"Actions\"),w(\"\"),[l(\"reduce\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Int\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Int\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Label\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Action\"),w(\"\"),no-attrs)" , 3 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Actions1_2sym ) ;
lf_AUX_Actions1_3sym = ATmakeSymbol ( "prod(id(\"Actions\"),w(\"\"),[l(\"reduce\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Int\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Int\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Int\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Action\"),w(\"\"),no-attrs)" , 3 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Actions\"),w(\"\"),[l(\"reduce\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Int\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Int\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Label\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Action\"),w(\"\"),no-attrs)" ) , lf_AUX_Actions1_2 , lf_AUX_Actions1_2sym ) ;
register_prod ( ATparse ( "prod(id(\"Actions\"),w(\"\"),[l(\"reduce\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Int\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Int\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Int\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Action\"),w(\"\"),no-attrs)" ) , lf_AUX_Actions1_3 , lf_AUX_Actions1_3sym ) ;
...
ATerm lf_AUX_Actions1_3 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
CONS_ENTRY ( lf_AUX_Actions1_3sym , ATmakeAppl ( lf_AUX_Actions1_3sym , arg0 , arg1 , arg2 ) ) ;
CONS_EXIT ( make_nf3 ( lf_AUX_Actions1_3sym , arg0 , arg1 , arg2 ) ) ;
}
ATerm lf_AUX_Actions1_2 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
CONS_ENTRY ( lf_AUX_Actions1_2sym , ATmakeAppl ( lf_AUX_Actions1_2sym , arg0 , arg1 , arg2 ) ) ;
CONS_EXIT ( make_nf3 ( lf_AUX_Actions1_2sym , arg0 , arg1 , arg2 ) ) ;
}
