#include  "support.h"
static Symbol lf_AUX_Parse_Table23_1sym ;
static ATerm lf_AUX_Parse_Table23_1 ( ATerm arg1 ) ;
static Symbol ef1sym ;
static funcptr ef1 ;
static Symbol ef2sym ;
static funcptr ef2 ;
void register_AUX_Parse_Table23 ( ) {
lf_AUX_Parse_Table23_1sym = ATmakeSymbol ( "prod(id(\"Parse-Table\"),w(\"\"),[sort(\"State\"),w(\"\"),ql(\"[\"),w(\"\"),l(\"id\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Int\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Parse_Table23_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Parse-Table\"),w(\"\"),[sort(\"State\"),w(\"\"),ql(\"[\"),w(\"\"),l(\"id\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Int\"),w(\"\"),no-attrs)" ) , lf_AUX_Parse_Table23_1 , lf_AUX_Parse_Table23_1sym ) ;
}
void resolve_AUX_Parse_Table23 ( ) {
...
void init_AUX_Parse_Table23 ( ) {
}
ATerm lf_AUX_Parse_Table23_1 ( ATerm arg0 ) {
FUNC_ENTRY ( lf_AUX_Parse_Table23_1sym , ATmakeAppl ( lf_AUX_Parse_Table23_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Parse_Table23_1sym , arg0 ) ) ;
}
