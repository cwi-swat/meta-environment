...
static Symbol lf_AUX_Kernel_Sdf_Projection12_1_recursivesym ;
static ATerm lf_AUX_Kernel_Sdf_Projection12_1_recursive ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
lf_AUX_Kernel_Sdf_Projection12_1_recursivesym = ATmakeSymbol ( "prod(id(\"Kernel-Sdf-Projection\"),w(\"\"),[ql(\"reachable\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"SymbolSet\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"SymbolSet\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Kernel_Sdf_Projection12_1_recursivesym ) ;
lf_AUX_Kernel_Sdf_Projection12_1sym = ATmakeSymbol ( "prod(id(\"Kernel-Sdf-Projection\"),w(\"\"),[ql(\"reachable\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"SymbolSet\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"SymbolSet\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" , 3 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Kernel-Sdf-Projection\"),w(\"\"),[ql(\"reachable\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"SymbolSet\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"SymbolSet\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) , lf_AUX_Kernel_Sdf_Projection12_1_recursive , lf_AUX_Kernel_Sdf_Projection12_1_recursivesym ) ;
...
( tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ) ;
( tmp [ 5 ] = ( * ef9 ) ( ( * ef10 ) ( make_nf1 ( ef3sym , lf3 ( make_list ( tmp [ 4 ] ) ) ) ) , arg0 ) ) ;
FUNC_EXIT ( ( * ef4 ) ( make_nf1 ( ef3sym , lf3 ( make_list ( tmp [ 4 ] ) ) ) , lf_AUX_Kernel_Sdf_Projection12_1_recursive ( ( * ef5 ) ( arg0 , ( * ef1 ) ( make_nf1 ( ef2sym , lf2 ( make_list ( tmp [ 0 ] ) ) ) ) ) , ( * ef5 ) ( tmp [ 5 ] , ( * ef1 ) ( make_nf1 ( ef2sym , lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) , make_list ( atmp200 ) ) ) ) ;
}
}
}
}
...
( tmp [ 0 ] = list_head ( atmp1000 ) ) ;
( tmp [ 1 ] = list_tail ( atmp1000 ) ) ;
FUNC_EXIT ( lf_AUX_Kernel_Sdf_Projection12_1_recursive ( arg0 , ( * ef1 ) ( make_nf1 ( ef2sym , lf2 ( make_list ( tmp [ 1 ] ) ) ) ) , make_list ( atmp200 ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_Kernel_Sdf_Projection12_1_recursive ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 6 ] ;
FUNC_ENTRY ( lf_AUX_Kernel_Sdf_Projection12_1_recursivesym , ATmakeAppl ( lf_AUX_Kernel_Sdf_Projection12_1_recursivesym , arg0 , arg1 , arg2 ) ) ;
{
ATerm ltmp [ 3 ] ;
lbl_lf_AUX_Kernel_Sdf_Projection12_1_recursive : ltmp [ 0 ] = arg0 ;
( ltmp [ 1 ] = arg1 ) ;
( ltmp [ 2 ] = arg2 ) ;
...
FUNC_EXIT ( ( * ef4 ) ( make_nf1 ( ef3sym , lf3 ( make_list ( tmp [ 4 ] ) ) ) , lf_AUX_Kernel_Sdf_Projection12_1_recursive ( ( * ef5 ) ( ltmp [ 0 ] , ( * ef1 ) ( make_nf1 ( ef2sym , lf2 ( make_list ( tmp [ 0 ] ) ) ) ) ) , ( * ef5 ) ( tmp [ 5 ] , ( * ef1 ) ( make_nf1 ( ef2sym , lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) , make_list ( atmp200 ) ) ) ) ;
}
}
}
}
...
( tmp [ 0 ] = list_head ( atmp1000 ) ) ;
( tmp [ 1 ] = list_tail ( atmp1000 ) ) ;
( arg1 = ( * ef1 ) ( make_nf1 ( ef2sym , lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) ;
( arg2 = make_list ( atmp200 ) ) ;
goto lbl_lf_AUX_Kernel_Sdf_Projection12_1_recursive ;
}
}
}
}
...
FUNC_EXIT ( make_nf3 ( lf_AUX_Kernel_Sdf_Projection12_1_recursivesym , ltmp [ 0 ] , ltmp [ 1 ] , ( * ef3 ) ( lf3 ( ltmp [ 2 ] ) ) ) ) ;
}
}
}
