...
tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ;
tmp [ 5 ] = ( * ef9 ) ( ( * ef10 ) ( ( * ef3 ) ( lf3 ( make_list ( tmp [ 4 ] ) ) ) ) , ltmp [ 0 ] ) ;
FUNC_EXIT ( ( * ef4 ) ( ( * ef3 ) ( lf3 ( make_list ( tmp [ 4 ] ) ) ) , lf_AUX_Kernel_Sdf_Projection12_1 ( ( * ef5 ) ( ltmp [ 0 ] , ( * ef1 ) ( ( * ef2 ) ( lf2 ( make_list ( tmp [ 0 ] ) ) ) ) ) , ( * ef5 ) ( tmp [ 5 ] , ( * ef1 ) ( ( * ef2 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) , ( * ef3 ) ( lf3 ( make_list ( atmp200 ) ) ) ) ) ) ;
}
}
}
}
