...
( tmp [ 2 ] = ( * ef5 ) ( ( * ef1 ) ( lf2 ( cons ( make_list ( tmp [ 0 ] ) , make_list ( ( * ef6 ) ( ( * ef1 ) ( lf2 ( cons ( make_list ( atmp000 ) , make_list ( tmp [ 1 ] ) ) ) ) ) ) ) ) ) , ( * ef6 ) ( ( * ef1 ) ( lf2 ( cons ( make_list ( atmp000 ) , cons ( make_list ( tmp [ 0 ] ) , make_list ( tmp [ 1 ] ) ) ) ) ) ) , ( * ef7 ) ( ) ) ) ;
