...
static ATerm lf_AUX_ATerm_Operations11_1 ( ATerm arg1 ) ;
...
lf_AUX_ATerm_Operations11_1sym = ATmakeSymbol ( "prod(id(\"ATerm-Operations\"),w(\"\"),[l(\"literal\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ATerm_Operations11_1sym ) ;
register_prod ( ATparse ( "prod(id(\"ATerm-Operations\"),w(\"\"),[l(\"literal\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)" ) , lf_AUX_ATerm_Operations11_1 , lf_AUX_ATerm_Operations11_1sym ) ;
}
...
ATerm lf_AUX_ATerm_Operations11_1 ( ATerm arg0 ) {
FUNC_ENTRY ( lf_AUX_ATerm_Operations11_1sym , ATmakeAppl ( lf_AUX_ATerm_Operations11_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_ATerm_Operations11_1sym , arg0 ) ) ;
}
