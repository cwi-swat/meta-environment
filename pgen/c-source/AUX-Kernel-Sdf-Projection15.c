...
static ATerm lf_AUX_Kernel_Sdf_Projection15_1 ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Kernel_Sdf_Projection15_1sym = ATmakeSymbol ( "prod(id(\"Kernel-Sdf-Projection\"),w(\"\"),[ql(\"nm-P\"),w(\"\"),ql(\"_\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Kernel-Sdf-Projection\"),w(\"\"),[ql(\"nm-P\"),w(\"\"),ql(\"_\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) , lf_AUX_Kernel_Sdf_Projection15_1 , lf_AUX_Kernel_Sdf_Projection15_1sym ) ;
...
ATerm lf_AUX_Kernel_Sdf_Projection15_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 7 ] ;
FUNC_ENTRY ( lf_AUX_Kernel_Sdf_Projection15_1sym , ATmakeAppl ( lf_AUX_Kernel_Sdf_Projection15_1sym , arg0 , arg1 ) ) ;
{
ATerm ltmp [ 2 ] ;
lbl_lf_AUX_Kernel_Sdf_Projection15_1 : ltmp [ 0 ] = arg0 ;
( ltmp [ 1 ] = arg1 ) ;
...
FUNC_EXIT ( ( * ef4 ) ( ( * ef1 ) ( lf2 ( make_list ( ( * ef2 ) ( ( * ef3 ) ( lf3 ( make_list ( tmp [ 6 ] ) ) ) , ltmp [ 0 ] , tmp [ 4 ] ) ) ) ) , lf_AUX_Kernel_Sdf_Projection15_1 ( ltmp [ 0 ] , ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) ) ;
}
}
}
}
...
goto lbl_lf_AUX_Kernel_Sdf_Projection15_1 ;
}
}
}
}
}
FUNC_EXIT ( make_nf2 ( lf_AUX_Kernel_Sdf_Projection15_1sym , ltmp [ 0 ] , ltmp [ 1 ] ) ) ;
}
}
}
