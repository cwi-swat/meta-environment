...
( tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ) ;
( tmp [ 5 ] = ( * ef19 ) ( ( * ef5 ) ( ( * ef6 ) ( ( * ef7 ) ( ( * ef20 ) ( ( * ef21 ) ( ) , ( * ef22 ) ( ) ) ) ) ) , tmp [ 2 ] ) ) ;
...
( tmp [ 7 ] = arg_0 ( tmp [ 6 ] ) ) ;
if ( term_equal ( tmp [ 7 ] , ( constant0 ? constant0 : ( constant0 = ( * ef9 ) ( ) ) ) ) ) {
if ( check_sym ( tmp [ 3 ] , ef10sym ) ) {
( tmp [ 8 ] = arg_0 ( tmp [ 3 ] ) ) ;
( tmp [ 9 ] = lf_AUX_Action_PCC7_1 ( ( * ef1 ) ( ( * ef2 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) ) ;
( tmp [ 10 ] = ( * ef11 ) ( tmp [ 9 ] , ( * ef12 ) ( ( * ef13 ) ( lf3 ( make_list ( ( * ef14 ) ( ( * ef15 ) ( ( * ef5 ) ( ( * ef6 ) ( ( * ef7 ) ( ( * ef8 ) ( ( * ef9 ) ( ) ) ) ) ) ) ) ) ) ) ) , ( * ef16 ) ( ( * ef17 ) ( lf4 ( make_list ( ( * ef18 ) ( ) ) ) ) ) ) ) ;
FUNC_EXIT ( tmp [ 10 ] ) ;
}
}
}
