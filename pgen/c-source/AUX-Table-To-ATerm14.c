...
static ATerm lf_AUX_Table_To_ATerm14_1 ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Table_To_ATerm14_1sym = ATmakeSymbol ( "prod(id(\"Table-To-ATerm\"),w(\"\"),[l(\"prios2aterm\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Priorities\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Label-Table\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Table_To_ATerm14_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Priority\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Table-To-ATerm\"),w(\"\"),[l(\"prios2aterm\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Priorities\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Label-Table\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)" ) , lf_AUX_Table_To_ATerm14_1 , lf_AUX_Table_To_ATerm14_1sym ) ;
...
ATerm lf_AUX_Table_To_ATerm14_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 1 ] ;
FUNC_ENTRY ( lf_AUX_Table_To_ATerm14_1sym , ATmakeAppl ( lf_AUX_Table_To_ATerm14_1sym , arg0 , arg1 ) ) ;
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Table_To_ATerm14_1sym , arg0 , arg1 ) ) ;
}
}
