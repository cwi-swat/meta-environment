...
static Symbol lf_AUX_Basic_Sdf_Normalization12_1_recursivesym ;
static ATerm lf_AUX_Basic_Sdf_Normalization12_1_recursive ( ATerm arg1 ) ;
...
lf_AUX_Basic_Sdf_Normalization12_1_recursivesym = ATmakeSymbol ( "prod(id(\"Basic-Sdf-Normalization\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\"-VARs\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Basic_Sdf_Normalization12_1_recursivesym ) ;
lf_AUX_Basic_Sdf_Normalization12_1sym = ATmakeSymbol ( "prod(id(\"Basic-Sdf-Normalization\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\"-VARs\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Basic-Sdf-Normalization\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\"-VARs\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) , lf_AUX_Basic_Sdf_Normalization12_1_recursive , lf_AUX_Basic_Sdf_Normalization12_1_recursivesym ) ;
...
( tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ) ;
( tmp [ 6 ] = ( * ef8 ) ( tmp [ 3 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( cons ( make_list ( ( * ef3 ) ( ( * ef5 ) ( make_nf1 ( ef4sym , lf3 ( make_list ( tmp [ 5 ] ) ) ) ) , ( * ef6 ) ( ( * ef7 ) ( tmp [ 2 ] ) ) , tmp [ 3 ] ) ) , make_list ( ( * ef3 ) ( make_nf1 ( ef4sym , lf3 ( make_list ( ( * ef6 ) ( ( * ef7 ) ( tmp [ 2 ] ) ) ) ) ) , ( * ef7 ) ( tmp [ 2 ] ) , tmp [ 6 ] ) ) ) ) ) ) ;
}
}
}
}
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef2 ) ( lf_AUX_Basic_Sdf_Normalization12_1_recursive ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) , lf_AUX_Basic_Sdf_Normalization12_1_recursive ( tmp [ 0 ] ) ) ) ;
}
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Basic_Sdf_Normalization12_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) ) ) ;
}
}
