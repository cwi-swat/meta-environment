...
FUNC_EXIT ( ( * ef2 ) ( ( * ef2 ) ( lf_AUX_Regular_Sdf_Normalization5_1 ( atmp00 ) , make_nf1 ( ef3sym , lf2 ( make_list ( ( * ef4 ) ( ( * ef5 ) ( lf3 ( ( ATerm ) ATmakeList ( 3 , char_table [ 34 ] , char_table [ 44 ] , char_table [ 34 ] ) ) ) ) ) ) ) ) , lf_AUX_Regular_Sdf_Normalization5_1 ( atmp01 ) ) ) ;
}
}
}
FUNC_EXIT ( make_nf1 ( ef3sym , lf2 ( make_list ( arg0 ) ) ) ) ;
