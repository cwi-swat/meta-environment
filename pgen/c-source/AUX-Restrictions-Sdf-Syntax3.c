...
ef4 = lookup_func ( ATreadFromString ( "prod(id(\"Restrictions-Sdf-Syntax\"),w(\"\"),[sort(\"CharClass\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Lookahead\"),w(\"\"),no-attrs)" ) ) ;
ef4sym = lookup_sym ( ATreadFromString ( "prod(id(\"Restrictions-Sdf-Syntax\"),w(\"\"),[sort(\"CharClass\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Lookahead\"),w(\"\"),no-attrs)" ) ) ;
}
...
( arg0 = ( * ef1 ) ( lf2 ( make_list ( ( * ef3 ) ( atmp000 , atmp001 ) ) ) ) ) ;
...
{
ATerm atmp000 = arg_0 ( atmp00 ) ;
( arg0 = ( * ef1 ) ( lf2 ( make_list ( ( * ef4 ) ( atmp000 ) ) ) ) ) ;
goto lbl_lf_AUX_Restrictions_Sdf_Syntax3_1 ;
}
}
}
...
( arg1 = ( * ef1 ) ( lf2 ( make_list ( ( * ef3 ) ( atmp100 , atmp101 ) ) ) ) ) ;
goto lbl_lf_AUX_Restrictions_Sdf_Syntax3_1 ;
}
}
}
...
{
ATerm atmp100 = arg_0 ( atmp10 ) ;
( arg1 = ( * ef1 ) ( lf2 ( make_list ( ( * ef4 ) ( atmp100 ) ) ) ) ) ;
goto lbl_lf_AUX_Restrictions_Sdf_Syntax3_1 ;
}
}
}
