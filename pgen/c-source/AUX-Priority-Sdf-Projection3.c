...
lf_AUX_Priority_Sdf_Projection3_1sym = ATmakeSymbol ( "prod(id(\"Priority-Sdf-Projection\"),w(\"\"),[ql(\"Pr\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Priorities\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Priority_Sdf_Projection3_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Priority\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Priority-Sdf-Projection\"),w(\"\"),[ql(\"Pr\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Priorities\"),w(\"\"),no-attrs)" ) , lf_AUX_Priority_Sdf_Projection3_1 , lf_AUX_Priority_Sdf_Projection3_1sym ) ;
...
FUNC_ENTRY ( lf_AUX_Priority_Sdf_Projection3_1sym , ATmakeAppl ( lf_AUX_Priority_Sdf_Projection3_1sym , arg0 ) ) ;
...
FUNC_EXIT ( ( * ef4 ) ( lf_AUX_Priority_Sdf_Projection3_1 ( atmp00 ) , lf_AUX_Priority_Sdf_Projection3_1 ( atmp01 ) ) ) ;
}
}
}
FUNC_EXIT_CONST ( constant0 , ( * ef2 ) ( lf2 ( make_list ( null ( ) ) ) ) ) ;
FUNC_EXIT ( make_nf1 ( lf_AUX_Priority_Sdf_Projection3_1sym , arg0 ) ) ;
}
