...
static ATerm lf_AUX_Modular_Sdf_Normalization8_1 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
lf_AUX_Modular_Sdf_Normalization8_1sym = ATmakeSymbol ( "prod(id(\"Modular-Sdf-Normalization\"),w(\"\"),[l(\"imp\"),w(\"\"),ql(\"[[\"),w(\"\"),sort(\"Definition\"),w(\"\"),ql(\"]]\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Imports\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Import\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IG\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Modular_Sdf_Normalization8_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Import\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Modular-Sdf-Normalization\"),w(\"\"),[l(\"imp\"),w(\"\"),ql(\"[[\"),w(\"\"),sort(\"Definition\"),w(\"\"),ql(\"]]\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Imports\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Import\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IG\"),w(\"\"),no-attrs)" ) , lf_AUX_Modular_Sdf_Normalization8_1 , lf_AUX_Modular_Sdf_Normalization8_1sym ) ;
...
ATerm lf_AUX_Modular_Sdf_Normalization8_1 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 1 ] ;
FUNC_ENTRY ( lf_AUX_Modular_Sdf_Normalization8_1sym , ATmakeAppl ( lf_AUX_Modular_Sdf_Normalization8_1sym , arg0 , arg1 , arg2 ) ) ;
...
FUNC_EXIT ( make_nf3 ( lf_AUX_Modular_Sdf_Normalization8_1sym , arg0 , arg1 , arg2 ) ) ;
}
}
