...
static Symbol lf_AUX_Kernel_Sdf_Projection16_1sym ;
static ATerm lf_AUX_Kernel_Sdf_Projection16_1 ( ATerm arg1 ) ;
...
void register_AUX_Kernel_Sdf_Projection16 ( ) {
lf_AUX_Kernel_Sdf_Projection16_1sym = ATmakeSymbol ( "prod(id(\"Kernel-Sdf-Projection\"),w(\"\"),[ql(\"nm-P\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Kernel_Sdf_Projection16_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Production\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Kernel-Sdf-Projection\"),w(\"\"),[ql(\"nm-P\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) , lf_AUX_Kernel_Sdf_Projection16_1 , lf_AUX_Kernel_Sdf_Projection16_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Production\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_Kernel_Sdf_Projection16 ( ) {
...
void init_AUX_Kernel_Sdf_Projection16 ( ) {
ATprotect ( & constant0 ) ;
}
ATerm lf_AUX_Kernel_Sdf_Projection16_1 ( ATerm arg0 ) {
FUNC_ENTRY ( lf_AUX_Kernel_Sdf_Projection16_1sym , ATmakeAppl ( lf_AUX_Kernel_Sdf_Projection16_1sym , arg0 ) ) ;
...
FUNC_EXIT ( ( * ef4 ) ( lf_AUX_Kernel_Sdf_Projection16_1 ( atmp00 ) , lf_AUX_Kernel_Sdf_Projection16_1 ( atmp01 ) ) ) ;
}
}
}
FUNC_EXIT_CONST ( constant0 , ( * ef2 ) ( lf2 ( make_list ( null ( ) ) ) ) ) ;
FUNC_EXIT ( make_nf1 ( lf_AUX_Kernel_Sdf_Projection16_1sym , arg0 ) ) ;
}
