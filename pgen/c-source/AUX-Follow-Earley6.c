...
{
ATerm ltmp [ 4 ] ;
lbl_lf_AUX_Follow_Earley6_1 : ltmp [ 0 ] = arg0 ;
ltmp [ 1 ] = arg1 ;
ltmp [ 2 ] = arg2 ;
ltmp [ 3 ] = arg3 ;
...
arg3 = ( * ef4 ) ( ltmp [ 0 ] , ( * ef5 ) ( ( constant0 ? constant0 : ( constant0 = ( * ef3 ) ( lf3 ( make_list ( null ( ) ) ) ) ) ) , ( * ef2 ) ( ( * ef3 ) ( lf3 ( make_list ( tmp [ 6 ] ) ) ) , tmp [ 3 ] , tmp [ 4 ] ) ) , ltmp [ 2 ] , ltmp [ 3 ] ) ;
...
FUNC_EXIT ( make_nf4 ( lf_AUX_Follow_Earley6_1sym , ltmp [ 0 ] , ltmp [ 1 ] , ltmp [ 2 ] , ltmp [ 3 ] ) ) ;
}
}
}
