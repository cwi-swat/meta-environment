...
static Symbol lf_AUX_Priority_Sdf_Renaming2_1_recursivesym ;
static ATerm lf_AUX_Priority_Sdf_Renaming2_1_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Priority_Sdf_Renaming2_1_recursivesym = ATmakeSymbol ( "prod(id(\"Priority-Sdf-Renaming\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\")\"),w(\"\"),sort(\"Renamings\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Priorities\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Priority_Sdf_Renaming2_1_recursivesym ) ;
lf_AUX_Priority_Sdf_Renaming2_1sym = ATmakeSymbol ( "prod(id(\"Priority-Sdf-Renaming\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\")\"),w(\"\"),sort(\"Renamings\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Priorities\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Priority-Sdf-Renaming\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\")\"),w(\"\"),sort(\"Renamings\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Priorities\"),w(\"\"),no-attrs)" ) , lf_AUX_Priority_Sdf_Renaming2_1_recursive , lf_AUX_Priority_Sdf_Renaming2_1_recursivesym ) ;
...
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( make_nf1 ( ef5sym , lf3 ( cons ( make_list ( ( * ef4 ) ( tmp [ 3 ] , arg1 ) ) , make_list ( ( * ef4 ) ( tmp [ 5 ] , arg1 ) ) ) ) ) ) ) ) ) ;
}
if ( not_empty_list ( tmp [ 4 ] ) ) {
( tmp [ 5 ] = list_head ( tmp [ 4 ] ) ) ;
( tmp [ 6 ] = list_tail ( tmp [ 4 ] ) ) ;
if ( not_empty_list ( tmp [ 6 ] ) ) {
( tmp [ 7 ] = lf_AUX_Priority_Sdf_Renaming2_1_recursive ( make_list ( make_nf1 ( ef5sym , lf3 ( cons ( make_list ( tmp [ 5 ] ) , make_list ( tmp [ 6 ] ) ) ) ) ) , arg1 ) ) ;
( tmp [ 8 ] = arg_0 ( tmp [ 7 ] ) ) ;
( tmp [ 9 ] = arg_0 ( tmp [ 8 ] ) ) ;
...
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( make_nf1 ( ef5sym , lf3 ( cons ( make_list ( ( * ef4 ) ( tmp [ 3 ] , arg1 ) ) , cons ( make_list ( tmp [ 13 ] ) , make_list ( tmp [ 14 ] ) ) ) ) ) ) ) ) ) ;
}
}
}
}
...
( tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ) ;
( tmp [ 3 ] = arg_2 ( tmp [ 0 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( ( * ef3 ) ( ( * ef4 ) ( tmp [ 1 ] , arg1 ) , tmp [ 2 ] , ( * ef4 ) ( tmp [ 3 ] , arg1 ) ) ) ) ) ) ;
}
}
}
}
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef2 ) ( lf_AUX_Priority_Sdf_Renaming2_1_recursive ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) , arg1 ) , lf_AUX_Priority_Sdf_Renaming2_1_recursive ( tmp [ 0 ] , arg1 ) ) ) ;
}
...
ATerm lf_AUX_Priority_Sdf_Renaming2_1_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 15 ] ;
FUNC_ENTRY ( lf_AUX_Priority_Sdf_Renaming2_1_recursivesym , ATmakeAppl ( lf_AUX_Priority_Sdf_Renaming2_1_recursivesym , arg0 , arg1 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Priority_Sdf_Renaming2_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) , arg1 ) ) ;
}
}
