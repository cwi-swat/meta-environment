...
ef3 = lookup_func ( ATreadFromString ( "prod(id(\"Priority-Sdf-Renaming\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Group\"),w(\"\"),ql(\")G\"),w(\"\"),sort(\"Renamings\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Group\"),w(\"\"),no-attrs)" ) ) ;
ef3sym = lookup_sym ( ATreadFromString ( "prod(id(\"Priority-Sdf-Renaming\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Group\"),w(\"\"),ql(\")G\"),w(\"\"),sort(\"Renamings\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Group\"),w(\"\"),no-attrs)" ) ) ;
...
( tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ) ;
( tmp [ 3 ] = arg_2 ( tmp [ 0 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( ( * ef4 ) ( ( * ef3 ) ( tmp [ 1 ] , arg1 ) , tmp [ 2 ] , ( * ef3 ) ( tmp [ 3 ] , arg1 ) ) ) ) ) ) ;
}
...
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( make_nf1 ( ef2sym , lf3 ( cons ( make_list ( ( * ef3 ) ( tmp [ 3 ] , arg1 ) ) , make_list ( ( * ef3 ) ( tmp [ 5 ] , arg1 ) ) ) ) ) ) ) ) ) ;
}
if ( not_empty_list ( tmp [ 4 ] ) ) {
( tmp [ 5 ] = list_head ( tmp [ 4 ] ) ) ;
( tmp [ 6 ] = list_tail ( tmp [ 4 ] ) ) ;
if ( not_empty_list ( tmp [ 6 ] ) ) {
( tmp [ 7 ] = lf_AUX_Priority_Sdf_Renaming2_1 ( make_nf1 ( ef1sym , lf2 ( make_list ( make_nf1 ( ef2sym , lf3 ( cons ( make_list ( tmp [ 5 ] ) , make_list ( tmp [ 6 ] ) ) ) ) ) ) ) , arg1 ) ) ;
...
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( make_nf1 ( ef2sym , lf3 ( cons ( make_list ( ( * ef3 ) ( tmp [ 3 ] , arg1 ) ) , cons ( make_list ( tmp [ 13 ] ) , make_list ( tmp [ 14 ] ) ) ) ) ) ) ) ) ) ;
}
}
}
}
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef5 ) ( lf_AUX_Priority_Sdf_Renaming2_1 ( make_nf1 ( ef1sym , lf2 ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) ) , arg1 ) , lf_AUX_Priority_Sdf_Renaming2_1 ( make_nf1 ( ef1sym , lf2 ( tmp [ 0 ] ) ) , arg1 ) ) ) ;
}
