#include  "support.h"
static Symbol lf_AUX_Goto_Earley10_1sym ;
static ATerm lf_AUX_Goto_Earley10_1 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
void register_AUX_Goto_Earley10 ( ) {
lf_AUX_Goto_Earley10_1sym = ATmakeSymbol ( "prod(id(\"Goto-Earley\"),w(\"\"),[l(\"nm-shift\"),w(\"\"),ql(\"[[\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\"]]\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Vertex\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Label\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Vertex\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Goto_Earley10_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Item\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Goto-Earley\"),w(\"\"),[l(\"nm-shift\"),w(\"\"),ql(\"[[\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\"]]\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Vertex\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Label\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Vertex\"),w(\"\"),no-attrs)" ) , lf_AUX_Goto_Earley10_1 , lf_AUX_Goto_Earley10_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Item\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_Goto_Earley10 ( ) {
...
void init_AUX_Goto_Earley10 ( ) {
}
ATerm lf_AUX_Goto_Earley10_1 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 3 ] ;
FUNC_ENTRY ( lf_AUX_Goto_Earley10_1sym , ATmakeAppl ( lf_AUX_Goto_Earley10_1sym , arg0 , arg1 , arg2 ) ) ;
...
FUNC_EXIT ( ( * ef4 ) ( ( * ef1 ) ( ( * ef3 ) ( arg0 , tmp [ 0 ] , arg2 ) ) , lf_AUX_Goto_Earley10_1 ( arg0 , ( * ef1 ) ( ( * ef2 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) ) , arg2 ) ) ) ;
}
}
*/
...
FUNC_EXIT ( make_nf3 ( lf_AUX_Goto_Earley10_1sym , arg0 , arg1 , arg2 ) ) ;
}
}
