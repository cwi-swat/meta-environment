...
static ATerm lf_AUX_Sdf2_Normalization5_1 ( ATerm arg1 ) ;
...
lf_AUX_Sdf2_Normalization5_1sym = ATmakeSymbol ( "prod(id(\"Sdf2-Normalization\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\"-LEXp\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Priorities\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Sdf2-Normalization\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\"-LEXp\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Priorities\"),w(\"\"),no-attrs)" ) , lf_AUX_Sdf2_Normalization5_1 , lf_AUX_Sdf2_Normalization5_1sym ) ;
...
ATerm lf_AUX_Sdf2_Normalization5_1 ( ATerm arg0 ) {
{
ATerm tmp [ 8 ] ;
FUNC_ENTRY ( lf_AUX_Sdf2_Normalization5_1sym , ATmakeAppl ( lf_AUX_Sdf2_Normalization5_1sym , arg0 ) ) ;
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef2 ) ( lf_AUX_Sdf2_Normalization5_1 ( ( * ef1 ) ( lf2 ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) ) ) , lf_AUX_Sdf2_Normalization5_1 ( ( * ef1 ) ( lf2 ( tmp [ 0 ] ) ) ) ) ) ;
}
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Sdf2_Normalization5_1sym , arg0 ) ) ;
}
}
