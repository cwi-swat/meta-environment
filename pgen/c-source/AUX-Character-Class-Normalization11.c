...
ef12 = lookup_func ( ATreadFromString ( "prod(id(\"Character-Arithmetic\"),w(\"\"),[ql(\"pred\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Character\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Character\"),w(\"\"),no-attrs)" ) ) ;
ef12sym = lookup_sym ( ATreadFromString ( "prod(id(\"Character-Arithmetic\"),w(\"\"),[ql(\"pred\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Character\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Character\"),w(\"\"),no-attrs)" ) ) ;
ef13 = lookup_func ( ATreadFromString ( "prod(id(\"Character-Arithmetic\"),w(\"\"),[ql(\"succ\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Character\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Character\"),w(\"\"),no-attrs)" ) ) ;
ef13sym = lookup_sym ( ATreadFromString ( "prod(id(\"Character-Arithmetic\"),w(\"\"),[ql(\"succ\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Character\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Character\"),w(\"\"),no-attrs)" ) ) ;
...
FUNC_EXIT ( ( * ef2 ) ( ( * ef3 ) ( atmp00 , atmp10 ) , ( * ef4 ) ( ( * ef5 ) ( ) ) , ( * ef4 ) ( ( * ef6 ) ( ( * ef7 ) ( arg0 ) ) ) ) ) ;
}
}
...
FUNC_EXIT ( ( * ef2 ) ( ( * ef9 ) ( ( * ef10 ) ( atmp10 , atmp00 ) , ( * ef10 ) ( atmp00 , atmp11 ) ) , ( * ef4 ) ( ( * ef5 ) ( ) ) , ( * ef4 ) ( ( * ef6 ) ( ( * ef7 ) ( arg0 ) ) ) ) ) ;
}
}
}
}
...
{
ATerm atmp10 = arg_0 ( arg1 ) ;
FUNC_EXIT ( ( * ef2 ) ( ( * ef9 ) ( ( * ef10 ) ( atmp00 , atmp10 ) , ( * ef10 ) ( atmp10 , atmp01 ) ) , ( * ef4 ) ( ( * ef6 ) ( ( * ef11 ) ( ( * ef7 ) ( ( * ef8 ) ( atmp00 , ( * ef12 ) ( atmp10 ) ) ) , ( * ef7 ) ( ( * ef8 ) ( ( * ef13 ) ( atmp10 ) , atmp01 ) ) ) ) ) , ( * ef4 ) ( ( * ef6 ) ( ( * ef7 ) ( arg0 ) ) ) ) ) ;
}
}
if ( check_sym ( arg1 , ef8sym ) ) {
{
...
ATerm atmp11 = arg_1 ( arg1 ) ;
( tmp [ 0 ] = ( * ef13 ) ( atmp11 ) ) ;
FUNC_EXIT ( ( * ef2 ) ( ( * ef9 ) ( ( * ef10 ) ( atmp10 , atmp01 ) , ( * ef14 ) ( atmp00 , tmp [ 0 ] ) ) , ( * ef4 ) ( ( * ef6 ) ( ( * ef11 ) ( ( * ef7 ) ( ( * ef8 ) ( atmp00 , ( * ef12 ) ( atmp10 ) ) ) , ( * ef7 ) ( ( * ef8 ) ( tmp [ 0 ] , atmp01 ) ) ) ) ) , ( * ef4 ) ( ( * ef6 ) ( ( * ef7 ) ( arg0 ) ) ) ) ) ;
}
}
}
}
