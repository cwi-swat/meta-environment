...
static Symbol lf_AUX_Modular_Sdf_Projection5_1_recursivesym ;
static ATerm lf_AUX_Modular_Sdf_Projection5_1_recursive ( ATerm arg1 ) ;
...
lf_AUX_Modular_Sdf_Projection5_1_recursivesym = ATmakeSymbol ( "prod(id(\"Modular-Sdf-Projection\"),w(\"\"),[ql(\"Exp\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Sections\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Modular_Sdf_Projection5_1_recursivesym ) ;
lf_AUX_Modular_Sdf_Projection5_1sym = ATmakeSymbol ( "prod(id(\"Modular-Sdf-Projection\"),w(\"\"),[ql(\"Exp\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Sections\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Modular_Sdf_Projection5_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Section\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Modular-Sdf-Projection\"),w(\"\"),[ql(\"Exp\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Sections\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) , lf_AUX_Modular_Sdf_Projection5_1 , lf_AUX_Modular_Sdf_Projection5_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Modular-Sdf-Projection\"),w(\"\"),[ql(\"Exp\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Sections\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) , lf_AUX_Modular_Sdf_Projection5_1_recursive , lf_AUX_Modular_Sdf_Projection5_1_recursivesym ) ;
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Modular_Sdf_Projection5_1_recursive ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) , lf_AUX_Modular_Sdf_Projection5_1_recursive ( tmp [ 0 ] ) ) ) ;
}
...
ATerm lf_AUX_Modular_Sdf_Projection5_1_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 2 ] ;
FUNC_ENTRY ( lf_AUX_Modular_Sdf_Projection5_1_recursivesym , ATmakeAppl ( lf_AUX_Modular_Sdf_Projection5_1_recursivesym , arg0 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Modular_Sdf_Projection5_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) ) ) ;
}
}
