...
lf_AUX_Modular_Sdf_Projection5_1sym = ATmakeSymbol ( "prod(id(\"Modular-Sdf-Projection\"),w(\"\"),[ql(\"Exp\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Sections\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef5 ) ( lf_AUX_Modular_Sdf_Projection5_1 ( make_nf1 ( ef1sym , lf2 ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) ) ) , lf_AUX_Modular_Sdf_Projection5_1 ( make_nf1 ( ef1sym , lf2 ( tmp [ 0 ] ) ) ) ) ) ;
}
