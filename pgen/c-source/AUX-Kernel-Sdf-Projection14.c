...
{
ATerm ltmp [ 2 ] ;
lbl_lf_AUX_Kernel_Sdf_Projection14_1 : ltmp [ 0 ] = arg0 ;
ltmp [ 1 ] = arg1 ;
...
FUNC_EXIT ( ( * ef4 ) ( ( * ef1 ) ( lf2 ( make_list ( ( * ef2 ) ( ( * ef3 ) ( lf3 ( make_list ( tmp [ 6 ] ) ) ) , ltmp [ 0 ] , tmp [ 4 ] ) ) ) ) , lf_AUX_Kernel_Sdf_Projection14_1 ( ltmp [ 0 ] , ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Kernel_Sdf_Projection14_1sym , ltmp [ 0 ] , ltmp [ 1 ] ) ) ;
}
}
}
