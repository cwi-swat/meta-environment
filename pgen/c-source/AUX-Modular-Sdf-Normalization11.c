...
ef6 = lookup_func ( ATreadFromString ( "prod(id(\"Modular-Sdf-Normalization\"),w(\"\"),[ql(\"ims\"),w(\"\"),ql(\"[[\"),w(\"\"),sort(\"Definition\"),w(\"\"),ql(\"]]\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Imports\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Imports\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IG\"),w(\"\"),no-attrs)" ) ) ;
ef6sym = lookup_sym ( ATreadFromString ( "prod(id(\"Modular-Sdf-Normalization\"),w(\"\"),[ql(\"ims\"),w(\"\"),ql(\"[[\"),w(\"\"),sort(\"Definition\"),w(\"\"),ql(\"]]\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Imports\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Imports\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IG\"),w(\"\"),no-attrs)" ) ) ;
}
...
( tmp [ 9 ] = arg_0 ( tmp [ 8 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( make_nf1 ( ef1sym , lf2 ( make_list ( tmp [ 9 ] ) ) ) , ( * ef2 ) ( tmp [ 2 ] , tmp [ 7 ] ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( ( * ef6 ) ( arg0 , make_nf1 ( ef1sym , lf2 ( make_list ( atmp100 ) ) ) , make_nf1 ( ef1sym , lf2 ( make_list ( atmp20000 ) ) ) ) ) ;
}
}
}
}
...
{
ATerm atmp100 = arg_0 ( atmp10 ) ;
FUNC_EXIT ( ( * ef3 ) ( make_nf1 ( ef1sym , lf2 ( make_list ( atmp100 ) ) ) , arg2 ) ) ;
}
}
}
}
