...
{
ATerm ltmp [ 1 ] ;
lbl_lf_AUX_Character_Syntax2_2 : ltmp [ 0 ] = arg0 ;
if ( check_sym ( ltmp [ 0 ] , lf_AUX_Character_Syntax2_1sym ) ) {
{
...
arg0 = lf_AUX_Character_Syntax2_1 ( cons ( ( constant0 ? constant0 : ( constant0 = make_list ( make_char ( 92 ) ) ) ) , make_list ( tmp [ 1 ] ) ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Character_Syntax2_2sym , ltmp [ 0 ] ) ) ;
}
}
}
