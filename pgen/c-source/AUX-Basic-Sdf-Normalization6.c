...
( tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( cons ( make_list ( ( * ef5 ) ( ( * ef3 ) ( make_nf1 ( ef4sym , lf3 ( make_list ( tmp [ 5 ] ) ) ) , tmp [ 2 ] , tmp [ 3 ] ) ) ) , make_list ( ( * ef3 ) ( ( * ef6 ) ( make_nf1 ( ef4sym , lf3 ( make_list ( tmp [ 2 ] ) ) ) ) , ( * ef7 ) ( tmp [ 2 ] ) , ( * ef8 ) ( ) ) ) ) ) ) ) ;
}
}
}
}
