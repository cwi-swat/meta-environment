...
( tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( cons ( make_list ( ( * ef3 ) ( ( * ef5 ) ( make_nf1 ( ef4sym , lf3 ( make_list ( tmp [ 5 ] ) ) ) ) , ( * ef6 ) ( ( * ef7 ) ( tmp [ 2 ] ) ) , tmp [ 3 ] ) ) , make_list ( ( * ef3 ) ( make_nf1 ( ef4sym , lf3 ( make_list ( ( * ef6 ) ( ( * ef7 ) ( tmp [ 2 ] ) ) ) ) ) , ( * ef7 ) ( tmp [ 2 ] ) , tmp [ 3 ] ) ) ) ) ) ) ;
}
}
}
}
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef2 ) ( lf_AUX_Basic_Sdf_Normalization13_1_recursive ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) , lf_AUX_Basic_Sdf_Normalization13_1_recursive ( tmp [ 0 ] ) ) ) ;
}
