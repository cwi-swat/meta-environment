...
lf_AUX_Sorts_Sdf_Projection2_1sym = ATmakeSymbol ( "prod(id(\"Sorts-Sdf-Projection\"),w(\"\"),[ql(\"S\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Sorts_Sdf_Projection2_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Symbol\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Sorts-Sdf-Projection\"),w(\"\"),[ql(\"S\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)" ) , lf_AUX_Sorts_Sdf_Projection2_1 , lf_AUX_Sorts_Sdf_Projection2_1sym ) ;
...
ef4 = lookup_func ( ATreadFromString ( "prod(id(\"Sorts-Sdf-Syntax\"),w(\"\"),[ql(\"sorts\"),w(\"\"),sort(\"Symbols\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
ef4sym = lookup_sym ( ATreadFromString ( "prod(id(\"Sorts-Sdf-Syntax\"),w(\"\"),[ql(\"sorts\"),w(\"\"),sort(\"Symbols\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
}
...
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Sorts_Sdf_Projection2_1 ( atmp00 ) , lf_AUX_Sorts_Sdf_Projection2_1 ( atmp01 ) ) ) ;
}
}
}
