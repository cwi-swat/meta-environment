...
FUNC_EXIT ( ( * ef4 ) ( make_nf1 ( ef3sym , lf4 ( make_list ( tmp [ 11 ] ) ) ) , lf_AUX_Modular_Sdf_Projection4_1_recursive ( arg0 , make_list ( tmp [ 1 ] ) ) ) ) ;
}
}
}
}
...
if ( ! not_empty_list ( tmp [ 9 ] ) ) {
if ( term_equal ( atmp00 , tmp [ 5 ] ) ) {
FUNC_EXIT ( ( * ef4 ) ( ( * ef8 ) ( make_nf1 ( ef3sym , lf4 ( make_list ( tmp [ 11 ] ) ) ) , ( * ef9 ) ( make_nf1 ( ef7sym , lf5 ( make_list ( tmp [ 8 ] ) ) ) , make_nf1 ( ef7sym , lf5 ( make_list ( atmp0100 ) ) ) ) ) , lf_AUX_Modular_Sdf_Projection4_1_recursive ( ( * ef6 ) ( atmp00 , make_nf1 ( ef7sym , lf5 ( make_list ( atmp0100 ) ) ) ) , make_list ( tmp [ 1 ] ) ) ) ) ;
}
}
}
}
...
ATerm atmp100 = arg_0 ( atmp10 ) ;
if ( ! not_empty_list ( atmp100 ) ) {
FUNC_EXIT_CONST ( constant0 , make_nf1 ( ef3sym , lf4 ( make_list ( null ( ) ) ) ) ) ;
}
else {
( tmp [ 0 ] = list_head ( atmp100 ) ) ;
( tmp [ 1 ] = list_tail ( atmp100 ) ) ;
...
FUNC_EXIT ( ( * ef4 ) ( make_nf1 ( ef3sym , lf4 ( make_list ( tmp [ 7 ] ) ) ) , lf_AUX_Modular_Sdf_Projection4_1_recursive ( arg0 , make_list ( tmp [ 1 ] ) ) ) ) ;
}
}
}
}
...
if ( ! not_empty_list ( tmp [ 9 ] ) ) {
if ( term_equal ( atmp00 , tmp [ 5 ] ) ) {
FUNC_EXIT ( ( * ef4 ) ( make_nf1 ( ef3sym , lf4 ( make_list ( tmp [ 11 ] ) ) ) , lf_AUX_Modular_Sdf_Projection4_1_recursive ( ltmp [ 0 ] , make_list ( tmp [ 1 ] ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( ( * ef4 ) ( make_nf1 ( ef3sym , lf4 ( make_list ( tmp [ 7 ] ) ) ) , lf_AUX_Modular_Sdf_Projection4_1_recursive ( ltmp [ 0 ] , make_list ( tmp [ 1 ] ) ) ) ) ;
}
}
}
}
