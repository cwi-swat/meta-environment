...
FUNC_EXIT ( ( * ef4 ) ( ( * ef3 ) ( lf4 ( make_list ( tmp [ 11 ] ) ) ) , lf_AUX_Modular_Sdf_Projection4_1 ( arg0 , ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( ( * ef4 ) ( ( * ef3 ) ( lf4 ( make_list ( tmp [ 7 ] ) ) ) , lf_AUX_Modular_Sdf_Projection4_1 ( arg0 , ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Modular_Sdf_Projection4_1sym , arg0 , arg1 ) ) ;
}
}
