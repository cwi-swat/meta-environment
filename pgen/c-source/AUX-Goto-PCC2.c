...
static Symbol lf_AUX_Goto_PCC2_1sym ;
static ATerm lf_AUX_Goto_PCC2_1 ( ATerm arg1 ) ;
...
void register_AUX_Goto_PCC2 ( ) {
lf_AUX_Goto_PCC2_1sym = ATmakeSymbol ( "prod(id(\"Goto-PCC\"),w(\"\"),[l(\"prods\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Labels\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Labels\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Goto_PCC2_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Label\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Goto-PCC\"),w(\"\"),[l(\"prods\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Labels\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Labels\"),w(\"\"),no-attrs)" ) , lf_AUX_Goto_PCC2_1 , lf_AUX_Goto_PCC2_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Label\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_Goto_PCC2 ( ) {
...
ef2 = lookup_func ( ATreadFromString ( "prod(id(\"Earley-Graphs\"),w(\"\"),[sort(\"Production\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Label\"),w(\"\"),no-attrs)" ) ) ;
ef2sym = lookup_sym ( ATreadFromString ( "prod(id(\"Earley-Graphs\"),w(\"\"),[sort(\"Production\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Label\"),w(\"\"),no-attrs)" ) ) ;
...
{
ATerm ltmp [ 1 ] ;
lbl_lf_AUX_Goto_PCC2_1 : ltmp [ 0 ] = arg0 ;
...
tmp [ 2 ] = arg_0 ( tmp [ 0 ] ) ;
FUNC_EXIT ( ( * ef3 ) ( ( * ef1 ) ( lf2 ( make_list ( ( * ef2 ) ( tmp [ 2 ] ) ) ) ) , lf_AUX_Goto_PCC2_1 ( ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) ) ;
}
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Goto_PCC2_1sym , ltmp [ 0 ] ) ) ;
}
}
}
