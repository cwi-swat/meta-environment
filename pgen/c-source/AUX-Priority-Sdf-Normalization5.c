...
static Symbol lf_AUX_Priority_Sdf_Normalization5_1_recursivesym ;
static ATerm lf_AUX_Priority_Sdf_Normalization5_1_recursive ( ATerm arg1 ) ;
...
lf_AUX_Priority_Sdf_Normalization5_1_recursivesym = ATmakeSymbol ( "prod(id(\"Priority-Sdf-Normalization\"),w(\"\"),[ql(\"syntax\"),w(\"\"),ql(\"[[\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\"]]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Priority_Sdf_Normalization5_1_recursivesym ) ;
lf_AUX_Priority_Sdf_Normalization5_1sym = ATmakeSymbol ( "prod(id(\"Priority-Sdf-Normalization\"),w(\"\"),[ql(\"syntax\"),w(\"\"),ql(\"[[\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\"]]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Priority-Sdf-Normalization\"),w(\"\"),[ql(\"syntax\"),w(\"\"),ql(\"[[\"),w(\"\"),sort(\"Priorities\"),w(\"\"),ql(\"]]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) , lf_AUX_Priority_Sdf_Normalization5_1_recursive , lf_AUX_Priority_Sdf_Normalization5_1_recursivesym ) ;
...
ef8 = lookup_func ( ATreadFromString ( "prod(id(\"Grammar-Syntax\"),w(\"\"),[ql(\"(/)\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
ef8sym = lookup_sym ( ATreadFromString ( "prod(id(\"Grammar-Syntax\"),w(\"\"),[ql(\"(/)\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) ) ;
}
...
( tmp [ 7 ] = arg_0 ( tmp [ 5 ] ) ) ;
FUNC_EXIT ( ( * ef4 ) ( make_nf1 ( ef5sym , lf3 ( cons ( make_list ( tmp [ 6 ] ) , make_list ( tmp [ 7 ] ) ) ) ) ) ) ;
}
}
}
}
...
if ( check_sym ( tmp [ 3 ] , ef3sym ) ) {
( tmp [ 5 ] = arg_0 ( tmp [ 3 ] ) ) ;
FUNC_EXIT ( ( * ef4 ) ( make_nf1 ( ef5sym , lf3 ( cons ( make_list ( tmp [ 4 ] ) , make_list ( tmp [ 5 ] ) ) ) ) ) ) ;
}
}
}
}
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef7 ) ( lf_AUX_Priority_Sdf_Normalization5_1_recursive ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) , lf_AUX_Priority_Sdf_Normalization5_1_recursive ( tmp [ 0 ] ) ) ) ;
}
...
ATerm lf_AUX_Priority_Sdf_Normalization5_1_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 8 ] ;
FUNC_ENTRY ( lf_AUX_Priority_Sdf_Normalization5_1_recursivesym , ATmakeAppl ( lf_AUX_Priority_Sdf_Normalization5_1_recursivesym , arg0 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Priority_Sdf_Normalization5_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) ) ) ;
}
}
