...
( tmp [ 5 ] = arg_0 ( tmp [ 3 ] ) ) ;
FUNC_EXIT ( ( * ef6 ) ( make_nf1 ( ef7sym , lf4 ( cons ( make_list ( tmp [ 4 ] ) , make_list ( tmp [ 5 ] ) ) ) ) ) ) ;
}
}
}
...
( tmp [ 7 ] = arg_0 ( tmp [ 5 ] ) ) ;
FUNC_EXIT ( ( * ef6 ) ( make_nf1 ( ef7sym , lf4 ( cons ( make_list ( tmp [ 6 ] ) , make_list ( tmp [ 7 ] ) ) ) ) ) ) ;
}
}
}
}
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Priority_Sdf_Normalization5_1_recursive ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) , lf_AUX_Priority_Sdf_Normalization5_1_recursive ( tmp [ 0 ] ) ) ) ;
}
