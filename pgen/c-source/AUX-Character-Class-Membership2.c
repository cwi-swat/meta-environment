...
ef11 = lookup_func ( ATreadFromString ( "prod(id(\"Booleans\"),w(\"\"),[sort(\"Bool\"),w(\"\"),ql(\"\\\\\\\\/\"),w(\"\"),sort(\"Bool\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"assoc\")],w(\"\"),l(\"}\")))" ) ) ;
ef11sym = lookup_sym ( ATreadFromString ( "prod(id(\"Booleans\"),w(\"\"),[sort(\"Bool\"),w(\"\"),ql(\"\\\\\\\\/\"),w(\"\"),sort(\"Bool\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"assoc\")],w(\"\"),l(\"}\")))" ) ) ;
}
...
FUNC_EXIT ( ( * ef7 ) ( ( * ef8 ) ( atmp1000 , arg0 ) , ( * ef8 ) ( arg0 , atmp1001 ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( ( * ef11 ) ( lf_AUX_Character_Class_Membership2_1 ( arg0 , ( * ef1 ) ( atmp100 ) ) , lf_AUX_Character_Class_Membership2_1 ( arg0 , ( * ef1 ) ( atmp101 ) ) ) ) ;
}
}
}
}
