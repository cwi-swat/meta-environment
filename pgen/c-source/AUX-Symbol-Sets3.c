...
FUNC_EXIT_CONST ( constant1 , make_nf1 ( ef1sym , make_nf1 ( ef2sym , lf2 ( make_list ( null ( ) ) ) ) ) ) ;
}
}
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef5 ) ( lf_AUX_Symbol_Sets3_1 ( make_nf1 ( ef1sym , make_nf1 ( ef2sym , lf2 ( slice ( atmp00000 [ 0 ] , atmp00000 [ 1 ] ) ) ) ) , arg1 ) , lf_AUX_Symbol_Sets3_1 ( make_nf1 ( ef1sym , make_nf1 ( ef2sym , lf2 ( tmp [ 0 ] ) ) ) , arg1 ) ) ) ;
}
