...
FUNC_EXIT ( lf_AUX_Restrictions_Sdf_Projection4_1 ( arg0 , ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) ;
}
else {
...
tmp [ 6 ] = list_head ( tmp [ 5 ] ) ;
tmp [ 7 ] = list_tail ( tmp [ 5 ] ) ;
FUNC_EXIT ( lf_AUX_Restrictions_Sdf_Projection4_1 ( arg0 , ( * ef1 ) ( lf2 ( cons ( make_list ( ( * ef4 ) ( ( * ef5 ) ( lf3 ( make_list ( tmp [ 7 ] ) ) ) , tmp [ 3 ] ) ) , make_list ( tmp [ 1 ] ) ) ) ) ) ) ;
}
}
}
}
