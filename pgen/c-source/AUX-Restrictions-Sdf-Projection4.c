...
static Symbol lf_AUX_Restrictions_Sdf_Projection4_1_recursivesym ;
...
lf_AUX_Restrictions_Sdf_Projection4_1_recursivesym = ATmakeSymbol ( "prod(id(\"Restrictions-Sdf-Projection\"),w(\"\"),[ql(\"proj\"),w(\"\"),ql(\"_\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Restrictions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Lookaheads\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
FUNC_EXIT ( lf_AUX_Restrictions_Sdf_Projection4_1_recursive ( arg0 , make_list ( tmp [ 1 ] ) ) ) ;
}
else {
...
ATerm lf_AUX_Restrictions_Sdf_Projection4_1_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 8 ] ;
FUNC_ENTRY ( lf_AUX_Restrictions_Sdf_Projection4_1_recursivesym , ATmakeAppl ( lf_AUX_Restrictions_Sdf_Projection4_1_recursivesym , arg0 , arg1 ) ) ;
{
ATerm ltmp [ 2 ] ;
lbl_lf_AUX_Restrictions_Sdf_Projection4_1_recursive : ltmp [ 0 ] = arg0 ;
( ltmp [ 1 ] = arg1 ) ;
{
ATerm atmp10 = arg1 ;
{
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Restrictions_Sdf_Projection4_1_recursivesym , ltmp [ 0 ] , ( * ef1 ) ( lf2 ( ltmp [ 1 ] ) ) ) ) ;
}
}
}
