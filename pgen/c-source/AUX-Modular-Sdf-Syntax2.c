...
( tmp [ 2 ] = ( * ef4 ) ( arg0 , make_nf1 ( ef1sym , lf3 ( make_list ( atmp200 ) ) ) ) ) ;
if ( check_sym ( tmp [ 2 ] , ef1sym ) ) {
( tmp [ 3 ] = arg_0 ( tmp [ 2 ] ) ) ;
if ( check_sym ( tmp [ 3 ] , lf3sym ) ) {
( tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ) ;
FUNC_EXIT ( lf_AUX_Modular_Sdf_Syntax2_2_recursive ( arg0 , make_list ( tmp [ 0 ] ) , make_nf1 ( ef1sym , lf3 ( cons ( make_list ( ( * ef2 ) ( ( * ef3 ) ( tmp [ 1 ] ) ) ) , make_list ( tmp [ 4 ] ) ) ) ) ) ) ;
}
}
}
}
...
( tmp [ 0 ] = list_prefix ( atmp10 ) ) ;
( tmp [ 1 ] = list_last ( atmp10 ) ) ;
( tmp [ 2 ] = ( * ef4 ) ( ltmp [ 0 ] , make_nf1 ( ef1sym , lf3 ( make_list ( atmp200 ) ) ) ) ) ;
if ( check_sym ( tmp [ 2 ] , ef1sym ) ) {
( tmp [ 3 ] = arg_0 ( tmp [ 2 ] ) ) ;
if ( check_sym ( tmp [ 3 ] , lf3sym ) ) {
( tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ) ;
( arg1 = make_list ( tmp [ 0 ] ) ) ;
( arg2 = make_nf1 ( ef1sym , lf3 ( cons ( make_list ( ( * ef2 ) ( ( * ef3 ) ( tmp [ 1 ] ) ) ) , make_list ( tmp [ 4 ] ) ) ) ) ) ;
goto lbl_lf_AUX_Modular_Sdf_Syntax2_2_recursive ;
}
}
}
