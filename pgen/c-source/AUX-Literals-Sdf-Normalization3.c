...
static Symbol lf_AUX_Literals_Sdf_Normalization3_1_recursivesym ;
static ATerm lf_AUX_Literals_Sdf_Normalization3_1_recursive ( ATerm arg1 ) ;
...
lf_AUX_Literals_Sdf_Normalization3_1_recursivesym = ATmakeSymbol ( "prod(id(\"Literals-Sdf-Normalization\"),w(\"\"),[ql(\"literals\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"SymbolSet\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Literals_Sdf_Normalization3_1_recursivesym ) ;
lf_AUX_Literals_Sdf_Normalization3_1sym = ATmakeSymbol ( "prod(id(\"Literals-Sdf-Normalization\"),w(\"\"),[ql(\"literals\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"SymbolSet\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Literals-Sdf-Normalization\"),w(\"\"),[ql(\"literals\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"SymbolSet\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) , lf_AUX_Literals_Sdf_Normalization3_1 , lf_AUX_Literals_Sdf_Normalization3_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Literals-Sdf-Normalization\"),w(\"\"),[ql(\"literals\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"SymbolSet\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) , lf_AUX_Literals_Sdf_Normalization3_1_recursive , lf_AUX_Literals_Sdf_Normalization3_1_recursivesym ) ;
...
ef7 = lookup_func ( ATreadFromString ( "prod(id(\"Literals-Sdf-Normalization\"),w(\"\"),[ql(\"chars\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Literal\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)" ) ) ;
ef7sym = lookup_sym ( ATreadFromString ( "prod(id(\"Literals-Sdf-Normalization\"),w(\"\"),[ql(\"chars\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Literal\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)" ) ) ;
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Literals_Sdf_Normalization3_1_recursive ( slice ( atmp00000 [ 0 ] , atmp00000 [ 1 ] ) ) , lf_AUX_Literals_Sdf_Normalization3_1_recursive ( tmp [ 0 ] ) ) ) ;
}
...
FUNC_EXIT_CONST ( constant0 , make_nf1 ( ef4sym , lf3 ( make_list ( null ( ) ) ) ) ) ;
}
if ( is_single_element ( atmp0000 ) ) {
( tmp [ 0 ] = list_head ( atmp0000 ) ) ;
if ( check_sym ( tmp [ 0 ] , ef5sym ) ) {
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef4sym , lf3 ( make_list ( ( * ef6 ) ( ( * ef7 ) ( tmp [ 1 ] ) , ( * ef5 ) ( tmp [ 1 ] ) , ( * ef8 ) ( ) ) ) ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_Literals_Sdf_Normalization3_1_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 2 ] ;
FUNC_ENTRY ( lf_AUX_Literals_Sdf_Normalization3_1_recursivesym , ATmakeAppl ( lf_AUX_Literals_Sdf_Normalization3_1_recursivesym , arg0 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Literals_Sdf_Normalization3_1_recursivesym , ( * ef1 ) ( ( * ef2 ) ( lf2 ( arg0 ) ) ) ) ) ;
}
}
