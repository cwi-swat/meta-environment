...
public class MetaPlaybackBridge extends MetaPlaybackTool{
  private MetaPlaybackTif tool;
  ...
  public MetaPlaybackBridge(ATermFactory factory, MetaPlaybackTif tool)
  {
    super(factory);
    this.tool = tool;
  }
  ...
  public ATerm readTerm(InputStream inputStream, ATermFactory factory, Object lock) throws IOException {
	...
	if(stringdata.indexOf("\"_baf-encoded_\"(\"")!=-1){
		...
		//result = factory.make("parseError(\"Baf encoded!!\")");
	try{
...
/*
public void sendMsg(ATerm term) {
	try {
