...
public class TestingTool extends Testing
{
  ...
  ATerm question(ATermAppl a0)
  {
    ...
    try {
      R = ATerm.the_world.makeSimple("snd-value(answer(\"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzABCDEFGHHIJKLMNOPQRSTUVWXYZ\"{[label,val]}))");
