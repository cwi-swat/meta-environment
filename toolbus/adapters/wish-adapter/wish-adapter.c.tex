...
\LA{}print_backslashes~{\nwtagstyle{}\subpageref{NWwisH-priH-1}}\RA{}
...
%}}}
%{{{ static void print_backslashes(FILE *f, int level)

To correctly escape all special characters, we need to print A LOT
of backslashes. How many is calculated by {\tt slash\_mania}.

\nwenddocs{}\nwbegincode{15}\sublabel{NWwisH-priH-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWwisH-priH-1}}}\moddef{print_backslashes~{\nwtagstyle{}\subpageref{NWwisH-priH-1}}}\endmoddef\let\nwnotused=\nwoutput{}\nwstartdeflinemarkup\nwusesondefline{\\{NWwisH-wisF-1}}\nwenddeflinemarkup
...
\nwixlogsorted{c}{{print_backslashes}{NWwisH-priH-1}{\nwixu{NWwisH-wisF-1}\nwixd{NWwisH-priH-1}}}%
