...
#line 1095 "wish-adapter.c.nw"
static void help()
{
   fprintf( stderr, USAGE_MSG );
}
#line 1107 "wish-adapter.c.nw"
static void cmd_options( int argc, char* argv[] )
{
   int i;
