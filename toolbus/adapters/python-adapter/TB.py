...
#
# string:	convert a Python string to ToolBus format.
...
def init(argvec):
	...
	# Reconstruct parser
	import TBterm
	filename = "%s/TBterm.mar" % LIB
	# print "using file %s to reconstruct parser" % filename
	parser = TBterm.unmarshal_term_parser(filename)
