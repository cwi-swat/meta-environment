...
In order to implement this functionality, we introduce \emp{interface
variables} in the arm-adapter. A value can be assigned to a interface
variable using \emp{matching}. For example, the following
...
and then reduce a number of terms \emp{without reloading the arm files!}.
