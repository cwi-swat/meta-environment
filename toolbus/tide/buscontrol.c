...
term *rec_monitor(int cid, term *T)
{
  ...
  if(TBmatch(T, "%f(%d,%f,%t,%t,%t,%t,%t,%d,%t)",
    ...
    fprintf(stderr, "setting PUF_WAITING of process: %d\n", pid1);
