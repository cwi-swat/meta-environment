...
TBbool check_let_vars(term_list *formals, term_list *outer_vars, term_list *locals, term *script_name, int lino)
{
  term_list *ls;
...
TBbool check_formals_vars(term_list *formals, term_list *vars, term *script_name, int lino)
{
  term_list *fs, *vs;
  int sv_nerror = nerror;
...
TBbool check_formal_actual(sym_idx name_idx, coords *c, char *p_or_t, term_list *formals, term_list *actuals)
{
