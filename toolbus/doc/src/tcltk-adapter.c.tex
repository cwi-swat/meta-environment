...
\LA{}stop_process~{\nwtagstyle{}\subpageref{NWtclI-stoC-1}}\RA{}
\LA{}supply_info~{\nwtagstyle{}\subpageref{NWtclI-supB-1}}\RA{}

\LA{}get_info~{\nwtagstyle{}\subpageref{NWtclI-get8-1}}\RA{}
\LA{}set_observation_point~{\nwtagstyle{}\subpageref{NWtclI-setL-1}}\RA{}
\LA{}clear_observation_point~{\nwtagstyle{}\subpageref{NWtclI-cleN-1}}\RA{}

\LA{}exec_control~{\nwtagstyle{}\subpageref{NWtclI-exeC-1}}\RA{}
\LA{}execute_actions~{\nwtagstyle{}\subpageref{NWtclI-exeF-1}}\RA{}
...
The tcl/tk adapter does not have to do anything special when a process
is restarted.
\nwenddocs{}\nwbegincode{89}\sublabel{NWtclI-conG-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWtclI-conG-1}}}\moddef{continue_process~{\nwtagstyle{}\subpageref{NWtclI-conG-1}}}\endmoddef\let\nwnotused=\nwoutput{}\nwstartdeflinemarkup\nwusesondefline{\\{NWtclI-TidC-1}}\nwenddeflinemarkup
void continue_process(int pid)
\{
\}
\nwused{\\{NWtclI-TidC-1}}\nwendcode{}\nwbegindocs{90}\nwdocspar
...
\nwenddocs{}\nwbegincode{91}\sublabel{NWtclI-stoC-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWtclI-stoC-1}}}\moddef{stop_process~{\nwtagstyle{}\subpageref{NWtclI-stoC-1}}}\endmoddef\let\nwnotused=\nwoutput{}\nwstartdeflinemarkup\nwusesondefline{\\{NWtclI-TidC-1}}\nwenddeflinemarkup
void stop_process(int pid)
\{
\}
\nwused{\\{NWtclI-TidC-1}}\nwendcode{}\nwbegindocs{92}\nwdocspar
...
\nwenddocs{}\nwbegincode{93}\sublabel{NWtclI-supB-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWtclI-supB-1}}}\moddef{supply_info~{\nwtagstyle{}\subpageref{NWtclI-supB-1}}}\endmoddef\let\nwnotused=\nwoutput{}\nwstartdeflinemarkup\nwusesondefline{\\{NWtclI-TidC-1}}\nwenddeflinemarkup
term *supply_info(int cid, char *key)
\{
...
\nwenddocs{}\nwbegincode{97}\sublabel{NWtclI-setL-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWtclI-setL-1}}}\moddef{set_observation_point~{\nwtagstyle{}\subpageref{NWtclI-setL-1}}}\endmoddef\let\nwnotused=\nwoutput{}\nwstartdeflinemarkup\nwusesondefline{\\{NWtclI-TidC-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{99}\sublabel{NWtclI-cleN-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWtclI-cleN-1}}}\moddef{clear_observation_point~{\nwtagstyle{}\subpageref{NWtclI-cleN-1}}}\endmoddef\let\nwnotused=\nwoutput{}\nwstartdeflinemarkup\nwusesondefline{\\{NWtclI-TidC-1}}\nwenddeflinemarkup
void clear_observation_point(int cid, term *pids, int oid)
\{
...
%}}}
%{{{ void exec_control(int cid, term *, term *)

Control the execution state of a tool.

\nwenddocs{}\nwbegincode{101}\sublabel{NWtclI-exeC-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWtclI-exeC-1}}}\moddef{exec_control~{\nwtagstyle{}\subpageref{NWtclI-exeC-1}}}\endmoddef\let\nwnotused=\nwoutput{}\nwstartdeflinemarkup\nwusesondefline{\\{NWtclI-TidC-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{103}\sublabel{NWtclI-exeF-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWtclI-exeF-1}}}\moddef{execute_actions~{\nwtagstyle{}\subpageref{NWtclI-exeF-1}}}\endmoddef\let\nwnotused=\nwoutput{}\nwstartdeflinemarkup\nwusesondefline{\\{NWtclI-TidC-1}}\nwenddeflinemarkup
term *execute_actions(int cid, term *pids, term_list *actions)
\{
...
\nwixlogsorted{c}{{clear_observation_point}{NWtclI-cleN-1}{\nwixu{NWtclI-TidC-1}\nwixd{NWtclI-cleN-1}}}%
\nwixlogsorted{c}{{continue_process}{NWtclI-conG-1}{\nwixu{NWtclI-TidC-1}\nwixd{NWtclI-conG-1}}}%
\nwixlogsorted{c}{{error}{NWtclI-err5-1}{\nwixu{NWtclI-terD-1}\nwixd{NWtclI-err5-1}}}%
\nwixlogsorted{c}{{eval_eval_1}{NWtclI-evaB-1}{\nwixu{NWtclI-funE-1}\nwixd{NWtclI-evaB-1}}}%
\nwixlogsorted{c}{{exec_control}{NWtclI-exeC-1}{\nwixu{NWtclI-TidC-1}\nwixd{NWtclI-exeC-1}}}%
\nwixlogsorted{c}{{execute_actions}{NWtclI-exeF-1}{\nwixu{NWtclI-TidC-1}\nwixd{NWtclI-exeF-1}}}%
...
\nwixlogsorted{c}{{set_observation_point}{NWtclI-setL-1}{\nwixu{NWtclI-TidC-1}\nwixd{NWtclI-setL-1}}}%
\nwixlogsorted{c}{{signal_handler}{NWtclI-sigE-1}{\nwixu{NWtclI-tclG-1}\nwixd{NWtclI-sigE-1}}}%
\nwixlogsorted{c}{{signals_set}{NWtclI-sigB-1}{\nwixu{NWtclI-tclG-1}\nwixd{NWtclI-sigB-1}}}%
\nwixlogsorted{c}{{stop_process}{NWtclI-stoC-1}{\nwixu{NWtclI-TidC-1}\nwixd{NWtclI-stoC-1}}}%
\nwixlogsorted{c}{{supply_info}{NWtclI-supB-1}{\nwixu{NWtclI-TidC-1}\nwixd{NWtclI-supB-1}}}%
