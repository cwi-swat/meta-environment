...
\subsection{\label{ATermIO}Input and output of ATerms}
...
\subsection{\label{ATermManipulation}Further ATerm manipulation functions}
...
\subsection{\label{Memory}Memory Management of ATerms}
