...
ME_SubjectSubjectList ME_appendSubjectSubjectList(ME_SubjectSubjectList arg, ME_Subject elem) {
  return (ME_SubjectSubjectList) ATappend((ATermList) arg, (ATerm) ((ATerm) elem));
}
...
ME_SubjectSubjectList ME_replaceSubjectSubjectListSubjectAt(ME_SubjectSubjectList arg, ME_Subject elem, int index) {
 return (ME_SubjectSubjectList) ATreplace((ATermList) arg, (ATerm) ((ATerm) elem), index);
}
ME_SubjectSubjectList ME_makeSubjectSubjectList2(ME_Subject elem1, ME_Subject elem2) {
  return (ME_SubjectSubjectList) ATmakeList2((ATerm) ((ATerm) elem2), (ATerm) ((ATerm) elem2));
}
ME_SubjectSubjectList ME_makeSubjectSubjectList3(ME_Subject elem1, ME_Subject elem2, ME_Subject elem3) {
  return (ME_SubjectSubjectList) ATmakeList3((ATerm) ((ATerm) elem3), (ATerm) ((ATerm) elem3), (ATerm) ((ATerm) elem3));
}
ME_SubjectSubjectList ME_makeSubjectSubjectList4(ME_Subject elem1, ME_Subject elem2, ME_Subject elem3, ME_Subject elem4) {
  return (ME_SubjectSubjectList) ATmakeList4((ATerm) ((ATerm) elem4), (ATerm) ((ATerm) elem4), (ATerm) ((ATerm) elem4), (ATerm) ((ATerm) elem4));
}
ME_SubjectSubjectList ME_makeSubjectSubjectList5(ME_Subject elem1, ME_Subject elem2, ME_Subject elem3, ME_Subject elem4, ME_Subject elem5) {
  return (ME_SubjectSubjectList) ATmakeList5((ATerm) ((ATerm) elem5), (ATerm) ((ATerm) elem5), (ATerm) ((ATerm) elem5), (ATerm) ((ATerm) elem5), (ATerm) ((ATerm) elem5));
}
ME_SubjectSubjectList ME_makeSubjectSubjectList6(ME_Subject elem1, ME_Subject elem2, ME_Subject elem3, ME_Subject elem4, ME_Subject elem5, ME_Subject elem6) {
  return (ME_SubjectSubjectList) ATmakeList6((ATerm) ((ATerm) elem6), (ATerm) ((ATerm) elem6), (ATerm) ((ATerm) elem6), (ATerm) ((ATerm) elem6), (ATerm) ((ATerm) elem6), (ATerm) ((ATerm) elem6));
}
...
ME_Information ME_makeInformationInformation(char* id, ME_Producer producer, ME_Description description, ME_Subjects subjects)
{
  return (ME_Information)(ATerm)ATmakeAppl4(ME_afun4, (ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue)), (ATerm) producer, (ATerm) description, (ATerm) subjects);
}
...
ME_Warning ME_makeWarningWarning(char* id, ME_Producer producer, ME_Description description, ME_Subjects subjects)
{
  return (ME_Warning)(ATerm)ATmakeAppl4(ME_afun5, (ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue)), (ATerm) producer, (ATerm) description, (ATerm) subjects);
}
...
ME_Error ME_makeErrorError(char* id, ME_Producer producer, ME_Description description, ME_Subjects subjects)
{
  return (ME_Error)(ATerm)ATmakeAppl4(ME_afun6, (ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue)), (ATerm) producer, (ATerm) description, (ATerm) subjects);
}
...
ME_FatalError ME_makeFatalErrorFatalError(char* id, ME_Producer producer, ME_Description description, ME_Subjects subjects)
{
  return (ME_FatalError)(ATerm)ATmakeAppl4(ME_afun7, (ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue)), (ATerm) producer, (ATerm) description, (ATerm) subjects);
}
...
ME_Producer ME_makeProducerProducer(char* id, char* type)
{
  return (ME_Producer)(ATerm)ATmakeAppl2(ME_afun8, (ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue)), (ATerm) (ATerm) ATmakeAppl(ATmakeAFun(type, 0, ATtrue)));
}
...
ME_Description ME_makeDescriptionDescription(char* String)
{
  return (ME_Description)(ATerm)ATmakeAppl1(ME_afun9, (ATerm) (ATerm) ATmakeAppl(ATmakeAFun(String, 0, ATtrue)));
}
...
/*}}}  */
/*{{{  ME_SubjectSubjectList ME_makeSubjectSubjectListSingle(ME_Subject head) */

ME_SubjectSubjectList ME_makeSubjectSubjectListSingle(ME_Subject head)
{
  return (ME_SubjectSubjectList)(ATerm)ATmakeList1((ATerm) head);
}
...
ME_Subject ME_makeSubjectWithoutLocation(char* id, ME_Location location)
{
  return (ME_Subject)(ATerm)ATmakeAppl2(ME_afun11, (ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue)), (ATerm) location);
}
...
ME_Subject ME_makeSubjectWithLocation(char* id)
{
  return (ME_Subject)(ATerm)ATmakeAppl1(ME_afun12, (ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue)));
}
...
ME_Location ME_makeLocationLocation(char* filename, ME_Area area)
{
  return (ME_Location)(ATerm)ATmakeAppl2(ME_afun13, (ATerm) (ATerm) ATmakeAppl(ATmakeAFun(filename, 0, ATtrue)), (ATerm) area);
}
...
ME_Area ME_makeAreaArea(int startLine, int startColumn, int endLine, int endColumn, int startOffset, int endOffset)
{
  return (ME_Area)(ATerm)ATmakeAppl6(ME_afun14, (ATerm) (ATerm) ATmakeInt(startLine), (ATerm) (ATerm) ATmakeInt(startColumn), (ATerm) (ATerm) ATmakeInt(endLine), (ATerm) (ATerm) ATmakeInt(endColumn), (ATerm) (ATerm) ATmakeInt(startOffset), (ATerm) (ATerm) ATmakeInt(endOffset));
}
...
ME_Area ME_makeAreaNoArea()
{
  return (ME_Area)(ATerm)ATmakeAppl0(ME_afun15);
}
...
{
  if (ME_isFeedbackInfo(arg)) {
    return (ME_Feedback)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) Information), 0);
  }
...
{
  if (ME_isFeedbackWarning(arg)) {
    return (ME_Feedback)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) Warning), 0);
  }
...
{
  if (ME_isFeedbackError(arg)) {
    return (ME_Feedback)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) Error), 0);
  }
...
{
  if (ME_isFeedbackFatalError(arg)) {
    return (ME_Feedback)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) FatalError), 0);
  }
...
{
  if (ME_isInformationInformation(arg)) {
    return (ME_Information)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue))), 0);
  }
...
{
  if (ME_isInformationInformation(arg)) {
    return (ME_Information)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) producer), 1);
  }
...
{
  if (ME_isInformationInformation(arg)) {
    return (ME_Information)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) description), 2);
  }
...
{
  if (ME_isInformationInformation(arg)) {
    return (ME_Information)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) subjects), 3);
  }
...
{
  if (ME_isWarningWarning(arg)) {
    return (ME_Warning)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue))), 0);
  }
...
{
  if (ME_isWarningWarning(arg)) {
    return (ME_Warning)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) producer), 1);
  }
...
{
  if (ME_isWarningWarning(arg)) {
    return (ME_Warning)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) description), 2);
  }
...
{
  if (ME_isWarningWarning(arg)) {
    return (ME_Warning)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) subjects), 3);
  }
...
{
  if (ME_isErrorError(arg)) {
    return (ME_Error)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue))), 0);
  }
...
{
  if (ME_isErrorError(arg)) {
    return (ME_Error)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) producer), 1);
  }
...
{
  if (ME_isErrorError(arg)) {
    return (ME_Error)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) description), 2);
  }
...
{
  if (ME_isErrorError(arg)) {
    return (ME_Error)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) subjects), 3);
  }
...
{
  if (ME_isFatalErrorFatalError(arg)) {
    return (ME_FatalError)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue))), 0);
  }
...
{
  if (ME_isFatalErrorFatalError(arg)) {
    return (ME_FatalError)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) producer), 1);
  }
...
{
  if (ME_isFatalErrorFatalError(arg)) {
    return (ME_FatalError)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) description), 2);
  }
...
{
  if (ME_isFatalErrorFatalError(arg)) {
    return (ME_FatalError)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) subjects), 3);
  }
...
{
  if (ME_isProducerProducer(arg)) {
    return (ME_Producer)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) (ATerm) ATmakeAppl(ATmakeAFun(id, 0, ATtrue))), 0);
  }
...
{
  if (ME_isProducerProducer(arg)) {
    return (ME_Producer)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) (ATerm) ATmakeAppl(ATmakeAFun(type, 0, ATtrue))), 1);
  }
...
{
  if (ME_isDescriptionDescription(arg)) {
    return (ME_Description)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) (ATerm) ATmakeAppl(ATmakeAFun(String, 0, ATtrue))), 0);
  }
...
{
  if (ME_isSubjectsSubjects(arg)) {
    return (ME_Subjects)ATsetArgument((ATermAppl)arg, (ATerm)((ATerm) subjectList), 0);
  }
...
ATbool ME_isValidSubjectSubjectList(ME_SubjectSubjectList arg)
{
  ...
  else if (ME_isSubjectSubjectListSingle(arg)) {
    return ATtrue;
  }
  else if (ME_isSubjectSubjectListMany(arg)) {
    return ATtrue;
  }
  return ATfalse;
}
...
/*}}}  */
/*{{{  inline ATbool ME_isSubjectSubjectListSingle(ME_SubjectSubjectList arg) */
...
inline ATbool ME_isSubjectSubjectListSingle(ME_SubjectSubjectList arg)
{
  ...
  }
  {
    ...
    if (last_gc != ATgetGCCount() || (ATerm)arg != last_arg) {
      last_arg = (ATerm)arg;
      last_result = ATmatchTerm((ATerm)arg, ME_patternSubjectSubjectListSingle, NULL);
      last_gc = ATgetGCCount();
    }
...
inline ATbool ME_isSubjectSubjectListMany(ME_SubjectSubjectList arg)
{
  ...
  }
  {
    ...
    if (last_gc != ATgetGCCount() || (ATerm)arg != last_arg) {
      last_arg = (ATerm)arg;
      last_result = ATmatchTerm((ATerm)arg, ME_patternSubjectSubjectListMany, NULL, NULL);
      last_gc = ATgetGCCount();
    }
...
ATbool ME_hasSubjectSubjectListHead(ME_SubjectSubjectList arg)
{
  if (ME_isSubjectSubjectListSingle(arg)) {
    return ATtrue;
  }
  else if (ME_isSubjectSubjectListMany(arg)) {
    return ATtrue;
...
{
  if (ME_isSubjectSubjectListSingle(arg)) {
    return (ME_SubjectSubjectList)ATreplace((ATermList)arg, (ATerm)((ATerm) head), 0);
  }
  else if (ME_isSubjectSubjectListMany(arg)) {
    return (ME_SubjectSubjectList)ATreplace((ATermList)arg, (ATerm)((ATerm) head), 0);
  }
...
{
  if (ME_isSubjectSubjectListMany(arg)) {
    return (ME_SubjectSubjectList)ATreplaceTail((ATermList)arg, (ATermList)((ATerm) tail), 1);
  }
...
ME_SubjectSubjectList ME_visitSubjectSubjectList(ME_SubjectSubjectList arg, ME_Subject (*acceptHead)(ME_Subject))
{
  ...
  if (ME_isSubjectSubjectListSingle(arg)) {
    return ME_makeSubjectSubjectListSingle(
