...
enum SGmodeFlags {
  ...
  SG_FILTER_INDIRECTEAGERNESSFLAG,
...
#define SG_FILTER_INDIRECTEAGERNESS \
 (_SG_Mode  &  SG_BIT(SG_FILTER_INDIRECTEAGERNESSFLAG))
#define SG_FILTER_INDIRECTEAGERNESS_ON() \
 (_SG_Mode  |=  SG_BIT(SG_FILTER_INDIRECTEAGERNESSFLAG))
#define SG_FILTER_INDIRECTEAGERNESS_OFF() \
 (_SG_Mode  &=  ~SG_BIT(SG_FILTER_INDIRECTEAGERNESSFLAG))
