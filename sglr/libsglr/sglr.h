...
enum SGmodeFlags {
  ...
  SG_DOTOUTFLAG, SG_NOLEXFLAG, SG_PRINTPRODSFLAG, SG_SHOWSTACKFLAG, SG_FILTERFLAG,
...
#define SG_PRINTPRODS        (_SG_Mode  &  SG_BIT(SG_PRINTPRODSFLAG))
#define SG_PRINTPRODS_ON()   (_SG_Mode |=  SG_BIT(SG_PRINTPRODSFLAG))
#define SG_PRINTPRODS_OFF()  (_SG_Mode &= ~SG_BIT(SG_PRINTPRODSFLAG))
