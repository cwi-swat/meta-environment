...
TREE2DOT - Parse Trees to DOT converter

=head1 SYNOPSIS

B<tree2dot> [-B<btvVxp>] [-B<D> I<file>] [-B<i> I<file>] [-B<o> I<file>]
...
Present for compatibilty reasons only; ignored.
...
Prints entire productions in the nodes of a parse tree instead of the 
result sort. 
