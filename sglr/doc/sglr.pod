...
B<sglr> -B<p> file [-B<2?bcdhlmnPstvV>] [-B<f>[adeirp]] [-B<i> I<file>] [-B<o> I<file>] [-B<s> I<sort>]
...
=head1 EXAMPLES
    ...
    $ sglr -h
    Usage:
      sglr    -p file [-2?bcdhlmnPtvV] [-f[adeirp]] [-i file] [-o file] \
              [-s sort]
    [. . .]
