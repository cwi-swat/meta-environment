...
public class ToolInstance {
  ...
  private LinkedList<ATerm> valuesFromTool;
  private LinkedList<ATermList> eventsFromTool;
  private LinkedList<ATermList> pendingEvents;
 ...
 * @param toolDefinition definition of the tool
  ...
  public ToolInstance(ToolDefinition toolDef, ToolBus myToolBus, int toolCount, TBTermFactory tbfactory) throws ToolBusException {
    ...
    eventsFromTool = new LinkedList<ATermList>();
    pendingEvents = new LinkedList<ATermList>();
  ...
  public void handleTermFromTool(ATerm t) {	
		...
		if (matches != null) {
			addValueFromTool((ATerm)matches.get(0)); 
			return;
		}
  ...
  public void addValueFromTool(ATerm res) {
  ...
  throws ToolBusException {
  	...
  	if (valuesFromTool.isEmpty()) {
  		...
  		ATerm result = valuesFromTool.getFirst();
  ...
  */
  ...
  public boolean getEventFromTool(ATermList alist, Environment env) {
    //System.err.println("getEventFromTool: " + " " + alist);
    for(ATermList eventArgs : eventsFromTool){
      try {
  ...
  private boolean ackWaiting(ATerm key){
	for(ATermList eventArgs : pendingEvents){
   ...
   * @param args generated by tool
   */

  public void addEventFromTool(ATermList args) {
    eventsFromTool.addLast(args);
    System.err.println("ToolInstance.addEvenFromTool: obj = " + args);
