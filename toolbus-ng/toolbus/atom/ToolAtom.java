...
public class ToolAtom extends Atom {
	...
	public void compile(ProcessInstance P, AtomSet follow, String name, String complName)
	throws ToolBusException
	{
		...
		if(!TBTerm.isVar(toolvar))
			throw new ToolBusException("first argument of " + name + " should be a variable");
		...
		TD.registerOccurrence(complName, TBTerm.makePattern(args, getEnv(), true));
