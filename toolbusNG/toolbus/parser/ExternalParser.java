...
public class ExternalParser {
     ...
     */
    public ExternalParser(String parseTable, 
			  String sglrLocation, 
			  String sglrSwitches,
			  String implodeCommand,
			  String implodeOptions) {
	parseCommand 
	    = sglrLocation+"/bin/sglr "
	    + sglrSwitches
	    + " -p "+parseTable;
     ...
     * symbol.
     */
    public ExternalParser(String startSymbol,
			  String parseTable, 
			  String sglrLocation, 
			  String sglrSwitches,
			  String implodeCommand,
     ...
     */
    public ExternalParser(String parseCommand,
			  String implodeCommand
			 ) {
     ...
     */
    public ATerm parse(String sourceFileName) 
	...
	InputStream in
	    = execute(implodeCommand, asfixFileName, "implode");
	try {
     ...
     * it.
     */
    public static Process execute(String command, String processType) 
      throws ExternalProcessException {
     ...
     */
    public static void waitForExternalResult(Process p,String msg, String processType)
	throws ExternalProcessException {
	int result;
	try {
	    result = p.waitFor();
    ...
    public static void copyErrorStream(Process p)
