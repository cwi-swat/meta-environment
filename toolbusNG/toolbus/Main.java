		...
		try {
			...
			if(T.parse(
				  //"/home/paulk/software/source/asfsdf-meta-asf-sdf-meta_1-5-bundle-1.5.3/toolbus/adapters/java-adapter/toolbus/test.tb");
				    ...
				    //"/home/paulk/software/installed/asfsdf-meta/share/asfsdf-meta/start-meta-studio.tb")){
			         "/home/paulk/software/installed/sdf-meta/share/sdf-meta/start-meta-studio.tb")){
				  ...
				  //ws + "/toolbusNG/toolbus/test/Call8.tb")){
			T.execute();
			Atom.statistics();
				  }
		} catch(Exception e){
