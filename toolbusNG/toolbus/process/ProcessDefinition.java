...
public class ProcessDefinition {
	...
	public ProcessExpression compile(ProcessInstance P, AtomSet follows, ATermList actuals)
...
//		System.out.println("actuals1 = " + actuals1);
		...
		for (int i = 0; i < nargs; i++) {
			...
			if (TBTerm.isResVar(formal))
				formal =
					TBTerm.compileVars(TBTerm.changeResVarIntoVar(formal), env);
			else
...
//		System.out.println("assigns = " + assigns);
		ProcessExpression PE1 =
			(assigns == null) ? PE.copy() : new Sequence(assigns, PE.copy());
