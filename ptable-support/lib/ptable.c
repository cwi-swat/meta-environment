...
PTBL_Version PTBL_makeVersionDefault(void)
{
  return (PTBL_Version)(ATerm)ATmakeInt(4);
}
...
PTBL_Priority PTBL_makePriorityRight(int label1, int label2)
{
  return (PTBL_Priority)(ATerm)ATmakeAppl2(PTBL_afun14, (ATerm) (ATerm) ATmakeInt(label1), (ATerm) (ATerm) ATmakeInt(label2));
}
...
PTBL_Priority PTBL_makePriorityNonAssoc(int label1, int label2)
{
  return (PTBL_Priority)(ATerm)ATmakeAppl2(PTBL_afun15, (ATerm) (ATerm) ATmakeInt(label1), (ATerm) (ATerm) ATmakeInt(label2));
}
...
PTBL_Priority PTBL_makePriorityGreater(int label1, int label2)
{
  return (PTBL_Priority)(ATerm)ATmakeAppl2(PTBL_afun16, (ATerm) (ATerm) ATmakeInt(label1), (ATerm) (ATerm) ATmakeInt(label2));
}
...
ATbool PTBL_isValidPriority(PTBL_Priority arg)
{
  if (PTBL_isPriorityLeft(arg)) {
    return ATtrue;
  }
  else if (PTBL_isPriorityRight(arg)) {
    return ATtrue;
  }
  else if (PTBL_isPriorityNonAssoc(arg)) {
    return ATtrue;
  }
  else if (PTBL_isPriorityGreater(arg)) {
    return ATtrue;
  }
  return ATfalse;
}
...
{
  {
    ...
    if (last_gc != ATgetGCCount() || (ATerm)arg != last_arg) {
      last_arg = (ATerm)arg;
      last_result = ATmatchTerm((ATerm)arg, PTBL_patternPriorityLeft, NULL, NULL);
      last_gc = ATgetGCCount();
    }
...
{
  {
    ...
    if (last_gc != ATgetGCCount() || (ATerm)arg != last_arg) {
      last_arg = (ATerm)arg;
      last_result = ATmatchTerm((ATerm)arg, PTBL_patternPriorityRight, NULL, NULL);
      last_gc = ATgetGCCount();
    }
...
{
  {
    ...
    if (last_gc != ATgetGCCount() || (ATerm)arg != last_arg) {
      last_arg = (ATerm)arg;
      last_result = ATmatchTerm((ATerm)arg, PTBL_patternPriorityNonAssoc, NULL, NULL);
      last_gc = ATgetGCCount();
    }
...
PTBL_Priority PTBL_visitPriority(PTBL_Priority arg, int (*acceptLabel1)(int), int (*acceptLabel2)(int))
{
  ...
  if (PTBL_isPriorityRight(arg)) {
    return PTBL_makePriorityRight(
        acceptLabel1 ? acceptLabel1(PTBL_getPriorityLabel1(arg)) : PTBL_getPriorityLabel1(arg),
        acceptLabel2 ? acceptLabel2(PTBL_getPriorityLabel2(arg)) : PTBL_getPriorityLabel2(arg));
  }
  if (PTBL_isPriorityNonAssoc(arg)) {
    return PTBL_makePriorityNonAssoc(
        acceptLabel1 ? acceptLabel1(PTBL_getPriorityLabel1(arg)) : PTBL_getPriorityLabel1(arg),
        acceptLabel2 ? acceptLabel2(PTBL_getPriorityLabel2(arg)) : PTBL_getPriorityLabel2(arg));
  }
