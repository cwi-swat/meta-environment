...
CFG_PropertyList CFG_makePropertyList2(CFG_Property elem1,
				       CFG_Property elem2);
CFG_PropertyList CFG_makePropertyList3(CFG_Property elem1, CFG_Property elem2,
				       CFG_Property elem3);
CFG_PropertyList CFG_makePropertyList4(CFG_Property elem1, CFG_Property elem2,
				       CFG_Property elem3,
				       CFG_Property elem4);
CFG_PropertyList CFG_makePropertyList5(CFG_Property elem1, CFG_Property elem2,
				       CFG_Property elem3, CFG_Property elem4,
				       CFG_Property elem5);
CFG_PropertyList CFG_makePropertyList6(CFG_Property elem1, CFG_Property elem2,
				       CFG_Property elem3, CFG_Property elem4,
				       CFG_Property elem5,
				       CFG_Property elem6);
...
CFG_getActionDescriptionListActionDescriptionAt(CFG_ActionDescriptionList arg,
						int index);
CFG_ActionDescriptionList
CFG_replaceActionDescriptionListActionDescriptionAt(CFG_ActionDescriptionList
						    ...
						    CFG_ActionDescription
						    elem, int index);
CFG_ActionDescriptionList CFG_makeActionDescriptionList2(CFG_ActionDescription
							 elem1,
							 CFG_ActionDescription
							 elem2);
CFG_ActionDescriptionList CFG_makeActionDescriptionList3(CFG_ActionDescription
							 elem1,
							 CFG_ActionDescription
							 elem2,
							 CFG_ActionDescription
							 elem3);
CFG_ActionDescriptionList CFG_makeActionDescriptionList4(CFG_ActionDescription
							 elem1,
							 CFG_ActionDescription
							 elem2,
							 CFG_ActionDescription
							 ...
							 CFG_ActionDescription
							 elem4);
CFG_ActionDescriptionList CFG_makeActionDescriptionList5(CFG_ActionDescription
							 elem1,
							 CFG_ActionDescription
							 elem2,
							 CFG_ActionDescription
							 ...
							 CFG_ActionDescription
							 elem5);
CFG_ActionDescriptionList CFG_makeActionDescriptionList6(CFG_ActionDescription
							 elem1,
							 CFG_ActionDescription
							 elem2,
							 CFG_ActionDescription
...
CFG_replaceTextAttributeMapTextAttributeAt(CFG_TextAttributeMap arg,
					   CFG_TextAttribute elem, int index);
...
CFG_ItemList CFG_makeItemList3(CFG_Item elem1, CFG_Item elem2,
			       CFG_Item elem3);
CFG_ItemList CFG_makeItemList4(CFG_Item elem1, CFG_Item elem2, CFG_Item elem3,
			       CFG_Item elem4);
CFG_ItemList CFG_makeItemList5(CFG_Item elem1, CFG_Item elem2, CFG_Item elem3,
			       CFG_Item elem4, CFG_Item elem5);
CFG_ItemList CFG_makeItemList6(CFG_Item elem1, CFG_Item elem2, CFG_Item elem3,
			       CFG_Item elem4, CFG_Item elem5,
			       CFG_Item elem6);
...
CFG_ShortCut CFG_makeShortCutShortcut(CFG_KeyModifier modifier,
				      CFG_VirtualKey key);
...
inline ATbool CFG_isVirtualKeyVKUnderscoreNUMBERUnderscoreSIGN(CFG_VirtualKey
							       arg);
inline ATbool CFG_isVirtualKeyVKUnderscoreOPENUnderscoreBRACKET(CFG_VirtualKey
								arg);
...
CFG_ActionDescription CFG_setActionDescriptionContext(CFG_ActionDescription
						      arg, ATerm context);
CFG_ActionDescription CFG_setActionDescriptionEvent(CFG_ActionDescription arg,
						    CFG_Event event);
...
CFG_ShortCut CFG_setShortCutModifier(CFG_ShortCut arg,
				     CFG_KeyModifier modifier);
...
CFG_Configuration CFG_visitConfiguration(CFG_Configuration arg,
					 ...
					 (CFG_PropertyList));
CFG_Property CFG_visitProperty(CFG_Property arg, char *(*acceptPath) (char *),
