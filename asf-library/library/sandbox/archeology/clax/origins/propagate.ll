...
; ---------------------------------------------------------------------------- ;
; #:origin:propagate-origin : propagate origin to a subterm.
;
(de :propagate-origin (tree path origin)
  (let
    ( (subtree (#:origin:tree:navigate tree path)) )
    (#:origin:join subtree origin)
  )
)
; ---------------------------------------------------------------------------- ;
