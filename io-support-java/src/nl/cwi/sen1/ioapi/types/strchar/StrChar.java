package nl.cwi.sen1.ioapi.types.strchar;

public class StrChar extends nl.cwi.sen1.ioapi.types.StrChar implements jjtraveler.Visitable {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getIoapiFactory().makeStrChar_StrChar(fun, args, annos);
  }
  ...
  public nl.cwi.sen1.ioapi.types.StrChar setString(String _string) {
    return (nl.cwi.sen1.ioapi.types.StrChar) super.setArgument(getFactory().makeAppl(getFactory().makeAFun(_string, 0, true)), index_string);
  }
  ...
  public nl.cwi.sen1.ioapi.AbstractType accept(nl.cwi.sen1.ioapi.Visitor v) throws jjtraveler.VisitFailure {
    return v.visit_StrChar_StrChar(this);
  }
