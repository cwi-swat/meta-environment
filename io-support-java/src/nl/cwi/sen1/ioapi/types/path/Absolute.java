...
public class Absolute extends nl.cwi.sen1.ioapi.types.Path implements jjtraveler.Visitable {
  public Absolute(nl.cwi.sen1.ioapi.Factory factory, aterm.ATermList annos, aterm.AFun fun, aterm.ATerm[] args) {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getIoapiFactory().makePath_Absolute(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof nl.cwi.sen1.ioapi.types.SegmentList)) { 
          throw new RuntimeException("Argument 0 of a Absolute should have type Segment-list");
        }
        break;
      default: throw new RuntimeException("Absolute does not have an argument at " + i );
    }
  ...
  public nl.cwi.sen1.ioapi.AbstractType accept(nl.cwi.sen1.ioapi.Visitor v) throws jjtraveler.VisitFailure {
    return v.visit_Path_Absolute(this);
  }
