...
import nl.cwi.sen1.gui.component.NodeSizer;
import aterm.ATerm;
import aterm.ATermAppl;
import aterm.ATermList;

public abstract class Graph extends GraphImpl {
    ...
    public static Graph fromImportList(MetaGraphFactory factory, ATermList imports) {
        ...
        while (iter.hasNext()) {
            ...
            Attribute shapeAttr = factory.makeAttribute_Shape(shape);
            Attribute labelAttr = factory.makeAttribute_Label(makeLabel(name));
            AttributeList attrs = factory.makeAttributeList_Empty();
            attrs = factory.makeAttributeList_Multi(shapeAttr, attrs);
            attrs = factory.makeAttributeList_Multi(labelAttr, attrs);
