// Java tool bridge DialogToolBridge
...
public class DialogToolBridge
  extends DialogToolTool
{
  private DialogToolTif tool;

  //{{{  public DialogToolBridge(ATermFactory factory, DialogToolTif tool)
