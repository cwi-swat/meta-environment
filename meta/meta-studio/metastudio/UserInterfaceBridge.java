...
// generation time: Dec 17, 2003 2:57:16 PM
  ...
  extends UserInterfaceTool
{
  ...
  {
    if (tool != null) {
      tool.displayFeedbackSummary(t0);
    }
    else {
      throw new UnsupportedOperationException("method `displayFeedbackSummary' not supported.");
    }
  }
