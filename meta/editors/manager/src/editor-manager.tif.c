 ...
 * Implementation generated at Tue Aug 12 14:55:09 2003
 */
...
static char *signature[NR_SIG_ENTRIES] = {
  ...
  "rec-eval(<editor-manager>,get-module-name(<term>))",
...
ATerm editor_manager_handler(int conn, ATerm term)
{
  ...
  if(ATmatch(term, "rec-eval(get-module-name(<term>))", &t0)) {
    return get_module_name(conn, t0);
  }
