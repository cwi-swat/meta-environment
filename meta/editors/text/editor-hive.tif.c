 ...
 * Implementation generated at Mon Jan 12 13:45:20 2004
 */
...
static char *signature[NR_SIG_ENTRIES] = {
  ...
  "rec-do(<editor-hive>,set-cursor-at-error-location(<term>,<term>))",
  "rec-do(<editor-hive>,set-focus-at-error-location(<term>,<term>))",
...
ATerm editor_hive_handler(int conn, ATerm term)
{
  ...
  if(ATmatch(term, "rec-do(set-cursor-at-error-location(<term>,<term>))", &t0, &t1)) {
    set_cursor_at_error_location(conn, t0, t1);
    return NULL;
  }
  ...
  if(ATmatch(term, "rec-do(set-focus-at-error-location(<term>,<term>))", &t0, &t1)) {
    set_focus_at_error_location(conn, t0, t1);
    return NULL;
  }
