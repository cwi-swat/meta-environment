 ...
 * Headerfile generated at Mon Jan 12 16:27:41 2004
 */
...
void set_cursor_at_error_location(int conn, ATerm, ATerm);
void reread_contents(int conn, ATerm);
void set_focus_at_error_location(int conn, ATerm, ATerm);
