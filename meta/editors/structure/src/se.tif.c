 ...
 * Implementation generated at Thu Oct 10 11:33:03 2002
 */
...
static char *signature[NR_SIG_ENTRIES] = {
  ...
  "rec-eval(<se>,insert-chars(<term>,<int>,<str>))",
  "rec-eval(<se>,delete-chars(<term>,<int>,<int>))",
...
ATerm se_handler(int conn, ATerm term)
{
  ...
  if(ATmatch(term, "rec-eval(delete-chars(<term>,<int>,<int>))", &t0, &i0, &i1)) {
    return delete_chars(conn, t0, i0, i1);
  }
  if(ATmatch(term, "rec-eval(get-dirty-focuses(<term>))", &t0)) {
    return get_dirty_focuses(conn, t0);
  }
  if(ATmatch(term, "rec-eval(insert-chars(<term>,<int>,<str>))", &t0, &i0, &s0)) {
    return insert_chars(conn, t0, i0, s0);
  }
