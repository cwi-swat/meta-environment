 ...
 * Implementation generated at Tue Aug 12 13:53:50 2003
 */
...
static char *signature[NR_SIG_ENTRIES] = {
  "rec-do(<se>,new-editor-given-text(<term>,<str>))",
  "rec-do(<se>,new-editor-given-tree(<term>,<term>))",
  ...
  "rec-eval(<se>,is-editor-modified(<term>))",
