 ...
 * Implementation generated at Wed May 21 12:55:02 2003
 */

#include "module-db.tif.h"

#define NR_SIG_ENTRIES	35
...
static char *signature[NR_SIG_ENTRIES] = {
  ...
  "rec-eval(<module-db>,update-sdf-module(<str>,<str>,<term>))",
...
ATerm module_db_handler(int conn, ATerm term)
{
  ...
  if(ATmatch(term, "rec-eval(update-sdf-module(<str>,<str>,<term>))", &s0, &s1, &t0)) {
    return update_sdf_module(conn, s0, s1, t0);
  }
