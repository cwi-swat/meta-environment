package errorapi.types.strcon;

public class StrCon extends errorapi.types.StrCon {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getErrorapiFactory().makeStrCon_StrCon(fun, args, annos);
  }
  ...
  public errorapi.types.StrCon setString(String _string) {
    return (errorapi.types.StrCon) super.setArgument(getFactory().makeAppl(getFactory().makeAFun(_string, 0, true)), index_string);
  }
