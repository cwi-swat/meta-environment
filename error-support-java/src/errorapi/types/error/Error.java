...
public class Error extends errorapi.types.Error {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getErrorapiFactory().makeError_Error(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof aterm.ATermAppl)) { 
          throw new RuntimeException("Argument 0 of a Error should have type str");
        }
        break;
      case 1:
        if (!(arg instanceof errorapi.types.SubjectList)) { 
          throw new RuntimeException("Argument 1 of a Error should have type Subject-list");
        }
        break;
      default: throw new RuntimeException("Error does not have an argument at " + i );
    }
