...
public class Warning extends errorapi.types.Error {
  public Warning(errorapi.Factory factory, aterm.ATermList annos, aterm.AFun fun, aterm.ATerm[] args) {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getErrorapiFactory().makeError_Warning(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof aterm.ATermAppl)) { 
          throw new RuntimeException("Argument 0 of a Warning should have type str");
        }
        break;
      case 1:
        if (!(arg instanceof errorapi.types.SubjectList)) { 
          throw new RuntimeException("Argument 1 of a Warning should have type Subject-list");
        }
        break;
      default: throw new RuntimeException("Warning does not have an argument at " + i );
    }
