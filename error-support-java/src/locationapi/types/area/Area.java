...
public class Area extends locationapi.types.Area {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getLocationapiFactory().makeArea_Area(fun, args, annos);
  }
  ...
  public locationapi.types.Area setBeginLine(int _beginLine) {
    return (locationapi.types.Area) super.setArgument(getFactory().makeInt(_beginLine), index_beginLine);
  }
  ...
  public locationapi.types.Area setBeginColumn(int _beginColumn) {
    return (locationapi.types.Area) super.setArgument(getFactory().makeInt(_beginColumn), index_beginColumn);
  }
  ...
  public locationapi.types.Area setEndLine(int _endLine) {
    return (locationapi.types.Area) super.setArgument(getFactory().makeInt(_endLine), index_endLine);
  }
  ...
  public locationapi.types.Area setEndColumn(int _endColumn) {
    return (locationapi.types.Area) super.setArgument(getFactory().makeInt(_endColumn), index_endColumn);
  }
  ...
  public locationapi.types.Area setOffset(int _offset) {
    return (locationapi.types.Area) super.setArgument(getFactory().makeInt(_offset), index_offset);
  }
  ...
  public locationapi.types.Area setLength(int _length) {
    return (locationapi.types.Area) super.setArgument(getFactory().makeInt(_length), index_length);
  }
