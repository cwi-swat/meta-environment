...
public class TermCollection extends SerializableObject{
	...
	/**
	 * Constructor.
	 * @param terms An array containing the terms that should be stored in this collection.
	 */
	public TermCollection(AbstractTerm[] terms){
		super();
	 ...
	 * @param index The index associated with the term.
	 * @return The term.
	 */
