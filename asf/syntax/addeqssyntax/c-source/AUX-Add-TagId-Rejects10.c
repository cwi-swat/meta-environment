...
if ( term_equal ( ( * ef10 ) ( ( * ef3 ) ( lf3 ( make_list ( tmp [ 1 ] ) ) ) ) , ( constant0 ? constant0 : ( constant0 = ( * ef11 ) ( ) ) ) ) ) {
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( ( * ef4 ) ( make_nf1 ( ef5sym , lf4 ( make_list ( ( * ef2 ) ( ( * ef3 ) ( lf3 ( cons ( make_list_char ( 34 ) , cons ( make_list ( tmp [ 1 ] ) , make_list ( make_char ( 34 ) ) ) ) ) ) ) ) ) ) , ( * ef6 ) ( ( * ef7 ) ( lf3 ( ( ATerm ) ATmakeList ( 5 , char_table [ 84 ] , char_table [ 97 ] , char_table [ 103 ] , char_table [ 73 ] , char_table [ 100 ] ) ) ) ) , ( * ef8 ) ( lf5 ( make_list ( ( * ef9 ) ( ) ) ) ) ) ) ) ) ) ;
}
}
}
}
