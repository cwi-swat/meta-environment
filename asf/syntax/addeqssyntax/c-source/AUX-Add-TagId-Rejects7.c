...
lf_AUX_Add_TagId_Rejects7_1sym = ATmakeSymbol ( "prod(id(\"Add-TagId-Rejects\"),w(\"\"),[ql(\"add-tir-for-productions\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
...
ef6 = lookup_func ( ATreadFromString ( "prod(id(\"Add-TagId-Rejects\"),w(\"\"),[ql(\"add-tir-for-production\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Production\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) ) ;
ef6sym = lookup_sym ( ATreadFromString ( "prod(id(\"Add-TagId-Rejects\"),w(\"\"),[ql(\"add-tir-for-production\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Production\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) ) ;
...
if ( term_equal ( list_head ( tmp [ 8 ] ) , ( constant0 ? constant0 : ( constant0 = ( * ef5 ) ( ) ) ) ) ) {
( tmp [ 10 ] = lf_AUX_Add_TagId_Rejects7_1 ( ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) ;
if ( check_sym ( tmp [ 10 ] , ef1sym ) ) {
( tmp [ 11 ] = arg_0 ( tmp [ 10 ] ) ) ;
if ( check_sym ( tmp [ 11 ] , lf2sym ) ) {
( tmp [ 12 ] = arg_0 ( tmp [ 11 ] ) ) ;
FUNC_EXIT ( ( * ef1 ) ( lf2 ( make_list ( tmp [ 12 ] ) ) ) ) ;
}
}
}
}
...
if ( check_sym ( tmp [ 5 ] , lf3sym ) ) {
( tmp [ 6 ] = arg_0 ( tmp [ 5 ] ) ) ;
( tmp [ 7 ] = ( * ef6 ) ( ( * ef2 ) ( ( * ef3 ) ( lf3 ( make_list ( tmp [ 6 ] ) ) ) , tmp [ 3 ] , ( * ef7 ) ( ) ) ) ) ;
...
if ( check_sym ( tmp [ 11 ] , lf2sym ) ) {
( tmp [ 12 ] = arg_0 ( tmp [ 11 ] ) ) ;
FUNC_EXIT ( ( * ef1 ) ( lf2 ( cons ( make_list ( tmp [ 9 ] ) , make_list ( tmp [ 12 ] ) ) ) ) ) ;
}
}
}
}
