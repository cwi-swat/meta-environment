...
static ATerm lf_AUX_Priority_Sdf_Syntax1_15 ( ATerm arg1 ) ;
...
lf_AUX_Priority_Sdf_Syntax1_15sym = ATmakeSymbol ( "prod(id(\"Priority-Sdf-Syntax\"),w(\"\"),[ql(\"priorities\"),w(\"\"),sort(\"Priorities\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Priority-Sdf-Syntax\"),w(\"\"),[ql(\"priorities\"),w(\"\"),sort(\"Priorities\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Grammar\"),w(\"\"),no-attrs)" ) , lf_AUX_Priority_Sdf_Syntax1_15 , lf_AUX_Priority_Sdf_Syntax1_15sym ) ;
}
void resolve_AUX_Priority_Sdf_Syntax1 ( ) {
}
void init_AUX_Priority_Sdf_Syntax1 ( ) {
}
ATerm lf_AUX_Priority_Sdf_Syntax1_15 ( ATerm arg0 ) {
CONS_ENTRY ( lf_AUX_Priority_Sdf_Syntax1_15sym , ATmakeAppl ( lf_AUX_Priority_Sdf_Syntax1_15sym , arg0 ) ) ;
CONS_EXIT ( make_nf1 ( lf_AUX_Priority_Sdf_Syntax1_15sym , arg0 ) ) ;
}
...
CONS_EXIT ( make_nf0 ( lf_AUX_Priority_Sdf_Syntax1_5sym ) ) ;
}
...
CONS_EXIT ( make_nf0 ( lf_AUX_Priority_Sdf_Syntax1_4sym ) ) ;
}
...
CONS_EXIT ( make_nf0 ( lf_AUX_Priority_Sdf_Syntax1_3sym ) ) ;
}
...
CONS_EXIT ( make_nf0 ( lf_AUX_Priority_Sdf_Syntax1_2sym ) ) ;
}
...
CONS_EXIT ( make_nf0 ( lf_AUX_Priority_Sdf_Syntax1_1sym ) ) ;
}
