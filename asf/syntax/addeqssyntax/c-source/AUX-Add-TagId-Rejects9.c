...
static Symbol lf_AUX_Add_TagId_Rejects9_1_recursivesym ;
static ATerm lf_AUX_Add_TagId_Rejects9_1_recursive ( ATerm arg1 ) ;
...
lf_AUX_Add_TagId_Rejects9_1_recursivesym = ATmakeSymbol ( "prod(id(\"Add-TagId-Rejects\"),w(\"\"),[ql(\"add-tir-for-symbols\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Symbols\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Add_TagId_Rejects9_1_recursivesym ) ;
lf_AUX_Add_TagId_Rejects9_1sym = ATmakeSymbol ( "prod(id(\"Add-TagId-Rejects\"),w(\"\"),[ql(\"add-tir-for-symbols\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Symbols\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Add-TagId-Rejects\"),w(\"\"),[ql(\"add-tir-for-symbols\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Symbols\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) , lf_AUX_Add_TagId_Rejects9_1_recursive , lf_AUX_Add_TagId_Rejects9_1_recursivesym ) ;
...
( tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ) ;
( tmp [ 5 ] = lf_AUX_Add_TagId_Rejects9_1 ( make_nf1 ( ef1sym , lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) ;
...
ATerm lf_AUX_Add_TagId_Rejects9_1_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 8 ] ;
FUNC_ENTRY ( lf_AUX_Add_TagId_Rejects9_1_recursivesym , ATmakeAppl ( lf_AUX_Add_TagId_Rejects9_1_recursivesym , arg0 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Add_TagId_Rejects9_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) ) ) ;
}
}
