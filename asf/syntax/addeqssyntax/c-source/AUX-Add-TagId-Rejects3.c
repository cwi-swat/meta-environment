...
static Symbol lf_AUX_Add_TagId_Rejects3_1sym ;
static ATerm lf_AUX_Add_TagId_Rejects3_1 ( ATerm arg1 ) ;
...
void register_AUX_Add_TagId_Rejects3 ( ) {
lf_AUX_Add_TagId_Rejects3_1sym = ATmakeSymbol ( "prod(id(\"Add-TagId-Rejects\"),w(\"\"),[ql(\"add-tir-for-mod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Module\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Add_TagId_Rejects3_1sym ) ;
...
register_prod ( ATparse ( "prod(id(\"Add-TagId-Rejects\"),w(\"\"),[ql(\"add-tir-for-mod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Module\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) , lf_AUX_Add_TagId_Rejects3_1 , lf_AUX_Add_TagId_Rejects3_1sym ) ;
...
void resolve_AUX_Add_TagId_Rejects3 ( ) {
...
ef4 = lookup_func ( ATreadFromString ( "prod(id(\"Add-TagId-Rejects\"),w(\"\"),[ql(\"add-tir-for-sections\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"Section\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) ) ;
ef4sym = lookup_sym ( ATreadFromString ( "prod(id(\"Add-TagId-Rejects\"),w(\"\"),[ql(\"add-tir-for-sections\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"Section\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) ) ;
}
void init_AUX_Add_TagId_Rejects3 ( ) {
}
ATerm lf_AUX_Add_TagId_Rejects3_1 ( ATerm arg0 ) {
{
ATerm tmp [ 3 ] ;
FUNC_ENTRY ( lf_AUX_Add_TagId_Rejects3_1sym , ATmakeAppl ( lf_AUX_Add_TagId_Rejects3_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Add_TagId_Rejects3_1sym , arg0 ) ) ;
}
}
