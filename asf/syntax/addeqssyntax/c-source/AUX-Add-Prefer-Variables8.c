...
static Symbol lf_AUX_Add_Prefer_Variables8_1_recursivesym ;
static ATerm lf_AUX_Add_Prefer_Variables8_1_recursive ( ATerm arg1 ) ;
...
lf_AUX_Add_Prefer_Variables8_1_recursivesym = ATmakeSymbol ( "prod(id(\"Add-Prefer-Variables\"),w(\"\"),[ql(\"add-pv-for-variables\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Add_Prefer_Variables8_1_recursivesym ) ;
lf_AUX_Add_Prefer_Variables8_1sym = ATmakeSymbol ( "prod(id(\"Add-Prefer-Variables\"),w(\"\"),[ql(\"add-pv-for-variables\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Add-Prefer-Variables\"),w(\"\"),[ql(\"add-pv-for-variables\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Productions\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) , lf_AUX_Add_Prefer_Variables8_1_recursive , lf_AUX_Add_Prefer_Variables8_1_recursivesym ) ;
...
( tmp [ 6 ] = arg_0 ( tmp [ 5 ] ) ) ;
if ( term_equal ( tmp [ 4 ] , ( constant1 ? constant1 : ( constant1 = ( * ef4 ) ( ) ) ) ) ) {
( tmp [ 7 ] = lf_AUX_Add_Prefer_Variables8_1_recursive ( make_list ( tmp [ 1 ] ) ) ) ;
( tmp [ 8 ] = arg_0 ( tmp [ 7 ] ) ) ;
( tmp [ 9 ] = arg_0 ( tmp [ 8 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( cons ( make_list ( ( * ef2 ) ( make_nf1 ( ef3sym , lf3 ( make_list ( tmp [ 6 ] ) ) ) , tmp [ 3 ] , ( * ef5 ) ( lf4 ( make_list ( ( * ef6 ) ( ) ) ) ) ) ) , make_list ( tmp [ 9 ] ) ) ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_Add_Prefer_Variables8_1_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 10 ] ;
FUNC_ENTRY ( lf_AUX_Add_Prefer_Variables8_1_recursivesym , ATmakeAppl ( lf_AUX_Add_Prefer_Variables8_1_recursivesym , arg0 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Add_Prefer_Variables8_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) ) ) ;
}
}
