...
static Symbol lf_AUX_Add_Prefer_Variables5_2_recursivesym ;
static ATerm lf_AUX_Add_Prefer_Variables5_2_recursive ( ATerm arg1 ) ;
...
lf_AUX_Add_Prefer_Variables5_2_recursivesym = ATmakeSymbol ( "prod(id(\"Add-Prefer-Variables\"),w(\"\"),[ql(\"add-pv-for-sections\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"Section\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Sections\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Add_Prefer_Variables5_2_recursivesym ) ;
lf_AUX_Add_Prefer_Variables5_2sym = ATmakeSymbol ( "prod(id(\"Add-Prefer-Variables\"),w(\"\"),[ql(\"add-pv-for-sections\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"Section\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Sections\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Add-Prefer-Variables\"),w(\"\"),[ql(\"add-pv-for-sections\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"Section\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Sections\"),w(\"\"),no-attrs)" ) , lf_AUX_Add_Prefer_Variables5_2_recursive , lf_AUX_Add_Prefer_Variables5_2_recursivesym ) ;
}
...
FUNC_EXIT_CONST ( constant0 , make_nf1 ( ef1sym , lf_AUX_Add_Prefer_Variables5_1 ( make_list ( null ( ) ) ) ) ) ;
}
else {
...
( tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf_AUX_Add_Prefer_Variables5_1 ( cons ( make_list ( tmp [ 2 ] ) , make_list ( tmp [ 5 ] ) ) ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_Add_Prefer_Variables5_2_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 6 ] ;
FUNC_ENTRY ( lf_AUX_Add_Prefer_Variables5_2_recursivesym , ATmakeAppl ( lf_AUX_Add_Prefer_Variables5_2_recursivesym , arg0 ) ) ;
{
ATerm atmp00 = arg0 ;
if ( ! not_empty_list ( atmp00 ) ) {
FUNC_EXIT_CONST ( constant0 , make_nf1 ( ef1sym , lf_AUX_Add_Prefer_Variables5_1 ( make_list ( null ( ) ) ) ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Add_Prefer_Variables5_2_recursivesym , lf_AUX_Add_Prefer_Variables5_1 ( arg0 ) ) ) ;
}
}
