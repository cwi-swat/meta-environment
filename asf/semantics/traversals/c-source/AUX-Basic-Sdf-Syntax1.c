...
static ATerm lf_AUX_Basic_Sdf_Syntax1_5 ( ATerm arg1 ) ;
static Symbol lf_AUX_Basic_Sdf_Syntax1_6sym ;
static ATerm lf_AUX_Basic_Sdf_Syntax1_6 ( ATerm arg1 ) ;
static Symbol lf_AUX_Basic_Sdf_Syntax1_7sym ;
static ATerm lf_AUX_Basic_Sdf_Syntax1_7 ( ATerm arg1 ) ;
static Symbol lf_AUX_Basic_Sdf_Syntax1_8sym ;
static ATerm lf_AUX_Basic_Sdf_Syntax1_8 ( ) ;
...
lf_AUX_Basic_Sdf_Syntax1_5sym = ATmakeSymbol ( "prod(id(\"Basic-Sdf-Syntax\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"-CF\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Basic_Sdf_Syntax1_5sym ) ;
lf_AUX_Basic_Sdf_Syntax1_6sym = ATmakeSymbol ( "prod(id(\"Basic-Sdf-Syntax\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"-LEX\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Basic_Sdf_Syntax1_6sym ) ;
lf_AUX_Basic_Sdf_Syntax1_7sym = ATmakeSymbol ( "prod(id(\"Basic-Sdf-Syntax\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"-VAR\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Basic_Sdf_Syntax1_7sym ) ;
lf_AUX_Basic_Sdf_Syntax1_8sym = ATmakeSymbol ( "prod(id(\"Basic-Sdf-Syntax\"),w(\"\"),[ql(\"LAYOUT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" , 0 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Basic_Sdf_Syntax1_8sym ) ;
...
register_prod ( ATparse ( "prod(id(\"Basic-Sdf-Syntax\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"-CF\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" ) , lf_AUX_Basic_Sdf_Syntax1_5 , lf_AUX_Basic_Sdf_Syntax1_5sym ) ;
register_prod ( ATparse ( "prod(id(\"Basic-Sdf-Syntax\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"-LEX\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" ) , lf_AUX_Basic_Sdf_Syntax1_6 , lf_AUX_Basic_Sdf_Syntax1_6sym ) ;
register_prod ( ATparse ( "prod(id(\"Basic-Sdf-Syntax\"),w(\"\"),[ql(\"<\"),w(\"\"),sort(\"Symbol\"),w(\"\"),ql(\"-VAR\"),w(\"\"),ql(\">\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" ) , lf_AUX_Basic_Sdf_Syntax1_7 , lf_AUX_Basic_Sdf_Syntax1_7sym ) ;
register_prod ( ATparse ( "prod(id(\"Basic-Sdf-Syntax\"),w(\"\"),[ql(\"LAYOUT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbol\"),w(\"\"),no-attrs)" ) , lf_AUX_Basic_Sdf_Syntax1_8 , lf_AUX_Basic_Sdf_Syntax1_8sym ) ;
}
void resolve_AUX_Basic_Sdf_Syntax1 ( ) {
}
void init_AUX_Basic_Sdf_Syntax1 ( ) {
}
ATerm lf_AUX_Basic_Sdf_Syntax1_8 ( ) {
CONS_ENTRY ( lf_AUX_Basic_Sdf_Syntax1_8sym , ATmakeAppl0 ( lf_AUX_Basic_Sdf_Syntax1_8sym ) ) ;
CONS_EXIT ( make_nf0 ( lf_AUX_Basic_Sdf_Syntax1_8sym ) ) ;
}
ATerm lf_AUX_Basic_Sdf_Syntax1_7 ( ATerm arg0 ) {
CONS_ENTRY ( lf_AUX_Basic_Sdf_Syntax1_7sym , ATmakeAppl ( lf_AUX_Basic_Sdf_Syntax1_7sym , arg0 ) ) ;
CONS_EXIT ( make_nf1 ( lf_AUX_Basic_Sdf_Syntax1_7sym , arg0 ) ) ;
}
ATerm lf_AUX_Basic_Sdf_Syntax1_6 ( ATerm arg0 ) {
CONS_ENTRY ( lf_AUX_Basic_Sdf_Syntax1_6sym , ATmakeAppl ( lf_AUX_Basic_Sdf_Syntax1_6sym , arg0 ) ) ;
CONS_EXIT ( make_nf1 ( lf_AUX_Basic_Sdf_Syntax1_6sym , arg0 ) ) ;
}
ATerm lf_AUX_Basic_Sdf_Syntax1_5 ( ATerm arg0 ) {
CONS_ENTRY ( lf_AUX_Basic_Sdf_Syntax1_5sym , ATmakeAppl ( lf_AUX_Basic_Sdf_Syntax1_5sym , arg0 ) ) ;
CONS_EXIT ( make_nf1 ( lf_AUX_Basic_Sdf_Syntax1_5sym , arg0 ) ) ;
}
