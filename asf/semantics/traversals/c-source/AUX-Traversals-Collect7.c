...
static Symbol lf_AUX_Traversals_Collect7_1sym ;
static ATerm lf_AUX_Traversals_Collect7_1 ( ATerm arg1 ) ;
...
void register_AUX_Traversals_Collect7 ( ) {
lf_AUX_Traversals_Collect7_1sym = ATmakeSymbol ( "prod(id(\"Traversals-Collect\"),w(\"\"),[ql(\"all_in_grammar\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Traversals_Collect7_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Production\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Traversals-Collect\"),w(\"\"),[ql(\"all_in_grammar\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Grammar\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Productions\"),w(\"\"),no-attrs)" ) , lf_AUX_Traversals_Collect7_1 , lf_AUX_Traversals_Collect7_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Production\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_Traversals_Collect7 ( ) {
...
void init_AUX_Traversals_Collect7 ( ) {
ATprotect ( & constant0 ) ;
}
ATerm lf_AUX_Traversals_Collect7_1 ( ATerm arg0 ) {
{
ATerm tmp [ 6 ] ;
FUNC_ENTRY ( lf_AUX_Traversals_Collect7_1sym , ATmakeAppl ( lf_AUX_Traversals_Collect7_1sym , arg0 ) ) ;
...
( tmp [ 0 ] = lf_AUX_Traversals_Collect7_1 ( atmp00 ) ) ;
if ( check_sym ( tmp [ 0 ] , ef2sym ) ) {
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
if ( check_sym ( tmp [ 1 ] , lf2sym ) ) {
( tmp [ 2 ] = arg_0 ( tmp [ 1 ] ) ) ;
( tmp [ 3 ] = lf_AUX_Traversals_Collect7_1 ( atmp01 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Traversals_Collect7_1sym , arg0 ) ) ;
}
}
