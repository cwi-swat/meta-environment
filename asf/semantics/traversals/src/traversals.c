...
/*}}}  */
/*{{{  ATerm add_traversals_function_standalone(ATerm term) */
...
ATerm add_traversals_function_standalone(ATerm term)
{
  ...
  if(ATmatchTerm(term, pattern_asfix_term,
    ...
    t_name = ATparse("l(\"GenerateTraversals\")");
    ...
    result = ATmakeTerm(pattern_asfix_appl,
                      ATparse("prod(id(\"Traversals\"),w(\"\"),[ql(\"GenerateTraversals\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"SDF\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SDF\"),w(\"\"),no-attrs)"),
                      term_ws,
...
/*}}}  */
/*{{{  ATerm add_traversals_function(char *str, ATerm term) */
...
ATerm add_traversals_function(char *str, ATerm term)
{
  ...
  if(ATmatchTerm(term, pattern_asfix_term,
    ...
    result = ATmakeTerm(pattern_asfix_appl,
                      ATparse("prod(id(\"Traversals\"),w(\"\"),[ql(\"GenerateTraversals\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ModuleName\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"SDF\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SDF\"),w(\"\"),no-attrs)"),
                      term_ws,
...
/*}}}  */
/*{{{  ATerm generate_traversals(int cid, char *name, ATerm t) */
...
ATerm generate_traversals(int cid, char *name, ATerm t)
{
  ...
  et = AFexpandTerm(t);
  ft = add_traversals_function(name, et);
...
int main(int argc, char *argv[])
{
  ...
  if(toolbus_mode) {
      ...
      cid = ATBconnect(NULL, NULL, -1, traversals_handler);
      ATBeventloop();
    #else
      ATwarning("traversals: Toolbus cannot be used in Windows.\n");
    #endif
  }
  else {
    ...
    if(proceed) {  
      ...
      et = add_traversals_function_standalone(t);
