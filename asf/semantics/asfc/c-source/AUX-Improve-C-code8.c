...
register_prod ( ATparse ( "prod(id(\"Improve-C-code\"),w(\"\"),[ql(\"transform-arg-in-stats\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)" ) , lf_AUX_Improve_C_code8_1 , lf_AUX_Improve_C_code8_1sym ) ;
...
ef3 = lookup_func ( ATreadFromString ( "prod(id(\"Improve-C-code\"),w(\"\"),[ql(\"transform-arg-in-stat\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement\"),w(\"\"),no-attrs)" ) ) ;
ef3sym = lookup_sym ( ATreadFromString ( "prod(id(\"Improve-C-code\"),w(\"\"),[ql(\"transform-arg-in-stat\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement\"),w(\"\"),no-attrs)" ) ) ;
}
...
( tmp [ 2 ] = ( * ef3 ) ( tmp [ 0 ] ) ) ;
( tmp [ 3 ] = lf_AUX_Improve_C_code8_1 ( ( * ef1 ) ( make_nf1 ( ef2sym , lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ) ) ;
...
FUNC_EXIT ( ( * ef1 ) ( make_nf1 ( ef2sym , lf2 ( cons ( make_list ( tmp [ 2 ] ) , make_list ( tmp [ 6 ] ) ) ) ) ) ) ;
}
}
}
}
