#include "support.h"
static asymbol * lf_AUX_Normalize_Conds7_2sym;
static aterm * lf_AUX_Normalize_Conds7_2( aterm * arg1 , aterm * arg2);
static asymbol * ef1sym;
static funcptr ef1;
static asymbol * ef2sym;
static funcptr ef2;
static asymbol * lf_AUX_Normalize_Conds7_1sym;
...
lf_AUX_Normalize_Conds7_2sym= TmkSymbol( "prod(id(\"Normalize-Conds\"),w(\"\"),[l(\"normalize-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TC-tuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf_AUX_Normalize_Conds7_1sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"Term\"),ql(\",\"))") , lf_AUX_Normalize_Conds7_1 , lf_AUX_Normalize_Conds7_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Normalize-Conds\"),w(\"\"),[l(\"normalize-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TC-tuple\"),w(\"\"),no-attrs)") , lf_AUX_Normalize_Conds7_2 , lf_AUX_Normalize_Conds7_2sym);
...
tmp[ 4]= arg_1( tmp[ 2]);
tmp[ 5]= arg_2( tmp[ 2]);
if( check_sym( tmp[ 3] , lf_AUX_Normalize_Conds7_1sym)) {
tmp[ 6]= arg_0( tmp[ 3]);
...
t_protect( tmp[ 1]);
t_protect( tmp[ 5]);
tmp[ 9]= lf_AUX_Normalize_Conds7_2( lf_AUX_Normalize_Conds7_1( make_list( tmp[ 1])) , tmp[ 5]);
...
t_unprotect( tmp[ 2]);
t_unprotect( tmp[ 9]);
return ( * ef2)( lf_AUX_Normalize_Conds7_1( cons( make_list( tmp[ 8]) , make_list( tmp[ 13]))) , lf3( cons( make_list( tmp[ 7]) , make_list( tmp[ 14]))) , tmp[ 12]);
}
}
}
}
