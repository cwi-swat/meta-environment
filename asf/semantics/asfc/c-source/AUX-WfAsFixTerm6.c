...
lf_AUX_WfAsFixTerm6_1sym= ATmakeSymbol( "prod(id(\"WfAsFixTerm\"),w(\"\"),[l(\"match-list-type\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 3 , ATtrue);
ATprotectSymbol( lf_AUX_WfAsFixTerm6_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"WfAsFixTerm\"),w(\"\"),[l(\"match-list-type\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_WfAsFixTerm6_1 , lf_AUX_WfAsFixTerm6_1sym);
...
return ( * ef12)( ( * ef13)( arg0 , ( * ef14)( atmp200) , ( constant1? constant1: ( constant1= ( * ef1)( ( * ef2)( ) , ( * ef3)( ( * ef4)( ( * ef5)( ( * ef6)( lf2( (ATerm) ATmakeList( 2 , char_table[ 34] , char_table[ 34])))))))))) , lf_AUX_WfAsFixTerm6_1( arg0 , ( constant2? constant2: ( constant2= ( * ef1)( ( * ef2)( ) , ( * ef3)( ( * ef4)( ( * ef5)( ( * ef6)( lf2( (ATerm) ATmakeList( 3 , char_table[ 34] , char_table[ 42] , char_table[ 34]))))))))) , ( * ef9)( atmp2011)));
}
}
}
}
