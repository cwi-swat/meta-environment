#include "support.h"
static Symbol lf_AUX_WfAsFixTerm6_1sym;
static ATerm lf_AUX_WfAsFixTerm6_1( ATerm arg1 , ATerm arg2 , ATerm arg3 , ATerm arg4);
...
lf_AUX_WfAsFixTerm6_1sym= ATmakeSymbol( "prod(id(\"WfAsFixTerm\"),w(\"\"),[l(\"match-list-type-with-sep\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 4 , ATtrue);
ATprotectSymbol( lf_AUX_WfAsFixTerm6_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"WfAsFixTerm\"),w(\"\"),[l(\"match-list-type-with-sep\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_WfAsFixTerm6_1 , lf_AUX_WfAsFixTerm6_1sym);
...
void init_AUX_WfAsFixTerm6( ) {
ATprotect( & constant0);
ATprotect( & constant1);
ATprotect( & constant2);
ATprotect( & constant3);
}
ATerm lf_AUX_WfAsFixTerm6_1( ATerm arg0 , ATerm arg1 , ATerm arg2 , ATerm arg3) {
{
ATerm tmp[2];
...
return ( * ef13)( ( * ef13)( ( * ef14)( arg1 , ( * ef1)( ( constant1? constant1: ( constant1= ( * ef2)( ))) , ( * ef3)( ( * ef4)( ( * ef5)( atmp301101000))))) , ( * ef15)( ( * ef16)( arg0) , ( * ef17)( ( * ef18)( arg0)) , arg1)) , lf_AUX_WfAsFixTerm6_1( arg0 , arg1 , ( constant2? constant2: ( constant2= ( * ef1)( ( * ef2)( ) , ( * ef3)( ( * ef4)( ( * ef5)( ( * ef6)( lf2( (ATerm) ATmakeList( 3 , char_table[ 34] , char_table[ 42] , char_table[ 34]))))))))) , ( * ef9)( atmp301111)));
}
}
}
}
...
return make_nf4( lf_AUX_WfAsFixTerm6_1sym , arg0 , arg1 , arg2 , arg3);
}
}
