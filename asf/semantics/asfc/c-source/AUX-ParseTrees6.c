...
lf_AUX_ParseTrees6_1sym = ATmakeSymbol ( "prod(id(\"ParseTrees\"),w(\"\"),[ql(\"get-list-tail\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ParseTrees6_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"ParseTrees\"),w(\"\"),[ql(\"get-list-tail\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)" ) , lf_AUX_ParseTrees6_1 , lf_AUX_ParseTrees6_1sym ) ;
...
ef10 = lookup_func ( ATreadFromString ( "prod(id(\"ParseTrees\"),w(\"\"),[ql(\"get-cons\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) ) ;
ef10sym = lookup_sym ( ATreadFromString ( "prod(id(\"ParseTrees\"),w(\"\"),[ql(\"get-cons\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) ) ;
ef11 = lookup_func ( ATreadFromString ( "prod(id(\"ATerm-Lists\"),w(\"\"),[ql(\"first\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)" ) ) ;
ef11sym = lookup_sym ( ATreadFromString ( "prod(id(\"ATerm-Lists\"),w(\"\"),[ql(\"first\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)" ) ) ;
}
...
if ( check_sym ( atmp00100 , ef6sym ) ) {
{
ATerm atmp00101 = arg_1 ( atmp0010 ) ;
if ( check_sym ( atmp00101 , ef2sym ) ) {
{
ATerm atmp001010 = arg_0 ( atmp00101 ) ;
if ( check_sym ( atmp001010 , ef7sym ) ) {
{
ATerm atmp0010100 = arg_0 ( atmp001010 ) ;
if ( check_sym ( atmp0010100 , ef8sym ) ) {
{
ATerm atmp00101000 = arg_0 ( atmp0010100 ) ;
{
ATerm atmp0011 = arg_1 ( atmp001 ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef4 ) ( ( * ef5 ) ( ( * ef6 ) ( ) , ( * ef2 ) ( ( * ef7 ) ( ( * ef8 ) ( atmp00101000 ) ) ) ) , atmp0011 ) ) ) ;
}
}
}
}
...
{
ATerm atmp001 = arg_1 ( atmp00 ) ;
if ( ! term_equal ( ( * ef10 ) ( ( * ef11 ) ( ( * ef1 ) ( atmp001 ) ) ) , ( * ef6 ) ( ) ) ) {
FUNC_EXIT ( ( * ef1 ) ( ( * ef4 ) ( ( * ef5 ) ( ( * ef6 ) ( ) , ( * ef2 ) ( ( * ef7 ) ( ( * ef8 ) ( ( * ef9 ) ( lf2 ( ( ATerm ) ATmakeList ( 2 , char_table [ 34 ] , char_table [ 34 ] ) ) ) ) ) ) ) , atmp001 ) ) ) ;
}
}
}
}
