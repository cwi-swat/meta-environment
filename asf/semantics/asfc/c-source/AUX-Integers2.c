...
return ( * ef1)( ( * ef2)( ( * ef3)( atmp000 , atmp100)));
}
else {
return ( * ef1)( ( * ef6)( ( * ef3)( atmp100 , atmp000)));
}
}
}
{
...
{
ATerm atmp100= arg_0( atmp10);
return ( * ef7)( arg0 , ( * ef1)( ( * ef2)( atmp100)));
}
}
}
}
...
{
ATerm atmp100= arg_0( atmp10);
return lf_AUX_Integers2_1( ( * ef1)( ( * ef2)( atmp100)) , ( * ef1)( ( * ef2)( atmp000)));
}
}
}
}
