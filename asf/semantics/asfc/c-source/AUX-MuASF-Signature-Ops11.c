...
lf_AUX_MuASF_Signature_Ops11_1sym = ATmakeSymbol ( "prod(id(\"MuASF-Signature-Ops\"),w(\"\"),[ql(\"is-external\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Annotations\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"MuASF-Signature-Ops\"),w(\"\"),[ql(\"is-external\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Annotations\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Signature_Ops11_1 , lf_AUX_MuASF_Signature_Ops11_1sym ) ;
