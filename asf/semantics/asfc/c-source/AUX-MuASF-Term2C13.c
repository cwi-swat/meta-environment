...
lf_AUX_MuASF_Term2C13_1sym = ATmakeSymbol ( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"is-protected-name\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Identifier\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Term2C13_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"is-protected-name\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Identifier\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Term2C13_1 , lf_AUX_MuASF_Term2C13_1sym ) ;
...
{
ATerm tmp [ 5 ] ;
PROF ( prof_lf_AUX_MuASF_Term2C13_1 ) ;
...
if ( term_equal ( list_head ( atmp000 ) , make_char ( 113 ) ) ) {
