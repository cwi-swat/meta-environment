...
static funcptr ef16 ;
void register_AUX_TermAsFixAccess24 ( ) {
lf_AUX_TermAsFixAccess24_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-literal-symbol-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess24_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-literal-symbol-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess24_1 , lf_AUX_TermAsFixAccess24_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess24 ( ) {
...
void init_AUX_TermAsFixAccess24 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess24_1 ( ATerm arg0 ) {
{
ATerm tmp [ 42 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess24_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess24_1sym , arg0 ) ) ;
...
( tmp [ 29 ] = list_tail ( atmp011110100000 ) ) ;
...
( tmp [ 30 ] = list_tail ( atmp0111110100000 ) ) ;
if ( not_empty_list ( tmp [ 30 ] ) ) {
if ( term_equal ( list_head ( tmp [ 30 ] ) , make_char ( 45 ) ) ) {
( tmp [ 31 ] = list_tail ( tmp [ 30 ] ) ) ;
if ( not_empty_list ( tmp [ 31 ] ) ) {
if ( term_equal ( list_head ( tmp [ 31 ] ) , make_char ( 62 ) ) ) {
...
( tmp [ 33 ] = list_tail ( atmp01111110100000 ) ) ;
...
( tmp [ 34 ] = list_tail ( atmp011111110100000 ) ) ;
if ( not_empty_list ( tmp [ 34 ] ) ) {
if ( term_equal ( list_head ( tmp [ 34 ] ) , make_char ( 83 ) ) ) {
( tmp [ 35 ] = list_tail ( tmp [ 34 ] ) ) ;
if ( not_empty_list ( tmp [ 35 ] ) ) {
if ( term_equal ( list_head ( tmp [ 35 ] ) , make_char ( 121 ) ) ) {
( tmp [ 36 ] = list_tail ( tmp [ 35 ] ) ) ;
if ( not_empty_list ( tmp [ 36 ] ) ) {
if ( term_equal ( list_head ( tmp [ 36 ] ) , make_char ( 109 ) ) ) {
( tmp [ 37 ] = list_tail ( tmp [ 36 ] ) ) ;
if ( not_empty_list ( tmp [ 37 ] ) ) {
if ( term_equal ( list_head ( tmp [ 37 ] ) , make_char ( 98 ) ) ) {
( tmp [ 38 ] = list_tail ( tmp [ 37 ] ) ) ;
if ( not_empty_list ( tmp [ 38 ] ) ) {
if ( term_equal ( list_head ( tmp [ 38 ] ) , make_char ( 111 ) ) ) {
( tmp [ 39 ] = list_tail ( tmp [ 38 ] ) ) ;
if ( not_empty_list ( tmp [ 39 ] ) ) {
if ( term_equal ( list_head ( tmp [ 39 ] ) , make_char ( 108 ) ) ) {
...
( tmp [ 41 ] = list_tail ( atmp0111111110100000 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess24_1sym , arg0 ) ) ;
}
}
