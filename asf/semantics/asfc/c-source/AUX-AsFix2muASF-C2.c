...
static ATerm lf_AUX_AsFix2muASF_C2_1( ATerm arg1 , ATerm arg2);
...
lf_AUX_AsFix2muASF_C2_1sym= ATmakeSymbol( "prod(id(\"AsFix2muASF-C\"),w(\"\"),[l(\"eqs2rules\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTableTuple\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"AsFix2muASF-C\"),w(\"\"),[l(\"eqs2rules\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTableTuple\"),w(\"\"),no-attrs)") , lf_AUX_AsFix2muASF_C2_1 , lf_AUX_AsFix2muASF_C2_1sym);
...
ATerm lf_AUX_AsFix2muASF_C2_1( ATerm arg0 , ATerm arg1) {
{
ATerm tmp[2];
...
return make_nf2( lf_AUX_AsFix2muASF_C2_1sym , arg0 , arg1);
}
}
