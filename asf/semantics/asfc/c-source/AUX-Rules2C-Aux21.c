...
static Symbol lf_AUX_Rules2C_Aux21_2sym ;
static ATerm lf_AUX_Rules2C_Aux21_2 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
lf_AUX_Rules2C_Aux21_2sym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"replace-second-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"replace-second-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux21_2 , lf_AUX_Rules2C_Aux21_2sym ) ;
...
void init_AUX_Rules2C_Aux21 ( ) {
ATprotect ( & constant0 ) ;
}
ATerm lf_AUX_Rules2C_Aux21_2 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 34 ] ;
FUNC_ENTRY ( lf_AUX_Rules2C_Aux21_2sym , ATmakeAppl ( lf_AUX_Rules2C_Aux21_2sym , arg0 , arg1 , arg2 ) ) ;
if ( check_sym ( arg2 , lf_AUX_Rules2C_Aux21_1sym ) ) {
{
...
( tmp [ 31 ] = lf_AUX_Rules2C_Aux21_2 ( arg0 , arg1 , lf_AUX_Rules2C_Aux21_1 ( make_list ( tmp [ 1 ] ) ) ) ) ;
if ( check_sym ( tmp [ 31 ] , ef1sym ) ) {
( tmp [ 32 ] = arg_0 ( tmp [ 31 ] ) ) ;
if ( check_sym ( tmp [ 32 ] , lf_AUX_Rules2C_Aux21_1sym ) ) {
( tmp [ 33 ] = arg_0 ( tmp [ 32 ] ) ) ;
FUNC_EXIT ( ( * ef1 ) ( lf_AUX_Rules2C_Aux21_1 ( cons ( make_list ( ( * ef2 ) ( lf3 ( make_list ( tmp [ 8 ] ) ) , lf4 ( cons ( make_list ( ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( lf5 ( ( ATerm ) ATmakeList ( 10 , char_table [ 116 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 109 ] , char_table [ 95 ] , char_table [ 101 ] , char_table [ 113 ] , char_table [ 117 ] , char_table [ 97 ] , char_table [ 108 ] ) ) ) , lf6 ( cons ( make_list ( tmp [ 28 ] ) , make_list ( arg0 ) ) ) ) , tmp [ 13 ] ) ) , make_list ( tmp [ 11 ] ) ) ) , tmp [ 4 ] , ( * ef6 ) ( tmp [ 5 ] , arg1 ) , ( * ef6 ) ( tmp [ 6 ] , arg1 ) , tmp [ 7 ] ) ) , make_list ( tmp [ 33 ] ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT_CONST ( constant0 , ( * ef1 ) ( lf_AUX_Rules2C_Aux21_1 ( make_list ( null ( ) ) ) ) ) ;
}
}
}
FUNC_EXIT ( make_nf3 ( lf_AUX_Rules2C_Aux21_2sym , arg0 , arg1 , arg2 ) ) ;
}
}
ATerm lf_AUX_Rules2C_Aux21_1 ( ATerm arg0 ) {
CONS_ENTRY ( lf_AUX_Rules2C_Aux21_1sym , ATmakeAppl ( lf_AUX_Rules2C_Aux21_1sym , arg0 ) ) ;
CONS_EXIT ( make_nf1 ( lf_AUX_Rules2C_Aux21_1sym , arg0 ) ) ;
}
