...
FUNC_EXIT_CONST ( constant0 , make_nf1 ( ef5sym , lf_AUX_Rules2C_Aux21_1 ( make_list ( null ( ) ) ) ) ) ;
}
else {
...
( tmp [ 33 ] = arg_0 ( tmp [ 32 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef5sym , lf_AUX_Rules2C_Aux21_1 ( cons ( make_list ( ( * ef1 ) ( lf3 ( make_list ( tmp [ 8 ] ) ) , lf4 ( cons ( make_list ( ( * ef2 ) ( ( * ef3 ) ( ( * ef4 ) ( lf5 ( ( ATerm ) ATmakeList ( 10 , char_table [ 116 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 109 ] , char_table [ 95 ] , char_table [ 101 ] , char_table [ 113 ] , char_table [ 117 ] , char_table [ 97 ] , char_table [ 108 ] ) ) ) , lf6 ( cons ( make_list ( tmp [ 28 ] ) , make_list ( arg0 ) ) ) ) , tmp [ 13 ] ) ) , make_list ( tmp [ 11 ] ) ) ) , tmp [ 4 ] , ( * ef6 ) ( tmp [ 5 ] , arg1 ) , ( * ef6 ) ( tmp [ 6 ] , arg1 ) , tmp [ 7 ] ) ) , make_list ( tmp [ 33 ] ) ) ) ) ) ;
}
}
}
}
