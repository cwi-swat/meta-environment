...
ef1 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Basics\"),w(\"\"),[ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"TermList\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncTermTableTuple\"),w(\"\"),no-attrs)" ) ) ;
ef1sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Basics\"),w(\"\"),[ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"TermList\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncTermTableTuple\"),w(\"\"),no-attrs)" ) ) ;
...
tmp [ 0 ] = ( constant0 ? constant0 : ( constant0 = ( * ef5 ) ( ) ) ) ;
...
tmp [ 2 ] = ( * ef9 ) ( arg0 , ( constant1 ? constant1 : ( constant1 = lf4 ( make_list ( ( * ef10 ) ( ) ) ) ) ) ) ;
tmp [ 3 ] = ( * ef11 ) ( tmp [ 2 ] ) ;
if ( term_equal ( tmp [ 3 ] , ( constant2 ? constant2 : ( constant2 = ( * ef15 ) ( ) ) ) ) ) {
tmp [ 4 ] = ( * ef16 ) ( tmp [ 2 ] ) ;
tmp [ 5 ] = ( * ef9 ) ( tmp [ 2 ] , ( constant3 ? constant3 : ( constant3 = lf4 ( make_list ( ( * ef17 ) ( ) ) ) ) ) ) ;
tmp [ 6 ] = ( * ef18 ) ( tmp [ 5 ] ) ;
...
tmp [ 10 ] = arg_0 ( tmp [ 9 ] ) ;
tmp [ 11 ] = arg_1 ( tmp [ 9 ] ) ;
tmp [ 12 ] = ( * ef9 ) ( arg0 , ( constant4 ? constant4 : ( constant4 = lf4 ( make_list ( ( * ef12 ) ( ) ) ) ) ) ) ;
...
if ( term_equal ( tmp [ 3 ] , ( constant0 ? constant0 : ( constant0 = ( * ef5 ) ( ) ) ) ) ) {
tmp [ 4 ] = ( * ef9 ) ( arg0 , ( constant4 ? constant4 : ( constant4 = lf4 ( make_list ( ( * ef12 ) ( ) ) ) ) ) ) ;
...
tmp [ 2 ] = ( * ef9 ) ( arg0 , ( constant5 ? constant5 : ( constant5 = lf4 ( make_list ( ( * ef26 ) ( ) ) ) ) ) ) ;
tmp [ 3 ] = ( * ef27 ) ( tmp [ 2 ] ) ;
tmp [ 4 ] = ( * ef28 ) ( tmp [ 3 ] , arg1 ) ;
if ( check_sym ( tmp [ 4 ] , ef20sym ) ) {
tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ;
tmp [ 6 ] = arg_1 ( tmp [ 4 ] ) ;
tmp [ 7 ] = ( * ef9 ) ( arg0 , ( constant6 ? constant6 : ( constant6 = lf4 ( make_list ( ( * ef29 ) ( ) ) ) ) ) ) ;
...
tmp [ 15 ] = arg_0 ( tmp [ 14 ] ) ;
tmp [ 16 ] = ( * ef31 ) ( tmp [ 3 ] , ( constant7 ? constant7 : ( constant7 = ( * ef2 ) ( lf3 ( make_list ( ( * ef32 ) ( ( * ef33 ) ( lf5 ( cons ( make_list ( make_char ( 110 ) ) , cons ( make_list ( make_char ( 117 ) ) , cons ( make_list ( make_char ( 108 ) ) , make_list ( make_char ( 108 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
...
tmp [ 3 ] = ( * ef9 ) ( arg0 , ( constant5 ? constant5 : ( constant5 = lf4 ( make_list ( ( * ef26 ) ( ) ) ) ) ) ) ;
if ( check_sym ( tmp [ 3 ] , ef35sym ) ) {
tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ;
tmp [ 5 ] = arg_1 ( tmp [ 3 ] ) ;
if ( term_equal ( tmp [ 4 ] , ( constant8 ? constant8 : ( constant8 = ( * ef36 ) ( ) ) ) ) ) {
...
tmp [ 9 ] = ( * ef9 ) ( arg0 , ( constant9 ? constant9 : ( constant9 = lf4 ( make_list ( ( * ef41 ) ( ) ) ) ) ) ) ;
if ( check_sym ( tmp [ 9 ] , ef38sym ) ) {
tmp [ 10 ] = arg_0 ( tmp [ 9 ] ) ;
if ( check_sym ( tmp [ 10 ] , ef39sym ) ) {
tmp [ 11 ] = arg_0 ( tmp [ 10 ] ) ;
tmp [ 12 ] = ( constant10 ? constant10 : ( constant10 = ( * ef33 ) ( lf5 ( cons ( make_list ( make_char ( 34 ) ) , cons ( make_list ( make_char ( 123 ) ) , cons ( make_list ( make_char ( 115 ) ) , cons ( make_list ( make_char ( 111 ) ) , cons ( make_list ( make_char ( 114 ) ) , cons ( make_list ( make_char ( 116 ) ) , cons ( make_list ( make_char ( 40 ) ) , cons ( make_list ( make_char ( 92 ) ) , cons ( make_list ( make_char ( 34 ) ) , cons ( make_list ( make_char ( 67 ) ) , cons ( make_list ( make_char ( 72 ) ) , cons ( make_list ( make_char ( 65 ) ) , cons ( make_list ( make_char ( 82 ) ) , cons ( make_list ( make_char ( 92 ) ) , cons ( make_list ( make_char ( 34 ) ) , cons ( make_list ( make_char ( 41 ) ) , cons ( make_list ( make_char ( 125 ) ) , make_list ( make_char ( 34 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
tmp [ 13 ] = ( * ef28 ) ( tmp [ 12 ] , arg1 ) ;
if ( check_sym ( tmp [ 13 ] , ef20sym ) ) {
tmp [ 14 ] = arg_0 ( tmp [ 13 ] ) ;
tmp [ 15 ] = arg_1 ( tmp [ 13 ] ) ;
tmp [ 16 ] = ( * ef31 ) ( tmp [ 12 ] , ( constant7 ? constant7 : ( constant7 = ( * ef2 ) ( lf3 ( make_list ( ( * ef32 ) ( ( * ef33 ) ( lf5 ( cons ( make_list ( make_char ( 110 ) ) , cons ( make_list ( make_char ( 117 ) ) , cons ( make_list ( make_char ( 108 ) ) , make_list ( make_char ( 108 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
tmp [ 17 ] = ( * ef44 ) ( tmp [ 8 ] ) ;
tmp [ 18 ] = ( * ef45 ) ( tmp [ 17 ] , tmp [ 15 ] ) ;
if ( check_sym ( tmp [ 18 ] , ef20sym ) ) {
tmp [ 19 ] = arg_0 ( tmp [ 18 ] ) ;
tmp [ 20 ] = arg_1 ( tmp [ 18 ] ) ;
tmp [ 21 ] = ( * ef21 ) ( tmp [ 19 ] , ( constant7 ? constant7 : ( constant7 = ( * ef2 ) ( lf3 ( make_list ( ( * ef32 ) ( ( * ef33 ) ( lf5 ( cons ( make_list ( make_char ( 110 ) ) , cons ( make_list ( make_char ( 117 ) ) , cons ( make_list ( make_char ( 108 ) ) , make_list ( make_char ( 108 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
tmp [ 22 ] = ( * ef46 ) ( tmp [ 11 ] ) ;
...
if ( term_equal ( ( * ef9 ) ( arg0 , ( constant5 ? constant5 : ( constant5 = lf4 ( make_list ( ( * ef26 ) ( ) ) ) ) ) ) , ( constant11 ? constant11 : ( constant11 = ( * ef35 ) ( ( * ef36 ) ( ) , ( * ef37 ) ( ( * ef38 ) ( ( * ef39 ) ( ( * ef40 ) ( lf5 ( ( ATerm ) ATmakeList ( 6 , char_table [ 34 ] , char_table [ 67 ] , char_table [ 72 ] , char_table [ 65 ] , char_table [ 82 ] , char_table [ 34 ] ) ) ) ) ) ) ) ) ) ) ) {
tmp [ 3 ] = ( * ef9 ) ( arg0 , ( constant9 ? constant9 : ( constant9 = lf4 ( make_list ( ( * ef41 ) ( ) ) ) ) ) ) ;
