...
static Symbol lf_AUX_ATerm_Operations2_1sym ;
static ATerm lf_AUX_ATerm_Operations2_1 ( ATerm arg1 ) ;
...
static funcptr ef4 ;
void register_AUX_ATerm_Operations2 ( ) {
lf_AUX_ATerm_Operations2_1sym = ATmakeSymbol ( "prod(id(\"ATerm-Operations\"),w(\"\"),[l(\"is-list\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ATerm_Operations2_1sym ) ;
register_prod ( ATparse ( "prod(id(\"ATerm-Operations\"),w(\"\"),[l(\"is-list\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_ATerm_Operations2_1 , lf_AUX_ATerm_Operations2_1sym ) ;
}
void resolve_AUX_ATerm_Operations2 ( ) {
...
void init_AUX_ATerm_Operations2 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_ATerm_Operations2_1 ( ATerm arg0 ) {
FUNC_ENTRY ( lf_AUX_ATerm_Operations2_1sym , ATmakeAppl ( lf_AUX_ATerm_Operations2_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_ATerm_Operations2_1sym , arg0 ) ) ;
}
