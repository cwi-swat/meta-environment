...
static ATerm lf_AUX_AsFix2Sign_C3_1 ( ATerm arg1 ) ;
...
lf_AUX_AsFix2Sign_C3_1sym = ATmakeSymbol ( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"attrs2terms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"attrs2terms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)" ) , lf_AUX_AsFix2Sign_C3_1 , lf_AUX_AsFix2Sign_C3_1sym ) ;
...
ef4 = lookup_func ( ATreadFromString ( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"attrlist2terms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)" ) ) ;
ef4sym = lookup_sym ( ATreadFromString ( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"attrlist2terms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)" ) ) ;
...
ATerm lf_AUX_AsFix2Sign_C3_1 ( ATerm arg0 ) {
{
ATerm tmp [ 2 ] ;
FUNC_ENTRY ( lf_AUX_AsFix2Sign_C3_1sym , ATmakeAppl ( lf_AUX_AsFix2Sign_C3_1sym , arg0 ) ) ;
...
tmp [ 0 ] = ( * ef7 ) ( arg0 , ( constant2 ? constant2 : ( constant2 = lf3 ( make_list ( ( * ef6 ) ( ) ) ) ) ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_AsFix2Sign_C3_1sym , arg0 ) ) ;
}
}
