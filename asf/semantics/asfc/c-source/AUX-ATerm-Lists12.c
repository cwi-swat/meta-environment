...
lf_AUX_ATerm_Lists12_1sym = ATmakeSymbol ( "prod(id(\"ATerm-Lists\"),w(\"\"),[ql(\"delete1\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ATerm_Lists12_1sym ) ;
register_prod ( ATparse ( "prod(id(\"ATerm-Lists\"),w(\"\"),[ql(\"delete1\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)" ) , lf_AUX_ATerm_Lists12_1 , lf_AUX_ATerm_Lists12_1sym ) ;
}
...
( tmp [ 0 ] = ( * ef4 ) ( arg0 ) ) ;
if ( term_equal ( ( * ef5 ) ( tmp [ 0 ] , arg1 ) , ( constant0 ? constant0 : ( constant0 = ( * ef6 ) ( ) ) ) ) ) {
FUNC_EXIT ( ( * ef2 ) ( tmp [ 0 ] , lf_AUX_ATerm_Lists12_1 ( ( * ef3 ) ( arg0 ) , arg1 ) ) ) ;
}
if ( term_equal ( ( * ef5 ) ( ( * ef4 ) ( arg0 ) , arg1 ) , ( constant1 ? constant1 : ( constant1 = ( * ef7 ) ( ) ) ) ) ) {
FUNC_EXIT ( ( * ef3 ) ( arg0 ) ) ;
}
}
}
