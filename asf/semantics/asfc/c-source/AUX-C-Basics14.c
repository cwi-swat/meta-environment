...
lf_AUX_C_Basics14_1sym= ATmakeSymbol( "prod(id(\"C-Basics\"),w(\"\"),[l(\"make-c-name\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Identifier\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_C_Basics14_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"C-Basics\"),w(\"\"),[l(\"make-c-name\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Identifier\"),w(\"\"),no-attrs)") , lf_AUX_C_Basics14_1 , lf_AUX_C_Basics14_1sym);
...
tmp[ 1]= lf_AUX_C_Basics14_1( ( * ef1)( lf2( make_list( tmp[ 0]))));
...
if( ! term_equal( ( * ef1)( lf2( make_list( tmp[ 0]))) , ( * ef1)( lf2( make_list( make_char( 45)))))) {
tmp[ 2]= lf_AUX_C_Basics14_1( ( * ef1)( lf2( make_list( tmp[ 1]))));
...
return make_nf1( lf_AUX_C_Basics14_1sym , arg0);
}
}
