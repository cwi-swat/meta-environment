...
lf_AUX_AVars2_1sym = ATmakeSymbol ( "prod(id(\"AVars\"),w(\"\"),[ql(\"is-avar\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_AVars2_1sym ) ;
register_prod ( ATparse ( "prod(id(\"AVars\"),w(\"\"),[ql(\"is-avar\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_AVars2_1 , lf_AUX_AVars2_1sym ) ;
}
