...
ef6 = lookup_func ( ATreadFromString ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"make-stats-function\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)" ) ) ;
ef6sym = lookup_sym ( ATreadFromString ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"make-stats-function\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)" ) ) ;
...
FUNC_EXIT_CONST ( constant0 , ( * ef1 ) ( lf3 ( make_list ( null ( ) ) ) , ( * ef7 ) ( ) , ( * ef8 ) ( ) ) ) ;
}
else {
...
FUNC_EXIT ( ( * ef1 ) ( lf3 ( make_list ( null ( ) ) ) , ( * ef2 ) ( make_nf1 ( ef3sym , lf4 ( make_list ( tmp [ 7 ] ) ) ) ) , ( * ef4 ) ( make_nf1 ( ef5sym , lf5 ( make_list ( tmp [ 10 ] ) ) ) ) ) ) ;
}
}
}
}
