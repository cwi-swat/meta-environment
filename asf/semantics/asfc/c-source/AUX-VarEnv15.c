...
lf_AUX_VarEnv15_1sym= ATmakeSymbol( "prod(id(\"VarEnv\"),w(\"\"),[l(\"nt-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"VarEnv\"),w(\"\"),[l(\"nt-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)") , lf_AUX_VarEnv15_1 , lf_AUX_VarEnv15_1sym);
...
tmp[ 2]= arg_0( tmp[ 1]);
return ( * ef3)( ( * ef2)( lf3( cons( make_list( atmp1100) , make_list( tmp[ 2])))) , ( * ef1)( lf2( make_list( ( * ef4)( arg0 , ( * ef2)( lf3( cons( make_list( atmp1100) , make_list( tmp[ 2]))))))) , ( * ef2)( lf3( make_list( atmp1100))) , ( * ef5)( atmp12) , atmp13));
}
}
}
}
