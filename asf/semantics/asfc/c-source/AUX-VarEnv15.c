#include "support.h"
static asymbol * lf_AUX_VarEnv15_1sym;
...
lf_AUX_VarEnv15_1sym= TmkSymbol( "prod(id(\"VarEnv\"),w(\"\"),[l(\"ntl-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"VarEnv\"),w(\"\"),[l(\"ntl-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)") , lf_AUX_VarEnv15_1 , lf_AUX_VarEnv15_1sym);
...
ef2= lookup_func( TmakeSimple( & local , "prod(id(\"VarEnv\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)"));
ef2sym= lookup_sym( TmakeSimple( & local , "prod(id(\"VarEnv\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)"));
...
t_protect( atmp12);
t_protect( atmp13);
tmp[ 4]= lf_AUX_VarEnv15_1( arg0 , ( * ef1)( lf2( make_list( tmp[ 3])) , atmp11 , atmp12 , atmp13));
...
t_unprotect( tmp[ 3]);
t_unprotect( tmp[ 4]);
return ( * ef2)( tmp[ 5] , ( * ef1)( lf2( cons( make_list( ( * ef4)( tmp[ 1] , tmp[ 2])) , make_list( tmp[ 11]))) , tmp[ 8] , tmp[ 9] , tmp[ 10]));
}
}
}
t_unprotect( tmp[ 4]);
...
t_unprotect( arg1);
t_unprotect( tmp[ 0]);
return ( * ef2)( tmp[ 2] , ( * ef1)( lf2( cons( make_list( ( * ef4)( arg0 , tmp[ 2])) , make_list( tmp[ 3]))) , atmp11 , atmp12 , atmp13));
}
t_unprotect( tmp[ 3]);
}
}
...
t_protect( atmp13);
t_unprotect( arg1);
return ( * ef2)( ( * ef3)( lf3( cons( make_list( make_char( 108)) , cons( make_list( make_char( 102)) , make_list( tmp[ 1]))))) , ( * ef1)( lf2( make_list( ( * ef4)( arg0 , ( * ef3)( lf3( cons( make_list( make_char( 108)) , cons( make_list( make_char( 102)) , make_list( tmp[ 1])))))))) , atmp11 , atmp12 , ( * ef5)( atmp13)));
}
}
}
}
