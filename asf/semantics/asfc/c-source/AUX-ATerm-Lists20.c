...
ef8 = lookup_func ( ATreadFromString ( "prod(id(\"ATerm-Operations\"),w(\"\"),[ql(\"if\"),w(\"\"),sort(\"Bool\"),w(\"\"),ql(\"then\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\"else\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\"fi\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)" ) ) ;
ef8sym = lookup_sym ( ATreadFromString ( "prod(id(\"ATerm-Operations\"),w(\"\"),[ql(\"if\"),w(\"\"),sort(\"Bool\"),w(\"\"),ql(\"then\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\"else\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\"fi\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)" ) ) ;
ef9 = lookup_func ( ATreadFromString ( "prod(id(\"ATerm-Lists\"),w(\"\"),[ql(\"empty\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
ef9sym = lookup_sym ( ATreadFromString ( "prod(id(\"ATerm-Lists\"),w(\"\"),[ql(\"empty\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
}
...
( tmp [ 0 ] = ( * ef5 ) ( arg3 ) ) ;
( tmp [ 1 ] = ( * ef5 ) ( arg4 ) ) ;
( tmp [ 2 ] = lf_AUX_ATerm_Lists20_1 ( arg0 , arg1 , arg2 , ( * ef6 ) ( arg3 ) , ( * ef6 ) ( arg4 ) ) ) ;
FUNC_EXIT ( ( * ef2 ) ( arg0 , ( * ef3 ) ( tmp [ 0 ] , ( * ef3 ) ( tmp [ 1 ] , ( * ef4 ) ( tmp [ 2 ] ) ) ) ) ) ;
}
}
}
}
if ( check_sym ( arg3 , ef7sym ) ) {
FUNC_EXIT ( ( * ef8 ) ( ( * ef9 ) ( arg4 ) , arg1 , arg2 ) ) ;
}
if ( check_sym ( arg4 , ef7sym ) ) {
FUNC_EXIT ( ( * ef8 ) ( ( * ef9 ) ( arg3 ) , arg1 , arg2 ) ) ;
}
