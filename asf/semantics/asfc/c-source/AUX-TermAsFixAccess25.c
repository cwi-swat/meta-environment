#include  "support.h"
static Symbol lf_AUX_TermAsFixAccess25_1sym ;
static ATerm lf_AUX_TermAsFixAccess25_1 ( ATerm arg1 ) ;
...
static funcptr ef16 ;
void register_AUX_TermAsFixAccess25 ( ) {
lf_AUX_TermAsFixAccess25_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-uqliteral-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess25_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-uqliteral-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess25_1 , lf_AUX_TermAsFixAccess25_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess25 ( ) {
...
void init_AUX_TermAsFixAccess25 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess25_1 ( ATerm arg0 ) {
{
ATerm tmp [ 45 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess25_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess25_1sym , arg0 ) ) ;
...
if ( term_equal ( list_head ( tmp [ 21 ] ) , make_char ( 85 ) ) ) {
tmp [ 22 ] = list_tail ( tmp [ 21 ] ) ;
if ( not_empty_list ( tmp [ 22 ] ) ) {
if ( term_equal ( list_head ( tmp [ 22 ] ) , make_char ( 81 ) ) ) {
tmp [ 23 ] = list_tail ( tmp [ 22 ] ) ;
if ( not_empty_list ( tmp [ 23 ] ) ) {
if ( term_equal ( list_head ( tmp [ 23 ] ) , make_char ( 76 ) ) ) {
tmp [ 24 ] = list_tail ( tmp [ 23 ] ) ;
if ( not_empty_list ( tmp [ 24 ] ) ) {
if ( term_equal ( list_head ( tmp [ 24 ] ) , make_char ( 105 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 28 ] ) , make_char ( 97 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 36 ] ) , make_char ( 76 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 39 ] ) , make_char ( 101 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 41 ] ) , make_char ( 97 ) ) ) {
tmp [ 42 ] = list_tail ( tmp [ 41 ] ) ;
if ( not_empty_list ( tmp [ 42 ] ) ) {
if ( term_equal ( list_head ( tmp [ 42 ] ) , make_char ( 108 ) ) ) {
...
tmp [ 44 ] = list_tail ( atmp0111111110100000 ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess25_1sym , arg0 ) ) ;
}
}
