#include "support.h"
static Symbol lf_AUX_AsFix2Sign_C11_1sym;
static ATerm lf_AUX_AsFix2Sign_C11_1( ATerm arg1 , ATerm arg2 , ATerm arg3);
...
lf_AUX_AsFix2Sign_C11_1sym= ATmakeSymbol( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"lexfunc2sign\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"SortList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncSortStruct\"),w(\"\"),no-attrs)"
 , 3 , ATtrue);
ATprotectSymbol( lf_AUX_AsFix2Sign_C11_1sym);
...
register_prod( ATparse( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"lexfunc2sign\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"SortList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncSortStruct\"),w(\"\"),no-attrs)") , lf_AUX_AsFix2Sign_C11_1 , lf_AUX_AsFix2Sign_C11_1sym);
...
ATerm lf_AUX_AsFix2Sign_C11_1( ATerm arg0 , ATerm arg1 , ATerm arg2) {
{
ATerm tmp[14];
...
return make_nf3( lf_AUX_AsFix2Sign_C11_1sym , arg0 , arg1 , arg2);
}
}
