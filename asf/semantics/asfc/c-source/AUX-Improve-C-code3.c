...
ef10 = lookup_func ( ATreadFromString ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"make-ltmp-array\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"IntCon\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)" ) ) ;
ef10sym = lookup_sym ( ATreadFromString ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"make-ltmp-array\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"IntCon\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)" ) ) ;
ef11 = lookup_func ( ATreadFromString ( "prod(id(\"Improve-C-code\"),w(\"\"),[ql(\"save-args\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Int\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)" ) ) ;
ef11sym = lookup_sym ( ATreadFromString ( "prod(id(\"Improve-C-code\"),w(\"\"),[ql(\"save-args\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Int\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)" ) ) ;
ef12 = lookup_func ( ATreadFromString ( "prod(id(\"Improve-C-code\"),w(\"\"),[ql(\"transform-arg-in-stats\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)" ) ) ;
ef12sym = lookup_sym ( ATreadFromString ( "prod(id(\"Improve-C-code\"),w(\"\"),[ql(\"transform-arg-in-stats\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)" ) ) ;
}
...
{
ATerm atmp30 = arg_0 ( arg3 ) ;
if ( check_sym ( atmp30 , ef8sym ) ) {
{
ATerm atmp300 = arg_0 ( atmp30 ) ;
if ( check_sym ( atmp300 , ef9sym ) ) {
{
...
ATerm atmp30 = arg_0 ( arg3 ) ;
if ( not_empty_list ( atmp2000 ) ) {
if ( ! term_equal ( atmp30 , ( * ef8 ) ( ( * ef9 ) ( lf3 ( make_list ( make_char ( 48 ) ) ) ) ) ) ) {
( tmp [ 0 ] = ( * ef10 ) ( atmp30 ) ) ;
( tmp [ 1 ] = ( * ef11 ) ( arg3 ) ) ;
...
( tmp [ 7 ] = ( * ef12 ) ( ( * ef2 ) ( make_nf1 ( ef3sym , lf2 ( make_list ( atmp2000 ) ) ) ) ) ) ;
...
FUNC_EXIT ( ( * ef2 ) ( make_nf1 ( ef3sym , lf2 ( make_list ( ( * ef6 ) ( tmp [ 0 ] , ( * ef2 ) ( make_nf1 ( ef3sym , lf2 ( cons ( make_list ( ( * ef7 ) ( arg1 , tmp [ 5 ] ) ) , cons ( make_list ( tmp [ 6 ] ) , make_list ( tmp [ 10 ] ) ) ) ) ) ) ) ) ) ) ) ) ;
}
}
}
}
