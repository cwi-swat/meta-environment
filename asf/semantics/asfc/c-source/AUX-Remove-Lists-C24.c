#include "support.h"
static Symbol lf_AUX_Remove_Lists_C24_2sym;
static ATerm lf_AUX_Remove_Lists_C24_2( ATerm arg1 , ATerm arg2);
...
static funcptr ef3;
static Symbol lf_AUX_Remove_Lists_C24_1sym;
static ATerm lf_AUX_Remove_Lists_C24_1( ATerm arg1);
...
void register_AUX_Remove_Lists_C24( ) {
lf_AUX_Remove_Lists_C24_2sym= ATmakeSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-multiple-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Remove_Lists_C24_2sym);
lf3sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf3sym);
lf_AUX_Remove_Lists_C24_1sym= ATmakeSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Remove_Lists_C24_1sym);
lf4sym= ATmakeSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , 1 , ATtrue);
ATprotectSymbol( lf4sym);
register_prod( ATparse( "listtype(sort(\"Term\"),ql(\",\"))") , lf_AUX_Remove_Lists_C24_1 , lf_AUX_Remove_Lists_C24_1sym);
register_prod( ATparse( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-multiple-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C24_2 , lf_AUX_Remove_Lists_C24_2sym);
register_prod( ATparse( "listtype(sort(\"CHAR\"))") , lf3 , lf3sym);
register_prod( ATparse( "listtype(sort(\"Cond\"),ql(\"&\"))") , lf4 , lf4sym);
}
void resolve_AUX_Remove_Lists_C24( ) {
...
tmp[ 4]= arg_0( tmp[ 3]);
{
if( check_sym( tmp[ 2] , lf_AUX_Remove_Lists_C24_1sym)) {
tmp[ 5]= arg_0( tmp[ 2]);
{
...
tmp[ 19]= arg_1( tmp[ 17]);
tmp[ 20]= arg_2( tmp[ 17]);
if( check_sym( tmp[ 18] , lf_AUX_Remove_Lists_C24_1sym)) {
tmp[ 21]= arg_0( tmp[ 18]);
...
tmp[ 27]= ( * ef16)( lf_AUX_Remove_Lists_C24_1( make_list( tmp[ 15])) , tmp[ 26]);
if( check_sym( tmp[ 27] , ef3sym)) {
tmp[ 28]= arg_0( tmp[ 27]);
tmp[ 29]= arg_1( tmp[ 27]);
tmp[ 30]= arg_2( tmp[ 27]);
if( check_sym( tmp[ 28] , lf_AUX_Remove_Lists_C24_1sym)) {
tmp[ 31]= arg_0( tmp[ 28]);
...
tmp[ 22]= arg_1( tmp[ 20]);
tmp[ 23]= arg_2( tmp[ 20]);
if( check_sym( tmp[ 21] , lf_AUX_Remove_Lists_C24_1sym)) {
tmp[ 24]= arg_0( tmp[ 21]);
