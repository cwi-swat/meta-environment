#include "support.h"
static asymbol * lf_AUX_Remove_Lists_C24_1sym;
...
lf_AUX_Remove_Lists_C24_1sym= TmkSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"make-default-rule\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Rule\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Rule\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"make-default-rule\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Rule\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Rule\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C24_1 , lf_AUX_Remove_Lists_C24_1sym);
...
t_protect( atmp02);
t_unprotect( arg0);
return ( * ef5)( ( * ef4)( lf2( make_list( atmp0000))) , atmp01 , atmp02);
}
}
}
}
