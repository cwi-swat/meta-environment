...
static Symbol lf_AUX_MuASF_Basics11_1sym ;
static ATerm lf_AUX_MuASF_Basics11_1 ( ATerm arg1 ) ;
...
static funcptr ef6 ;
void register_AUX_MuASF_Basics11 ( ) {
lf_AUX_MuASF_Basics11_1sym = ATmakeSymbol ( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"is-var-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Basics11_1sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"is-var-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Basics11_1 , lf_AUX_MuASF_Basics11_1sym ) ;
}
void resolve_AUX_MuASF_Basics11 ( ) {
...
void init_AUX_MuASF_Basics11 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_MuASF_Basics11_1 ( ATerm arg0 ) {
FUNC_ENTRY ( lf_AUX_MuASF_Basics11_1sym , ATmakeAppl ( lf_AUX_MuASF_Basics11_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_MuASF_Basics11_1sym , arg0 ) ) ;
}
