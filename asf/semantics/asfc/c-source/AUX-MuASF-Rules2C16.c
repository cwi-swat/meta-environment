...
static aterm * lf_AUX_MuASF_Rules2C16_2( aterm * arg1 , aterm * arg2 , aterm * arg3);
...
lf_AUX_MuASF_Rules2C16_2sym= TmkSymbol( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"make-c-expression\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"make-c-expression\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Rules2C16_2 , lf_AUX_MuASF_Rules2C16_2sym);
...
aterm * lf_AUX_MuASF_Rules2C16_2( aterm * arg0 , aterm * arg1 , aterm * arg2) {
{
aterm * tmp[4];
PROF( prof_lf_AUX_MuASF_Rules2C16_2);
if( check_sym( arg2 , lf_AUX_MuASF_Rules2C16_1sym)) {
{
...
return make_nf3( lf_AUX_MuASF_Rules2C16_2sym , arg0 , arg1 , arg2);
}
}
