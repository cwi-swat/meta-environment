#include "support.h"
static asymbol * lf_AUX_C_Basics10_1sym;
...
lf_AUX_C_Basics10_1sym= TmkSymbol( "prod(id(\"C-Basics\"),w(\"\"),[l(\"remove-protect\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Expression\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"remove-protect\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)") , lf_AUX_C_Basics10_1 , lf_AUX_C_Basics10_1sym);
...
t_protect( atmp101);
t_unprotect( arg1);
return ( * ef11)( lf_AUX_C_Basics10_1( arg0 , ( * ef2)( atmp100)) , ( * ef2)( ( * ef3)( atmp101)));
}
}
}
}
