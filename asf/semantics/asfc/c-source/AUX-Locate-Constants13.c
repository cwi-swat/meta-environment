#include "support.h"
static Symbol lf_AUX_Locate_Constants13_1sym;
static ATerm lf_AUX_Locate_Constants13_1( ATerm arg1);
...
static funcptr ef6;
void register_AUX_Locate_Constants13( ) {
lf_AUX_Locate_Constants13_1sym= ATmakeSymbol( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"is-integer\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Locate_Constants13_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"is-integer\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_Locate_Constants13_1 , lf_AUX_Locate_Constants13_1sym);
register_prod( ATparse( "listtype(sort(\"CHAR\"))") , lf2 , lf2sym);
}
void resolve_AUX_Locate_Constants13( ) {
...
void init_AUX_Locate_Constants13( ) {
ATprotect( & constant0);
ATprotect( & constant1);
}
