...
tmp[ 0]= ( * ef4)( lf_AUX_MuASF_Rules2C6_2( make_list( atmp10)));
if( check_sym( tmp[ 0] , ef5sym)) {
tmp[ 1]= arg_0( tmp[ 0]);
if( check_sym( tmp[ 1] , lf_AUX_MuASF_Rules2C6_2sym)) {
tmp[ 2]= arg_0( tmp[ 1]);
if( not_empty_list( tmp[ 2])) {
tmp[ 3]= ( * ef6)( lf_AUX_MuASF_Rules2C6_2( make_list( tmp[ 2])) , lf_AUX_MuASF_Rules2C6_3( make_list( atmp30)));
tmp[ 4]= ( * ef8)( lf_AUX_MuASF_Rules2C6_1( make_list( atmp00)) , lf_AUX_MuASF_Rules2C6_2( make_list( atmp20)) , lf_AUX_MuASF_Rules2C6_3( make_list( atmp30)));
if( check_sym( tmp[ 4] , ef1sym)) {
tmp[ 5]= arg_0( tmp[ 4]);
tmp[ 6]= arg_1( tmp[ 4]);
if( check_sym( tmp[ 5] , lf_AUX_MuASF_Rules2C6_1sym)) {
tmp[ 7]= arg_0( tmp[ 5]);
return ( * ef1)( lf_AUX_MuASF_Rules2C6_1( make_list( tmp[ 7])) , ( * ef7)( tmp[ 6] , ( * ef2)( ( * ef3)( tmp[ 3]))));
}
}
}
}
...
if( not_empty_list( tmp[ 2])) {
tmp[ 3]= ( * ef6)( lf_AUX_MuASF_Rules2C6_2( make_list( tmp[ 2])) , lf_AUX_MuASF_Rules2C6_3( make_list( atmp30)));
return ( * ef1)( lf_AUX_MuASF_Rules2C6_1( make_list( atmp00)) , ( * ef2)( ( * ef3)( tmp[ 3])));
}
}
}
}
