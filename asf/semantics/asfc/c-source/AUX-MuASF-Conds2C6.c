...
tmp [ 19 ] = ( * ef10 ) ( ( constant0 ? constant0 : ( constant0 = ( * ef11 ) ( ) ) ) , lf6 ( make_list ( tmp [ 17 ] ) ) , tmp [ 5 ] , tmp [ 6 ] , arg2 , tmp [ 18 ] , tmp [ 7 ] , lf_AUX_MuASF_Conds2C6_2 ( make_list ( atmp10 ) ) ) ;
