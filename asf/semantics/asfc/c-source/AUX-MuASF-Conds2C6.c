...
ef10= lookup_func( ATreadFromString( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"terms2cargs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)"));
ef10sym= lookup_sym( ATreadFromString( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"terms2cargs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)"));
...
tmp[ 18]= ( * ef10)( ( constant0? constant0: ( constant0= ( * ef11)( ))) , lf6( make_list( tmp[ 16])) , tmp[ 5] , tmp[ 6] , arg2 , tmp[ 17] , lf_AUX_MuASF_Conds2C6_2( make_list( atmp10)));
if( check_sym( tmp[ 18] , ef12sym)) {
tmp[ 19]= arg_0( tmp[ 18]);
tmp[ 20]= arg_1( tmp[ 18]);
tmp[ 21]= arg_2( tmp[ 18]);
tmp[ 22]= ( * ef13)( ( * ef1)( lf4( make_list( tmp[ 7])) , lf5( cons( make_list( ( * ef2)( tmp[ 11] , tmp[ 12])) , make_list( tmp[ 10]))) , tmp[ 4] , tmp[ 5] , tmp[ 6]) , lf_AUX_MuASF_Conds2C6_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 22] , ef14sym)) {
tmp[ 23]= arg_0( tmp[ 22]);
tmp[ 24]= arg_1( tmp[ 22]);
if( check_sym( tmp[ 23] , lf_AUX_MuASF_Conds2C6_1sym)) {
tmp[ 25]= arg_0( tmp[ 23]);
if( check_sym( tmp[ 24] , lf_AUX_MuASF_Conds2C6_1sym)) {
tmp[ 26]= arg_0( tmp[ 24]);
tmp[ 27]= ( * ef15)( ( * ef1)( lf4( make_list( tmp[ 7])) , lf5( cons( make_list( ( * ef2)( tmp[ 11] , tmp[ 12])) , make_list( tmp[ 10]))) , tmp[ 4] , tmp[ 5] , tmp[ 6]) , lf_AUX_MuASF_Conds2C6_1( make_list( tmp[ 25])));
if( check_sym( tmp[ 27] , ef14sym)) {
tmp[ 28]= arg_0( tmp[ 27]);
tmp[ 29]= arg_1( tmp[ 27]);
if( check_sym( tmp[ 28] , lf_AUX_MuASF_Conds2C6_1sym)) {
tmp[ 30]= arg_0( tmp[ 28]);
if( check_sym( tmp[ 29] , lf_AUX_MuASF_Conds2C6_1sym)) {
tmp[ 31]= arg_0( tmp[ 29]);
tmp[ 32]= ( * ef16)( lf_AUX_MuASF_Conds2C6_1( make_list( tmp[ 30])));
if( check_sym( tmp[ 32] , ef17sym)) {
tmp[ 33]= arg_0( tmp[ 32]);
if( check_sym( tmp[ 33] , lf_AUX_MuASF_Conds2C6_1sym)) {
tmp[ 34]= arg_0( tmp[ 33]);
tmp[ 35]= ( * ef18)( lf_AUX_MuASF_Conds2C6_1( make_list( tmp[ 34])) , lf_AUX_MuASF_Conds2C6_2( make_list( atmp10)) , tmp[ 21]);
if( check_sym( tmp[ 35] , ef3sym)) {
tmp[ 36]= arg_0( tmp[ 35]);
tmp[ 37]= arg_1( tmp[ 35]);
tmp[ 38]= ( * ef16)( lf_AUX_MuASF_Conds2C6_1( make_list( tmp[ 31])));
if( check_sym( tmp[ 38] , ef17sym)) {
tmp[ 39]= arg_0( tmp[ 38]);
if( check_sym( tmp[ 39] , lf_AUX_MuASF_Conds2C6_1sym)) {
tmp[ 40]= arg_0( tmp[ 39]);
tmp[ 41]= ( * ef18)( lf_AUX_MuASF_Conds2C6_1( make_list( tmp[ 40])) , lf_AUX_MuASF_Conds2C6_2( make_list( atmp10)) , tmp[ 21]);
if( check_sym( tmp[ 41] , ef3sym)) {
tmp[ 42]= arg_0( tmp[ 41]);
tmp[ 43]= arg_1( tmp[ 41]);
tmp[ 44]= ( * ef18)( lf_AUX_MuASF_Conds2C6_1( make_list( tmp[ 26])) , lf_AUX_MuASF_Conds2C6_2( make_list( atmp10)) , tmp[ 21]);
...
return make_nf3( lf_AUX_MuASF_Conds2C6_3sym , arg0 , arg1 , arg2);
}
}
