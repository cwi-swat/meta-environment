...
{
ATerm tmp[12];
PROF( prof_lf_AUX_MuASF_Sign2C4_3);
...
return ( * ef1)( tmp[ 0] , lf_AUX_MuASF_Sign2C4_2( make_list( atmp10)));
}
...
tmp[ 11]= arg_0( tmp[ 8]);
return ( * ef2)( lf_AUX_MuASF_Sign2C4_1( cons( make_list( tmp[ 6]) , make_list( tmp[ 11]))) , ( * ef3)( tmp[ 4] , tmp[ 9]) , ( * ef4)( tmp[ 5] , tmp[ 10]));
}
}
}
}
...
return make_nf2( lf_AUX_MuASF_Sign2C4_3sym , arg0 , arg1);
}
}
...
return make_nf1( lf_AUX_MuASF_Sign2C4_2sym , arg0);
}
