...
static Symbol lf_AUX_MuASF_Sign2C4_3_recursivesym ;
static ATerm lf_AUX_MuASF_Sign2C4_3_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_MuASF_Sign2C4_3_recursivesym = ATmakeSymbol ( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[ql(\"funcdefs2cfuncs\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Sign2C4_3_recursivesym ) ;
lf_AUX_MuASF_Sign2C4_3sym = ATmakeSymbol ( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[ql(\"funcdefs2cfuncs\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[ql(\"funcdefs2cfuncs\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Sign2C4_3 , lf_AUX_MuASF_Sign2C4_3sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[ql(\"funcdefs2cfuncs\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Sign2C4_3_recursive , lf_AUX_MuASF_Sign2C4_3_recursivesym ) ;
}
...
ef4 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[ql(\"funcdef2cfuncs\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)" ) ) ;
ef4sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[ql(\"funcdef2cfuncs\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)" ) ) ;
}
...
( tmp [ 2 ] = ( * ef4 ) ( tmp [ 0 ] , lf_AUX_MuASF_Sign2C4_2 ( make_list ( atmp10 ) ) ) ) ;
...
( tmp [ 11 ] = arg_0 ( tmp [ 8 ] ) ) ;
FUNC_EXIT ( ( * ef1 ) ( lf_AUX_MuASF_Sign2C4_1 ( cons ( make_list ( tmp [ 6 ] ) , make_list ( tmp [ 11 ] ) ) ) , ( * ef2 ) ( tmp [ 4 ] , tmp [ 9 ] ) , ( * ef3 ) ( tmp [ 5 ] , tmp [ 10 ] ) ) ) ;
}
}
}
}
...
( tmp [ 0 ] = list_head ( atmp00 ) ) ;
FUNC_EXIT ( ( * ef4 ) ( tmp [ 0 ] , lf_AUX_MuASF_Sign2C4_2 ( make_list ( atmp10 ) ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_MuASF_Sign2C4_3_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 12 ] ;
FUNC_ENTRY ( lf_AUX_MuASF_Sign2C4_3_recursivesym , ATmakeAppl ( lf_AUX_MuASF_Sign2C4_3_recursivesym , arg0 , arg1 ) ) ;
{
ATerm atmp00 = arg0 ;
if ( check_sym ( arg1 , lf_AUX_MuASF_Sign2C4_2sym ) ) {
{
...
FUNC_EXIT ( make_nf2 ( lf_AUX_MuASF_Sign2C4_3_recursivesym , lf_AUX_MuASF_Sign2C4_1 ( arg0 ) , arg1 ) ) ;
}
}
