...
static Symbol lf_AUX_TermAsFixAccess36_1sym ;
static ATerm lf_AUX_TermAsFixAccess36_1 ( ATerm arg1 ) ;
...
static funcptr ef17 ;
void register_AUX_TermAsFixAccess36 ( ) {
lf_AUX_TermAsFixAccess36_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-right-assoc-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess36_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-right-assoc-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess36_1 , lf_AUX_TermAsFixAccess36_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess36 ( ) {
...
void init_AUX_TermAsFixAccess36 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess36_1 ( ATerm arg0 ) {
{
ATerm tmp [ 47 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess36_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess36_1sym , arg0 ) ) ;
...
if ( term_equal ( list_head ( tmp [ 23 ] ) , make_char ( 103 ) ) ) {
( tmp [ 24 ] = list_tail ( tmp [ 23 ] ) ) ;
if ( not_empty_list ( tmp [ 24 ] ) ) {
if ( term_equal ( list_head ( tmp [ 24 ] ) , make_char ( 104 ) ) ) {
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess36_1sym , arg0 ) ) ;
}
}
