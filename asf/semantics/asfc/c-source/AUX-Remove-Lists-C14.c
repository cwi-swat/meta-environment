#include "support.h"
static asymbol * lf_AUX_Remove_Lists_C14_2sym;
static aterm * lf_AUX_Remove_Lists_C14_2( aterm * arg1 , aterm * arg2);
...
static aterm * lf_AUX_Remove_Lists_C14_1( aterm * arg1);
static asymbol * new__1__lf_AUX_Remove_Lists_C14_2sym;
static aterm * new__1__lf_AUX_Remove_Lists_C14_2( aterm * arg1 , aterm * arg2);
void register_AUX_Remove_Lists_C14( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_Remove_Lists_C14_2sym= TmkSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf_AUX_Remove_Lists_C14_1sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
new__1__lf_AUX_Remove_Lists_C14_2sym= TmkSymbol( "new__1__lf_AUX_Remove_Lists_C14_2" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"Term\"),ql(\",\"))") , lf_AUX_Remove_Lists_C14_1 , lf_AUX_Remove_Lists_C14_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C14_2 , lf_AUX_Remove_Lists_C14_2sym);
...
aterm * new__1__lf_AUX_Remove_Lists_C14_2( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[1];
PROF( prof_new__1__lf_AUX_Remove_Lists_C14_2);
if( check_sym( arg0 , lf_AUX_Remove_Lists_C14_1sym)) {
{
...
t_unprotect( arg0);
return ( * ef8)( lf_AUX_Remove_Lists_C14_1( make_list( tmp[ 0])) , arg1);
}
}
}
return make_nf2( new__1__lf_AUX_Remove_Lists_C14_2sym , arg0 , arg1);
}
}
aterm * lf_AUX_Remove_Lists_C14_2( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[17];
PROF( prof_lf_AUX_Remove_Lists_C14_2);
if( check_sym( arg0 , lf_AUX_Remove_Lists_C14_1sym)) {
{
aterm * atmp00= arg_0( arg0);
t_protect( atmp00);
...
tmp[ 4]= arg_0( tmp[ 3]);
{
if( check_sym( tmp[ 2] , lf_AUX_Remove_Lists_C14_1sym)) {
tmp[ 5]= arg_0( tmp[ 2]);
t_protect( tmp[ 4]);
...
t_unprotect( tmp[ 14]);
t_unprotect( tmp[ 16]);
return ( * ef3)( lf_AUX_Remove_Lists_C14_1( cons( make_list( tmp[ 13]) , make_list( tmp[ 15]))) , arg1);
}
t_protect( tmp[ 16]);
...
t_unprotect( tmp[ 14]);
t_unprotect( tmp[ 16]);
return ( * ef6)( lf_AUX_Remove_Lists_C14_1( make_list( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))) , lf_AUX_Remove_Lists_C14_1( cons( make_list( tmp[ 13]) , make_list( tmp[ 15])))))) , arg1);
}
t_unprotect( tmp[ 16]);
t_unprotect( tmp[ 15]);
}
...
tmp[ 0]= list_head( atmp00);
t_unprotect( arg0);
return new__1__lf_AUX_Remove_Lists_C14_2( lf_AUX_Remove_Lists_C14_1( make_list( tmp[ 0])) , arg1);
}
}
}
return make_nf2( lf_AUX_Remove_Lists_C14_2sym , arg0 , arg1);
}
}
aterm * lf_AUX_Remove_Lists_C14_1( aterm * arg0) {
PROF( prof_lf_AUX_Remove_Lists_C14_1);
return make_nf1( lf_AUX_Remove_Lists_C14_1sym , arg0);
}
