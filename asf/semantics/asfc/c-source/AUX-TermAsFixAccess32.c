...
lf_AUX_TermAsFixAccess32_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-memo-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess32_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-memo-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess32_1 , lf_AUX_TermAsFixAccess32_1sym ) ;
...
if ( term_equal ( list_head ( tmp [ 28 ] ) , make_char ( 65 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 33 ] ) , make_char ( 98 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 36 ] ) , make_char ( 101 ) ) ) {
...
( tmp [ 38 ] = list_tail ( atmp0111111110100000 ) ) ;
