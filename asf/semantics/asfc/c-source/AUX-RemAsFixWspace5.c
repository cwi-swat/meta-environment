#include "support.h"
static asymbol * lf_AUX_RemAsFixWspace5_1sym;
...
lf_AUX_RemAsFixWspace5_1sym= TmkSymbol( "prod(id(\"RemAsFixWspace\"),w(\"\"),[l(\"change-ws\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"RemAsFixWspace\"),w(\"\"),[l(\"change-ws\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)") , lf_AUX_RemAsFixWspace5_1 , lf_AUX_RemAsFixWspace5_1sym);
...
ef10= lookup_func( TmakeSimple( & local , "prod(id(\"RemAsFixWspace\"),w(\"\"),[l(\"change-ws-trms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"));
ef10sym= lookup_sym( TmakeSimple( & local , "prod(id(\"RemAsFixWspace\"),w(\"\"),[l(\"change-ws-trms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"));
...
t_unprotect( arg0);
return ( * ef3)( ( * ef4)( ( * ef5)( ( * ef6)( ) , ( * ef4)( ( * ef1)( ( * ef2)( ( * ef7)( lf2( cons( make_list( make_char( 34)) , make_list( make_char( 34)))))))))));
}
}
{
aterm * atmp00= arg_0( arg0);
