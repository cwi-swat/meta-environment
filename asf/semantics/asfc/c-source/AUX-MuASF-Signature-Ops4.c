...
static Symbol lf_AUX_MuASF_Signature_Ops4_1_recursivesym ;
static ATerm lf_AUX_MuASF_Signature_Ops4_1_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_MuASF_Signature_Ops4_1_recursivesym = ATmakeSymbol ( "prod(id(\"MuASF-Signature-Ops\"),w(\"\"),[sort(\"FuncDef\"),w(\"\"),ql(\"in\"),w(\"\"),sort(\"FuncDefList\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Signature_Ops4_1_recursivesym ) ;
lf_AUX_MuASF_Signature_Ops4_1sym = ATmakeSymbol ( "prod(id(\"MuASF-Signature-Ops\"),w(\"\"),[sort(\"FuncDef\"),w(\"\"),ql(\"in\"),w(\"\"),sort(\"FuncDefList\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"MuASF-Signature-Ops\"),w(\"\"),[sort(\"FuncDef\"),w(\"\"),ql(\"in\"),w(\"\"),sort(\"FuncDefList\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Signature_Ops4_1_recursive , lf_AUX_MuASF_Signature_Ops4_1_recursivesym ) ;
...
FUNC_EXIT ( lf_AUX_MuASF_Signature_Ops4_1_recursive ( arg0 , make_list ( tmp [ 1 ] ) ) ) ;
}
else {
...
FUNC_EXIT ( make_nf2 ( lf_AUX_MuASF_Signature_Ops4_1sym , arg0 , arg1 ) ) ;
}
}
ATerm lf_AUX_MuASF_Signature_Ops4_1_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 2 ] ;
FUNC_ENTRY ( lf_AUX_MuASF_Signature_Ops4_1_recursivesym , ATmakeAppl ( lf_AUX_MuASF_Signature_Ops4_1_recursivesym , arg0 , arg1 ) ) ;
{
ATerm ltmp [ 2 ] ;
lbl_lf_AUX_MuASF_Signature_Ops4_1_recursive : ltmp [ 0 ] = arg0 ;
( ltmp [ 1 ] = arg1 ) ;
{
ATerm atmp10 = arg1 ;
{
...
goto lbl_lf_AUX_MuASF_Signature_Ops4_1_recursive ;
}
else {
FUNC_EXIT_CONST ( constant0 , ( * ef3 ) ( ) ) ;
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_MuASF_Signature_Ops4_1_recursivesym , ltmp [ 0 ] , ( * ef1 ) ( lf2 ( ltmp [ 1 ] ) ) ) ) ;
}
}
}
