...
static Symbol lf_AUX_Rules2C_Aux20_2_recursivesym ;
static ATerm lf_AUX_Rules2C_Aux20_2_recursive ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
lf_AUX_Rules2C_Aux20_2_recursivesym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"replace-first-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Rules2C_Aux20_2_recursivesym ) ;
lf_AUX_Rules2C_Aux20_2sym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"replace-first-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)" , 3 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"replace-first-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux20_2 , lf_AUX_Rules2C_Aux20_2sym ) ;
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"replace-first-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux20_2_recursive , lf_AUX_Rules2C_Aux20_2_recursivesym ) ;
...
( tmp [ 33 ] = arg_0 ( tmp [ 32 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf_AUX_Rules2C_Aux20_1 ( cons ( make_list ( ( * ef2 ) ( lf3 ( make_list ( tmp [ 8 ] ) ) , lf4 ( cons ( make_list ( ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( lf5 ( ( ATerm ) ATmakeList ( 10 , char_table [ 116 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 109 ] , char_table [ 95 ] , char_table [ 101 ] , char_table [ 113 ] , char_table [ 117 ] , char_table [ 97 ] , char_table [ 108 ] ) ) ) , lf6 ( cons ( make_list ( arg0 ) , make_list ( tmp [ 30 ] ) ) ) ) , tmp [ 13 ] ) ) , make_list ( tmp [ 11 ] ) ) ) , tmp [ 4 ] , ( * ef6 ) ( tmp [ 5 ] , arg1 ) , ( * ef6 ) ( tmp [ 6 ] , arg1 ) , tmp [ 7 ] ) ) , make_list ( tmp [ 33 ] ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT_CONST ( constant0 , make_nf1 ( ef1sym , lf_AUX_Rules2C_Aux20_1 ( make_list ( null ( ) ) ) ) ) ;
}
}
}
...
ATerm lf_AUX_Rules2C_Aux20_2_recursive ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 34 ] ;
FUNC_ENTRY ( lf_AUX_Rules2C_Aux20_2_recursivesym , ATmakeAppl ( lf_AUX_Rules2C_Aux20_2_recursivesym , arg0 , arg1 , arg2 ) ) ;
{
ATerm atmp20 = arg2 ;
if ( not_empty_list ( atmp20 ) ) {
( tmp [ 0 ] = list_head ( atmp20 ) ) ;
...
FUNC_EXIT ( make_nf3 ( lf_AUX_Rules2C_Aux20_2_recursivesym , arg0 , arg1 , lf_AUX_Rules2C_Aux20_1 ( arg2 ) ) ) ;
}
}
