...
static ATerm lf_AUX_Rules2C_Aux20_2( ATerm arg1);
...
lf_AUX_Rules2C_Aux20_2sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux20_2 , lf_AUX_Rules2C_Aux20_2sym);
...
ATerm lf_AUX_Rules2C_Aux20_2( ATerm arg0) {
{
ATerm tmp[21];
...
tmp[ 17]= arg_0( tmp[ 16]);
tmp[ 18]= lf_AUX_Rules2C_Aux20_2( lf_AUX_Rules2C_Aux20_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 18] , ef1sym)) {
tmp[ 19]= arg_0( tmp[ 18]);
if( check_sym( tmp[ 19] , lf_AUX_Rules2C_Aux20_1sym)) {
tmp[ 20]= arg_0( tmp[ 19]);
return ( * ef1)( lf_AUX_Rules2C_Aux20_1( cons( make_list( ( * ef2)( lf3( cons( make_list( tmp[ 14]) , make_list( tmp[ 10]))) , lf5( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 20]))));
}
}
}
}
...
tmp[ 13]= arg_0( tmp[ 12]);
tmp[ 14]= lf_AUX_Rules2C_Aux20_2( lf_AUX_Rules2C_Aux20_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 14] , ef1sym)) {
tmp[ 15]= arg_0( tmp[ 14]);
if( check_sym( tmp[ 15] , lf_AUX_Rules2C_Aux20_1sym)) {
tmp[ 16]= arg_0( tmp[ 15]);
return ( * ef1)( lf_AUX_Rules2C_Aux20_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 10])) , lf5( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 16]))));
}
}
}
}
...
return ( constant0? constant0: ( constant0= ( * ef1)( lf_AUX_Rules2C_Aux20_1( make_list( null( ))))));
}
}
}
return make_nf1( lf_AUX_Rules2C_Aux20_2sym , arg0);
}
}
