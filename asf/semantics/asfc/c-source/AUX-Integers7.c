#include "support.h"
static Symbol lf_AUX_Integers7_1sym;
...
lf_AUX_Integers7_1sym= ATmakeSymbol( "prod(id(\"Integers\"),w(\"\"),[sort(\"INT\"),w(\"\"),ql(\"*\"),w(\"\"),sort(\"INT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Integers7_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"Integers\"),w(\"\"),[sort(\"INT\"),w(\"\"),ql(\"*\"),w(\"\"),sort(\"INT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))") , lf_AUX_Integers7_1 , lf_AUX_Integers7_1sym);
...
ef6= lookup_func( ATreadFromString( "prod(id(\"Integers\"),w(\"\"),[l(\"gt\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"NAT\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NAT\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
ef6sym= lookup_sym( ATreadFromString( "prod(id(\"Integers\"),w(\"\"),[l(\"gt\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"NAT\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NAT\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
...
ef8= lookup_func( ATreadFromString( "prod(id(\"Integers\"),w(\"\"),[ql(\"-\"),w(\"\"),sort(\"NAT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),no-attrs)"));
ef8sym= lookup_sym( ATreadFromString( "prod(id(\"Integers\"),w(\"\"),[ql(\"-\"),w(\"\"),sort(\"NAT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),no-attrs)"));
}
...
tmp[ 2]= lf_AUX_Integers7_1( ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( atmp00000))))) , ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( tmp[ 0]))))));
...
return ( * ef4)( ( * ef1)( ( * ef2)( ( * ef3)( lf2( cons( make_list( tmp[ 6]) , ( constant0? constant0: ( constant0= make_list( make_char( 48))))))))) , lf_AUX_Integers7_1( ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( atmp00000))))) , ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( tmp[ 1])))))));
}
}
}
}
...
if( term_equal( ( * ef6)( ( * ef2)( ( * ef3)( lf2( make_list( tmp[ 0])))) , ( constant1? constant1: ( constant1= ( * ef2)( ( * ef3)( lf2( make_list( make_char( 49)))))))) , ( constant2? constant2: ( constant2= ( * ef7)( ))))) {
return ( * ef4)( arg0 , lf_AUX_Integers7_1( arg0 , ( * ef5)( ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( tmp[ 0]))))) , ( constant3? constant3: ( constant3= ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( make_char( 49)))))))))));
}
tmp[ 0]= list_head( atmp10000);
...
{
ATerm atmp10= arg_0( arg1);
tmp[ 0]= lf_AUX_Integers7_1( arg0 , ( * ef1)( atmp10));
...
{
ATerm atmp10= arg_0( arg1);
tmp[ 0]= lf_AUX_Integers7_1( ( * ef1)( atmp00) , arg1);
if( check_sym( tmp[ 0] , ef1sym)) {
tmp[ 1]= arg_0( tmp[ 0]);
return ( * ef8)( tmp[ 1]);
}
...
{
ATerm atmp10= arg_0( arg1);
return lf_AUX_Integers7_1( ( * ef1)( atmp00) , ( * ef1)( atmp10));
}
}
}
}
