...
lf_AUX_Integers13_1sym= ATmakeSymbol( "prod(id(\"Integers\"),w(\"\"),[l(\"gt\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"NAT\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NAT\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Integers13_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"Integers\"),w(\"\"),[l(\"gt\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"NAT\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NAT\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_Integers13_1 , lf_AUX_Integers13_1sym);
...
if( term_equal( lf_AUX_Integers13_1( ( * ef1)( ( * ef2)( lf2( make_list( tmp[ 0])))) , ( * ef1)( ( * ef2)( lf2( make_list( tmp[ 2]))))) , ( constant0? constant0: ( constant0= ( * ef3)( ))))) {
return ( constant0? constant0: ( constant0= ( * ef3)( )));
}
if( term_equal( tmp[ 0] , tmp[ 2])) {
return lf_AUX_Integers13_1( ( * ef1)( ( * ef2)( lf2( make_list( tmp[ 1])))) , ( * ef1)( ( * ef2)( lf2( make_list( tmp[ 3])))));
}
}
}
}
