#include "support.h"
static asymbol * lf_AUX_MuASF_Basics22_1sym;
...
static asymbol * new__1__lf_AUX_MuASF_Basics22_1sym;
static aterm * new__1__lf_AUX_MuASF_Basics22_1( aterm * arg1);
void register_AUX_MuASF_Basics22( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_MuASF_Basics22_1sym= TmkSymbol( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"deslashed-lit2str\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Literal\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
new__1__lf_AUX_MuASF_Basics22_1sym= TmkSymbol( "new__1__lf_AUX_MuASF_Basics22_1" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"deslashed-lit2str\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Literal\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Basics22_1 , lf_AUX_MuASF_Basics22_1sym);
...
aterm * new__1__lf_AUX_MuASF_Basics22_1( aterm * arg0) {
{
aterm * tmp[4];
PROF( prof_new__1__lf_AUX_MuASF_Basics22_1);
...
t_unprotect( tmp[ 0]);
t_unprotect( tmp[ 2]);
return ( * ef5)( ( * ef3)( lf2( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))) , lf3( cons( make_list( ( * ef4)( ( * ef1)( lf2( cons( make_list( make_char( 34)) , cons( make_list( tmp[ 1]) , make_list( make_char( 34)))))))) , make_list( lf_AUX_MuASF_Basics22_1( ( * ef1)( lf2( cons( make_list( make_char( 34)) , cons( make_list( tmp[ 3]) , make_list( make_char( 34)))))))))));
}
}
t_unprotect( tmp[ 3]);
}
...
return make_nf1( new__1__lf_AUX_MuASF_Basics22_1sym , arg0);
}
}
aterm * lf_AUX_MuASF_Basics22_1( aterm * arg0) {
{
aterm * tmp[8];
PROF( prof_lf_AUX_MuASF_Basics22_1);
if( check_sym( arg0 , ef1sym)) {
{
aterm * atmp00= arg_0( arg0);
if( check_sym( atmp00 , lf2sym)) {
...
t_unprotect( tmp[ 4]);
t_unprotect( tmp[ 5]);
return ( * ef5)( ( * ef3)( lf2( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))) , lf3( cons( make_list( ( * ef2)( ( * ef3)( lf2( cons( make_list( make_char( 92)) , make_list( make_char( 92))))))) , make_list( lf_AUX_MuASF_Basics22_1( ( * ef1)( lf2( cons( make_list( make_char( 34)) , cons( make_list( tmp[ 6]) , make_list( make_char( 34)))))))))));
}
}
t_unprotect( tmp[ 6]);
}
...
t_unprotect( tmp[ 5]);
t_unprotect( tmp[ 6]);
return ( * ef5)( ( * ef3)( lf2( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))) , lf3( cons( make_list( ( * ef2)( ( * ef3)( lf2( cons( make_list( make_char( 39)) , make_list( make_char( 34))))))) , make_list( lf_AUX_MuASF_Basics22_1( ( * ef1)( lf2( cons( make_list( make_char( 34)) , cons( make_list( tmp[ 7]) , make_list( make_char( 34)))))))))));
}
}
t_unprotect( tmp[ 7]);
}
...
t_unprotect( tmp[ 0]);
t_unprotect( tmp[ 2]);
return new__1__lf_AUX_MuASF_Basics22_1( ( * ef1)( lf2( cons( make_list( make_char( 34)) , cons( make_list( tmp[ 1]) , cons( make_list( tmp[ 3]) , make_list( make_char( 34))))))));
}
}
t_unprotect( tmp[ 3]);
}
...
return make_nf1( lf_AUX_MuASF_Basics22_1sym , arg0);
}
}
