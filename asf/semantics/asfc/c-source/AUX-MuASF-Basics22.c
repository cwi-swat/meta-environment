...
static ATerm lf_AUX_MuASF_Basics22_1( ATerm arg1 , ATerm arg2 , ATerm arg3);
...
lf_AUX_MuASF_Basics22_1sym= ATmakeSymbol( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"prefix-id\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)"
 , 3 , ATtrue);
ATprotectSymbol( lf_AUX_MuASF_Basics22_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"prefix-id\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Basics22_1 , lf_AUX_MuASF_Basics22_1sym);
...
ATerm lf_AUX_MuASF_Basics22_1( ATerm arg0 , ATerm arg1 , ATerm arg2) {
{
ATerm tmp[4];
...
return ( * ef1)( lf2( cons( ( constant0? constant0: ( constant0= make_list_char( 34))) , cons( make_list( tmp[ 1]) , cons( make_list( atmp2000) , cons( ( constant1? constant1: ( constant1= make_list_char( 95))) , cons( ( constant1? constant1: ( constant1= make_list_char( 95))) , cons( make_list( tmp[ 3]) , ( constant2? constant2: ( constant2= make_list( make_char( 34))))))))))));
}
}
}
}
...
tmp[ 1]= list_prefix( tmp[ 0]);
if( term_equal( list_last( tmp[ 0]) , make_char( 34))) {
return ( * ef1)( lf2( cons( make_list( tmp[ 1]) , cons( make_list( atmp2000) , cons( ( constant1? constant1: ( constant1= make_list_char( 95))) , cons( ( constant1? constant1: ( constant1= make_list_char( 95))) , make_list( atmp100)))))));
}
}
}
}
...
return make_nf3( lf_AUX_MuASF_Basics22_1sym , arg0 , arg1 , arg2);
}
}
