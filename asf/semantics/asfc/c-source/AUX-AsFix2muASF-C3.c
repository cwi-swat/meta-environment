...
{
ATerm tmp [ 2 ] ;
FUNC_ENTRY ( lf_AUX_AsFix2muASF_C3_1sym , ATmakeAppl ( lf_AUX_AsFix2muASF_C3_1sym , arg0 , arg1 ) ) ;
...
tmp [ 0 ] = ( * ef7 ) ( arg0 , ( constant1 ? constant1 : ( constant1 = lf4 ( make_list ( ( * ef8 ) ( ) ) ) ) ) ) ;
if ( check_sym ( tmp [ 0 ] , ef9sym ) ) {
tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ;
FUNC_EXIT ( ( * ef4 ) ( tmp [ 1 ] , arg1 ) ) ;
}
}
FUNC_EXIT ( make_nf2 ( lf_AUX_AsFix2muASF_C3_1sym , arg0 , arg1 ) ) ;
}
}
