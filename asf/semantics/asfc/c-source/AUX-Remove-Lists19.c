...
static Symbol lf_AUX_Remove_Lists19_2sym ;
static ATerm lf_AUX_Remove_Lists19_2 ( ATerm arg1 , ATerm arg2 ) ;
...
static funcptr ef3 ;
static Symbol lf_AUX_Remove_Lists19_1sym ;
static ATerm lf_AUX_Remove_Lists19_1 ( ATerm arg1 ) ;
...
void register_AUX_Remove_Lists19 ( ) {
lf_AUX_Remove_Lists19_2sym = ATmakeSymbol ( "prod(id(\"Remove-Lists\"),w(\"\"),[l(\"transform-no-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Remove_Lists19_2sym ) ;
lf3sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf3sym ) ;
lf_AUX_Remove_Lists19_1sym = ATmakeSymbol ( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Remove_Lists19_1sym ) ;
lf4sym = ATmakeSymbol ( "listtype(sort(\"Cond\"),ql(\"&\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf4sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Term\"),ql(\",\"))" ) , lf_AUX_Remove_Lists19_1 , lf_AUX_Remove_Lists19_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Remove-Lists\"),w(\"\"),[l(\"transform-no-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)" ) , lf_AUX_Remove_Lists19_2 , lf_AUX_Remove_Lists19_2sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf3 , lf3sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Cond\"),ql(\"&\"))" ) , lf4 , lf4sym ) ;
}
void resolve_AUX_Remove_Lists19 ( ) {
...
ef11 = lookup_func ( ATreadFromString ( "prod(id(\"Remove-Lists\"),w(\"\"),[l(\"transform-lhs-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)" ) ) ;
ef11sym = lookup_sym ( ATreadFromString ( "prod(id(\"Remove-Lists\"),w(\"\"),[l(\"transform-lhs-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)" ) ) ;
ef12 = lookup_func ( ATreadFromString ( "prod(id(\"Remove-Lists\"),w(\"\"),[l(\"rem-lists-from-lhs-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)" ) ) ;
ef12sym = lookup_sym ( ATreadFromString ( "prod(id(\"Remove-Lists\"),w(\"\"),[l(\"rem-lists-from-lhs-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)" ) ) ;
...
ef16 = lookup_func ( ATreadFromString ( "prod(id(\"Integers-Extended\"),w(\"\"),[l(\"succ\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntCon\"),w(\"\"),no-attrs)" ) ) ;
ef16sym = lookup_sym ( ATreadFromString ( "prod(id(\"Integers-Extended\"),w(\"\"),[l(\"succ\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntCon\"),w(\"\"),no-attrs)" ) ) ;
...
void init_AUX_Remove_Lists19 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_Remove_Lists19_2 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 38 ] ;
FUNC_ENTRY ( lf_AUX_Remove_Lists19_2sym , ATmakeAppl ( lf_AUX_Remove_Lists19_2sym , arg0 , arg1 ) ) ;
if ( check_sym ( arg0 , lf_AUX_Remove_Lists19_1sym ) ) {
{
...
( tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ) ;
{
if ( check_sym ( tmp [ 2 ] , lf_AUX_Remove_Lists19_1sym ) ) {
( tmp [ 5 ] = arg_0 ( tmp [ 2 ] ) ) ;
{
...
( tmp [ 19 ] = arg_1 ( tmp [ 17 ] ) ) ;
( tmp [ 20 ] = arg_2 ( tmp [ 17 ] ) ) ;
if ( check_sym ( tmp [ 18 ] , lf_AUX_Remove_Lists19_1sym ) ) {
( tmp [ 21 ] = arg_0 ( tmp [ 18 ] ) ) ;
...
( tmp [ 26 ] = arg_1 ( tmp [ 24 ] ) ) ;
( tmp [ 27 ] = arg_2 ( tmp [ 24 ] ) ) ;
if ( check_sym ( tmp [ 25 ] , lf_AUX_Remove_Lists19_1sym ) ) {
( tmp [ 28 ] = arg_0 ( tmp [ 25 ] ) ) ;
...
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Remove_Lists19_1 ( make_list ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 32 ] ) ) ) ) , lf4 ( cons ( make_list ( ( * ef6 ) ( ( * ef1 ) ( ( * ef2 ) ( lf3 ( ( ATerm ) ATmakeList ( 11 , char_table [ 108 ] , char_table [ 105 ] , char_table [ 115 ] , char_table [ 116 ] , char_table [ 95 ] , char_table [ 112 ] , char_table [ 114 ] , char_table [ 101 ] , char_table [ 102 ] , char_table [ 105 ] , char_table [ 120 ] ) ) ) , lf_AUX_Remove_Lists19_1 ( make_list ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 32 ] ) ) ) ) ) , tmp [ 23 ] ) ) , cons ( make_list ( tmp [ 22 ] ) , cons ( make_list ( ( * ef6 ) ( ( * ef1 ) ( ( * ef2 ) ( lf3 ( ( ATerm ) ATmakeList ( 14 , char_table [ 110 ] , char_table [ 111 ] , char_table [ 116 ] , char_table [ 95 ] , char_table [ 101 ] , char_table [ 109 ] , char_table [ 112 ] , char_table [ 116 ] , char_table [ 121 ] , char_table [ 95 ] , char_table [ 108 ] , char_table [ 105 ] , char_table [ 115 ] , char_table [ 116 ] ) ) ) , lf_AUX_Remove_Lists19_1 ( make_list ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 32 ] ) ) ) ) ) , ( * ef7 ) ( ( * ef2 ) ( lf3 ( make_list ( make_char ( 116 ) ) ) ) ) ) ) , cons ( make_list ( ( * ef8 ) ( ( * ef1 ) ( ( * ef2 ) ( lf3 ( ( ATerm ) ATmakeList ( 9 , char_table [ 108 ] , char_table [ 105 ] , char_table [ 115 ] , char_table [ 116 ] , char_table [ 95 ] , char_table [ 108 ] , char_table [ 97 ] , char_table [ 115 ] , char_table [ 116 ] ) ) ) , lf_AUX_Remove_Lists19_1 ( make_list ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 32 ] ) ) ) ) ) , tmp [ 30 ] ) ) , make_list ( tmp [ 29 ] ) ) ) ) ) ) , tmp [ 33 ] ) ) ;
}
}
}
}
...
( tmp [ 20 ] = arg_1 ( tmp [ 18 ] ) ) ;
( tmp [ 21 ] = arg_2 ( tmp [ 18 ] ) ) ;
if ( check_sym ( tmp [ 19 ] , lf_AUX_Remove_Lists19_1sym ) ) {
( tmp [ 22 ] = arg_0 ( tmp [ 19 ] ) ) ;
...
( tmp [ 28 ] = ( * ef19 ) ( tmp [ 15 ] ) ) ;
( tmp [ 29 ] = lf_AUX_Remove_Lists19_2 ( lf_AUX_Remove_Lists19_1 ( make_list ( ( * ef1 ) ( ( * ef2 ) ( lf3 ( ( ATerm ) ATmakeList ( 4 , char_table [ 99 ] , char_table [ 111 ] , char_table [ 110 ] , char_table [ 115 ] ) ) ) , lf_AUX_Remove_Lists19_1 ( cons ( make_list ( tmp [ 13 ] ) , make_list ( tmp [ 28 ] ) ) ) ) ) ) , tmp [ 27 ] ) ) ;
if ( check_sym ( tmp [ 29 ] , ef3sym ) ) {
( tmp [ 30 ] = arg_0 ( tmp [ 29 ] ) ) ;
( tmp [ 31 ] = arg_1 ( tmp [ 29 ] ) ) ;
( tmp [ 32 ] = arg_2 ( tmp [ 29 ] ) ) ;
if ( check_sym ( tmp [ 30 ] , lf_AUX_Remove_Lists19_1sym ) ) {
( tmp [ 33 ] = arg_0 ( tmp [ 30 ] ) ) ;
...
( tmp [ 37 ] = arg_0 ( tmp [ 36 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Remove_Lists19_1 ( make_list ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 26 ] ) ) ) ) , lf4 ( cons ( make_list ( ( * ef6 ) ( ( * ef1 ) ( ( * ef2 ) ( lf3 ( ( ATerm ) ATmakeList ( 11 , char_table [ 108 ] , char_table [ 105 ] , char_table [ 115 ] , char_table [ 116 ] , char_table [ 95 ] , char_table [ 112 ] , char_table [ 114 ] , char_table [ 101 ] , char_table [ 102 ] , char_table [ 105 ] , char_table [ 120 ] ) ) ) , lf_AUX_Remove_Lists19_1 ( make_list ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 26 ] ) ) ) ) ) , ( * ef4 ) ( ( * ef5 ) ( tmp [ 37 ] ) ) ) ) , cons ( make_list ( ( * ef6 ) ( ( * ef1 ) ( ( * ef2 ) ( lf3 ( ( ATerm ) ATmakeList ( 14 , char_table [ 110 ] , char_table [ 111 ] , char_table [ 116 ] , char_table [ 95 ] , char_table [ 101 ] , char_table [ 109 ] , char_table [ 112 ] , char_table [ 116 ] , char_table [ 121 ] , char_table [ 95 ] , char_table [ 108 ] , char_table [ 105 ] , char_table [ 115 ] , char_table [ 116 ] ) ) ) , lf_AUX_Remove_Lists19_1 ( make_list ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 26 ] ) ) ) ) ) , ( * ef7 ) ( ( * ef2 ) ( lf3 ( make_list ( make_char ( 116 ) ) ) ) ) ) ) , cons ( make_list ( ( * ef8 ) ( ( * ef1 ) ( ( * ef2 ) ( lf3 ( ( ATerm ) ATmakeList ( 9 , char_table [ 108 ] , char_table [ 105 ] , char_table [ 115 ] , char_table [ 116 ] , char_table [ 95 ] , char_table [ 108 ] , char_table [ 97 ] , char_table [ 115 ] , char_table [ 116 ] ) ) ) , lf_AUX_Remove_Lists19_1 ( make_list ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 26 ] ) ) ) ) ) , tmp [ 24 ] ) ) , cons ( make_list ( tmp [ 23 ] ) , make_list ( tmp [ 34 ] ) ) ) ) ) ) , tmp [ 32 ] ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Remove_Lists19_2sym , arg0 , arg1 ) ) ;
}
}
...
ATerm lf_AUX_Remove_Lists19_1 ( ATerm arg0 ) {
CONS_ENTRY ( lf_AUX_Remove_Lists19_1sym , ATmakeAppl ( lf_AUX_Remove_Lists19_1sym , arg0 ) ) ;
CONS_EXIT ( make_nf1 ( lf_AUX_Remove_Lists19_1sym , arg0 ) ) ;
}
