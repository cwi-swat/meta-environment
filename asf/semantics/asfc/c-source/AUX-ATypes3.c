...
{
ATerm atmp100= arg_0( atmp10);
return ( * ef13)( lf_AUX_ATypes3_1( atmp010 , ( * ef14)( ( * ef10)( atmp100))) , lf_AUX_ATypes3_1( arg0 , ( * ef8)( ( * ef15)( ( * ef10)( atmp100)))));
}
}
}
}
...
return lf_AUX_ATypes3_1( ( * ef8)( ( * ef10)( atmp01)) , ( * ef8)( ( * ef10)( atmp11)));
}
}
}
}
...
{
ATerm atmp100= arg_0( atmp10);
return ( * ef13)( lf_AUX_ATypes3_1( ( * ef14)( ( * ef10)( atmp000)) , ( * ef14)( ( * ef10)( atmp100))) , lf_AUX_ATypes3_1( ( * ef8)( ( * ef15)( ( * ef10)( atmp000))) , ( * ef8)( ( * ef15)( ( * ef10)( atmp100)))));
}
}
}
}
...
{
ATerm atmp10= arg_0( arg1);
return lf_AUX_ATypes3_1( atmp00 , atmp10);
}
}
}
}
...
{
ATerm atmp01= arg_1( arg0);
return lf_AUX_ATypes3_1( atmp01 , arg1);
}
}
}
...
{
ATerm atmp11= arg_1( arg1);
return lf_AUX_ATypes3_1( arg0 , atmp11);
}
}
}
