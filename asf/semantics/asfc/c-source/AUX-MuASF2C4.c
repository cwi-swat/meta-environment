...
lf_AUX_MuASF2C4_2sym = ATmakeSymbol ( "prod(id(\"MuASF2C\"),w(\"\"),[l(\"funcdefs2cfuncs\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"MuASF2C\"),w(\"\"),[l(\"funcdefs2cfuncs\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF2C4_2 , lf_AUX_MuASF2C4_2sym ) ;
}
...
tmp [ 2 ] = ( * ef5 ) ( lf_AUX_MuASF2C4_1 ( make_list ( tmp [ 0 ] ) ) ) ;
tmp [ 3 ] = lf_AUX_MuASF2C4_2 ( lf_AUX_MuASF2C4_1 ( make_list ( tmp [ 1 ] ) ) ) ;
FUNC_EXIT ( ( * ef2 ) ( tmp [ 3 ] , ( * ef3 ) ( ( * ef4 ) ( tmp [ 2 ] ) ) ) ) ;
}
else {
