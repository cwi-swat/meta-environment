...
static Symbol lf_AUX_Remove_Lists4_2sym ;
...
lf_AUX_Remove_Lists4_2sym = ATmakeSymbol ( "prod(id(\"Remove-Lists\"),w(\"\"),[l(\"rem-lists-from-rules\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTuple\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Remove-Lists\"),w(\"\"),[l(\"rem-lists-from-rules\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTuple\"),w(\"\"),no-attrs)" ) , lf_AUX_Remove_Lists4_2 , lf_AUX_Remove_Lists4_2sym ) ;
register_prod ( ATparse ( "listtype(sort(\"FuncDef\"),ql(\";\"))" ) , lf3 , lf3sym ) ;
}
void resolve_AUX_Remove_Lists4 ( ) {
...
ef2 = lookup_func ( ATreadFromString ( "prod(id(\"Remove-Lists\"),w(\"\"),[l(\"rem-lists-from-rule\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Rule\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTuple\"),w(\"\"),no-attrs)" ) ) ;
ef2sym = lookup_sym ( ATreadFromString ( "prod(id(\"Remove-Lists\"),w(\"\"),[l(\"rem-lists-from-rule\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Rule\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTuple\"),w(\"\"),no-attrs)" ) ) ;
...
void init_AUX_Remove_Lists4 ( ) {
}
ATerm lf_AUX_Remove_Lists4_2 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 17 ] ;
FUNC_ENTRY ( lf_AUX_Remove_Lists4_2sym , ATmakeAppl ( lf_AUX_Remove_Lists4_2sym , arg0 , arg1 ) ) ;
...
( tmp [ 6 ] = arg_0 ( tmp [ 3 ] ) ) ;
if ( check_sym ( tmp [ 4 ] , lf_AUX_Remove_Lists4_1sym ) ) {
( tmp [ 7 ] = arg_0 ( tmp [ 4 ] ) ) ;
( tmp [ 8 ] = lf_AUX_Remove_Lists4_2 ( lf_AUX_Remove_Lists4_1 ( make_list ( tmp [ 1 ] ) ) , tmp [ 5 ] ) ) ;
...
( tmp [ 12 ] = arg_0 ( tmp [ 9 ] ) ) ;
if ( check_sym ( tmp [ 10 ] , lf_AUX_Remove_Lists4_1sym ) ) {
( tmp [ 13 ] = arg_0 ( tmp [ 10 ] ) ) ;
...
( tmp [ 16 ] = arg_0 ( tmp [ 15 ] ) ) ;
FUNC_EXIT ( ( * ef1 ) ( lf3 ( make_list ( tmp [ 16 ] ) ) , lf_AUX_Remove_Lists4_1 ( cons ( make_list ( tmp [ 7 ] ) , make_list ( tmp [ 13 ] ) ) ) , tmp [ 11 ] ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Remove_Lists4_2sym , arg0 , arg1 ) ) ;
}
}
