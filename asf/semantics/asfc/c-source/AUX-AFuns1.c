#include "support.h"
static Symbol lf_AUX_AFuns1_1sym;
...
lf_AUX_AFuns1_1sym= ATmakeSymbol( "prod(id(\"AFuns\"),w(\"\"),[l(\"holds\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerms\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_AFuns1_1sym);
register_prod( ATparse( "prod(id(\"AFuns\"),w(\"\"),[l(\"holds\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerms\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_AFuns1_1 , lf_AUX_AFuns1_1sym);
}
...
{
ATerm atmp10= arg_0( arg1);
return lf_AUX_AFuns1_1( ( constant6? constant6: ( constant6= ( * ef17)( ))) , ( * ef2)( ( * ef10)( ( * ef11)( atmp10 , ( constant7? constant7: ( constant7= ( * ef18)( )))) , ( * ef11)( ( * ef11)( atmp10 , ( constant4? constant4: ( constant4= ( * ef14)( )))) , ( constant5? constant5: ( constant5= ( * ef15)( )))))));
}
}
}
