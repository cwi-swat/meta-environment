#include "support.h"
static Symbol lf_AUX_AsFix2muASF_C13_2sym;
...
static funcptr ef2;
static Symbol lf_AUX_AsFix2muASF_C13_1sym;
static ATerm lf_AUX_AsFix2muASF_C13_1( ATerm arg1);
void register_AUX_AsFix2muASF_C13( ) {
lf_AUX_AsFix2muASF_C13_2sym= ATmakeSymbol( "prod(id(\"AsFix2muASF-C\"),w(\"\"),[l(\"make-c-list-cons\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_AsFix2muASF_C13_2sym);
lf3sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf3sym);
lf_AUX_AsFix2muASF_C13_1sym= ATmakeSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_AsFix2muASF_C13_1sym);
register_prod( ATparse( "listtype(sort(\"Term\"),ql(\",\"))") , lf_AUX_AsFix2muASF_C13_1 , lf_AUX_AsFix2muASF_C13_1sym);
register_prod( ATparse( "prod(id(\"AsFix2muASF-C\"),w(\"\"),[l(\"make-c-list-cons\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)") , lf_AUX_AsFix2muASF_C13_2 , lf_AUX_AsFix2muASF_C13_2sym);
...
return lf_AUX_AsFix2muASF_C13_2( lf_AUX_AsFix2muASF_C13_1( make_list( tmp[ 10])) , lf_AUX_AsFix2muASF_C13_1( make_list( ( * ef1)( ( constant0? constant0: ( constant0= ( * ef2)( lf3( (ATerm) ATmakeList( 4 , char_table[ 99] , char_table[ 111] , char_table[ 110] , char_table[ 115]))))) , lf_AUX_AsFix2muASF_C13_1( cons( make_list( tmp[ 12]) , make_list( tmp[ 1])))))));
}
}
}
}
...
if( is_single_element( atmp10)) {
tmp[ 1]= list_head( atmp10);
return ( * ef1)( ( constant0? constant0: ( constant0= ( * ef2)( lf3( (ATerm) ATmakeList( 4 , char_table[ 99] , char_table[ 111] , char_table[ 110] , char_table[ 115]))))) , lf_AUX_AsFix2muASF_C13_1( cons( make_list( tmp[ 0]) , make_list( tmp[ 1]))));
}
}
}
}
