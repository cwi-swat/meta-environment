...
static ATerm lf_AUX_AsFix2muASF_C13_2( ATerm arg1 , ATerm arg2 , ATerm arg3 , ATerm arg4);
...
lf_AUX_AsFix2muASF_C13_2sym= ATmakeSymbol( "prod(id(\"AsFix2muASF-C\"),w(\"\"),[l(\"make-rule\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Cond\"),w(\"\"),ql(\"&\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Rule\"),w(\"\"),no-attrs)"
 , 4 , ATtrue);
ATprotectSymbol( lf_AUX_AsFix2muASF_C13_2sym);
lf_AUX_AsFix2muASF_C13_1sym= ATmakeSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_AsFix2muASF_C13_1sym);
register_prod( ATparse( "listtype(sort(\"Cond\"),ql(\"&\"))") , lf_AUX_AsFix2muASF_C13_1 , lf_AUX_AsFix2muASF_C13_1sym);
register_prod( ATparse( "prod(id(\"AsFix2muASF-C\"),w(\"\"),[l(\"make-rule\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Cond\"),w(\"\"),ql(\"&\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Rule\"),w(\"\"),no-attrs)") , lf_AUX_AsFix2muASF_C13_2 , lf_AUX_AsFix2muASF_C13_2sym);
}
...
ATerm lf_AUX_AsFix2muASF_C13_2( ATerm arg0 , ATerm arg1 , ATerm arg2 , ATerm arg3) {
...
return ( * ef2)( ( * ef3)( lf_AUX_AsFix2muASF_C13_1( make_list( atmp10))) , arg2 , arg3);
}
}
}
}
...
ATerm atmp10= arg_0( arg1);
if( not_empty_list( atmp10)) {
return ( * ef5)( ( * ef3)( lf_AUX_AsFix2muASF_C13_1( make_list( atmp10))) , arg2 , arg3);
}
}
}
}
return make_nf4( lf_AUX_AsFix2muASF_C13_2sym , arg0 , arg1 , arg2 , arg3);
}
