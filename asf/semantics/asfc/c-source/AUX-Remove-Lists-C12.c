#include "support.h"
static asymbol * lf_AUX_Remove_Lists_C12_1sym;
static aterm * lf_AUX_Remove_Lists_C12_1( aterm * arg1 , aterm * arg2);
...
lf_AUX_Remove_Lists_C12_1sym= TmkSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"rem-lists-from-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Cond\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CList-VarEnv\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"rem-lists-from-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Cond\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CList-VarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C12_1 , lf_AUX_Remove_Lists_C12_1sym);
...
aterm * lf_AUX_Remove_Lists_C12_1( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[14];
...
return make_nf2( lf_AUX_Remove_Lists_C12_1sym , arg0 , arg1);
}
}
