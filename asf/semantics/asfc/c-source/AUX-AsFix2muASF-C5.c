...
lf_AUX_AsFix2muASF_C5_1sym = ATmakeSymbol ( "prod(id(\"AsFix2muASF-C\"),w(\"\"),[l(\"ceqeq2rules\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTableTuple\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"AsFix2muASF-C\"),w(\"\"),[l(\"ceqeq2rules\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTableTuple\"),w(\"\"),no-attrs)" ) , lf_AUX_AsFix2muASF_C5_1 , lf_AUX_AsFix2muASF_C5_1sym ) ;
...
{
ATerm tmp [ 30 ] ;
FUNC_ENTRY ( lf_AUX_AsFix2muASF_C5_1sym , ATmakeAppl ( lf_AUX_AsFix2muASF_C5_1sym , arg0 , arg1 , arg2 ) ) ;
...
FUNC_EXIT ( make_nf3 ( lf_AUX_AsFix2muASF_C5_1sym , arg0 , arg1 , arg2 ) ) ;
}
}
