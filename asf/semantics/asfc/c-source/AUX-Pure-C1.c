...
lf_AUX_Pure_C1_1sym= ATmakeSymbol( "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Expression\"),w(\"\"),ql(\"=\"),w(\"\"),sort(\"Expression\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Pure_C1_1sym);
register_prod( ATparse( "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Expression\"),w(\"\"),ql(\"=\"),w(\"\"),sort(\"Expression\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)") , lf_AUX_Pure_C1_1 , lf_AUX_Pure_C1_1sym);
}
...
if( check_sym( atmp00 , lf_AUX_Pure_C1_1sym)) {
{
