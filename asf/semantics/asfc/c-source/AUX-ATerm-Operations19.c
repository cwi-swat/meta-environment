...
lf_AUX_ATerm_Operations19_1sym = ATmakeSymbol ( "prod(id(\"ATerm-Operations\"),w(\"\"),[l(\"term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ATerm_Operations19_1sym ) ;
register_prod ( ATparse ( "prod(id(\"ATerm-Operations\"),w(\"\"),[l(\"term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)" ) , lf_AUX_ATerm_Operations19_1 , lf_AUX_ATerm_Operations19_1sym ) ;
}
...
PROF ( prof_lf_AUX_ATerm_Operations19_1 ) ;
...
return ( * ef4 ) ( atmp00 , atmp01 ) ;
}
}
}
}
return make_nf1 ( lf_AUX_ATerm_Operations19_1sym , arg0 ) ;
}
