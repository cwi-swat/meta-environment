...
static Symbol lf_AUX_TermAsFixAccess38_1sym ;
static ATerm lf_AUX_TermAsFixAccess38_1 ( ATerm arg1 ) ;
...
static funcptr ef17 ;
void register_AUX_TermAsFixAccess38 ( ) {
lf_AUX_TermAsFixAccess38_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-nonassoc-assoc-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess38_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-nonassoc-assoc-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess38_1 , lf_AUX_TermAsFixAccess38_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess38 ( ) {
...
void init_AUX_TermAsFixAccess38 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess38_1 ( ATerm arg0 ) {
{
ATerm tmp [ 51 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess38_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess38_1sym , arg0 ) ) ;
...
if ( term_equal ( list_head ( tmp [ 21 ] ) , make_char ( 110 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 24 ] ) , make_char ( 45 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 26 ] ) , make_char ( 115 ) ) ) {
...
( tmp [ 31 ] = list_tail ( atmp011110100000 ) ) ;
...
( tmp [ 32 ] = list_tail ( atmp0111110100000 ) ) ;
if ( not_empty_list ( tmp [ 32 ] ) ) {
if ( term_equal ( list_head ( tmp [ 32 ] ) , make_char ( 45 ) ) ) {
( tmp [ 33 ] = list_tail ( tmp [ 32 ] ) ) ;
if ( not_empty_list ( tmp [ 33 ] ) ) {
if ( term_equal ( list_head ( tmp [ 33 ] ) , make_char ( 62 ) ) ) {
...
( tmp [ 35 ] = list_tail ( atmp01111110100000 ) ) ;
...
( tmp [ 36 ] = list_tail ( atmp011111110100000 ) ) ;
if ( not_empty_list ( tmp [ 36 ] ) ) {
if ( term_equal ( list_head ( tmp [ 36 ] ) , make_char ( 65 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 38 ] ) , make_char ( 115 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 41 ] ) , make_char ( 105 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 45 ] ) , make_char ( 118 ) ) ) {
( tmp [ 46 ] = list_tail ( tmp [ 45 ] ) ) ;
if ( not_empty_list ( tmp [ 46 ] ) ) {
if ( term_equal ( list_head ( tmp [ 46 ] ) , make_char ( 105 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 48 ] ) , make_char ( 121 ) ) ) {
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess38_1sym , arg0 ) ) ;
}
}
