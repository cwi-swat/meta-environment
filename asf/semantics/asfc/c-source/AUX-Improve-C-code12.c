...
ef8 = lookup_func ( ATreadFromString ( "prod(id(\"C\"),w(\"\"),[sort(\"Primary-expression\"),w(\"\"),ql(\"[\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Primary-expression\"),w(\"\"),no-attrs)" ) ) ;
ef8sym = lookup_sym ( ATreadFromString ( "prod(id(\"C\"),w(\"\"),[sort(\"Primary-expression\"),w(\"\"),ql(\"[\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Primary-expression\"),w(\"\"),no-attrs)" ) ) ;
...
ef11 = lookup_func ( ATreadFromString ( "prod(id(\"C\"),w(\"\"),[sort(\"Integer-constant\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Primary-expression\"),w(\"\"),no-attrs)" ) ) ;
ef11sym = lookup_sym ( ATreadFromString ( "prod(id(\"C\"),w(\"\"),[sort(\"Integer-constant\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Primary-expression\"),w(\"\"),no-attrs)" ) ) ;
ef12 = lookup_func ( ATreadFromString ( "prod(id(\"GEN-LexConsFuncs\"),w(\"\"),[ql(\"integer-constant\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Integer-constant\"),w(\"\"),no-attrs)" ) ) ;
ef12sym = lookup_sym ( ATreadFromString ( "prod(id(\"GEN-LexConsFuncs\"),w(\"\"),[ql(\"integer-constant\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Integer-constant\"),w(\"\"),no-attrs)" ) ) ;
...
FUNC_EXIT_CONST ( constant0 , ( * ef2 ) ( make_nf1 ( ef3sym , lf2 ( make_list ( ( * ef4 ) ( ( * ef5 ) ( ( * ef6 ) ( ( * ef7 ) ( ( * ef8 ) ( ( * ef9 ) ( ( * ef10 ) ( lf3 ( ( ATerm ) ATmakeList ( 4 , char_table [ 108 ] , char_table [ 116 ] , char_table [ 109 ] , char_table [ 112 ] ) ) ) ) , ( * ef6 ) ( ( * ef7 ) ( ( * ef11 ) ( ( * ef12 ) ( lf3 ( make_list ( make_char ( 48 ) ) ) ) ) ) ) ) ) ) , ( * ef6 ) ( ( * ef7 ) ( ( * ef9 ) ( ( * ef10 ) ( lf3 ( ( ATerm ) ATmakeList ( 4 , char_table [ 97 ] , char_table [ 114 ] , char_table [ 103 ] , char_table [ 48 ] ) ) ) ) ) ) ) ) ) ) ) ) ) ;
}
}
}
}
...
{
ATerm atmp00 = arg_0 ( arg0 ) ;
if ( ! term_equal ( atmp00 , ( * ef13 ) ( ( * ef14 ) ( lf3 ( make_list ( make_char ( 49 ) ) ) ) ) ) ) {
( tmp [ 0 ] = ( * ef15 ) ( arg0 , ( * ef1 ) ( ( * ef13 ) ( ( * ef14 ) ( lf3 ( make_list ( make_char ( 49 ) ) ) ) ) ) ) ) ;
...
FUNC_EXIT ( ( * ef2 ) ( make_nf1 ( ef3sym , lf2 ( cons ( make_list ( tmp [ 8 ] ) , make_list ( ( * ef4 ) ( ( * ef5 ) ( ( * ef6 ) ( ( * ef7 ) ( ( * ef8 ) ( ( * ef9 ) ( ( * ef10 ) ( lf3 ( ( ATerm ) ATmakeList ( 4 , char_table [ 108 ] , char_table [ 116 ] , char_table [ 109 ] , char_table [ 112 ] ) ) ) ) , ( * ef6 ) ( ( * ef7 ) ( ( * ef11 ) ( ( * ef12 ) ( lf3 ( make_list ( tmp [ 4 ] ) ) ) ) ) ) ) ) ) , ( * ef6 ) ( ( * ef7 ) ( ( * ef9 ) ( ( * ef10 ) ( lf3 ( cons ( make_list_char ( 97 ) , cons ( make_list_char ( 114 ) , cons ( make_list_char ( 103 ) , make_list ( tmp [ 4 ] ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
}
}
}
}
