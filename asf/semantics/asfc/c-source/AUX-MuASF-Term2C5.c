...
static ATerm lf_AUX_MuASF_Term2C5_3( ATerm arg1 , ATerm arg2 , ATerm arg3 , ATerm arg4 , ATerm arg5 , ATerm arg6 , ATerm arg7);
...
lf_AUX_MuASF_Term2C5_3sym= ATmakeSymbol( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"terms2cargs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)"
 , 7 , ATtrue);
...
ATerm lf_AUX_MuASF_Term2C5_3( ATerm arg0 , ATerm arg1 , ATerm arg2 , ATerm arg3 , ATerm arg4 , ATerm arg5 , ATerm arg6) {
{
ATerm tmp[16];
PROF( prof_lf_AUX_MuASF_Term2C5_3);
if( check_sym( arg1 , lf_AUX_MuASF_Term2C5_1sym)) {
{
ATerm atmp10= arg_0( arg1);
if( check_sym( arg6 , lf_AUX_MuASF_Term2C5_2sym)) {
{
ATerm atmp60= arg_0( arg6);
if( is_single_element( atmp10)) {
tmp[ 0]= list_head( atmp10);
return ( * ef1)( arg0 , tmp[ 0] , arg2 , arg3 , arg4 , arg5 , lf_AUX_MuASF_Term2C5_2( make_list( atmp60)));
}
if( not_empty_list( atmp10)) {
tmp[ 0]= list_prefix( atmp10);
if( not_empty_list( tmp[ 0])) {
tmp[ 1]= list_last( atmp10);
tmp[ 2]= lf_AUX_MuASF_Term2C5_3( arg0 , lf_AUX_MuASF_Term2C5_1( make_list( tmp[ 0])) , arg2 , arg3 , arg4 , arg5 , lf_AUX_MuASF_Term2C5_2( make_list( atmp60)));
...
tmp[ 9]= ( * ef1)( arg0 , tmp[ 1] , arg2 , arg3 , tmp[ 5] , tmp[ 8] , lf_AUX_MuASF_Term2C5_2( make_list( atmp60)));
...
return make_nf7( lf_AUX_MuASF_Term2C5_3sym , arg0 , arg1 , arg2 , arg3 , arg4 , arg5 , arg6);
}
}
...
return make_nf1( lf_AUX_MuASF_Term2C5_2sym , arg0);
}
