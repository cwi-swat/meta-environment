...
lf_AUX_Rules2C_Aux12_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-same-rhs-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-same-rhs-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux12_2 , lf_AUX_Rules2C_Aux12_2sym);
...
t_protect( atmp04);
t_protect( tmp[ 16]);
tmp[ 17]= lf_AUX_Rules2C_Aux12_2( ( * ef2)( lf3( make_list( atmp000)) , lf4( cons( make_list( ( * ef3)( tmp[ 1] , tmp[ 2])) , make_list( tmp[ 3]))) , atmp02 , atmp03 , atmp04) , lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 16])));
...
t_unprotect( tmp[ 16]);
t_unprotect( tmp[ 17]);
return ( * ef1)( lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 20])) , lf_AUX_Rules2C_Aux12_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 10])) , lf4( cons( make_list( ( * ef3)( tmp[ 1] , tmp[ 14])) , make_list( tmp[ 15]))) , tmp[ 7] , tmp[ 8] , tmp[ 9])) , make_list( tmp[ 21]))));
}
}
}
t_unprotect( tmp[ 17]);
...
t_protect( arg0);
t_protect( tmp[ 1]);
tmp[ 24]= lf_AUX_Rules2C_Aux12_2( arg0 , lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 24] , ef1sym)) {
tmp[ 25]= arg_0( tmp[ 24]);
tmp[ 26]= arg_1( tmp[ 24]);
if( check_sym( tmp[ 25] , lf_AUX_Rules2C_Aux12_1sym)) {
tmp[ 27]= arg_0( tmp[ 25]);
if( check_sym( tmp[ 26] , lf_AUX_Rules2C_Aux12_1sym)) {
tmp[ 28]= arg_0( tmp[ 26]);
t_protect( tmp[ 27]);
t_protect( tmp[ 28]);
t_unprotect( arg0);
...
t_unprotect( tmp[ 23]);
t_unprotect( tmp[ 24]);
return ( * ef1)( lf_AUX_Rules2C_Aux12_1( cons( make_list( tmp[ 0]) , make_list( tmp[ 27]))) , lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 28])));
}
}
}
t_unprotect( tmp[ 24]);
...
t_protect( arg0);
t_protect( tmp[ 1]);
tmp[ 2]= lf_AUX_Rules2C_Aux12_2( arg0 , lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 2] , ef1sym)) {
tmp[ 3]= arg_0( tmp[ 2]);
tmp[ 4]= arg_1( tmp[ 2]);
if( check_sym( tmp[ 3] , lf_AUX_Rules2C_Aux12_1sym)) {
tmp[ 5]= arg_0( tmp[ 3]);
if( check_sym( tmp[ 4] , lf_AUX_Rules2C_Aux12_1sym)) {
tmp[ 6]= arg_0( tmp[ 4]);
t_protect( tmp[ 5]);
t_protect( tmp[ 6]);
t_unprotect( arg0);
...
t_unprotect( tmp[ 1]);
t_unprotect( tmp[ 2]);
return ( * ef1)( lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 5])) , lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 6])));
}
}
}
t_unprotect( tmp[ 2]);
...
t_unprotect( arg1);
return ( * ef1)( lf_AUX_Rules2C_Aux12_1( make_list( arg0)) , lf_AUX_Rules2C_Aux12_1( make_list( null( ))));
}
}
}
