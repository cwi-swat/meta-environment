...
static asymbol * new__1__lf_AUX_Rules2C_Aux12_2sym;
static aterm * new__1__lf_AUX_Rules2C_Aux12_2( aterm * arg1 , aterm * arg2);
void register_AUX_Rules2C_Aux12( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_Rules2C_Aux12_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-conds-on-second-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
new__1__lf_AUX_Rules2C_Aux12_2sym= TmkSymbol( "new__1__lf_AUX_Rules2C_Aux12_2" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"C-Rule\"),ql(\";\"))") , lf_AUX_Rules2C_Aux12_1 , lf_AUX_Rules2C_Aux12_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-conds-on-second-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux12_2 , lf_AUX_Rules2C_Aux12_2sym);
...
aterm * new__1__lf_AUX_Rules2C_Aux12_2( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[14];
PROF( prof_new__1__lf_AUX_Rules2C_Aux12_2);
...
t_protect( arg0);
t_protect( tmp[ 8]);
tmp[ 9]= lf_AUX_Rules2C_Aux12_2( arg0 , lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 8])));
if( check_sym( tmp[ 9] , ef1sym)) {
tmp[ 10]= arg_0( tmp[ 9]);
tmp[ 11]= arg_1( tmp[ 9]);
if( check_sym( tmp[ 10] , lf_AUX_Rules2C_Aux12_1sym)) {
tmp[ 12]= arg_0( tmp[ 10]);
if( check_sym( tmp[ 11] , lf_AUX_Rules2C_Aux12_1sym)) {
tmp[ 13]= arg_0( tmp[ 11]);
t_protect( tmp[ 12]);
t_protect( tmp[ 6]);
t_protect( tmp[ 7]);
...
t_unprotect( tmp[ 8]);
t_unprotect( tmp[ 9]);
return ( * ef1)( lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 12])) , lf_AUX_Rules2C_Aux12_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 6])) , lf4( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 13]))));
}
}
}
t_unprotect( tmp[ 9]);
...
return make_nf2( new__1__lf_AUX_Rules2C_Aux12_2sym , arg0 , arg1);
}
}
...
t_protect( arg0);
t_protect( tmp[ 29]);
tmp[ 30]= lf_AUX_Rules2C_Aux12_2( arg0 , lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 29])));
if( check_sym( tmp[ 30] , ef1sym)) {
tmp[ 31]= arg_0( tmp[ 30]);
tmp[ 32]= arg_1( tmp[ 30]);
if( check_sym( tmp[ 31] , lf_AUX_Rules2C_Aux12_1sym)) {
tmp[ 33]= arg_0( tmp[ 31]);
if( check_sym( tmp[ 32] , lf_AUX_Rules2C_Aux12_1sym)) {
tmp[ 34]= arg_0( tmp[ 32]);
t_protect( tmp[ 6]);
t_protect( tmp[ 10]);
t_protect( tmp[ 3]);
...
t_unprotect( tmp[ 29]);
t_unprotect( tmp[ 30]);
return ( * ef1)( lf_AUX_Rules2C_Aux12_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 6])) , lf4( cons( make_list( ( * ef3)( ( * ef4)( ( * ef5)( lf5( cons( make_list( make_char( 116)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 113)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 97)) , make_list( make_char( 108))))))))))))) , lf6( cons( make_list( tmp[ 25]) , make_list( arg0)))) , tmp[ 10])) , make_list( tmp[ 28]))) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 33]))) , lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 34])));
}
}
}
t_unprotect( tmp[ 30]);
...
t_unprotect( arg1);
t_unprotect( tmp[ 0]);
return new__1__lf_AUX_Rules2C_Aux12_2( arg0 , lf_AUX_Rules2C_Aux12_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 6])) , lf4( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 8]))));
}
}
}
t_unprotect( tmp[ 0]);
