...
static ATerm lf_AUX_Rules2C_Aux12_2( ATerm arg1);
...
lf_AUX_Rules2C_Aux12_2sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-same-list-pat\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-same-list-pat\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux12_2 , lf_AUX_Rules2C_Aux12_2sym);
...
ATerm lf_AUX_Rules2C_Aux12_2( ATerm arg0) {
{
ATerm tmp[16];
PROF( prof_lf_AUX_Rules2C_Aux12_2);
if( check_sym( arg0 , lf_AUX_Rules2C_Aux12_1sym)) {
{
...
tmp[ 11]= ( * ef3)( tmp[ 9] , lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 1])));
...
tmp[ 15]= arg_0( tmp[ 13]);
return ( * ef1)( lf_AUX_Rules2C_Aux12_1( cons( make_list( ( * ef2)( lf3( cons( make_list( tmp[ 9]) , make_list( tmp[ 10]))) , lf4( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 14]))) , lf_AUX_Rules2C_Aux12_1( make_list( tmp[ 15])));
}
}
}
}
...
return ( constant0? constant0: ( constant0= ( * ef1)( lf_AUX_Rules2C_Aux12_1( make_list( null( ))) , lf_AUX_Rules2C_Aux12_1( make_list( null( ))))));
}
}
}
return make_nf1( lf_AUX_Rules2C_Aux12_2sym , arg0);
}
}
