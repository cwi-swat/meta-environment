#include "support.h"
static Symbol lf_AUX_Locate_Constants10_2sym;
static ATerm lf_AUX_Locate_Constants10_2( ATerm arg1);
...
lf_AUX_Locate_Constants10_2sym= ATmakeSymbol( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"expressions-contain-variables\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Locate_Constants10_2sym);
lf_AUX_Locate_Constants10_1sym= ATmakeSymbol( "listtype(sort(\"Expression\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Locate_Constants10_1sym);
register_prod( ATparse( "listtype(sort(\"Expression\"),ql(\",\"))") , lf_AUX_Locate_Constants10_1 , lf_AUX_Locate_Constants10_1sym);
register_prod( ATparse( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"expressions-contain-variables\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_Locate_Constants10_2 , lf_AUX_Locate_Constants10_2sym);
}
...
ATerm lf_AUX_Locate_Constants10_2( ATerm arg0) {
{
ATerm tmp[4];
PROF( prof_lf_AUX_Locate_Constants10_2);
if( check_sym( arg0 , lf_AUX_Locate_Constants10_1sym)) {
{
...
tmp[ 2]= ( * ef3)( tmp[ 0]);
tmp[ 3]= lf_AUX_Locate_Constants10_2( lf_AUX_Locate_Constants10_1( make_list( tmp[ 1])));
...
return make_nf1( lf_AUX_Locate_Constants10_2sym , arg0);
}
}
ATerm lf_AUX_Locate_Constants10_1( ATerm arg0) {
PROF( prof_lf_AUX_Locate_Constants10_1);
return make_nf1( lf_AUX_Locate_Constants10_1sym , arg0);
}
