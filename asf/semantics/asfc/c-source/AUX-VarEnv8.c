...
lf_AUX_VarEnv8_1sym = ATmakeSymbol ( "prod(id(\"VarEnv\"),w(\"\"),[l(\"gen-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_VarEnv8_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"VarEnv\"),w(\"\"),[l(\"gen-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)" ) , lf_AUX_VarEnv8_1 , lf_AUX_VarEnv8_1sym ) ;
...
FUNC_ENTRY ( lf_AUX_VarEnv8_1sym , ATmakeAppl ( lf_AUX_VarEnv8_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_VarEnv8_1sym , arg0 ) ) ;
}
