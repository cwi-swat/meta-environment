...
lf_AUX_MuASF_Rules2C10_3sym= ATmakeSymbol( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"asfrules2cstats\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SlI-tuple\"),w(\"\"),no-attrs)"
 , 4 , ATtrue);
...
tmp[ 14]= ( * ef10)( lf_AUX_MuASF_Rules2C10_1( cons( make_list( ( * ef9)( lf5( make_list( ( * ef11)( tmp[ 10] , lf7( make_list( tmp[ 12]))))) , lf6( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 1]))) , lf_AUX_MuASF_Rules2C10_2( make_list( atmp20)) , arg3);
...
return ( * ef10)( lf_AUX_MuASF_Rules2C10_1( cons( make_list( ( * ef9)( ( constant1? constant1: ( constant1= lf5( make_list( null( ))))) , lf6( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 1]))) , lf_AUX_MuASF_Rules2C10_2( make_list( atmp20)) , arg3);
}
else {
tmp[ 9]= list_head( tmp[ 7]);
...
tmp[ 14]= ( * ef16)( lf_AUX_MuASF_Rules2C10_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 14] , ef17sym)) {
tmp[ 15]= arg_0( tmp[ 14]);
if( check_sym( tmp[ 15] , lf_AUX_MuASF_Rules2C10_1sym)) {
tmp[ 16]= arg_0( tmp[ 15]);
tmp[ 17]= ( * ef15)( lf7( make_list( tmp[ 13])));
tmp[ 18]= ( * ef18)( lf_AUX_MuASF_Rules2C10_1( cons( make_list( ( * ef9)( lf5( make_list( tmp[ 10])) , lf6( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 16]))));
if( check_sym( tmp[ 18] , ef19sym)) {
tmp[ 19]= arg_0( tmp[ 18]);
tmp[ 20]= arg_1( tmp[ 18]);
if( check_sym( tmp[ 19] , lf_AUX_MuASF_Rules2C10_1sym)) {
tmp[ 21]= arg_0( tmp[ 19]);
if( check_sym( tmp[ 20] , lf_AUX_MuASF_Rules2C10_1sym)) {
tmp[ 22]= arg_0( tmp[ 20]);
tmp[ 23]= lf_AUX_MuASF_Rules2C10_3( lf_AUX_MuASF_Rules2C10_1( make_list( tmp[ 21])) , lf_AUX_MuASF_Rules2C10_1( make_list( tmp[ 22])) , lf_AUX_MuASF_Rules2C10_2( make_list( atmp20)) , arg3);
