...
t_unprotect( arg2);
t_unprotect( tmp[ 0]);
return ( * ef2)( lf_AUX_MuASF_Rules2C10_1( cons( make_list( ( * ef1)( lf4( make_list( null( ))) , lf5( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 1]))) , arg1 , lf_AUX_MuASF_Rules2C10_2( make_list( atmp20)) , arg3);
}
