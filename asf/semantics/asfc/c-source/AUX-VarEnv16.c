#include "support.h"
static asymbol * lf_AUX_VarEnv16_2sym;
static aterm * lf_AUX_VarEnv16_2( aterm * arg1 , aterm * arg2);
...
static funcptr ef2;
static asymbol * lf_AUX_VarEnv16_1sym;
static aterm * lf_AUX_VarEnv16_1( aterm * arg1);
void register_AUX_VarEnv16( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_VarEnv16_2sym= TmkSymbol( "prod(id(\"VarEnv\"),w(\"\"),[l(\"np-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf_AUX_VarEnv16_1sym= TmkSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"NamePair\"),ql(\",\"))") , lf_AUX_VarEnv16_1 , lf_AUX_VarEnv16_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"VarEnv\"),w(\"\"),[l(\"np-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)") , lf_AUX_VarEnv16_2 , lf_AUX_VarEnv16_2sym);
...
aterm * lf_AUX_VarEnv16_2( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[4];
PROF( prof_lf_AUX_VarEnv16_2);
...
return make_nf2( lf_AUX_VarEnv16_2sym , arg0 , arg1);
}
}
aterm * lf_AUX_VarEnv16_1( aterm * arg0) {
PROF( prof_lf_AUX_VarEnv16_1);
return make_nf1( lf_AUX_VarEnv16_1sym , arg0);
}
