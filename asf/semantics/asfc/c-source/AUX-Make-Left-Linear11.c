...
lf_AUX_Make_Left_Linear11_1sym = ATmakeSymbol ( "prod(id(\"Make-Left-Linear\"),w(\"\"),[ql(\"make-eq-cond\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Cond\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Make-Left-Linear\"),w(\"\"),[ql(\"make-eq-cond\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Cond\"),w(\"\"),no-attrs)" ) , lf_AUX_Make_Left_Linear11_1 , lf_AUX_Make_Left_Linear11_1sym ) ;
