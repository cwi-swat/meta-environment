#include "support.h"
static Symbol lf_AUX_Make_Left_Linear1_1sym;
static ATerm lf_AUX_Make_Left_Linear1_1( ATerm arg1);
...
lf_AUX_Make_Left_Linear1_1sym= ATmakeSymbol( "prod(id(\"Make-Left-Linear\"),w(\"\"),[l(\"make-left-linear\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Module\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Module\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Make_Left_Linear1_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"Rule\"),ql(\";\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"Make-Left-Linear\"),w(\"\"),[l(\"make-left-linear\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Module\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Module\"),w(\"\"),no-attrs)") , lf_AUX_Make_Left_Linear1_1 , lf_AUX_Make_Left_Linear1_1sym);
...
ATerm lf_AUX_Make_Left_Linear1_1( ATerm arg0) {
{
ATerm tmp[4];
PROF( prof_lf_AUX_Make_Left_Linear1_1);
...
return make_nf1( lf_AUX_Make_Left_Linear1_1sym , arg0);
}
}
