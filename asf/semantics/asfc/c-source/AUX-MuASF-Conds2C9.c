...
tmp [ 7 ] = ( * ef5 ) ( ( constant0 ? constant0 : ( constant0 = ( * ef6 ) ( ) ) ) , lf5 ( make_list ( tmp [ 6 ] ) ) , ( * ef1 ) ( lf3 ( make_list ( atmp000 ) ) , lf4 ( make_list ( tmp [ 1 ] ) ) , atmp02 , atmp03 , atmp04 , atmp05 ) , arg1 , lf_AUX_MuASF_Conds2C9_1 ( make_list ( atmp20 ) ) , arg3 ) ;
