#include  "support.h"
static Symbol lf_AUX_Remove_Lists_C15_1sym ;
static ATerm lf_AUX_Remove_Lists_C15_1 ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Remove_Lists_C15_1sym = ATmakeSymbol ( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"rem-lists-from-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Cond\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CList-VarEnv\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Remove_Lists_C15_1sym ) ;
lf3sym = ATmakeSymbol ( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf3sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Cond\"),ql(\"&\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"rem-lists-from-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Cond\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CList-VarEnv\"),w(\"\"),no-attrs)" ) , lf_AUX_Remove_Lists_C15_1 , lf_AUX_Remove_Lists_C15_1sym ) ;
...
void init_AUX_Remove_Lists_C15 ( ) {
}
ATerm lf_AUX_Remove_Lists_C15_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 14 ] ;
FUNC_ENTRY ( lf_AUX_Remove_Lists_C15_1sym , ATmakeAppl ( lf_AUX_Remove_Lists_C15_1sym , arg0 , arg1 ) ) ;
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Remove_Lists_C15_1sym , arg0 , arg1 ) ) ;
}
}
