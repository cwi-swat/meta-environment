...
static ATerm lf_AUX_ParseTrees11_1( ATerm arg1 , ATerm arg2);
...
lf_AUX_ParseTrees11_1sym= ATmakeSymbol( "prod(id(\"ParseTrees\"),w(\"\"),[sort(\"ATerm\"),w(\"\"),ql(\"[\"),w(\"\"),sort(\"AFun\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_ParseTrees11_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"ParseTrees\"),w(\"\"),[sort(\"ATerm\"),w(\"\"),ql(\"[\"),w(\"\"),sort(\"AFun\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)") , lf_AUX_ParseTrees11_1 , lf_AUX_ParseTrees11_1sym);
...
ATerm lf_AUX_ParseTrees11_1( ATerm arg0 , ATerm arg1) {
{
ATerm tmp[3];
...
{
ATerm atmp01= arg_1( arg0);
return lf_AUX_ParseTrees11_1( atmp01 , arg1);
}
}
}
...
return make_nf2( lf_AUX_ParseTrees11_1sym , arg0 , arg1);
}
}
