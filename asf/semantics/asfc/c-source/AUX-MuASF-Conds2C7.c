#include "support.h"
static asymbol * lf_AUX_MuASF_Conds2C7_3sym;
static aterm * lf_AUX_MuASF_Conds2C7_3( aterm * arg1 , aterm * arg2 , aterm * arg3 , aterm * arg4 , aterm * arg5);
...
lf_AUX_MuASF_Conds2C7_3sym= TmkSymbol( "prod(id(\"MuASF-Conds2C\"),w(\"\"),[l(\"listcondspatterns2cstats\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SlI-tuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf_AUX_MuASF_Conds2C7_1sym= TmkSymbol( "listtype(sort(\"C-Rule\"),ql(\";\"))" , SYM_STRING);
lf_AUX_MuASF_Conds2C7_2sym= TmkSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"C-Rule\"),ql(\";\"))") , lf_AUX_MuASF_Conds2C7_1 , lf_AUX_MuASF_Conds2C7_1sym);
register_prod( TmakeSimple( & local , "listtype(sort(\"NamePair\"),ql(\",\"))") , lf_AUX_MuASF_Conds2C7_2 , lf_AUX_MuASF_Conds2C7_2sym);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Conds2C\"),w(\"\"),[l(\"listcondspatterns2cstats\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SlI-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Conds2C7_3 , lf_AUX_MuASF_Conds2C7_3sym);
}
...
aterm * lf_AUX_MuASF_Conds2C7_3( aterm * arg0 , aterm * arg1 , aterm * arg2 , aterm * arg3 , aterm * arg4) {
{
aterm * tmp[10];
...
if( check_sym( arg3 , lf_AUX_MuASF_Conds2C7_2sym)) {
{
...
t_protect( atmp30);
t_protect( arg4);
tmp[ 1]= ( * ef3)( tmp[ 0] , arg1 , arg2 , lf_AUX_MuASF_Conds2C7_2( make_list( atmp30)) , arg4);
...
t_protect( atmp30);
t_protect( arg4);
tmp[ 2]= ( * ef3)( tmp[ 0] , arg1 , arg2 , lf_AUX_MuASF_Conds2C7_2( make_list( atmp30)) , arg4);
...
t_protect( atmp30);
t_protect( tmp[ 5]);
tmp[ 6]= lf_AUX_MuASF_Conds2C7_3( lf_AUX_MuASF_Conds2C7_1( make_list( tmp[ 1])) , arg1 , arg2 , lf_AUX_MuASF_Conds2C7_2( make_list( atmp30)) , tmp[ 5]);
...
return make_nf5( lf_AUX_MuASF_Conds2C7_3sym , arg0 , arg1 , arg2 , arg3 , arg4);
}
}
