...
tmp[ 16]= ( * ef5)( tmp[ 13] , arg3 , lf_AUX_MuASF_Conds2C7_2( make_list( atmp10)));
...
tmp[ 19]= ( * ef17)( lf_AUX_MuASF_Conds2C7_1( cons( make_list( ( * ef1)( lf4( make_list( tmp[ 7])) , lf5( cons( make_list( ( * ef2)( tmp[ 11] , ( * ef3)( tmp[ 13] , lf6( make_list( tmp[ 15]))))) , make_list( tmp[ 10]))) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 1]))) , tmp[ 17] , lf_AUX_MuASF_Conds2C7_2( make_list( atmp10)) , ( * ef18)( arg2));
