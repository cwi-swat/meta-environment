...
return ( constant0 ? constant0 : ( constant0 = ( * ef2 ) ( lf2 ( make_list ( make_char ( 45 ) ) ) ) ) ) ;
}
...
tmp [ 3 ] = arg_0 ( tmp [ 2 ] ) ;
return ( * ef2 ) ( lf2 ( cons ( ( constant1 ? constant1 : ( constant1 = make_list_char ( 45 ) ) ) , make_list ( tmp [ 3 ] ) ) ) ) ;
}
}
}
tmp [ 0 ] = list_head ( atmp000 ) ;
...
return make_nf1 ( lf_AUX_C_Basics16_1sym , arg0 ) ;
}
}
