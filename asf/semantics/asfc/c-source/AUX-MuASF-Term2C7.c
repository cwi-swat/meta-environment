#include "support.h"
static asymbol * lf_AUX_MuASF_Term2C7_3sym;
static aterm * lf_AUX_MuASF_Term2C7_3( aterm * arg1 , aterm * arg2 , aterm * arg3 , aterm * arg4);
...
static funcptr ef25;
static asymbol * lf_AUX_MuASF_Term2C7_2sym;
...
static funcptr ef34;
static asymbol * lf_AUX_MuASF_Term2C7_1sym;
static aterm * lf_AUX_MuASF_Term2C7_1( aterm * arg1);
void register_AUX_MuASF_Term2C7( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_MuASF_Term2C7_3sym= TmkSymbol( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"second-term-common\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SRI-tuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf_AUX_MuASF_Term2C7_2sym= TmkSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , SYM_STRING);
...
lf_AUX_MuASF_Term2C7_1sym= TmkSymbol( "listtype(sort(\"C-Rule\"),ql(\";\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"C-Rule\"),ql(\";\"))") , lf_AUX_MuASF_Term2C7_1 , lf_AUX_MuASF_Term2C7_1sym);
register_prod( TmakeSimple( & local , "listtype(sort(\"NamePair\"),ql(\",\"))") , lf_AUX_MuASF_Term2C7_2 , lf_AUX_MuASF_Term2C7_2sym);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"second-term-common\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SRI-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Term2C7_3 , lf_AUX_MuASF_Term2C7_3sym);
...
aterm * lf_AUX_MuASF_Term2C7_3( aterm * arg0 , aterm * arg1 , aterm * arg2 , aterm * arg3) {
{
aterm * tmp[61];
...
if( check_sym( arg2 , lf_AUX_MuASF_Term2C7_2sym)) {
{
...
t_protect( arg1);
t_protect( atmp20);
tmp[ 48]= ( * ef24)( ( * ef9)( ) , tmp[ 39] , tmp[ 5] , tmp[ 6] , ( * ef25)( arg3) , tmp[ 46] , arg1 , lf_AUX_MuASF_Term2C7_2( make_list( atmp20)));
...
t_unprotect( tmp[ 40]);
t_unprotect( tmp[ 41]);
return ( * ef5)( ( * ef6)( ) , ( * ef6)( ) , lf_AUX_MuASF_Term2C7_1( cons( make_list( ( * ef1)( lf4( make_list( tmp[ 7])) , lf5( cons( make_list( ( * ef2)( ( * ef3)( ( * ef4)( lf6( cons( make_list( make_char( 116)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 113)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 97)) , make_list( make_char( 108))))))))))))) , lf7( cons( make_list( tmp[ 37]) , make_list( tmp[ 39])))) , tmp[ 12])) , make_list( tmp[ 10]))) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 1]))) , arg3 , arg1);
}
}
}
}
...
return make_nf4( lf_AUX_MuASF_Term2C7_3sym , arg0 , arg1 , arg2 , arg3);
}
}
