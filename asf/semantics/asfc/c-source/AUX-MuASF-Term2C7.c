...
t_protect( tmp[ 37]);
t_protect( tmp[ 39]);
tmp[ 41]= ( * ef10)( tmp[ 37] , lf_AUX_MuASF_Term2C7_1( make_list( tmp[ 39])));
...
t_unprotect( tmp[ 40]);
t_unprotect( tmp[ 41]);
return ( * ef5)( ( * ef6)( ) , ( * ef6)( ) , lf_AUX_MuASF_Term2C7_1( cons( make_list( ( * ef1)( lf4( make_list( tmp[ 6])) , lf5( cons( make_list( ( * ef2)( ( * ef3)( ( * ef4)( lf6( cons( make_list( make_char( 116)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 113)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 97)) , make_list( make_char( 108))))))))))))) , lf7( cons( make_list( tmp[ 35]) , make_list( tmp[ 37])))) , tmp[ 10])) , make_list( tmp[ 38]))) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 39]))) , arg3 , arg1);
}
else {
t_protect( arg3);
...
t_protect( arg1);
t_protect( atmp20);
tmp[ 48]= ( * ef24)( ( * ef9)( ) , tmp[ 37] , tmp[ 4] , tmp[ 5] , ( * ef25)( arg3) , tmp[ 46] , arg1 , lf_AUX_MuASF_Term2C7_2( make_list( atmp20)));
