...
static aterm * lf_AUX_MuASF_Conds2C8_2( aterm * arg1 , aterm * arg2 , aterm * arg3 , aterm * arg4 , aterm * arg5);
...
lf_AUX_MuASF_Conds2C8_2sym= TmkSymbol( "prod(id(\"MuASF-Conds2C\"),w(\"\"),[l(\"listcondspattern2cstats\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADSI-tuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
lf_AUX_MuASF_Conds2C8_1sym= TmkSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"NamePair\"),ql(\",\"))") , lf_AUX_MuASF_Conds2C8_1 , lf_AUX_MuASF_Conds2C8_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Conds2C\"),w(\"\"),[l(\"listcondspattern2cstats\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADSI-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Conds2C8_2 , lf_AUX_MuASF_Conds2C8_2sym);
...
aterm * lf_AUX_MuASF_Conds2C8_2( aterm * arg0 , aterm * arg1 , aterm * arg2 , aterm * arg3 , aterm * arg4) {
{
aterm * tmp[11];
...
if( check_sym( arg3 , lf_AUX_MuASF_Conds2C8_1sym)) {
{
...
t_protect( atmp30);
t_protect( arg4);
tmp[ 7]= ( * ef5)( ( * ef6)( ) , lf5( make_list( tmp[ 6])) , ( * ef1)( lf3( make_list( atmp000)) , lf4( make_list( tmp[ 1])) , atmp02 , atmp03 , atmp04) , arg1 , arg2 , lf_AUX_MuASF_Conds2C8_1( make_list( atmp30)) , arg4);
...
return make_nf5( lf_AUX_MuASF_Conds2C8_2sym , arg0 , arg1 , arg2 , arg3 , arg4);
}
}
