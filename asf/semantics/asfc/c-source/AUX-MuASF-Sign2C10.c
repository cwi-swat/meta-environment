...
static Symbol lf_AUX_MuASF_Sign2C10_2_recursivesym ;
static ATerm lf_AUX_MuASF_Sign2C10_2_recursive ( ATerm arg1 ) ;
...
lf_AUX_MuASF_Sign2C10_2_recursivesym = ATmakeSymbol ( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[ql(\"namepairs2lstats\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Sign2C10_2_recursivesym ) ;
lf_AUX_MuASF_Sign2C10_2sym = ATmakeSymbol ( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[ql(\"namepairs2lstats\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[ql(\"namepairs2lstats\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Sign2C10_2 , lf_AUX_MuASF_Sign2C10_2sym ) ;
...
ATerm lf_AUX_MuASF_Sign2C10_2_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 2 ] ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_MuASF_Sign2C10_2_recursivesym , lf_AUX_MuASF_Sign2C10_1 ( arg0 ) ) ) ;
}
}
