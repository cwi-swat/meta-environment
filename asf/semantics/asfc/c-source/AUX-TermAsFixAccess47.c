...
static Symbol lf_AUX_TermAsFixAccess47_1sym ;
static ATerm lf_AUX_TermAsFixAccess47_1 ( ATerm arg1 ) ;
...
static funcptr ef17 ;
void register_AUX_TermAsFixAccess47 ( ) {
lf_AUX_TermAsFixAccess47_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-iter-sep-star-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess47_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-iter-sep-star-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess47_1 , lf_AUX_TermAsFixAccess47_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess47 ( ) {
...
ef17 = lookup_func ( ATreadFromString ( "prod(id(\"ATerm-Booleans\"),w(\"\"),[ql(\"false\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
ef17sym = lookup_sym ( ATreadFromString ( "prod(id(\"ATerm-Booleans\"),w(\"\"),[ql(\"false\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
}
static ATerm constant0 = NULL ;
static ATerm constant1 = NULL ;
void init_AUX_TermAsFixAccess47 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess47_1 ( ATerm arg0 ) {
{
ATerm tmp [ 57 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess47_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess47_1sym , arg0 ) ) ;
...
if ( check_sym ( atmp0111000111100 , ef13sym ) ) {
{
...
if ( check_sym ( atmp011100011111100 , ef12sym ) ) {
{
...
if ( check_sym ( atmp011100011111111 , ef5sym ) ) {
{
...
if ( check_sym ( atmp01110001111111100 , ef12sym ) ) {
{
...
if ( check_sym ( atmp0111111100 , ef13sym ) ) {
{
...
if ( term_equal ( list_head ( tmp [ 0 ] ) , make_char ( 82 ) ) ) {
( tmp [ 1 ] = list_tail ( tmp [ 0 ] ) ) ;
if ( not_empty_list ( tmp [ 1 ] ) ) {
if ( term_equal ( list_head ( tmp [ 1 ] ) , make_char ( 101 ) ) ) {
( tmp [ 2 ] = list_tail ( tmp [ 1 ] ) ) ;
if ( not_empty_list ( tmp [ 2 ] ) ) {
if ( term_equal ( list_head ( tmp [ 2 ] ) , make_char ( 103 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 12 ] ) , make_char ( 83 ) ) ) {
( tmp [ 13 ] = list_tail ( tmp [ 12 ] ) ) ;
if ( not_empty_list ( tmp [ 13 ] ) ) {
if ( term_equal ( list_head ( tmp [ 13 ] ) , make_char ( 121 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 17 ] ) , make_char ( 120 ) ) ) {
...
( tmp [ 19 ] = list_tail ( atmp0110100000 ) ) ;
...
( tmp [ 20 ] = list_tail ( atmp01110000100000 ) ) ;
if ( not_empty_list ( tmp [ 20 ] ) ) {
if ( term_equal ( list_head ( tmp [ 20 ] ) , make_char ( 123 ) ) ) {
...
( tmp [ 22 ] = list_tail ( atmp011100010100000 ) ) ;
...
( tmp [ 23 ] = list_tail ( atmp0111000110100000 ) ) ;
if ( not_empty_list ( tmp [ 23 ] ) ) {
if ( term_equal ( list_head ( tmp [ 23 ] ) , make_char ( 83 ) ) ) {
( tmp [ 24 ] = list_tail ( tmp [ 23 ] ) ) ;
if ( not_empty_list ( tmp [ 24 ] ) ) {
if ( term_equal ( list_head ( tmp [ 24 ] ) , make_char ( 121 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 26 ] ) , make_char ( 98 ) ) ) {
( tmp [ 27 ] = list_tail ( tmp [ 26 ] ) ) ;
if ( not_empty_list ( tmp [ 27 ] ) ) {
if ( term_equal ( list_head ( tmp [ 27 ] ) , make_char ( 111 ) ) ) {
...
( tmp [ 30 ] = list_tail ( atmp01110001110100000 ) ) ;
...
( tmp [ 31 ] = list_tail ( atmp011100011110100000 ) ) ;
if ( not_empty_list ( tmp [ 31 ] ) ) {
if ( term_equal ( list_head ( tmp [ 31 ] ) , make_char ( 83 ) ) ) {
( tmp [ 32 ] = list_tail ( tmp [ 31 ] ) ) ;
if ( not_empty_list ( tmp [ 32 ] ) ) {
if ( term_equal ( list_head ( tmp [ 32 ] ) , make_char ( 121 ) ) ) {
( tmp [ 33 ] = list_tail ( tmp [ 32 ] ) ) ;
if ( not_empty_list ( tmp [ 33 ] ) ) {
if ( term_equal ( list_head ( tmp [ 33 ] ) , make_char ( 109 ) ) ) {
( tmp [ 34 ] = list_tail ( tmp [ 33 ] ) ) ;
if ( not_empty_list ( tmp [ 34 ] ) ) {
if ( term_equal ( list_head ( tmp [ 34 ] ) , make_char ( 98 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 36 ] ) , make_char ( 108 ) ) ) {
...
( tmp [ 38 ] = list_tail ( atmp0111000111110100000 ) ) ;
...
( tmp [ 39 ] = list_tail ( atmp01110001111110100000 ) ) ;
...
( tmp [ 41 ] = list_tail ( atmp011100011111110100000 ) ) ;
...
( tmp [ 44 ] = list_tail ( atmp011110100000 ) ) ;
...
( tmp [ 45 ] = list_tail ( atmp0111110100000 ) ) ;
if ( not_empty_list ( tmp [ 45 ] ) ) {
if ( term_equal ( list_head ( tmp [ 45 ] ) , make_char ( 45 ) ) ) {
( tmp [ 46 ] = list_tail ( tmp [ 45 ] ) ) ;
if ( not_empty_list ( tmp [ 46 ] ) ) {
if ( term_equal ( list_head ( tmp [ 46 ] ) , make_char ( 62 ) ) ) {
...
( tmp [ 48 ] = list_tail ( atmp01111110100000 ) ) ;
...
( tmp [ 49 ] = list_tail ( atmp011111110100000 ) ) ;
if ( not_empty_list ( tmp [ 49 ] ) ) {
if ( term_equal ( list_head ( tmp [ 49 ] ) , make_char ( 83 ) ) ) {
( tmp [ 50 ] = list_tail ( tmp [ 49 ] ) ) ;
if ( not_empty_list ( tmp [ 50 ] ) ) {
if ( term_equal ( list_head ( tmp [ 50 ] ) , make_char ( 121 ) ) ) {
( tmp [ 51 ] = list_tail ( tmp [ 50 ] ) ) ;
if ( not_empty_list ( tmp [ 51 ] ) ) {
if ( term_equal ( list_head ( tmp [ 51 ] ) , make_char ( 109 ) ) ) {
( tmp [ 52 ] = list_tail ( tmp [ 51 ] ) ) ;
if ( not_empty_list ( tmp [ 52 ] ) ) {
if ( term_equal ( list_head ( tmp [ 52 ] ) , make_char ( 98 ) ) ) {
( tmp [ 53 ] = list_tail ( tmp [ 52 ] ) ) ;
if ( not_empty_list ( tmp [ 53 ] ) ) {
if ( term_equal ( list_head ( tmp [ 53 ] ) , make_char ( 111 ) ) ) {
( tmp [ 54 ] = list_tail ( tmp [ 53 ] ) ) ;
if ( not_empty_list ( tmp [ 54 ] ) ) {
if ( term_equal ( list_head ( tmp [ 54 ] ) , make_char ( 108 ) ) ) {
...
( tmp [ 56 ] = list_tail ( atmp0111111110100000 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess47_1sym , arg0 ) ) ;
}
}
