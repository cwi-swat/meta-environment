#include "support.h"
static Symbol lf_AUX_MuASF_Basics17_2sym;
static ATerm lf_AUX_MuASF_Basics17_2( ATerm arg1);
...
lf_AUX_MuASF_Basics17_2sym= ATmakeSymbol( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"args-contain-var\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_MuASF_Basics17_2sym);
lf_AUX_MuASF_Basics17_1sym= ATmakeSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_MuASF_Basics17_1sym);
register_prod( ATparse( "listtype(sort(\"Term\"),ql(\",\"))") , lf_AUX_MuASF_Basics17_1 , lf_AUX_MuASF_Basics17_1sym);
register_prod( ATparse( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"args-contain-var\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Basics17_2 , lf_AUX_MuASF_Basics17_2sym);
}
...
ATerm lf_AUX_MuASF_Basics17_2( ATerm arg0) {
{
ATerm tmp[2];
PROF( prof_lf_AUX_MuASF_Basics17_2);
if( check_sym( arg0 , lf_AUX_MuASF_Basics17_1sym)) {
{
ATerm atmp00= arg_0( arg0);
if( not_empty_list( atmp00)) {
tmp[ 0]= list_head( atmp00);
tmp[ 1]= list_tail( atmp00);
return ( * ef2)( ( * ef3)( tmp[ 0]) , lf_AUX_MuASF_Basics17_2( lf_AUX_MuASF_Basics17_1( make_list( tmp[ 1]))));
}
else {
...
return make_nf1( lf_AUX_MuASF_Basics17_2sym , arg0);
}
}
