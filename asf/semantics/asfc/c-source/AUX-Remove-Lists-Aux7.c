...
static ATerm lf_AUX_Remove_Lists_Aux7_1 ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Remove_Lists_Aux7_1sym = ATmakeSymbol ( "prod(id(\"Remove-Lists-Aux\"),w(\"\"),[l(\"make-new-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Cond\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Remove-Lists-Aux\"),w(\"\"),[l(\"make-new-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Cond\"),w(\"\"),no-attrs)" ) , lf_AUX_Remove_Lists_Aux7_1 , lf_AUX_Remove_Lists_Aux7_1sym ) ;
...
ef2 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"term-contains-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
ef2sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"term-contains-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
...
ATerm lf_AUX_Remove_Lists_Aux7_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 1 ] ;
FUNC_ENTRY ( lf_AUX_Remove_Lists_Aux7_1sym , ATmakeAppl ( lf_AUX_Remove_Lists_Aux7_1sym , arg0 , arg1 ) ) ;
tmp [ 0 ] = ( * ef2 ) ( arg1 ) ;
...
FUNC_EXIT ( ( * ef1 ) ( ( * ef4 ) ( ( * ef5 ) ( lf2 ( ( ATerm ) ATmakeList ( 10 , char_table [ 116 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 109 ] , char_table [ 45 ] , char_table [ 101 ] , char_table [ 113 ] , char_table [ 117 ] , char_table [ 97 ] , char_table [ 108 ] ) ) ) , lf3 ( cons ( make_list ( arg0 ) , make_list ( arg1 ) ) ) ) , ( * ef6 ) ( ( * ef5 ) ( lf2 ( make_list ( make_char ( 116 ) ) ) ) ) ) ) ;
}
FUNC_EXIT ( make_nf2 ( lf_AUX_Remove_Lists_Aux7_1sym , arg0 , arg1 ) ) ;
}
}
