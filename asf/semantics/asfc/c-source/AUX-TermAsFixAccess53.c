...
lf_AUX_TermAsFixAccess53_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-iter-sep-star-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess53_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-iter-sep-star-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess53_1 , lf_AUX_TermAsFixAccess53_1sym ) ;
...
if ( check_sym ( atmp0111000111101 , ef6sym ) ) {
{
ATerm atmp01110001111010 = arg_0 ( atmp0111000111101 ) ;
if ( check_sym ( atmp01110001111010 , ef7sym ) ) {
{
ATerm atmp011100011110100 = arg_0 ( atmp01110001111010 ) ;
if ( check_sym ( atmp011100011110100 , ef8sym ) ) {
{
ATerm atmp0111000111101000 = arg_0 ( atmp011100011110100 ) ;
if ( check_sym ( atmp0111000111101000 , ef9sym ) ) {
{
...
if ( check_sym ( atmp011100011111111 , ef6sym ) ) {
{
