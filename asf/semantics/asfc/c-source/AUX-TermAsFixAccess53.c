...
static Symbol lf_AUX_TermAsFixAccess53_1sym ;
static ATerm lf_AUX_TermAsFixAccess53_1 ( ATerm arg1 ) ;
...
static funcptr ef12 ;
void register_AUX_TermAsFixAccess53 ( ) {
lf_AUX_TermAsFixAccess53_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"term-get-args-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess53_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"term-get-args-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess53_1 , lf_AUX_TermAsFixAccess53_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess53 ( ) {
...
void init_AUX_TermAsFixAccess53 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
ATprotect ( & constant2 ) ;
}
ATerm lf_AUX_TermAsFixAccess53_1 ( ATerm arg0 ) {
{
ATerm tmp [ 21 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess53_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess53_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess53_1sym , arg0 ) ) ;
}
}
