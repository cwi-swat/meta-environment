...
lf_AUX_Remove_Lists_C18_2sym= TmkSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-no-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-no-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C18_2 , lf_AUX_Remove_Lists_C18_2sym);
...
ef11= lookup_func( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
ef11sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
...
tmp[ 19]= arg_1( tmp[ 17]);
tmp[ 20]= arg_2( tmp[ 17]);
if( check_sym( tmp[ 18] , lf_AUX_Remove_Lists_C18_1sym)) {
tmp[ 21]= arg_0( tmp[ 18]);
if( check_sym( tmp[ 19] , lf4sym)) {
tmp[ 22]= arg_0( tmp[ 19]);
if( m_is_single_element( tmp[ 21])) {
tmp[ 23]= m_list_head( tmp[ 21]);
t_protect( tmp[ 15]);
t_protect( tmp[ 20]);
...
tmp[ 26]= arg_1( tmp[ 24]);
tmp[ 27]= arg_2( tmp[ 24]);
if( check_sym( tmp[ 25] , lf_AUX_Remove_Lists_C18_1sym)) {
tmp[ 28]= arg_0( tmp[ 25]);
if( check_sym( tmp[ 26] , lf4sym)) {
tmp[ 29]= arg_0( tmp[ 26]);
if( m_is_single_element( tmp[ 28])) {
tmp[ 30]= m_list_head( tmp[ 28]);
t_protect( tmp[ 27]);
tmp[ 31]= ( * ef13)( tmp[ 27]);
t_protect( tmp[ 31]);
tmp[ 32]= ( * ef14)( tmp[ 31]);
...
t_unprotect( tmp[ 24]);
t_unprotect( tmp[ 31]);
return ( * ef3)( lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 32])))) , lf4( cons( make_list( ( * ef6)( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 112)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 102)) , cons( make_list( make_char( 105)) , make_list( make_char( 120)))))))))))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 32]))))) , tmp[ 23])) , cons( make_list( tmp[ 22]) , cons( make_list( ( * ef6)( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 110)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 112)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 121)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , make_list( make_char( 116))))))))))))))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 32]))))) , ( * ef7)( ( * ef2)( lf3( make_list( make_char( 116))))))) , cons( make_list( ( * ef8)( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 97)) , cons( make_list( make_char( 115)) , make_list( make_char( 116)))))))))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 32]))))) , tmp[ 30])) , make_list( tmp[ 29])))))) , tmp[ 33]);
}
}
}
}
...
tmp[ 20]= arg_1( tmp[ 18]);
tmp[ 21]= arg_2( tmp[ 18]);
if( check_sym( tmp[ 19] , lf_AUX_Remove_Lists_C18_1sym)) {
tmp[ 22]= arg_0( tmp[ 19]);
if( check_sym( tmp[ 20] , lf4sym)) {
tmp[ 23]= arg_0( tmp[ 20]);
if( m_is_single_element( tmp[ 22])) {
tmp[ 24]= m_list_head( tmp[ 22]);
t_protect( tmp[ 21]);
tmp[ 25]= ( * ef13)( tmp[ 21]);
t_protect( tmp[ 25]);
tmp[ 26]= ( * ef14)( tmp[ 25]);
...
t_protect( tmp[ 28]);
t_protect( tmp[ 27]);
tmp[ 29]= lf_AUX_Remove_Lists_C18_2( lf_AUX_Remove_Lists_C18_1( make_list( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))) , lf_AUX_Remove_Lists_C18_1( cons( make_list( tmp[ 13]) , make_list( tmp[ 28])))))) , tmp[ 27]);
if( check_sym( tmp[ 29] , ef3sym)) {
tmp[ 30]= arg_0( tmp[ 29]);
tmp[ 31]= arg_1( tmp[ 29]);
tmp[ 32]= arg_2( tmp[ 29]);
if( check_sym( tmp[ 30] , lf_AUX_Remove_Lists_C18_1sym)) {
tmp[ 33]= arg_0( tmp[ 30]);
if( check_sym( tmp[ 31] , lf4sym)) {
tmp[ 34]= arg_0( tmp[ 31]);
if( m_is_single_element( tmp[ 33])) {
tmp[ 35]= m_list_head( tmp[ 33]);
...
t_unprotect( tmp[ 29]);
t_unprotect( tmp[ 35]);
return ( * ef3)( lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 26])))) , lf4( cons( make_list( ( * ef6)( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 112)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 102)) , cons( make_list( make_char( 105)) , make_list( make_char( 120)))))))))))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 26]))))) , ( * ef4)( ( * ef5)( tmp[ 37])))) , cons( make_list( ( * ef6)( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 110)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 112)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 121)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , make_list( make_char( 116))))))))))))))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 26]))))) , ( * ef7)( ( * ef2)( lf3( make_list( make_char( 116))))))) , cons( make_list( ( * ef8)( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 97)) , cons( make_list( make_char( 115)) , make_list( make_char( 116)))))))))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 26]))))) , tmp[ 24])) , cons( make_list( tmp[ 23]) , make_list( tmp[ 34])))))) , tmp[ 32]);
}
}
t_unprotect( tmp[ 35]);
}
