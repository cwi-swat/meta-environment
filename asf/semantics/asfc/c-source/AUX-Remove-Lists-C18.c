...
lf_AUX_Remove_Lists_C18_2sym= ATmakeSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-no-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-no-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C18_2 , lf_AUX_Remove_Lists_C18_2sym);
...
ef13= lookup_func( ATreadFromString( "prod(id(\"VarEnv\"),w(\"\"),[l(\"get-int\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AInt\"),w(\"\"),no-attrs)"));
ef13sym= lookup_sym( ATreadFromString( "prod(id(\"VarEnv\"),w(\"\"),[l(\"get-int\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AInt\"),w(\"\"),no-attrs)"));
ef14= lookup_func( ATreadFromString( "prod(id(\"VarEnv\"),w(\"\"),[l(\"newlistvar\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"VarId\"),w(\"\"),no-attrs)"));
ef14sym= lookup_sym( ATreadFromString( "prod(id(\"VarEnv\"),w(\"\"),[l(\"newlistvar\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"VarId\"),w(\"\"),no-attrs)"));
...
ef16= lookup_func( ATreadFromString( "prod(id(\"ANumerals\"),w(\"\"),[l(\"succ\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AInt\"),w(\"\"),no-attrs)"));
ef16sym= lookup_sym( ATreadFromString( "prod(id(\"ANumerals\"),w(\"\"),[l(\"succ\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AInt\"),w(\"\"),no-attrs)"));
ef17= lookup_func( ATreadFromString( "prod(id(\"Booleans\"),w(\"\"),[l(\"true\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
ef17sym= lookup_sym( ATreadFromString( "prod(id(\"Booleans\"),w(\"\"),[l(\"true\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
...
return ( * ef3)( lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 32])))) , lf4( cons( make_list( ( * ef6)( ( * ef1)( ( constant1? constant1: ( constant1= ( * ef2)( lf3( (ATerm) ATmakeList( 11 , char_table[ 108] , char_table[ 105] , char_table[ 115] , char_table[ 116] , char_table[ 45] , char_table[ 112] , char_table[ 114] , char_table[ 101] , char_table[ 102] , char_table[ 105] , char_table[ 120]))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 32]))))) , tmp[ 23])) , cons( make_list( tmp[ 22]) , cons( make_list( ( * ef6)( ( * ef1)( ( constant2? constant2: ( constant2= ( * ef2)( lf3( (ATerm) ATmakeList( 14 , char_table[ 110] , char_table[ 111] , char_table[ 116] , char_table[ 45] , char_table[ 101] , char_table[ 109] , char_table[ 112] , char_table[ 116] , char_table[ 121] , char_table[ 45] , char_table[ 108] , char_table[ 105] , char_table[ 115] , char_table[ 116]))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 32]))))) , ( constant3? constant3: ( constant3= ( * ef7)( ( * ef2)( lf3( make_list( make_char( 116))))))))) , cons( make_list( ( * ef8)( ( * ef1)( ( constant4? constant4: ( constant4= ( * ef2)( lf3( (ATerm) ATmakeList( 9 , char_table[ 108] , char_table[ 105] , char_table[ 115] , char_table[ 116] , char_table[ 45] , char_table[ 108] , char_table[ 97] , char_table[ 115] , char_table[ 116]))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 32]))))) , tmp[ 30])) , make_list( tmp[ 29])))))) , tmp[ 33]);
}
}
}
}
...
tmp[ 28]= ( * ef19)( tmp[ 15]);
tmp[ 29]= lf_AUX_Remove_Lists_C18_2( lf_AUX_Remove_Lists_C18_1( make_list( ( * ef1)( ( constant6? constant6: ( constant6= ( * ef2)( lf3( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))))) , lf_AUX_Remove_Lists_C18_1( cons( make_list( tmp[ 13]) , make_list( tmp[ 28])))))) , tmp[ 27]);
...
tmp[ 37]= arg_0( tmp[ 36]);
return ( * ef3)( lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 26])))) , lf4( cons( make_list( ( * ef6)( ( * ef1)( ( constant1? constant1: ( constant1= ( * ef2)( lf3( (ATerm) ATmakeList( 11 , char_table[ 108] , char_table[ 105] , char_table[ 115] , char_table[ 116] , char_table[ 45] , char_table[ 112] , char_table[ 114] , char_table[ 101] , char_table[ 102] , char_table[ 105] , char_table[ 120]))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 26]))))) , ( * ef4)( ( * ef5)( tmp[ 37])))) , cons( make_list( ( * ef6)( ( * ef1)( ( constant2? constant2: ( constant2= ( * ef2)( lf3( (ATerm) ATmakeList( 14 , char_table[ 110] , char_table[ 111] , char_table[ 116] , char_table[ 45] , char_table[ 101] , char_table[ 109] , char_table[ 112] , char_table[ 116] , char_table[ 121] , char_table[ 45] , char_table[ 108] , char_table[ 105] , char_table[ 115] , char_table[ 116]))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 26]))))) , ( constant3? constant3: ( constant3= ( * ef7)( ( * ef2)( lf3( make_list( make_char( 116))))))))) , cons( make_list( ( * ef8)( ( * ef1)( ( constant4? constant4: ( constant4= ( * ef2)( lf3( (ATerm) ATmakeList( 9 , char_table[ 108] , char_table[ 105] , char_table[ 115] , char_table[ 116] , char_table[ 45] , char_table[ 108] , char_table[ 97] , char_table[ 115] , char_table[ 116]))))) , lf_AUX_Remove_Lists_C18_1( make_list( ( * ef4)( ( * ef5)( tmp[ 26]))))) , tmp[ 24])) , cons( make_list( tmp[ 23]) , make_list( tmp[ 34])))))) , tmp[ 32]);
}
}
}
}
