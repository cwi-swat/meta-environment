...
static Symbol lf_AUX_VarEnv20_2sym ;
static ATerm lf_AUX_VarEnv20_2 ( ATerm arg1 , ATerm arg2 ) ;
...
static Symbol lf_AUX_VarEnv20_1sym ;
static ATerm lf_AUX_VarEnv20_1 ( ATerm arg1 ) ;
void register_AUX_VarEnv20 ( ) {
lf_AUX_VarEnv20_2sym = ATmakeSymbol ( "prod(id(\"VarEnv\"),w(\"\"),[l(\"np-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_VarEnv20_2sym ) ;
lf3sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf3sym ) ;
lf4sym = ATmakeSymbol ( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf4sym ) ;
lf_AUX_VarEnv20_1sym = ATmakeSymbol ( "listtype(sort(\"NamePair\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_VarEnv20_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"NamePair\"),ql(\",\"))" ) , lf_AUX_VarEnv20_1 , lf_AUX_VarEnv20_1sym ) ;
register_prod ( ATparse ( "prod(id(\"VarEnv\"),w(\"\"),[l(\"np-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)" ) , lf_AUX_VarEnv20_2 , lf_AUX_VarEnv20_2sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf3 , lf3sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Term\"),ql(\",\"))" ) , lf4 , lf4sym ) ;
}
void resolve_AUX_VarEnv20 ( ) {
...
{
ATerm ltmp [ 2 ] ;
lbl_lf_AUX_VarEnv20_2 : ltmp [ 0 ] = arg0 ;
ltmp [ 1 ] = arg1 ;
...
if ( check_sym ( ltmp [ 1 ] , lf_AUX_VarEnv20_1sym ) ) {
{
...
arg1 = lf_AUX_VarEnv20_1 ( make_list ( tmp [ 1 ] ) ) ;
goto lbl_lf_AUX_VarEnv20_2 ;
}
else {
FUNC_EXIT ( tmp [ 2 ] ) ;
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_VarEnv20_2sym , ltmp [ 0 ] , ltmp [ 1 ] ) ) ;
}
}
}
