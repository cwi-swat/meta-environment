...
static ATerm lf_AUX_Rules2C_Aux41_1 ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Rules2C_Aux41_1sym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-if-then-else\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Rules2C_Aux41_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-if-then-else\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux41_1 , lf_AUX_Rules2C_Aux41_1sym ) ;
}
...
ATerm lf_AUX_Rules2C_Aux41_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 1 ] ;
FUNC_ENTRY ( lf_AUX_Rules2C_Aux41_1sym , ATmakeAppl ( lf_AUX_Rules2C_Aux41_1sym , arg0 , arg1 ) ) ;
tmp [ 0 ] = ( * ef6 ) ( arg1 ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef2 ) ( ( * ef3 ) ( arg0 , ( * ef4 ) ( ( * ef5 ) ( ) , tmp [ 0 ] ) ) ) ) ) ;
FUNC_EXIT ( make_nf2 ( lf_AUX_Rules2C_Aux41_1sym , arg0 , arg1 ) ) ;
}
}
