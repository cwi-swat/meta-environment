#include "support.h"
static Symbol lf_AUX_AFuns10_1sym;
...
lf_AUX_AFuns10_1sym= ATmakeSymbol( "prod(id(\"AFuns\"),w(\"\"),[l(\"map1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_AFuns10_1sym);
register_prod( ATparse( "prod(id(\"AFuns\"),w(\"\"),[l(\"map1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)") , lf_AUX_AFuns10_1 , lf_AUX_AFuns10_1sym);
}
