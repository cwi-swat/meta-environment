...
lf_AUX_AFuns10_1sym= ATmakeSymbol( "prod(id(\"AFuns\"),w(\"\"),[l(\"filter1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_AFuns10_1sym);
register_prod( ATparse( "prod(id(\"AFuns\"),w(\"\"),[l(\"filter1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)") , lf_AUX_AFuns10_1 , lf_AUX_AFuns10_1sym);
}
...
return ( * ef3)( ( * ef4)( arg0 , ( * ef5)( ( * ef6)( arg1))) , ( * ef7)( ( * ef2)( ( * ef5)( ( * ef6)( arg1))) , lf_AUX_AFuns10_1( arg0 , ( * ef8)( arg1))) , lf_AUX_AFuns10_1( arg0 , ( * ef8)( arg1)));
}
}
