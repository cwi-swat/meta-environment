#include "support.h"
static asymbol * lf_AUX_C_Basics21_1sym;
static aterm * lf_AUX_C_Basics21_1( aterm * arg1);
...
lf_AUX_C_Basics21_1sym= TmkSymbol( "prod(id(\"C-Basics\"),w(\"\"),[l(\"is-true\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"is-true\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_C_Basics21_1 , lf_AUX_C_Basics21_1sym);
...
aterm * lf_AUX_C_Basics21_1( aterm * arg0) {
