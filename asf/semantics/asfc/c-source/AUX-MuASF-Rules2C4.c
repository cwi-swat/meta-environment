#include "support.h"
static Symbol lf_AUX_MuASF_Rules2C4_4sym;
static ATerm lf_AUX_MuASF_Rules2C4_4( ATerm arg1 , ATerm arg2 , ATerm arg3);
static Symbol ef1sym;
static funcptr ef1;
static Symbol lf_AUX_MuASF_Rules2C4_3sym;
...
static funcptr ef4;
static Symbol lf_AUX_MuASF_Rules2C4_2sym;
...
lf_AUX_MuASF_Rules2C4_4sym= ATmakeSymbol( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"asfrules2cfuncs\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FT-tuple\"),w(\"\"),no-attrs)"
 , 3 , ATtrue);
ATprotectSymbol( lf_AUX_MuASF_Rules2C4_4sym);
lf_AUX_MuASF_Rules2C4_3sym= ATmakeSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_MuASF_Rules2C4_3sym);
lf_AUX_MuASF_Rules2C4_2sym= ATmakeSymbol( "listtype(sort(\"Rule\"),ql(\";\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_MuASF_Rules2C4_2sym);
lf_AUX_MuASF_Rules2C4_1sym= ATmakeSymbol( "listtype(sort(\"FuncDef\"),ql(\";\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_MuASF_Rules2C4_1sym);
register_prod( ATparse( "listtype(sort(\"FuncDef\"),ql(\";\"))") , lf_AUX_MuASF_Rules2C4_1 , lf_AUX_MuASF_Rules2C4_1sym);
register_prod( ATparse( "listtype(sort(\"Rule\"),ql(\";\"))") , lf_AUX_MuASF_Rules2C4_2 , lf_AUX_MuASF_Rules2C4_2sym);
register_prod( ATparse( "listtype(sort(\"NamePair\"),ql(\",\"))") , lf_AUX_MuASF_Rules2C4_3 , lf_AUX_MuASF_Rules2C4_3sym);
register_prod( ATparse( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"asfrules2cfuncs\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FT-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Rules2C4_4 , lf_AUX_MuASF_Rules2C4_4sym);
}
...
tmp[ 7]= arg_0( tmp[ 5]);
tmp[ 8]= ( * ef5)( tmp[ 2] , lf_AUX_MuASF_Rules2C4_1( make_list( atmp00)));
if( check_sym( tmp[ 8] , ef6sym)) {
tmp[ 9]= arg_0( tmp[ 8]);
if( check_sym( tmp[ 9] , lf_AUX_MuASF_Rules2C4_1sym)) {
tmp[ 10]= arg_0( tmp[ 9]);
return ( * ef1)( lf_AUX_MuASF_Rules2C4_1( make_list( tmp[ 10])) , lf_AUX_MuASF_Rules2C4_2( make_list( tmp[ 6])) , lf_AUX_MuASF_Rules2C4_2( make_list( tmp[ 7])) , lf_AUX_MuASF_Rules2C4_3( make_list( atmp20)));
}
}
}
}
