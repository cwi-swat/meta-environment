...
static ATerm lf_AUX_Integers4_1( ATerm arg1);
...
lf_AUX_Integers4_1sym= ATmakeSymbol( "prod(id(\"Integers\"),w(\"\"),[ql(\"-\"),w(\"\"),sort(\"NAT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Integers4_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"Integers\"),w(\"\"),[ql(\"-\"),w(\"\"),sort(\"NAT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),no-attrs)") , lf_AUX_Integers4_1 , lf_AUX_Integers4_1sym);
...
ATerm lf_AUX_Integers4_1( ATerm arg0) {
...
return make_nf1( lf_AUX_Integers4_1sym , arg0);
}
