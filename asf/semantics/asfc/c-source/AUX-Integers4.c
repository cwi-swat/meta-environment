...
lf_AUX_Integers4_1sym= ATmakeSymbol( "prod(id(\"Integers\"),w(\"\"),[sort(\"INT\"),w(\"\"),ql(\"+\"),w(\"\"),sort(\"INT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Integers4_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"Integers\"),w(\"\"),[sort(\"INT\"),w(\"\"),ql(\"+\"),w(\"\"),sort(\"INT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))") , lf_AUX_Integers4_1 , lf_AUX_Integers4_1sym);
...
tmp[ 11]= lf_AUX_Integers4_1( lf_AUX_Integers4_1( ( * ef1)( ( * ef2)( ( * ef3)( lf2( cons( ( constant17? constant17: ( constant17= make_list( make_char( 48)))) , make_list( tmp[ 0])))))) , ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( tmp[ 2])))))) , ( * ef1)( ( * ef2)( ( * ef3)( lf2( cons( ( constant17? constant17: ( constant17= make_list( make_char( 48)))) , make_list( tmp[ 9])))))));
...
tmp[ 9]= list_prefix( tmp[ 8]);
tmp[ 10]= list_last( tmp[ 8]);
tmp[ 11]= lf_AUX_Integers4_1( lf_AUX_Integers4_1( ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( tmp[ 0]))))) , ( * ef1)( ( * ef2)( ( * ef3)( lf2( cons( ( constant17? constant17: ( constant17= make_list( make_char( 48)))) , make_list( tmp[ 2]))))))) , ( * ef1)( ( * ef2)( ( * ef3)( lf2( cons( ( constant17? constant17: ( constant17= make_list( make_char( 48)))) , make_list( tmp[ 9])))))));
if( check_sym( tmp[ 11] , ef1sym)) {
tmp[ 12]= arg_0( tmp[ 11]);
if( check_sym( tmp[ 12] , ef2sym)) {
tmp[ 13]= arg_0( tmp[ 12]);
...
tmp[ 9]= list_prefix( tmp[ 8]);
tmp[ 10]= list_last( tmp[ 8]);
tmp[ 11]= lf_AUX_Integers4_1( lf_AUX_Integers4_1( ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( tmp[ 0]))))) , ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( tmp[ 2])))))) , ( * ef1)( ( * ef2)( ( * ef3)( lf2( cons( ( constant17? constant17: ( constant17= make_list( make_char( 48)))) , make_list( tmp[ 9])))))));
if( check_sym( tmp[ 11] , ef1sym)) {
tmp[ 12]= arg_0( tmp[ 11]);
if( check_sym( tmp[ 12] , ef2sym)) {
tmp[ 13]= arg_0( tmp[ 12]);
