...
tmp[ 8]= make_char( 57);
if( m_term_equal( tmp[ 0] , tmp[ 8])) {
if( m_is_single_element( atmp10000)) {
tmp[ 9]= m_list_head( atmp10000);
t_protect( tmp[ 9]);
