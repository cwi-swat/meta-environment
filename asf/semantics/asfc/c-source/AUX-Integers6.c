...
lf_AUX_Integers6_1sym= ATmakeSymbol( "prod(id(\"Integers\"),w(\"\"),[sort(\"INT\"),w(\"\"),ql(\"*\"),w(\"\"),sort(\"INT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Integers6_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"Integers\"),w(\"\"),[sort(\"INT\"),w(\"\"),ql(\"*\"),w(\"\"),sort(\"INT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))") , lf_AUX_Integers6_1 , lf_AUX_Integers6_1sym);
...
return ( * ef4)( ( * ef1)( ( * ef2)( ( * ef3)( lf2( cons( make_list( tmp[ 6]) , ( constant0? constant0: ( constant0= make_list( make_char( 48))))))))) , lf_AUX_Integers6_1( ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( atmp00000))))) , ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( tmp[ 1])))))));
}
}
}
}
...
return ( * ef4)( arg0 , lf_AUX_Integers6_1( arg0 , ( * ef5)( ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( tmp[ 0]))))) , ( constant3? constant3: ( constant3= ( * ef1)( ( * ef2)( ( * ef3)( lf2( make_list( make_char( 49)))))))))));
}
tmp[ 0]= list_head( atmp10000);
