...
static Symbol lf_AUX_TermAsFixAccess10_1sym ;
static ATerm lf_AUX_TermAsFixAccess10_1 ( ATerm arg1 ) ;
...
static funcptr ef8 ;
void register_AUX_TermAsFixAccess10 ( ) {
lf_AUX_TermAsFixAccess10_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-lex-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess10_1sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-lex-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess10_1 , lf_AUX_TermAsFixAccess10_1sym ) ;
}
void resolve_AUX_TermAsFixAccess10 ( ) {
...
void init_AUX_TermAsFixAccess10 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess10_1 ( ATerm arg0 ) {
FUNC_ENTRY ( lf_AUX_TermAsFixAccess10_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess10_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess10_1sym , arg0 ) ) ;
}
