...
static Symbol lf_AUX_Check_List_Pats23_1sym ;
...
lf_AUX_Check_List_Pats23_1sym = ATmakeSymbol ( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"contains-zero-or-one-list-vars-in-rule\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Rule\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Check_List_Pats23_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Cond\"),ql(\"&\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"contains-zero-or-one-list-vars-in-rule\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Rule\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_Check_List_Pats23_1 , lf_AUX_Check_List_Pats23_1sym ) ;
...
void init_AUX_Check_List_Pats23 ( ) {
}
ATerm lf_AUX_Check_List_Pats23_1 ( ATerm arg0 ) {
FUNC_ENTRY ( lf_AUX_Check_List_Pats23_1sym , ATmakeAppl ( lf_AUX_Check_List_Pats23_1sym , arg0 ) ) ;
...
FUNC_EXIT ( ( * ef6 ) ( ( * ef7 ) ( lf2 ( make_list ( atmp0000 ) ) ) , ( * ef2 ) ( atmp01 ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Check_List_Pats23_1sym , arg0 ) ) ;
}
