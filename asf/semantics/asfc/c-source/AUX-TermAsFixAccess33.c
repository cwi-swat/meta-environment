...
lf_AUX_TermAsFixAccess33_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-traverse-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess33_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-traverse-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess33_1 , lf_AUX_TermAsFixAccess33_1sym ) ;
...
if ( term_equal ( list_head ( tmp [ 21 ] ) , make_char ( 118 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 25 ] ) , make_char ( 101 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 33 ] ) , make_char ( 116 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 40 ] ) , make_char ( 101 ) ) ) {
