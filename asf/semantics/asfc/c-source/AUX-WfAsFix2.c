#include "support.h"
static asymbol * lf_AUX_WfAsFix2_1sym;
...
lf_AUX_WfAsFix2_1sym= TmkSymbol( "prod(id(\"WfAsFix\"),w(\"\"),[l(\"expand-module\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"WfAsFix\"),w(\"\"),[l(\"expand-module\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)") , lf_AUX_WfAsFix2_1 , lf_AUX_WfAsFix2_1sym);
}
