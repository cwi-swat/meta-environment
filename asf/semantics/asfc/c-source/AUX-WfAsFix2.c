#include "support.h"
static Symbol lf_AUX_WfAsFix2_1sym;
static ATerm lf_AUX_WfAsFix2_1( ATerm arg1 , ATerm arg2);
...
static funcptr ef4;
void register_AUX_WfAsFix2( ) {
lf_AUX_WfAsFix2_1sym= ATmakeSymbol( "prod(id(\"WfAsFix\"),w(\"\"),[l(\"expand\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_WfAsFix2_1sym);
register_prod( ATparse( "prod(id(\"WfAsFix\"),w(\"\"),[l(\"expand\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)") , lf_AUX_WfAsFix2_1 , lf_AUX_WfAsFix2_1sym);
}
void resolve_AUX_WfAsFix2( ) {
...
void init_AUX_WfAsFix2( ) {
ATprotect( & constant0);
}
ATerm lf_AUX_WfAsFix2_1( ATerm arg0 , ATerm arg1) {
PROF( prof_lf_AUX_WfAsFix2_1);
...
return make_nf2( lf_AUX_WfAsFix2_1sym , arg0 , arg1);
}
