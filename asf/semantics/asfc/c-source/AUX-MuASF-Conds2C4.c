...
ef19 = lookup_func ( ATreadFromString ( "prod(id(\"Pure-C\"),w(\"\"),[iter(sort(\"Statement\"),w(\"\"),l(\"+\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),no-attrs)" ) ) ;
ef19sym = lookup_sym ( ATreadFromString ( "prod(id(\"Pure-C\"),w(\"\"),[iter(sort(\"Statement\"),w(\"\"),l(\"+\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),no-attrs)" ) ) ;
...
tmp [ 16 ] = arg_0 ( tmp [ 15 ] ) ;
tmp [ 17 ] = ( * ef8 ) ( lf_AUX_MuASF_Conds2C4_1 ( cons ( make_list ( ( * ef1 ) ( lf4 ( make_list ( tmp [ 8 ] ) ) , lf5 ( cons ( make_list ( ( * ef2 ) ( tmp [ 12 ] , tmp [ 13 ] ) ) , make_list ( tmp [ 11 ] ) ) ) , tmp [ 4 ] , tmp [ 5 ] , tmp [ 6 ] , tmp [ 7 ] ) ) , make_list ( tmp [ 1 ] ) ) ) , ( constant1 ? constant1 : ( constant1 = lf_AUX_MuASF_Conds2C4_1 ( make_list ( null ( ) ) ) ) ) , lf_AUX_MuASF_Conds2C4_2 ( make_list ( atmp10 ) ) , arg2 , tmp [ 16 ] ) ;
...
if ( term_equal ( tmp [ 14 ] , ( constant2 ? constant2 : ( constant2 = ( * ef9 ) ( ) ) ) ) ) {
tmp [ 15 ] = ( * ef10 ) ( ( * ef11 ) ( ( * ef12 ) ( arg2 ) ) ) ;
tmp [ 16 ] = ( * ef13 ) ( ( constant2 ? constant2 : ( constant2 = ( * ef9 ) ( ) ) ) , tmp [ 12 ] , tmp [ 5 ] , tmp [ 6 ] , ( * ef14 ) ( arg2 ) , tmp [ 15 ] , tmp [ 7 ] , lf_AUX_MuASF_Conds2C4_2 ( make_list ( atmp10 ) ) ) ;
...
tmp [ 23 ] = ( * ef8 ) ( lf_AUX_MuASF_Conds2C4_1 ( cons ( make_list ( ( * ef1 ) ( lf4 ( make_list ( tmp [ 8 ] ) ) , lf5 ( cons ( make_list ( ( * ef2 ) ( tmp [ 12 ] , tmp [ 13 ] ) ) , make_list ( tmp [ 11 ] ) ) ) , tmp [ 4 ] , tmp [ 5 ] , tmp [ 6 ] , tmp [ 7 ] ) ) , make_list ( tmp [ 1 ] ) ) ) , ( constant1 ? constant1 : ( constant1 = lf_AUX_MuASF_Conds2C4_1 ( make_list ( null ( ) ) ) ) ) , lf_AUX_MuASF_Conds2C4_2 ( make_list ( atmp10 ) ) , tmp [ 19 ] , tmp [ 15 ] ) ;
