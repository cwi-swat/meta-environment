...
lf_AUX_RemAsFixWspace4_1sym= ATmakeSymbol( "prod(id(\"RemAsFixWspace\"),w(\"\"),[l(\"remove-ws-trms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_RemAsFixWspace4_1sym);
register_prod( ATparse( "prod(id(\"RemAsFixWspace\"),w(\"\"),[l(\"remove-ws-trms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)") , lf_AUX_RemAsFixWspace4_1 , lf_AUX_RemAsFixWspace4_1sym);
}
