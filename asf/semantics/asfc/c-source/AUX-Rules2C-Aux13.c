...
lf_AUX_Rules2C_Aux13_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-conds-on-first-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-conds-on-first-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux13_2 , lf_AUX_Rules2C_Aux13_2sym);
...
t_protect( arg0);
t_protect( tmp[ 29]);
tmp[ 30]= lf_AUX_Rules2C_Aux13_2( arg0 , lf_AUX_Rules2C_Aux13_1( make_list( tmp[ 29])));
if( check_sym( tmp[ 30] , ef1sym)) {
tmp[ 31]= arg_0( tmp[ 30]);
tmp[ 32]= arg_1( tmp[ 30]);
if( check_sym( tmp[ 31] , lf_AUX_Rules2C_Aux13_1sym)) {
tmp[ 33]= arg_0( tmp[ 31]);
if( check_sym( tmp[ 32] , lf_AUX_Rules2C_Aux13_1sym)) {
tmp[ 34]= arg_0( tmp[ 32]);
t_protect( tmp[ 6]);
t_protect( tmp[ 10]);
t_protect( tmp[ 3]);
...
t_unprotect( arg0);
t_unprotect( arg1);
return ( * ef1)( lf_AUX_Rules2C_Aux13_1( make_list( null( ))) , lf_AUX_Rules2C_Aux13_1( make_list( null( ))));
}
}
}
if( check_sym( arg1 , lf_AUX_Rules2C_Aux13_1sym)) {
...
t_protect( arg0);
t_protect( tmp[ 8]);
tmp[ 9]= lf_AUX_Rules2C_Aux13_2( arg0 , lf_AUX_Rules2C_Aux13_1( make_list( tmp[ 8])));
if( check_sym( tmp[ 9] , ef1sym)) {
tmp[ 10]= arg_0( tmp[ 9]);
tmp[ 11]= arg_1( tmp[ 9]);
if( check_sym( tmp[ 10] , lf_AUX_Rules2C_Aux13_1sym)) {
tmp[ 12]= arg_0( tmp[ 10]);
if( check_sym( tmp[ 11] , lf_AUX_Rules2C_Aux13_1sym)) {
tmp[ 13]= arg_0( tmp[ 11]);
t_protect( tmp[ 12]);
t_protect( tmp[ 6]);
t_protect( tmp[ 7]);
...
t_unprotect( tmp[ 8]);
t_unprotect( tmp[ 9]);
return ( * ef1)( lf_AUX_Rules2C_Aux13_1( make_list( tmp[ 12])) , lf_AUX_Rules2C_Aux13_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 6])) , lf4( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 13]))));
}
}
}
t_unprotect( tmp[ 9]);
