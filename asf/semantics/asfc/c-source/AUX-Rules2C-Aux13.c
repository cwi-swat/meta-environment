...
lf_AUX_Rules2C_Aux13_2sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-same-list-pat\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FV-Path\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-same-list-pat\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FV-Path\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux13_2 , lf_AUX_Rules2C_Aux13_2sym);
...
tmp[ 11]= lf_AUX_Rules2C_Aux13_2( arg0 , lf_AUX_Rules2C_Aux13_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 11] , ef1sym)) {
tmp[ 12]= arg_0( tmp[ 11]);
tmp[ 13]= arg_1( tmp[ 11]);
if( check_sym( tmp[ 12] , lf_AUX_Rules2C_Aux13_1sym)) {
tmp[ 14]= arg_0( tmp[ 12]);
if( check_sym( tmp[ 13] , lf_AUX_Rules2C_Aux13_1sym)) {
tmp[ 15]= arg_0( tmp[ 13]);
return ( * ef1)( lf_AUX_Rules2C_Aux13_1( make_list( tmp[ 14])) , lf_AUX_Rules2C_Aux13_1( cons( make_list( ( * ef2)( lf3( cons( make_list( tmp[ 9]) , make_list( tmp[ 10]))) , lf4( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 15]))));
}
}
}
...
if( check_sym( tmp[ 13] , lf_AUX_Rules2C_Aux13_1sym)) {
tmp[ 15]= arg_0( tmp[ 13]);
return ( * ef1)( lf_AUX_Rules2C_Aux13_1( cons( make_list( ( * ef2)( lf3( cons( make_list( arg0) , make_list( tmp[ 10]))) , lf4( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 14]))) , lf_AUX_Rules2C_Aux13_1( make_list( tmp[ 15])));
}
}
}
}
...
return ( constant0? constant0: ( constant0= ( * ef1)( lf_AUX_Rules2C_Aux13_1( make_list( null( ))) , lf_AUX_Rules2C_Aux13_1( make_list( null( ))))));
}
}
}
