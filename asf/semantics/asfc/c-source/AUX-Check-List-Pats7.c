...
lf_AUX_Check_List_Pats7_1sym= TmkSymbol( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"is-list-elem-list-elem-list\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"is-list-elem-list-elem-list\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_Check_List_Pats7_1 , lf_AUX_Check_List_Pats7_1sym);
...
if( m_not_empty_list( tmp[ 34])) {
t_protect( tmp[ 34]);
if( term_equal( list_head( tmp[ 34]) , make_char( 110))) {
tmp[ 35]= m_list_tail( tmp[ 34]);
if( m_is_single_element( tmp[ 35])) {
t_protect( tmp[ 35]);
if( term_equal( list_head( tmp[ 35]) , make_char( 115))) {
if( m_not_empty_list( tmp[ 32])) {
tmp[ 36]= m_list_head( tmp[ 32]);
tmp[ 37]= m_list_tail( tmp[ 32]);
if( m_is_single_element( tmp[ 37])) {
tmp[ 38]= m_list_head( tmp[ 37]);
t_protect( tmp[ 3]);
if( term_equal( ( * ef4)( tmp[ 3]) , ( * ef3)( ))) {
t_protect( tmp[ 14]);
if( term_equal( ( * ef4)( tmp[ 14]) , ( * ef5)( ))) {
t_protect( tmp[ 25]);
if( term_equal( ( * ef4)( tmp[ 25]) , ( * ef3)( ))) {
t_protect( tmp[ 36]);
if( term_equal( ( * ef4)( tmp[ 36]) , ( * ef5)( ))) {
t_protect( tmp[ 38]);
if( term_equal( ( * ef4)( tmp[ 38]) , ( * ef3)( ))) {
t_unprotect( arg0);
t_unprotect( tmp[ 0]);
t_unprotect( tmp[ 1]);
t_unprotect( tmp[ 2]);
