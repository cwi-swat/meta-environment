#include "support.h"
static Symbol lf_AUX_MuASF_Signs12_1sym;
...
lf_AUX_MuASF_Signs12_1sym= ATmakeSymbol( "prod(id(\"MuASF-Signs\"),w(\"\"),[l(\"make-new-funcdef2\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_MuASF_Signs12_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
lf3sym= ATmakeSymbol( "listtype(sort(\"SigArg\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf3sym);
register_prod( ATparse( "prod(id(\"MuASF-Signs\"),w(\"\"),[l(\"make-new-funcdef2\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Signs12_1 , lf_AUX_MuASF_Signs12_1sym);
...
return ( * ef2)( arg1 , ( constant0? constant0: ( constant0= lf3( cons( make_list( ( * ef3)( )) , make_list( ( * ef3)( )))))));
}
...
return ( * ef2)( tmp[ 3] , lf3( cons( ( constant1? constant1: ( constant1= make_list( ( * ef3)( )))) , make_list( tmp[ 5]))));
}
}
}
}
