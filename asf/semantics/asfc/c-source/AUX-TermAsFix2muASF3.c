...
static Symbol lf_AUX_TermAsFix2muASF3_2_recursivesym ;
static ATerm lf_AUX_TermAsFix2muASF3_2_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_TermAsFix2muASF3_2_recursivesym = ATmakeSymbol ( "prod(id(\"TermAsFix2muASF\"),w(\"\"),[ql(\"make-c-list-cons\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"prefer\")],w(\"\"),l(\"}\")))"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFix2muASF3_2_recursivesym ) ;
lf_AUX_TermAsFix2muASF3_2sym = ATmakeSymbol ( "prod(id(\"TermAsFix2muASF\"),w(\"\"),[ql(\"make-c-list-cons\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"prefer\")],w(\"\"),l(\"}\")))" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"TermAsFix2muASF\"),w(\"\"),[ql(\"make-c-list-cons\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"prefer\")],w(\"\"),l(\"}\")))" ) , lf_AUX_TermAsFix2muASF3_2_recursive , lf_AUX_TermAsFix2muASF3_2_recursivesym ) ;
...
if ( check_sym ( arg0 , lf_AUX_TermAsFix2muASF3_1sym ) ) {
{
ATerm atmp00 = arg_0 ( arg0 ) ;
if ( check_sym ( arg1 , lf_AUX_TermAsFix2muASF3_1sym ) ) {
{
...
FUNC_EXIT ( lf_AUX_TermAsFix2muASF3_2_recursive ( make_list ( tmp [ 10 ] ) , lf_AUX_TermAsFix2muASF3_1 ( make_list ( ( * ef1 ) ( ( * ef2 ) ( lf3 ( ( ATerm ) ATmakeList ( 4 , char_table [ 99 ] , char_table [ 111 ] , char_table [ 110 ] , char_table [ 115 ] ) ) ) , lf_AUX_TermAsFix2muASF3_1 ( cons ( make_list ( tmp [ 12 ] ) , make_list ( tmp [ 1 ] ) ) ) ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_TermAsFix2muASF3_2sym , arg0 , arg1 ) ) ;
}
}
ATerm lf_AUX_TermAsFix2muASF3_2_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 13 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFix2muASF3_2_recursivesym , ATmakeAppl ( lf_AUX_TermAsFix2muASF3_2_recursivesym , arg0 , arg1 ) ) ;
{
ATerm ltmp [ 2 ] ;
lbl_lf_AUX_TermAsFix2muASF3_2_recursive : ltmp [ 0 ] = arg0 ;
( ltmp [ 1 ] = arg1 ) ;
{
ATerm atmp00 = arg0 ;
...
goto lbl_lf_AUX_TermAsFix2muASF3_2_recursive ;
}
}
}
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_TermAsFix2muASF3_2_recursivesym , lf_AUX_TermAsFix2muASF3_1 ( ltmp [ 0 ] ) , ltmp [ 1 ] ) ) ;
}
}
}
