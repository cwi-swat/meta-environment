...
static ATerm lf_AUX_MuASF2C5_1 ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_MuASF2C5_1sym = ATmakeSymbol ( "prod(id(\"MuASF2C\"),w(\"\"),[l(\"create-name-table\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"SignatureOpt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"NameTable\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF2C5_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"FuncDef\"),ql(\";\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF2C\"),w(\"\"),[l(\"create-name-table\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"SignatureOpt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"NameTable\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF2C5_1 , lf_AUX_MuASF2C5_1sym ) ;
...
ATerm lf_AUX_MuASF2C5_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 1 ] ;
FUNC_ENTRY ( lf_AUX_MuASF2C5_1sym , ATmakeAppl ( lf_AUX_MuASF2C5_1sym , arg0 , arg1 ) ) ;
...
FUNC_EXIT ( make_nf2 ( lf_AUX_MuASF2C5_1sym , arg0 , arg1 ) ) ;
}
}
