...
ef21 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[sort(\"FunId\"),w(\"\"),sort(\"Annotations\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)" ) ) ;
ef21sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[sort(\"FunId\"),w(\"\"),sort(\"Annotations\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)" ) ) ;
ef22 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[sort(\"FunId\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"SigArg\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)" ) ) ;
ef22sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[sort(\"FunId\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"SigArg\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)" ) ) ;
ef23 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[l(\"sigargs2cargs\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"SigArg\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Parameter-list\"),w(\"\"),no-attrs)" ) ) ;
ef23sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[l(\"sigargs2cargs\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"SigArg\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Parameter-list\"),w(\"\"),no-attrs)" ) ) ;
...
ef26 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[sort(\"FunId\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"SigArg\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\"),w(\"\"),sort(\"Annotations\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)" ) ) ;
ef26sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[sort(\"FunId\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"SigArg\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\"),w(\"\"),sort(\"Annotations\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)" ) ) ;
}
...
tmp [ 6 ] = ( * ef23 ) ( lf6 ( make_list ( tmp [ 5 ] ) ) , ( constant10 ? constant10 : ( constant10 = ( * ef24 ) ( ( * ef25 ) ( lf3 ( make_list ( make_char ( 48 ) ) ) ) ) ) ) ) ;
...
return ( * ef3 ) ( ( constant7 ? constant7 : ( constant7 = ( * ef4 ) ( lf4 ( make_list ( ( * ef5 ) ( ( * ef6 ) ( lf3 ( ( ATerm ) ATmakeList ( 5 , char_table [ 65 ] , char_table [ 84 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 109 ] ) ) ) ) ) ) ) ) ) , ( * ef7 ) ( ( * ef6 ) ( lf3 ( make_list ( tmp [ 4 ] ) ) ) , tmp [ 6 ] ) , ( * ef9 ) ( ( constant9 ? constant9 : ( constant9 = ( * ef10 ) ( ) ) ) , tmp [ 8 ] ) ) ;
}
}
}
}
}
if ( check_sym ( tmp [ 0 ] , ef26sym ) ) {
tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ;
tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ;
tmp [ 3 ] = arg_2 ( tmp [ 0 ] ) ;
if ( check_sym ( tmp [ 1 ] , ef2sym ) ) {
...
tmp [ 7 ] = ( * ef23 ) ( lf6 ( make_list ( tmp [ 6 ] ) ) , ( constant10 ? constant10 : ( constant10 = ( * ef24 ) ( ( * ef25 ) ( lf3 ( make_list ( make_char ( 48 ) ) ) ) ) ) ) ) ;
tmp [ 8 ] = ( * ef11 ) ( ( * ef2 ) ( lf3 ( make_list ( tmp [ 5 ] ) ) ) , lf6 ( make_list ( tmp [ 6 ] ) ) ) ;
tmp [ 9 ] = ( * ef12 ) ( ( * ef13 ) ( ( * ef14 ) ( ( * ef15 ) ( ( * ef16 ) ( ( * ef17 ) ( ( * ef18 ) ( ( constant1 ? constant1 : ( constant1 = ( * ef19 ) ( ( * ef6 ) ( lf3 ( cons ( make_list ( make_char ( 80 ) ) , cons ( make_list ( make_char ( 82 ) ) , cons ( make_list ( make_char ( 79 ) ) , make_list ( make_char ( 70 ) ) ) ) ) ) ) ) ) ) , ( * ef20 ) ( lf7 ( make_list ( ( * ef16 ) ( ( * ef17 ) ( ( * ef19 ) ( ( * ef6 ) ( lf3 ( cons ( ( constant2 ? constant2 : ( constant2 = make_list ( make_char ( 112 ) ) ) ) , cons ( ( constant3 ? constant3 : ( constant3 = make_list ( make_char ( 114 ) ) ) ) , cons ( ( constant4 ? constant4 : ( constant4 = make_list ( make_char ( 111 ) ) ) ) , cons ( ( constant5 ? constant5 : ( constant5 = make_list ( make_char ( 102 ) ) ) ) , cons ( ( constant6 ? constant6 : ( constant6 = make_list ( make_char ( 95 ) ) ) ) , make_list ( tmp [ 5 ] ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) , tmp [ 8 ] ) ;
return ( * ef3 ) ( ( constant7 ? constant7 : ( constant7 = ( * ef4 ) ( lf4 ( make_list ( ( * ef5 ) ( ( * ef6 ) ( lf3 ( ( ATerm ) ATmakeList ( 5 , char_table [ 65 ] , char_table [ 84 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 109 ] ) ) ) ) ) ) ) ) ) , ( * ef7 ) ( ( * ef6 ) ( lf3 ( make_list ( tmp [ 5 ] ) ) ) , tmp [ 7 ] ) , ( * ef9 ) ( ( constant9 ? constant9 : ( constant9 = ( * ef10 ) ( ) ) ) , tmp [ 9 ] ) ) ;
}
}
}
}
...
return ( * ef3 ) ( ( constant7 ? constant7 : ( constant7 = ( * ef4 ) ( lf4 ( make_list ( ( * ef5 ) ( ( * ef6 ) ( lf3 ( ( ATerm ) ATmakeList ( 5 , char_table [ 65 ] , char_table [ 84 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 109 ] ) ) ) ) ) ) ) ) ) , ( * ef7 ) ( ( * ef6 ) ( lf3 ( make_list ( tmp [ 3 ] ) ) ) , ( constant8 ? constant8 : ( constant8 = ( * ef8 ) ( lf5 ( make_list ( null ( ) ) ) ) ) ) ) , ( * ef9 ) ( ( constant9 ? constant9 : ( constant9 = ( * ef10 ) ( ) ) ) , tmp [ 5 ] ) ) ;
}
}
}
}
...
return make_nf1 ( lf_AUX_MuASF2C5_2sym , arg0 ) ;
}
}
...
PROF ( prof_lf_AUX_MuASF2C5_1 ) ;
return make_nf1 ( lf_AUX_MuASF2C5_1sym , arg0 ) ;
}
