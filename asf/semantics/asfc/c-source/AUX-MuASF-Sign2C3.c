...
FUNC_EXIT ( make_nf1 ( ef3sym , lf4 ( make_list ( ( * ef4 ) ( make_nf1 ( ef5sym , lf5 ( make_list ( ( * ef6 ) ( ( * ef7 ) ( lf3 ( ( ATerm ) ATmakeList ( 5 , char_table [ 65 ] , char_table [ 84 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 109 ] ) ) ) ) ) ) ) , ( * ef8 ) ( ( * ef7 ) ( lf3 ( cons ( make_list_char ( 97 ) , cons ( make_list_char ( 114 ) , cons ( make_list_char ( 103 ) , make_list ( atmp1000 ) ) ) ) ) ) ) ) ) ) ) ) ;
}
}
}
}
...
( tmp [ 2 ] = lf_AUX_MuASF_Sign2C3_2_recursive ( make_list ( tmp [ 1 ] ) , ( * ef10 ) ( arg1 ) ) ) ;
if ( check_sym ( arg1 , ef1sym ) ) {
( tmp [ 3 ] = arg_0 ( arg1 ) ) ;
...
( tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ) ;
FUNC_EXIT ( ( * ef9 ) ( ( * ef4 ) ( make_nf1 ( ef5sym , lf5 ( make_list ( ( * ef6 ) ( ( * ef7 ) ( lf3 ( ( ATerm ) ATmakeList ( 5 , char_table [ 65 ] , char_table [ 84 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 109 ] ) ) ) ) ) ) ) , ( * ef8 ) ( ( * ef7 ) ( lf3 ( cons ( make_list_char ( 97 ) , cons ( make_list_char ( 114 ) , cons ( make_list_char ( 103 ) , make_list ( tmp [ 5 ] ) ) ) ) ) ) ) ) , tmp [ 2 ] ) ) ;
}
}
}
}
