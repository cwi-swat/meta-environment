#include  "support.h"
static Symbol lf_AUX_TermAsFixAccess34_1sym ;
static ATerm lf_AUX_TermAsFixAccess34_1 ( ATerm arg1 ) ;
...
static funcptr ef16 ;
void register_AUX_TermAsFixAccess34 ( ) {
lf_AUX_TermAsFixAccess34_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-associativity-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess34_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-associativity-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess34_1 , lf_AUX_TermAsFixAccess34_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess34 ( ) {
...
void init_AUX_TermAsFixAccess34 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess34_1 ( ATerm arg0 ) {
{
ATerm tmp [ 51 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess34_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess34_1sym , arg0 ) ) ;
...
if ( term_equal ( list_head ( tmp [ 0 ] ) , make_char ( 80 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 21 ] ) , make_char ( 65 ) ) ) {
tmp [ 22 ] = list_tail ( tmp [ 21 ] ) ;
if ( not_empty_list ( tmp [ 22 ] ) ) {
if ( term_equal ( list_head ( tmp [ 22 ] ) , make_char ( 115 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 25 ] ) , make_char ( 99 ) ) ) {
tmp [ 26 ] = list_tail ( tmp [ 25 ] ) ;
if ( not_empty_list ( tmp [ 26 ] ) ) {
if ( term_equal ( list_head ( tmp [ 26 ] ) , make_char ( 105 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 30 ] ) , make_char ( 118 ) ) ) {
...
tmp [ 35 ] = list_tail ( atmp011110100000 ) ;
...
tmp [ 36 ] = list_tail ( atmp0111110100000 ) ;
if ( not_empty_list ( tmp [ 36 ] ) ) {
if ( term_equal ( list_head ( tmp [ 36 ] ) , make_char ( 45 ) ) ) {
tmp [ 37 ] = list_tail ( tmp [ 36 ] ) ;
if ( not_empty_list ( tmp [ 37 ] ) ) {
if ( term_equal ( list_head ( tmp [ 37 ] ) , make_char ( 62 ) ) ) {
...
tmp [ 39 ] = list_tail ( atmp01111110100000 ) ;
...
tmp [ 40 ] = list_tail ( atmp011111110100000 ) ;
...
tmp [ 50 ] = list_tail ( atmp0111111110100000 ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess34_1sym , arg0 ) ) ;
}
}
