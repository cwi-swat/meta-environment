...
lf_AUX_Check_List_Pats3_1sym= TmkSymbol( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"rule-contains-list-vars\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Rule\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"rule-contains-list-vars\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Rule\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_Check_List_Pats3_1 , lf_AUX_Check_List_Pats3_1sym);
...
t_protect( atmp02);
t_unprotect( arg0);
return ( * ef2)( ( * ef2)( ( * ef6)( lf2( make_list( atmp0000))) , ( * ef3)( atmp01)) , ( * ef3)( atmp02));
}
}
}
}
