#include "support.h"
static asymbol * lf_AUX_Check_List_Pats3_2sym;
static aterm * lf_AUX_Check_List_Pats3_2( aterm * arg1);
...
lf_AUX_Check_List_Pats3_2sym= TmkSymbol( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"conds-contains-list-vars\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Cond\"),w(\"\"),ql(\"&\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf_AUX_Check_List_Pats3_1sym= TmkSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"Cond\"),ql(\"&\"))") , lf_AUX_Check_List_Pats3_1 , lf_AUX_Check_List_Pats3_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"conds-contains-list-vars\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Cond\"),w(\"\"),ql(\"&\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_Check_List_Pats3_2 , lf_AUX_Check_List_Pats3_2sym);
}
...
aterm * lf_AUX_Check_List_Pats3_2( aterm * arg0) {
{
aterm * tmp[2];
PROF( prof_lf_AUX_Check_List_Pats3_2);
if( check_sym( arg0 , lf_AUX_Check_List_Pats3_1sym)) {
{
...
t_unprotect( arg0);
return ( * ef2)( ( * ef3)( tmp[ 0]) , lf_AUX_Check_List_Pats3_2( lf_AUX_Check_List_Pats3_1( make_list( tmp[ 1]))));
}
else {
t_unprotect( arg0);
return ( * ef1)( );
...
return make_nf1( lf_AUX_Check_List_Pats3_2sym , arg0);
}
}
