#include "support.h"
static Symbol lf_AUX_Rules2C_Aux15_2sym;
...
static funcptr ef1;
static Symbol lf_AUX_Rules2C_Aux15_1sym;
static ATerm lf_AUX_Rules2C_Aux15_1( ATerm arg1);
void register_AUX_Rules2C_Aux15( ) {
lf_AUX_Rules2C_Aux15_2sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-same-rhs-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Rules2C_Aux15_2sym);
lf3sym= ATmakeSymbol( "listtype(sort(\"FV-Path\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf3sym);
lf4sym= ATmakeSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , 1 , ATtrue);
ATprotectSymbol( lf4sym);
lf_AUX_Rules2C_Aux15_1sym= ATmakeSymbol( "listtype(sort(\"C-Rule\"),ql(\";\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Rules2C_Aux15_1sym);
register_prod( ATparse( "listtype(sort(\"C-Rule\"),ql(\";\"))") , lf_AUX_Rules2C_Aux15_1 , lf_AUX_Rules2C_Aux15_1sym);
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-same-rhs-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux15_2 , lf_AUX_Rules2C_Aux15_2sym);
...
if( ! term_equal( tmp[ 5] , tmp[ 16])) {
tmp[ 17]= lf_AUX_Rules2C_Aux15_2( ( * ef2)( lf3( make_list( atmp000)) , lf4( cons( make_list( ( * ef3)( tmp[ 4] , tmp[ 5])) , make_list( tmp[ 1]))) , atmp02 , atmp03 , atmp04) , lf_AUX_Rules2C_Aux15_1( make_list( tmp[ 3])));
if( check_sym( tmp[ 17] , ef1sym)) {
tmp[ 18]= arg_0( tmp[ 17]);
tmp[ 19]= arg_1( tmp[ 17]);
if( check_sym( tmp[ 18] , lf_AUX_Rules2C_Aux15_1sym)) {
tmp[ 20]= arg_0( tmp[ 18]);
if( check_sym( tmp[ 19] , lf_AUX_Rules2C_Aux15_1sym)) {
tmp[ 21]= arg_0( tmp[ 19]);
return ( * ef1)( lf_AUX_Rules2C_Aux15_1( make_list( tmp[ 20])) , lf_AUX_Rules2C_Aux15_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 11])) , lf4( cons( make_list( ( * ef3)( tmp[ 4] , tmp[ 16])) , make_list( tmp[ 14]))) , tmp[ 8] , tmp[ 9] , tmp[ 10])) , make_list( tmp[ 21]))));
}
}
}
}
...
if( term_equal( tmp[ 12] , tmp[ 23])) {
tmp[ 24]= lf_AUX_Rules2C_Aux15_2( arg0 , lf_AUX_Rules2C_Aux15_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 24] , ef1sym)) {
tmp[ 25]= arg_0( tmp[ 24]);
tmp[ 26]= arg_1( tmp[ 24]);
if( check_sym( tmp[ 25] , lf_AUX_Rules2C_Aux15_1sym)) {
tmp[ 27]= arg_0( tmp[ 25]);
if( check_sym( tmp[ 26] , lf_AUX_Rules2C_Aux15_1sym)) {
tmp[ 28]= arg_0( tmp[ 26]);
return ( * ef1)( lf_AUX_Rules2C_Aux15_1( cons( make_list( tmp[ 0]) , make_list( tmp[ 27]))) , lf_AUX_Rules2C_Aux15_1( make_list( tmp[ 28])));
}
}
}
}
...
tmp[ 2]= lf_AUX_Rules2C_Aux15_2( arg0 , lf_AUX_Rules2C_Aux15_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 2] , ef1sym)) {
tmp[ 3]= arg_0( tmp[ 2]);
tmp[ 4]= arg_1( tmp[ 2]);
if( check_sym( tmp[ 3] , lf_AUX_Rules2C_Aux15_1sym)) {
tmp[ 5]= arg_0( tmp[ 3]);
if( check_sym( tmp[ 4] , lf_AUX_Rules2C_Aux15_1sym)) {
tmp[ 6]= arg_0( tmp[ 4]);
return ( * ef1)( lf_AUX_Rules2C_Aux15_1( make_list( tmp[ 5])) , lf_AUX_Rules2C_Aux15_1( make_list( tmp[ 6])));
}
}
}
}
...
return ( * ef1)( lf_AUX_Rules2C_Aux15_1( make_list( arg0)) , ( constant0? constant0: ( constant0= lf_AUX_Rules2C_Aux15_1( make_list( null( ))))));
}
}
}
