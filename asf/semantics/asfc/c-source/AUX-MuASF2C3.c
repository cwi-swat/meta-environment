...
static Symbol lf_AUX_MuASF2C3_2_recursivesym ;
static ATerm lf_AUX_MuASF2C3_2_recursive ( ATerm arg1 ) ;
...
lf_AUX_MuASF2C3_2_recursivesym = ATmakeSymbol ( "prod(id(\"MuASF2C\"),w(\"\"),[ql(\"funcdefs2cfuncs\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF2C3_2_recursivesym ) ;
lf_AUX_MuASF2C3_2sym = ATmakeSymbol ( "prod(id(\"MuASF2C\"),w(\"\"),[ql(\"funcdefs2cfuncs\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"MuASF2C\"),w(\"\"),[ql(\"funcdefs2cfuncs\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF2C3_2 , lf_AUX_MuASF2C3_2sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF2C\"),w(\"\"),[ql(\"funcdefs2cfuncs\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF2C3_2_recursive , lf_AUX_MuASF2C3_2_recursivesym ) ;
...
ATerm lf_AUX_MuASF2C3_2_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 4 ] ;
