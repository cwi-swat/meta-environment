...
static Symbol lf_AUX_MuASF_Equations_Ops19_1sym ;
static ATerm lf_AUX_MuASF_Equations_Ops19_1 ( ATerm arg1 ) ;
static Symbol ef1sym ;
static funcptr ef1 ;
static Symbol lf2sym ;
static ATerm lf2 ( ATerm arg1 ) ;
void register_AUX_MuASF_Equations_Ops19 ( ) {
lf_AUX_MuASF_Equations_Ops19_1sym = ATmakeSymbol ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[l(\"remove-trans-from-list-id\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Equations_Ops19_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[l(\"remove-trans-from-list-id\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Equations_Ops19_1 , lf_AUX_MuASF_Equations_Ops19_1sym ) ;
...
void init_AUX_MuASF_Equations_Ops19 ( ) {
}
ATerm lf_AUX_MuASF_Equations_Ops19_1 ( ATerm arg0 ) {
{
ATerm tmp [ 13 ] ;
FUNC_ENTRY ( lf_AUX_MuASF_Equations_Ops19_1sym , ATmakeAppl ( lf_AUX_MuASF_Equations_Ops19_1sym , arg0 ) ) ;
...
FUNC_EXIT ( ( * ef1 ) ( lf2 ( cons ( make_list_char ( 34 ) , cons ( make_list_char ( 123 ) , cons ( make_list ( tmp [ 12 ] ) , ( ATerm ) ATmakeList ( 2 , char_table [ 125 ] , char_table [ 34 ] ) ) ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf1 ( lf_AUX_MuASF_Equations_Ops19_1sym , arg0 ) ) ;
}
}
