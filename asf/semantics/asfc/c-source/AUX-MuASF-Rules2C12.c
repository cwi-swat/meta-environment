...
static aterm * lf_AUX_MuASF_Rules2C12_1( aterm * arg1 , aterm * arg2);
...
lf_AUX_MuASF_Rules2C12_1sym= TmkSymbol( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"funargs2cbuild\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"EI-pair\"),ql(\",\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Expression\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"funargs2cbuild\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Rules2C12_1 , lf_AUX_MuASF_Rules2C12_1sym);
...
aterm * lf_AUX_MuASF_Rules2C12_1( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[9];
...
t_protect( tmp[ 1]);
t_protect( arg1);
tmp[ 4]= lf_AUX_MuASF_Rules2C12_1( ( * ef1)( lf2( make_list( tmp[ 1]))) , ( * ef6)( arg1));
...
t_protect( tmp[ 2]);
t_protect( tmp[ 5]);
tmp[ 8]= ( * ef7)( ( * ef4)( lf3( make_list( tmp[ 2]))) , tmp[ 5]);
t_protect( tmp[ 7]);
t_unprotect( arg0);
t_unprotect( arg1);
t_unprotect( tmp[ 0]);
...
return make_nf2( lf_AUX_MuASF_Rules2C12_1sym , arg0 , arg1);
}
}
