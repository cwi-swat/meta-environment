...
tmp[ 12]= arg_0( tmp[ 11]);
tmp[ 13]= ( * ef6)( tmp[ 10]);
if( term_equal( tmp[ 13] , ( constant0? constant0: ( constant0= ( * ef10)( ))))) {
tmp[ 14]= ( * ef11)( lf6( make_list( tmp[ 12])));
...
tmp[ 17]= arg_0( tmp[ 16]);
tmp[ 18]= ( * ef2)( lf_AUX_MuASF_Rules2C12_1( cons( make_list( ( * ef1)( ( constant1? constant1: ( constant1= lf4( make_list( null( ))))) , lf5( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 17]))) , lf_AUX_MuASF_Rules2C12_2( make_list( atmp10)) , arg2);
if( check_sym( tmp[ 18] , ef8sym)) {
tmp[ 19]= arg_0( tmp[ 18]);
tmp[ 20]= arg_1( tmp[ 18]);
return ( * ef8)( ( * ef9)( tmp[ 14] , tmp[ 19]) , tmp[ 20]);
}
}
}
}
if( term_equal( tmp[ 13] , ( constant2? constant2: ( constant2= ( * ef7)( ))))) {
tmp[ 14]= ( * ef3)( lf_AUX_MuASF_Rules2C12_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 14] , ef4sym)) {
tmp[ 15]= arg_0( tmp[ 14]);
if( check_sym( tmp[ 15] , lf_AUX_MuASF_Rules2C12_1sym)) {
tmp[ 16]= arg_0( tmp[ 15]);
return ( * ef2)( lf_AUX_MuASF_Rules2C12_1( cons( make_list( ( * ef1)( ( constant1? constant1: ( constant1= lf4( make_list( null( ))))) , lf5( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 16]))) , lf_AUX_MuASF_Rules2C12_2( make_list( atmp10)) , arg2);
}
}
}
}
...
tmp[ 11]= arg_0( tmp[ 10]);
return ( * ef2)( lf_AUX_MuASF_Rules2C12_1( cons( make_list( ( * ef1)( ( constant1? constant1: ( constant1= lf4( make_list( null( ))))) , lf5( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 11]))) , lf_AUX_MuASF_Rules2C12_2( make_list( atmp10)) , arg2);
}
}
}
}
...
tmp[ 9]= arg_0( tmp[ 7]);
return ( * ef12)( lf_AUX_MuASF_Rules2C12_1( make_list( tmp[ 8])) , lf_AUX_MuASF_Rules2C12_1( make_list( tmp[ 9])) , lf_AUX_MuASF_Rules2C12_2( make_list( atmp10)) , arg2);
}
}
}
}
