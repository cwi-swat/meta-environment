...
lf_AUX_C1_2sym= ATmakeSymbol( "prod(id(\"caller\"),w(\"\"),[l(\"cfilename\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CFilename\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
...
lf_AUX_C1_4sym= ATmakeSymbol( "prod(id(\"caller\"),w(\"\"),[l(\"cdir\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CDir\"),w(\"\"),no-attrs)" , 1 , ATtrue);
...
register_prod( ATparse( "prod(id(\"caller\"),w(\"\"),[l(\"cfilename\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CFilename\"),w(\"\"),no-attrs)") , lf_AUX_C1_2 , lf_AUX_C1_2sym);
...
register_prod( ATparse( "prod(id(\"caller\"),w(\"\"),[l(\"cdir\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CDir\"),w(\"\"),no-attrs)") , lf_AUX_C1_4 , lf_AUX_C1_4sym);
