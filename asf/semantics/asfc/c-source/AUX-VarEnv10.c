...
return ( * ef3)( lf2( cons( ( constant0? constant0: ( constant0= make_list_char( 86))) , cons( ( constant1? constant1: ( constant1= make_list_char( 108))) , cons( ( constant2? constant2: ( constant2= make_list_char( 105))) , cons( ( constant3? constant3: ( constant3= make_list_char( 115))) , cons( ( constant4? constant4: ( constant4= make_list_char( 116))) , make_list( atmp0000))))))));
}
}
}
}
