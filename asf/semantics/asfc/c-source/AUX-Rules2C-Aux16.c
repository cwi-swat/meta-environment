...
static aterm * lf_AUX_Rules2C_Aux16_2( aterm * arg1);
...
lf_AUX_Rules2C_Aux16_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-first-cond\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-first-cond\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux16_2 , lf_AUX_Rules2C_Aux16_2sym);
...
aterm * lf_AUX_Rules2C_Aux16_2( aterm * arg0) {
{
aterm * tmp[14];
PROF( prof_lf_AUX_Rules2C_Aux16_2);
if( check_sym( arg0 , lf_AUX_Rules2C_Aux16_1sym)) {
{
...
t_protect( tmp[ 10]);
tmp[ 11]= lf_AUX_Rules2C_Aux16_2( lf_AUX_Rules2C_Aux16_1( make_list( tmp[ 10])));
if( check_sym( tmp[ 11] , ef1sym)) {
tmp[ 12]= arg_0( tmp[ 11]);
if( check_sym( tmp[ 12] , lf_AUX_Rules2C_Aux16_1sym)) {
tmp[ 13]= arg_0( tmp[ 12]);
t_protect( tmp[ 6]);
t_protect( tmp[ 3]);
t_protect( tmp[ 4]);
...
t_unprotect( tmp[ 10]);
t_unprotect( tmp[ 11]);
return ( * ef1)( lf_AUX_Rules2C_Aux16_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 6])) , lf4( make_list( tmp[ 9])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 13]))));
}
}
t_unprotect( tmp[ 11]);
t_unprotect( tmp[ 10]);
...
return make_nf1( lf_AUX_Rules2C_Aux16_2sym , arg0);
}
}
