#include "support.h"
static asymbol * lf_AUX_Rules2C_Aux16_2sym;
static aterm * lf_AUX_Rules2C_Aux16_2( aterm * arg1 , aterm * arg2 , aterm * arg3);
...
static funcptr ef1;
static asymbol * lf_AUX_Rules2C_Aux16_1sym;
static aterm * lf_AUX_Rules2C_Aux16_1( aterm * arg1);
void register_AUX_Rules2C_Aux16( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_Rules2C_Aux16_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"replace-second-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
lf_AUX_Rules2C_Aux16_1sym= TmkSymbol( "listtype(sort(\"C-Rule\"),ql(\";\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"C-Rule\"),ql(\";\"))") , lf_AUX_Rules2C_Aux16_1 , lf_AUX_Rules2C_Aux16_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"replace-second-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux16_2 , lf_AUX_Rules2C_Aux16_2sym);
...
aterm * lf_AUX_Rules2C_Aux16_2( aterm * arg0 , aterm * arg1 , aterm * arg2) {
{
aterm * tmp[33];
PROF( prof_lf_AUX_Rules2C_Aux16_2);
if( check_sym( arg2 , lf_AUX_Rules2C_Aux16_1sym)) {
{
...
t_protect( arg1);
t_protect( tmp[ 29]);
tmp[ 30]= lf_AUX_Rules2C_Aux16_2( arg0 , arg1 , lf_AUX_Rules2C_Aux16_1( make_list( tmp[ 29])));
...
t_unprotect( tmp[ 29]);
t_unprotect( tmp[ 30]);
return ( * ef1)( lf_AUX_Rules2C_Aux16_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 6])) , lf4( cons( make_list( ( * ef3)( ( * ef4)( ( * ef5)( lf5( cons( make_list( make_char( 116)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 113)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 97)) , make_list( make_char( 108))))))))))))) , lf6( cons( make_list( tmp[ 25]) , make_list( arg0)))) , tmp[ 10])) , make_list( tmp[ 28]))) , tmp[ 3] , ( * ef6)( tmp[ 4] , arg1) , ( * ef6)( tmp[ 5] , arg1))) , make_list( tmp[ 32]))));
}
}
t_unprotect( tmp[ 30]);
t_unprotect( tmp[ 29]);
...
t_unprotect( arg1);
t_unprotect( arg2);
return ( * ef1)( lf_AUX_Rules2C_Aux16_1( make_list( null( ))));
}
}
}
return make_nf3( lf_AUX_Rules2C_Aux16_2sym , arg0 , arg1 , arg2);
}
}
