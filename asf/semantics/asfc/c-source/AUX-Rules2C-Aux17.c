...
lf_AUX_Rules2C_Aux17_2sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-conds-on-second-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-conds-on-second-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux17_2 , lf_AUX_Rules2C_Aux17_2sym);
...
tmp[ 30]= lf_AUX_Rules2C_Aux17_2( arg0 , lf_AUX_Rules2C_Aux17_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 30] , ef1sym)) {
tmp[ 31]= arg_0( tmp[ 30]);
tmp[ 32]= arg_1( tmp[ 30]);
if( check_sym( tmp[ 31] , lf_AUX_Rules2C_Aux17_1sym)) {
tmp[ 33]= arg_0( tmp[ 31]);
if( check_sym( tmp[ 32] , lf_AUX_Rules2C_Aux17_1sym)) {
tmp[ 34]= arg_0( tmp[ 32]);
return ( * ef1)( lf_AUX_Rules2C_Aux17_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 7])) , lf4( cons( make_list( ( * ef3)( ( * ef4)( ( constant0? constant0: ( constant0= ( * ef5)( lf5( (ATerm) ATmakeList( 10 , char_table[ 116] , char_table[ 101] , char_table[ 114] , char_table[ 109] , char_table[ 45] , char_table[ 101] , char_table[ 113] , char_table[ 117] , char_table[ 97] , char_table[ 108]))))) , lf6( cons( make_list( tmp[ 27]) , make_list( arg0)))) , tmp[ 12])) , make_list( tmp[ 10]))) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 33]))) , lf_AUX_Rules2C_Aux17_1( make_list( tmp[ 34])));
}
}
}
}
...
return ( constant1? constant1: ( constant1= ( * ef1)( lf_AUX_Rules2C_Aux17_1( make_list( null( ))) , lf_AUX_Rules2C_Aux17_1( make_list( null( ))))));
}
}
}
if( check_sym( arg1 , lf_AUX_Rules2C_Aux17_1sym)) {
...
if( check_sym( tmp[ 3] , lf4sym)) {
tmp[ 8]= arg_0( tmp[ 3]);
tmp[ 9]= lf_AUX_Rules2C_Aux17_2( arg0 , lf_AUX_Rules2C_Aux17_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 9] , ef1sym)) {
tmp[ 10]= arg_0( tmp[ 9]);
tmp[ 11]= arg_1( tmp[ 9]);
if( check_sym( tmp[ 10] , lf_AUX_Rules2C_Aux17_1sym)) {
tmp[ 12]= arg_0( tmp[ 10]);
if( check_sym( tmp[ 11] , lf_AUX_Rules2C_Aux17_1sym)) {
tmp[ 13]= arg_0( tmp[ 11]);
return ( * ef1)( lf_AUX_Rules2C_Aux17_1( make_list( tmp[ 12])) , lf_AUX_Rules2C_Aux17_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 7])) , lf4( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 13]))));
}
}
}
}
