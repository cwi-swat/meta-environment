...
static ATerm lf_AUX_Rules2C_Aux17_2( ATerm arg1 , ATerm arg2 , ATerm arg3);
...
lf_AUX_Rules2C_Aux17_2sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"replace-first-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , 3 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"replace-first-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux17_2 , lf_AUX_Rules2C_Aux17_2sym);
...
ATerm lf_AUX_Rules2C_Aux17_2( ATerm arg0 , ATerm arg1 , ATerm arg2) {
{
ATerm tmp[33];
PROF( prof_lf_AUX_Rules2C_Aux17_2);
if( check_sym( arg2 , lf_AUX_Rules2C_Aux17_1sym)) {
{
...
tmp[ 30]= lf_AUX_Rules2C_Aux17_2( arg0 , arg1 , lf_AUX_Rules2C_Aux17_1( make_list( tmp[ 1])));
...
return ( constant1? constant1: ( constant1= ( * ef1)( lf_AUX_Rules2C_Aux17_1( make_list( null( ))))));
}
}
}
return make_nf3( lf_AUX_Rules2C_Aux17_2sym , arg0 , arg1 , arg2);
}
}
