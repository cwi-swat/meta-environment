...
static aterm * lf_AUX_Rules2C_Aux17_2( aterm * arg1);
...
lf_AUX_Rules2C_Aux17_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux17_2 , lf_AUX_Rules2C_Aux17_2sym);
...
aterm * lf_AUX_Rules2C_Aux17_2( aterm * arg0) {
{
aterm * tmp[21];
...
t_protect( tmp[ 13]);
tmp[ 14]= lf_AUX_Rules2C_Aux17_2( lf_AUX_Rules2C_Aux17_1( make_list( tmp[ 13])));
if( check_sym( tmp[ 14] , ef1sym)) {
tmp[ 15]= arg_0( tmp[ 14]);
if( check_sym( tmp[ 15] , lf_AUX_Rules2C_Aux17_1sym)) {
tmp[ 16]= arg_0( tmp[ 15]);
t_protect( tmp[ 7]);
t_protect( tmp[ 3]);
t_protect( tmp[ 4]);
...
t_unprotect( tmp[ 13]);
t_unprotect( tmp[ 14]);
return ( * ef1)( lf_AUX_Rules2C_Aux17_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 12])) , lf5( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 16]))));
}
}
t_unprotect( tmp[ 14]);
t_unprotect( tmp[ 13]);
...
t_protect( tmp[ 17]);
tmp[ 18]= lf_AUX_Rules2C_Aux17_2( lf_AUX_Rules2C_Aux17_1( make_list( tmp[ 17])));
...
t_unprotect( tmp[ 17]);
t_unprotect( tmp[ 18]);
return ( * ef1)( lf_AUX_Rules2C_Aux17_1( cons( make_list( ( * ef2)( lf3( cons( make_list( tmp[ 15]) , make_list( tmp[ 16]))) , lf5( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 20]))));
}
}
t_unprotect( tmp[ 18]);
t_unprotect( tmp[ 17]);
...
return make_nf1( lf_AUX_Rules2C_Aux17_2sym , arg0);
}
}
