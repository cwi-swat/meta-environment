...
static Symbol lf_AUX_Rules2C_Aux17_2_recursivesym ;
static ATerm lf_AUX_Rules2C_Aux17_2_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Rules2C_Aux17_2_recursivesym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-same-rhs-cond\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Rules2C_Aux17_2_recursivesym ) ;
lf_AUX_Rules2C_Aux17_2sym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-same-rhs-cond\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-same-rhs-cond\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux17_2 , lf_AUX_Rules2C_Aux17_2sym ) ;
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-same-rhs-cond\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux17_2_recursive , lf_AUX_Rules2C_Aux17_2_recursivesym ) ;
...
( tmp [ 18 ] = lf_AUX_Rules2C_Aux17_2 ( ( * ef1 ) ( lf3 ( make_list ( atmp000 ) ) , lf4 ( cons ( make_list ( ( * ef2 ) ( tmp [ 4 ] , tmp [ 5 ] ) ) , make_list ( tmp [ 1 ] ) ) ) , atmp02 , atmp03 , atmp04 , atmp05 ) , lf_AUX_Rules2C_Aux17_1 ( make_list ( tmp [ 3 ] ) ) ) ) ;
...
( tmp [ 22 ] = arg_0 ( tmp [ 20 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Rules2C_Aux17_1 ( make_list ( tmp [ 21 ] ) ) , lf_AUX_Rules2C_Aux17_1 ( cons ( make_list ( ( * ef1 ) ( lf3 ( make_list ( tmp [ 12 ] ) ) , lf4 ( cons ( make_list ( ( * ef2 ) ( tmp [ 4 ] , tmp [ 17 ] ) ) , make_list ( tmp [ 15 ] ) ) ) , tmp [ 8 ] , tmp [ 9 ] , tmp [ 10 ] , tmp [ 11 ] ) ) , make_list ( tmp [ 22 ] ) ) ) ) ) ;
}
}
}
}
...
( tmp [ 30 ] = arg_0 ( tmp [ 28 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Rules2C_Aux17_1 ( cons ( make_list ( tmp [ 0 ] ) , make_list ( tmp [ 29 ] ) ) ) , lf_AUX_Rules2C_Aux17_1 ( make_list ( tmp [ 30 ] ) ) ) ) ;
}
}
}
}
...
( tmp [ 6 ] = arg_0 ( tmp [ 4 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Rules2C_Aux17_1 ( make_list ( tmp [ 5 ] ) ) , lf_AUX_Rules2C_Aux17_1 ( make_list ( tmp [ 6 ] ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Rules2C_Aux17_1 ( make_list ( arg0 ) ) , lf_AUX_Rules2C_Aux17_1 ( make_list ( null ( ) ) ) ) ) ;
}
}
}
...
ATerm lf_AUX_Rules2C_Aux17_2_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 31 ] ;
FUNC_ENTRY ( lf_AUX_Rules2C_Aux17_2_recursivesym , ATmakeAppl ( lf_AUX_Rules2C_Aux17_2_recursivesym , arg0 , arg1 ) ) ;
if ( check_sym ( arg0 , ef1sym ) ) {
{
ATerm atmp00 = arg_0 ( arg0 ) ;
if ( check_sym ( atmp00 , lf3sym ) ) {
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Rules2C_Aux17_2_recursivesym , arg0 , lf_AUX_Rules2C_Aux17_1 ( arg1 ) ) ) ;
}
}
