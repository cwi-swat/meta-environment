#include "support.h"
static Symbol lf_AUX_ATermLists2_1sym;
static ATerm lf_AUX_ATermLists2_1( ATerm arg1 , ATerm arg2);
static Symbol ef1sym;
static funcptr ef1;
static Symbol ef2sym;
static funcptr ef2;
void register_AUX_ATermLists2( ) {
lf_AUX_ATermLists2_1sym= ATmakeSymbol( "prod(id(\"ATermLists\"),w(\"\"),[sort(\"ATerm\"),w(\"\"),ql(\"==\"),w(\"\"),sort(\"ATerm\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_ATermLists2_1sym);
register_prod( ATparse( "prod(id(\"ATermLists\"),w(\"\"),[sort(\"ATerm\"),w(\"\"),ql(\"==\"),w(\"\"),sort(\"ATerm\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_ATermLists2_1 , lf_AUX_ATermLists2_1sym);
}
...
void init_AUX_ATermLists2( ) {
ATprotect( & constant0);
ATprotect( & constant1);
}
ATerm lf_AUX_ATermLists2_1( ATerm arg0 , ATerm arg1) {
