...
ef15 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[l(\"is-list-funid\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
ef15sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[l(\"is-list-funid\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
...
( tmp [ 19 ] = ( * ef18 ) ( lf7 ( make_list ( tmp [ 16 ] ) ) , ltmp [ 4 ] , ltmp [ 3 ] , ( * ef19 ) ( ( * ef20 ) ( lf8 ( make_list ( make_char ( 48 ) ) ) ) ) ) ) ;
...
if ( term_equal ( tmp [ 17 ] , ( constant1 ? constant1 : ( constant1 = ( * ef5 ) ( ) ) ) ) ) {
...
if ( term_equal ( ( * ef4 ) ( tmp [ 13 ] ) , ( constant1 ? constant1 : ( constant1 = ( * ef5 ) ( ) ) ) ) ) {
