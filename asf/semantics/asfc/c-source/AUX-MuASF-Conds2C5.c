...
lf_AUX_MuASF_Conds2C5_3sym= TmkSymbol( "prod(id(\"MuASF-Conds2C\"),w(\"\"),[l(\"listconds2cstats\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SlI-tuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
t_protect( arg4);
t_protect( atmp20);
tmp[ 16]= ( * ef5)( tmp[ 11] , arg4 , lf_AUX_MuASF_Conds2C5_2( make_list( atmp20)));
t_protect( arg3);
tmp[ 17]= ( * ef6)( ( * ef7)( arg3));
t_protect( tmp[ 17]);
t_protect( arg4);
...
t_protect( atmp20);
t_protect( arg3);
tmp[ 19]= ( * ef16)( lf_AUX_MuASF_Conds2C5_1( cons( make_list( ( * ef1)( lf4( make_list( tmp[ 6])) , lf5( cons( make_list( ( * ef2)( tmp[ 9] , ( * ef3)( tmp[ 11] , lf6( make_list( tmp[ 13]))))) , make_list( tmp[ 14]))) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 15]))) , tmp[ 17] , arg1 , lf_AUX_MuASF_Conds2C5_2( make_list( atmp20)) , ( * ef17)( arg3));
