...
static aterm * lf_AUX_Rules2C_Aux18_2( aterm * arg1 , aterm * arg2 , aterm * arg3);
...
lf_AUX_Rules2C_Aux18_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"replace-second-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"replace-second-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux18_2 , lf_AUX_Rules2C_Aux18_2sym);
...
aterm * lf_AUX_Rules2C_Aux18_2( aterm * arg0 , aterm * arg1 , aterm * arg2) {
{
aterm * tmp[33];
PROF( prof_lf_AUX_Rules2C_Aux18_2);
if( check_sym( arg2 , lf_AUX_Rules2C_Aux18_1sym)) {
{
aterm * atmp20= arg_0( arg2);
if( m_not_empty_list( atmp20)) {
tmp[ 0]= m_list_head( atmp20);
tmp[ 1]= m_list_tail( atmp20);
...
t_protect( arg1);
t_protect( tmp[ 1]);
tmp[ 30]= lf_AUX_Rules2C_Aux18_2( arg0 , arg1 , lf_AUX_Rules2C_Aux18_1( make_list( tmp[ 1])));
...
t_unprotect( tmp[ 29]);
t_unprotect( tmp[ 30]);
return ( * ef1)( lf_AUX_Rules2C_Aux18_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 7])) , lf4( cons( make_list( ( * ef3)( ( * ef4)( ( * ef5)( lf5( cons( make_list( make_char( 116)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 113)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 97)) , make_list( make_char( 108))))))))))))) , lf6( cons( make_list( tmp[ 27]) , make_list( arg0)))) , tmp[ 12])) , make_list( tmp[ 10]))) , tmp[ 4] , ( * ef6)( tmp[ 5] , arg1) , ( * ef6)( tmp[ 6] , arg1))) , make_list( tmp[ 32]))));
}
}
t_unprotect( tmp[ 30]);
t_unprotect( tmp[ 29]);
...
t_unprotect( arg1);
t_unprotect( arg2);
return ( * ef1)( lf_AUX_Rules2C_Aux18_1( make_list( null( ))));
}
}
}
return make_nf3( lf_AUX_Rules2C_Aux18_2sym , arg0 , arg1 , arg2);
}
}
