...
static aterm * lf_AUX_Rules2C_Aux7_2( aterm * arg1);
...
lf_AUX_Rules2C_Aux7_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
lf_AUX_Rules2C_Aux7_1sym= TmkSymbol( "listtype(sort(\"C-Rule\"),ql(\";\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"C-Rule\"),ql(\";\"))") , lf_AUX_Rules2C_Aux7_1 , lf_AUX_Rules2C_Aux7_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux7_2 , lf_AUX_Rules2C_Aux7_2sym);
...
ef8= lookup_func( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"));
ef8sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"));
}
aterm * lf_AUX_Rules2C_Aux7_2( aterm * arg0) {
{
aterm * tmp[21];
PROF( prof_lf_AUX_Rules2C_Aux7_2);
if( check_sym( arg0 , lf_AUX_Rules2C_Aux7_1sym)) {
{
...
t_protect( tmp[ 13]);
tmp[ 15]= lf_AUX_Rules2C_Aux7_2( lf_AUX_Rules2C_Aux7_1( make_list( tmp[ 13])));
if( check_sym( tmp[ 15] , ef1sym)) {
tmp[ 16]= arg_0( tmp[ 15]);
tmp[ 17]= arg_1( tmp[ 15]);
if( check_sym( tmp[ 16] , lf_AUX_Rules2C_Aux7_1sym)) {
tmp[ 18]= arg_0( tmp[ 16]);
if( check_sym( tmp[ 17] , lf_AUX_Rules2C_Aux7_1sym)) {
tmp[ 19]= arg_0( tmp[ 17]);
t_protect( tmp[ 18]);
t_protect( tmp[ 9]);
t_protect( tmp[ 11]);
...
t_unprotect( tmp[ 14]);
t_unprotect( tmp[ 15]);
return ( * ef1)( lf_AUX_Rules2C_Aux7_1( make_list( tmp[ 18])) , lf_AUX_Rules2C_Aux7_1( cons( make_list( ( * ef2)( lf3( cons( make_list( ( * ef3)( tmp[ 9] , lf5( make_list( tmp[ 11])))) , make_list( tmp[ 12]))) , lf4( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 19]))));
}
}
}
t_unprotect( tmp[ 15]);
...
t_protect( tmp[ 15]);
t_protect( tmp[ 13]);
tmp[ 16]= ( * ef8)( tmp[ 15] , lf_AUX_Rules2C_Aux7_1( make_list( tmp[ 13])));
if( check_sym( tmp[ 16] , ef1sym)) {
tmp[ 17]= arg_0( tmp[ 16]);
tmp[ 18]= arg_1( tmp[ 16]);
if( check_sym( tmp[ 17] , lf_AUX_Rules2C_Aux7_1sym)) {
tmp[ 19]= arg_0( tmp[ 17]);
if( check_sym( tmp[ 18] , lf_AUX_Rules2C_Aux7_1sym)) {
tmp[ 20]= arg_0( tmp[ 18]);
t_protect( tmp[ 9]);
t_protect( tmp[ 11]);
t_protect( tmp[ 7]);
...
t_unprotect( tmp[ 15]);
t_unprotect( tmp[ 16]);
return ( * ef1)( lf_AUX_Rules2C_Aux7_1( cons( make_list( ( * ef2)( lf3( cons( make_list( ( * ef3)( tmp[ 9] , lf5( make_list( tmp[ 11])))) , make_list( tmp[ 12]))) , lf4( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 19]))) , lf_AUX_Rules2C_Aux7_1( make_list( tmp[ 20])));
}
}
}
t_unprotect( tmp[ 16]);
...
t_protect( tmp[ 8]);
tmp[ 9]= lf_AUX_Rules2C_Aux7_2( lf_AUX_Rules2C_Aux7_1( make_list( tmp[ 8])));
if( check_sym( tmp[ 9] , ef1sym)) {
tmp[ 10]= arg_0( tmp[ 9]);
tmp[ 11]= arg_1( tmp[ 9]);
if( check_sym( tmp[ 10] , lf_AUX_Rules2C_Aux7_1sym)) {
tmp[ 12]= arg_0( tmp[ 10]);
if( check_sym( tmp[ 11] , lf_AUX_Rules2C_Aux7_1sym)) {
tmp[ 13]= arg_0( tmp[ 11]);
t_protect( tmp[ 12]);
t_protect( tmp[ 7]);
t_protect( tmp[ 3]);
...
t_unprotect( tmp[ 8]);
t_unprotect( tmp[ 9]);
return ( * ef1)( lf_AUX_Rules2C_Aux7_1( make_list( tmp[ 12])) , lf_AUX_Rules2C_Aux7_1( cons( make_list( ( * ef2)( lf3( make_list( null( ))) , lf4( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 13]))));
}
}
}
t_unprotect( tmp[ 9]);
...
return make_nf1( lf_AUX_Rules2C_Aux7_2sym , arg0);
}
}
