...
lf_AUX_ATermLists15_1sym= ATmakeSymbol( "prod(id(\"ATermLists\"),w(\"\"),[l(\"diff\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_ATermLists15_1sym);
register_prod( ATparse( "prod(id(\"ATermLists\"),w(\"\"),[l(\"diff\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)") , lf_AUX_ATermLists15_1 , lf_AUX_ATermLists15_1sym);
}
...
return lf_AUX_ATermLists15_1( ( * ef2)( arg0 , ( * ef3)( arg1)) , ( * ef4)( arg1));
}
