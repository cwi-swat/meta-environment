...
( tmp [ 12 ] = arg_0 ( tmp [ 11 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf_AUX_Rules2C_Aux26_1 ( cons ( make_list ( ( * ef2 ) ( lf3 ( make_list ( tmp [ 8 ] ) ) , lf4 ( make_list ( tmp [ 9 ] ) ) , tmp [ 4 ] , ( * ef3 ) ( tmp [ 5 ] , arg1 ) , ( * ef3 ) ( tmp [ 6 ] , arg1 ) , tmp [ 7 ] ) ) , make_list ( tmp [ 12 ] ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT_CONST ( constant0 , make_nf1 ( ef1sym , lf_AUX_Rules2C_Aux26_1 ( make_list ( null ( ) ) ) ) ) ;
}
}
}
