...
lf_AUX_Optimize_MuASF32_1sym = ATmakeSymbol ( "prod(id(\"Optimize-MuASF\"),w(\"\"),[ql(\"check-emb-terms\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"TermList\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"EmbeddingAt\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
ef8 = lookup_func ( ATreadFromString ( "prod(id(\"Optimize-MuASF\"),w(\"\"),[ql(\"check-emb-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Embedding\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
ef8sym = lookup_sym ( ATreadFromString ( "prod(id(\"Optimize-MuASF\"),w(\"\"),[ql(\"check-emb-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Embedding\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
ef9 = lookup_func ( ATreadFromString ( "prod(id(\"Integers\"),w(\"\"),[sort(\"Int\"),w(\"\"),ql(\"-\"),w(\"\"),sort(\"Int\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Int\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))" ) ) ;
ef9sym = lookup_sym ( ATreadFromString ( "prod(id(\"Integers\"),w(\"\"),[sort(\"Int\"),w(\"\"),ql(\"-\"),w(\"\"),sort(\"Int\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Int\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))" ) ) ;
}
...
{
ATerm ltmp [ 2 ] ;
lbl_lf_AUX_Optimize_MuASF32_1 : ltmp [ 0 ] = arg0 ;
( ltmp [ 1 ] = arg1 ) ;
...
( tmp [ 1 ] = ( * ef7 ) ( tmp [ 0 ] ) ) ;
( tmp [ 2 ] = ( * ef8 ) ( tmp [ 0 ] , atmp10 ) ) ;
FUNC_EXIT ( ( * ef6 ) ( tmp [ 1 ] , tmp [ 2 ] ) ) ;
}
}
}
...
if ( term_equal ( list_head ( atmp110000 ) , make_char ( 48 ) ) ) {
( tmp [ 2 ] = ( * ef7 ) ( tmp [ 0 ] ) ) ;
( tmp [ 3 ] = ( * ef8 ) ( tmp [ 0 ] , atmp10 ) ) ;
FUNC_EXIT ( ( * ef6 ) ( tmp [ 2 ] , tmp [ 3 ] ) ) ;
}
}
}
}
...
( arg1 = ( * ef2 ) ( atmp10 , ( * ef9 ) ( ( * ef3 ) ( atmp110 ) , ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( lf3 ( make_list ( make_char ( 49 ) ) ) ) ) ) ) ) ) ;
goto lbl_lf_AUX_Optimize_MuASF32_1 ;
}
}
}
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Optimize_MuASF32_1sym , ltmp [ 0 ] , ltmp [ 1 ] ) ) ;
}
}
}
