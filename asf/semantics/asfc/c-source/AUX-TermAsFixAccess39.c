...
static Symbol lf_AUX_TermAsFixAccess39_1sym ;
static ATerm lf_AUX_TermAsFixAccess39_1 ( ATerm arg1 ) ;
...
static funcptr ef16 ;
void register_AUX_TermAsFixAccess39 ( ) {
lf_AUX_TermAsFixAccess39_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-ceq-equ-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess39_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-ceq-equ-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess39_1 , lf_AUX_TermAsFixAccess39_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess39 ( ) {
...
void init_AUX_TermAsFixAccess39 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess39_1 ( ATerm arg0 ) {
{
ATerm tmp [ 44 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess39_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess39_1sym , arg0 ) ) ;
...
( tmp [ 25 ] = list_tail ( atmp011110100000 ) ) ;
...
( tmp [ 26 ] = list_tail ( atmp0111110100000 ) ) ;
if ( not_empty_list ( tmp [ 26 ] ) ) {
if ( term_equal ( list_head ( tmp [ 26 ] ) , make_char ( 45 ) ) ) {
( tmp [ 27 ] = list_tail ( tmp [ 26 ] ) ) ;
if ( not_empty_list ( tmp [ 27 ] ) ) {
if ( term_equal ( list_head ( tmp [ 27 ] ) , make_char ( 62 ) ) ) {
...
( tmp [ 29 ] = list_tail ( atmp01111110100000 ) ) ;
...
( tmp [ 30 ] = list_tail ( atmp011111110100000 ) ) ;
if ( not_empty_list ( tmp [ 30 ] ) ) {
if ( term_equal ( list_head ( tmp [ 30 ] ) , make_char ( 67 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 33 ] ) , make_char ( 100 ) ) ) {
( tmp [ 34 ] = list_tail ( tmp [ 33 ] ) ) ;
if ( not_empty_list ( tmp [ 34 ] ) ) {
if ( term_equal ( list_head ( tmp [ 34 ] ) , make_char ( 69 ) ) ) {
( tmp [ 35 ] = list_tail ( tmp [ 34 ] ) ) ;
if ( not_empty_list ( tmp [ 35 ] ) ) {
if ( term_equal ( list_head ( tmp [ 35 ] ) , make_char ( 113 ) ) ) {
...
( tmp [ 43 ] = list_tail ( atmp0111111110100000 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess39_1sym , arg0 ) ) ;
}
}
