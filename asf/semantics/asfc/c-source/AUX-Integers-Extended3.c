...
lf_AUX_Integers_Extended3_1sym = ATmakeSymbol ( "prod(id(\"Integers-Extended\"),w(\"\"),[ql(\"gtr\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"IntCon\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntCon\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Integers_Extended3_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Integers-Extended\"),w(\"\"),[ql(\"gtr\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"IntCon\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntCon\"),w(\"\"),no-attrs)" ) , lf_AUX_Integers_Extended3_1 , lf_AUX_Integers_Extended3_1sym ) ;
}
