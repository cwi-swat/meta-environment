...
static aterm * lf_AUX_Rules2C_Aux25_2( aterm * arg1 , aterm * arg2);
...
lf_AUX_Rules2C_Aux25_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"add-to-set\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"AInt\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"A-set\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"add-to-set\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"AInt\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"A-set\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux25_2 , lf_AUX_Rules2C_Aux25_2sym);
...
aterm * lf_AUX_Rules2C_Aux25_2( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[3];
...
t_protect( tmp[ 0]);
t_protect( tmp[ 1]);
tmp[ 2]= ( * ef6)( lf_AUX_Rules2C_Aux25_1( cons( make_list( tmp[ 0]) , make_list( tmp[ 1]))));
t_protect( atmp100);
t_unprotect( arg0);
t_unprotect( arg1);
t_unprotect( tmp[ 0]);
...
return make_nf2( lf_AUX_Rules2C_Aux25_2sym , arg0 , arg1);
}
}
