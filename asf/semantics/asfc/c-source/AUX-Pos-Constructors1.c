...
lf_AUX_Pos_Constructors1_1sym = ATmakeSymbol ( "prod(id(\"Pos-Constructors\"),w(\"\"),[ql(\"pos\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"
 , 0 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Pos_Constructors1_1sym ) ;
lf_AUX_Pos_Constructors1_2sym = ATmakeSymbol ( "prod(id(\"Pos-Constructors\"),w(\"\"),[ql(\"pos-info\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" , 0 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Pos_Constructors1_2sym ) ;
register_prod ( ATparse ( "prod(id(\"Pos-Constructors\"),w(\"\"),[ql(\"pos\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) , lf_AUX_Pos_Constructors1_1 , lf_AUX_Pos_Constructors1_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Pos-Constructors\"),w(\"\"),[ql(\"pos-info\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) , lf_AUX_Pos_Constructors1_2 , lf_AUX_Pos_Constructors1_2sym ) ;
}
