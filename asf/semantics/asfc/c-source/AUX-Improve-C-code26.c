#include  "support.h"
static Symbol lf_AUX_Improve_C_code26_1sym ;
static ATerm lf_AUX_Improve_C_code26_1 ( ATerm arg1 , ATerm arg2 ) ;
...
void register_AUX_Improve_C_code26 ( ) {
lf_AUX_Improve_C_code26_1sym = ATmakeSymbol ( "prod(id(\"Improve-C-code\"),w(\"\"),[l(\"transform-args\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Argument-expression-list\"),w(\"\"),ql(\"|\"),w(\"\"),sort(\"Int\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Improve_C_code26_1sym ) ;
...
register_prod ( ATparse ( "prod(id(\"Improve-C-code\"),w(\"\"),[l(\"transform-args\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Argument-expression-list\"),w(\"\"),ql(\"|\"),w(\"\"),sort(\"Int\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)" ) , lf_AUX_Improve_C_code26_1 , lf_AUX_Improve_C_code26_1sym ) ;
...
void resolve_AUX_Improve_C_code26 ( ) {
...
ef13 = lookup_func ( ATreadFromString ( "prod(id(\"Basic-Integers\"),w(\"\"),[sort(\"Int\"),w(\"\"),ql(\"+\"),w(\"\"),sort(\"Int\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Int\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))" ) ) ;
ef13sym = lookup_sym ( ATreadFromString ( "prod(id(\"Basic-Integers\"),w(\"\"),[sort(\"Int\"),w(\"\"),ql(\"+\"),w(\"\"),sort(\"Int\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Int\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))" ) ) ;
}
static ATerm constant0 = NULL ;
void init_AUX_Improve_C_code26 ( ) {
ATprotect ( & constant0 ) ;
}
ATerm lf_AUX_Improve_C_code26_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 9 ] ;
FUNC_ENTRY ( lf_AUX_Improve_C_code26_1sym , ATmakeAppl ( lf_AUX_Improve_C_code26_1sym , arg0 , arg1 ) ) ;
...
tmp [ 3 ] = arg_0 ( tmp [ 2 ] ) ;
FUNC_EXIT ( ( * ef3 ) ( ( * ef4 ) ( lf3 ( make_list ( ( * ef5 ) ( ( * ef6 ) ( ( * ef7 ) ( ( * ef8 ) ( ( * ef9 ) ( ( * ef10 ) ( lf4 ( cons ( make_list_char ( 97 ) , cons ( make_list_char ( 114 ) , cons ( make_list_char ( 103 ) , make_list ( tmp [ 3 ] ) ) ) ) ) ) ) ) ) , tmp [ 0 ] ) ) ) ) ) ) ) ;
}
}
}
}
...
tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ;
tmp [ 5 ] = lf_AUX_Improve_C_code26_1 ( ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) , ( * ef13 ) ( ( constant0 ? constant0 : ( constant0 = ( * ef2 ) ( ( * ef11 ) ( ( * ef12 ) ( lf4 ( make_list ( make_char ( 49 ) ) ) ) ) ) ) ) , arg1 ) ) ;
...
FUNC_EXIT ( ( * ef3 ) ( ( * ef4 ) ( lf3 ( cons ( make_list ( ( * ef5 ) ( ( * ef6 ) ( ( * ef7 ) ( ( * ef8 ) ( ( * ef9 ) ( ( * ef10 ) ( lf4 ( cons ( make_list_char ( 97 ) , cons ( make_list_char ( 114 ) , cons ( make_list_char ( 103 ) , make_list ( tmp [ 4 ] ) ) ) ) ) ) ) ) ) , tmp [ 0 ] ) ) ) , make_list ( tmp [ 8 ] ) ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Improve_C_code26_1sym , arg0 , arg1 ) ) ;
}
}
