...
static Symbol lf_AUX_TermAsFixAccess55_1sym ;
static ATerm lf_AUX_TermAsFixAccess55_1 ( ATerm arg1 ) ;
...
static funcptr ef13 ;
void register_AUX_TermAsFixAccess55 ( ) {
lf_AUX_TermAsFixAccess55_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-condition-iter\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess55_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-condition-iter\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess55_1 , lf_AUX_TermAsFixAccess55_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess55 ( ) {
...
void init_AUX_TermAsFixAccess55 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess55_1 ( ATerm arg0 ) {
{
ATerm tmp [ 22 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess55_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess55_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess55_1sym , arg0 ) ) ;
}
}
