...
tmp [ 59 ] = ( * ef29 ) ( tmp [ 58 ] , ( * ef30 ) ( lf9 ( make_list ( ( * ef31 ) ( tmp [ 58 ] , tmp [ 47 ] ) ) ) ) , lf_AUX_MuASF_Term2C8_1 ( cons ( make_list ( ( * ef1 ) ( lf4 ( make_list ( tmp [ 8 ] ) ) , lf5 ( cons ( make_list ( ( * ef2 ) ( ( * ef3 ) ( ( constant3 ? constant3 : ( constant3 = ( * ef4 ) ( lf6 ( cons ( make_list ( make_char ( 116 ) ) , cons ( make_list ( make_char ( 101 ) ) , cons ( make_list ( make_char ( 114 ) ) , cons ( make_list ( make_char ( 109 ) ) , cons ( make_list ( make_char ( 45 ) ) , cons ( make_list ( make_char ( 101 ) ) , cons ( make_list ( make_char ( 113 ) ) , cons ( make_list ( make_char ( 117 ) ) , cons ( make_list ( make_char ( 97 ) ) , make_list ( make_char ( 108 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) , lf7 ( cons ( make_list ( tmp [ 38 ] ) , make_list ( tmp [ 40 ] ) ) ) ) , tmp [ 13 ] ) ) , make_list ( tmp [ 11 ] ) ) ) , tmp [ 4 ] , tmp [ 5 ] , tmp [ 6 ] , tmp [ 7 ] ) ) , make_list ( tmp [ 45 ] ) ) ) ) ;
if ( check_sym ( tmp [ 59 ] , ef32sym ) ) {
tmp [ 60 ] = arg_0 ( tmp [ 59 ] ) ;
if ( check_sym ( tmp [ 60 ] , lf_AUX_MuASF_Term2C8_1sym ) ) {
tmp [ 61 ] = arg_0 ( tmp [ 60 ] ) ;
if ( not_empty_list ( tmp [ 61 ] ) ) {
FUNC_EXIT ( ( * ef5 ) ( ( * ef12 ) ( tmp [ 50 ] , ( * ef13 ) ( ( * ef14 ) ( ( * ef15 ) ( ( * ef16 ) ( tmp [ 47 ] , tmp [ 54 ] ) ) ) ) ) , ( * ef6 ) ( ) , lf_AUX_MuASF_Term2C8_1 ( cons ( make_list ( tmp [ 61 ] ) , make_list ( tmp [ 46 ] ) ) ) , tmp [ 51 ] ) ) ;
}
}
}
}
