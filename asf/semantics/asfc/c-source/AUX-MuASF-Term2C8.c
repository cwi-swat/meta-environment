...
ef20= lookup_func( ATreadFromString( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"term2carg\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)"));
ef20sym= lookup_sym( ATreadFromString( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"term2carg\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)"));
...
tmp[ 41]= ( * ef10)( tmp[ 39] , lf_AUX_MuASF_Term2C8_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 41] , ef11sym)) {
tmp[ 42]= arg_0( tmp[ 41]);
tmp[ 43]= arg_1( tmp[ 41]);
{
if( check_sym( tmp[ 42] , lf_AUX_MuASF_Term2C8_1sym)) {
tmp[ 44]= arg_0( tmp[ 42]);
{
...
tmp[ 47]= ( * ef20)( ( constant0? constant0: ( constant0= ( * ef9)( ))) , tmp[ 39] , tmp[ 5] , tmp[ 6] , ( * ef21)( arg2) , tmp[ 46] , lf_AUX_MuASF_Term2C8_2( make_list( atmp10)));
...
tmp[ 54]= arg_0( arg2);
if( check_sym( tmp[ 54] , ef25sym)) {
tmp[ 55]= arg_0( tmp[ 54]);
if( check_sym( tmp[ 55] , lf6sym)) {
tmp[ 56]= arg_0( tmp[ 55]);
tmp[ 57]= ( * ef26)( ( * ef27)( ( * ef28)( lf6( cons( ( constant1? constant1: ( constant1= make_list( make_char( 67)))) , cons( ( constant2? constant2: ( constant2= make_list( make_char( 86)))) , make_list( tmp[ 56])))))));
tmp[ 58]= ( * ef29)( tmp[ 57] , ( * ef30)( lf9( make_list( ( * ef31)( tmp[ 57] , tmp[ 46])))) , lf_AUX_MuASF_Term2C8_1( cons( make_list( ( * ef1)( lf4( make_list( tmp[ 7])) , lf5( cons( make_list( ( * ef2)( ( * ef3)( ( constant3? constant3: ( constant3= ( * ef4)( lf6( cons( make_list( make_char( 116)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 113)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 97)) , make_list( make_char( 108))))))))))))))) , lf7( cons( make_list( tmp[ 37]) , make_list( tmp[ 39])))) , tmp[ 12])) , make_list( tmp[ 10]))) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 44]))));
if( check_sym( tmp[ 58] , ef32sym)) {
tmp[ 59]= arg_0( tmp[ 58]);
if( check_sym( tmp[ 59] , lf_AUX_MuASF_Term2C8_1sym)) {
tmp[ 60]= arg_0( tmp[ 59]);
if( not_empty_list( tmp[ 60])) {
return ( * ef5)( ( * ef12)( tmp[ 49] , ( * ef13)( ( * ef14)( ( * ef15)( ( * ef16)( tmp[ 46] , tmp[ 53]))))) , ( constant4? constant4: ( constant4= ( * ef6)( ))) , lf_AUX_MuASF_Term2C8_1( cons( make_list( tmp[ 60]) , make_list( tmp[ 45]))) , tmp[ 50]);
}
}
}
}
