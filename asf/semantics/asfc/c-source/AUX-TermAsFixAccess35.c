...
static Symbol lf_AUX_TermAsFixAccess35_1sym ;
static ATerm lf_AUX_TermAsFixAccess35_1 ( ATerm arg1 ) ;
...
static funcptr ef17 ;
void register_AUX_TermAsFixAccess35 ( ) {
lf_AUX_TermAsFixAccess35_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-left-assoc-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess35_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-left-assoc-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess35_1 , lf_AUX_TermAsFixAccess35_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess35 ( ) {
...
void init_AUX_TermAsFixAccess35 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess35_1 ( ATerm arg0 ) {
{
ATerm tmp [ 46 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess35_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess35_1sym , arg0 ) ) ;
...
( tmp [ 26 ] = list_tail ( atmp011110100000 ) ) ;
...
( tmp [ 30 ] = list_tail ( atmp01111110100000 ) ) ;
...
( tmp [ 31 ] = list_tail ( atmp011111110100000 ) ) ;
if ( not_empty_list ( tmp [ 31 ] ) ) {
if ( term_equal ( list_head ( tmp [ 31 ] ) , make_char ( 65 ) ) ) {
( tmp [ 32 ] = list_tail ( tmp [ 31 ] ) ) ;
if ( not_empty_list ( tmp [ 32 ] ) ) {
if ( term_equal ( list_head ( tmp [ 32 ] ) , make_char ( 115 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 34 ] ) , make_char ( 111 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 39 ] ) , make_char ( 105 ) ) ) {
( tmp [ 40 ] = list_tail ( tmp [ 39 ] ) ) ;
if ( not_empty_list ( tmp [ 40 ] ) ) {
if ( term_equal ( list_head ( tmp [ 40 ] ) , make_char ( 118 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 43 ] ) , make_char ( 121 ) ) ) {
...
( tmp [ 45 ] = list_tail ( atmp0111111110100000 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess35_1sym , arg0 ) ) ;
}
}
