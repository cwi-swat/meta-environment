...
lf_AUX_TermAsFixAccess35_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-avoid-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess35_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-avoid-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess35_1 , lf_AUX_TermAsFixAccess35_1sym ) ;
...
if ( term_equal ( list_head ( tmp [ 26 ] ) , make_char ( 118 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 29 ] ) , make_char ( 100 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 41 ] ) , make_char ( 98 ) ) ) {
( tmp [ 42 ] = list_tail ( tmp [ 41 ] ) ) ;
if ( not_empty_list ( tmp [ 42 ] ) ) {
if ( term_equal ( list_head ( tmp [ 42 ] ) , make_char ( 117 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 44 ] ) , make_char ( 101 ) ) ) {
