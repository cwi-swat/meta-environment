#include "support.h"
static asymbol * lf_AUX_Check_List_Pats27_1sym;
...
lf_AUX_Check_List_Pats27_1sym= TmkSymbol( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"contains-no-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"contains-no-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_Check_List_Pats27_1 , lf_AUX_Check_List_Pats27_1sym);
...
t_unprotect( tmp[ 8]);
t_unprotect( tmp[ 10]);
return lf_AUX_Check_List_Pats27_1( tmp[ 9]);
}
t_unprotect( tmp[ 10]);
t_unprotect( tmp[ 9]);
}
