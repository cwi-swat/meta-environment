#include  "support.h"
static Symbol lf_AUX_TermAsFixAccess26_1sym ;
static ATerm lf_AUX_TermAsFixAccess26_1 ( ATerm arg1 ) ;
...
static funcptr ef16 ;
void register_AUX_TermAsFixAccess26 ( ) {
lf_AUX_TermAsFixAccess26_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-sort-symbol-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess26_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-sort-symbol-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess26_1 , lf_AUX_TermAsFixAccess26_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess26 ( ) {
...
void init_AUX_TermAsFixAccess26 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess26_1 ( ATerm arg0 ) {
{
ATerm tmp [ 36 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess26_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess26_1sym , arg0 ) ) ;
...
if ( term_equal ( list_head ( tmp [ 28 ] ) , make_char ( 83 ) ) ) {
tmp [ 29 ] = list_tail ( tmp [ 28 ] ) ;
if ( not_empty_list ( tmp [ 29 ] ) ) {
if ( term_equal ( list_head ( tmp [ 29 ] ) , make_char ( 121 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 31 ] ) , make_char ( 98 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 33 ] ) , make_char ( 108 ) ) ) {
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess26_1sym , arg0 ) ) ;
}
}
