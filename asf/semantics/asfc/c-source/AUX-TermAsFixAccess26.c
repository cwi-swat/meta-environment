...
lf_AUX_TermAsFixAccess26_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-symbol-itersep\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess26_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-symbol-itersep\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess26_1 , lf_AUX_TermAsFixAccess26_1sym ) ;
...
( tmp [ 10 ] = list_tail ( atmp011110100000 ) ) ;
...
( tmp [ 11 ] = list_tail ( atmp0111110100000 ) ) ;
if ( not_empty_list ( tmp [ 11 ] ) ) {
if ( term_equal ( list_head ( tmp [ 11 ] ) , make_char ( 44 ) ) ) {
...
( tmp [ 13 ] = list_tail ( atmp01111110100000 ) ) ;
...
( tmp [ 14 ] = list_tail ( atmp011111110100000 ) ) ;
if ( not_empty_list ( tmp [ 14 ] ) ) {
if ( term_equal ( list_head ( tmp [ 14 ] ) , make_char ( 125 ) ) ) {
...
( tmp [ 16 ] = list_tail ( atmp0111111110100000 ) ) ;
...
( tmp [ 17 ] = list_tail ( atmp01111111110100000 ) ) ;
