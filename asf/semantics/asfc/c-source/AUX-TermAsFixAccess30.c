...
static Symbol lf_AUX_TermAsFixAccess30_1sym ;
static ATerm lf_AUX_TermAsFixAccess30_1 ( ATerm arg1 ) ;
...
static funcptr ef17 ;
void register_AUX_TermAsFixAccess30 ( ) {
lf_AUX_TermAsFixAccess30_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-bracket-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess30_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-bracket-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess30_1 , lf_AUX_TermAsFixAccess30_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess30 ( ) {
...
void init_AUX_TermAsFixAccess30 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess30_1 ( ATerm arg0 ) {
{
ATerm tmp [ 45 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess30_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess30_1sym , arg0 ) ) ;
...
if ( term_equal ( list_head ( tmp [ 25 ] ) , make_char ( 107 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 34 ] ) , make_char ( 65 ) ) ) {
( tmp [ 35 ] = list_tail ( tmp [ 34 ] ) ) ;
if ( not_empty_list ( tmp [ 35 ] ) ) {
if ( term_equal ( list_head ( tmp [ 35 ] ) , make_char ( 116 ) ) ) {
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess30_1sym , arg0 ) ) ;
}
}
