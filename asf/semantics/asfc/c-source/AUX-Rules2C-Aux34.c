...
static asymbol * new__1__lf_AUX_Rules2C_Aux34_1sym;
static aterm * new__1__lf_AUX_Rules2C_Aux34_1( aterm * arg1);
void register_AUX_Rules2C_Aux34( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_Rules2C_Aux34_1sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-unprotect-without-args\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
new__1__lf_AUX_Rules2C_Aux34_1sym= TmkSymbol( "new__1__lf_AUX_Rules2C_Aux34_1" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-unprotect-without-args\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux34_1 , lf_AUX_Rules2C_Aux34_1sym);
...
aterm * new__1__lf_AUX_Rules2C_Aux34_1( aterm * arg0) {
{
aterm * tmp[4];
PROF( prof_new__1__lf_AUX_Rules2C_Aux34_1);
...
t_unprotect( arg0);
t_unprotect( tmp[ 0]);
return ( * ef7)( ( * ef8)( ( * ef9)( ( * ef10)( ( * ef4)( ( * ef11)( ( * ef5)( ( * ef6)( lf3( cons( make_list( make_char( 116)) , cons( make_list( make_char( 95)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 110)) , cons( make_list( make_char( 112)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 99)) , make_list( make_char( 116))))))))))))))) , ( * ef12)( lf4( make_list( tmp[ 1])))))))) , lf_AUX_Rules2C_Aux34_1( ( * ef1)( lf2( make_list( tmp[ 3])))));
}
t_unprotect( tmp[ 0]);
}
}
...
return make_nf1( new__1__lf_AUX_Rules2C_Aux34_1sym , arg0);
}
}
...
t_protect( atmp000);
tmp[ 10]= list_tail( atmp000);
t_unprotect( arg0);
t_unprotect( tmp[ 0]);
t_unprotect( tmp[ 7]);
t_unprotect( tmp[ 8]);
t_unprotect( tmp[ 9]);
return lf_AUX_Rules2C_Aux34_1( ( * ef1)( lf2( make_list( tmp[ 10]))));
}
}
t_unprotect( tmp[ 8]);
}
...
t_unprotect( arg0);
t_unprotect( tmp[ 0]);
return new__1__lf_AUX_Rules2C_Aux34_1( ( * ef1)( lf2( cons( make_list( ( * ef3)( tmp[ 1] , tmp[ 2])) , make_list( tmp[ 3])))));
}
t_unprotect( tmp[ 0]);
}
}
...
return make_nf1( lf_AUX_Rules2C_Aux34_1sym , arg0);
}
}
