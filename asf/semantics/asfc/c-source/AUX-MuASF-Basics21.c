...
{
ATerm tmp [ 4 ] ;
FUNC_ENTRY ( lf_AUX_MuASF_Basics21_1sym , ATmakeAppl ( lf_AUX_MuASF_Basics21_1sym , arg0 , arg1 , arg2 ) ) ;
...
FUNC_EXIT ( ( * ef1 ) ( lf2 ( cons ( make_list_char ( 34 ) , cons ( make_list ( tmp [ 1 ] ) , cons ( make_list ( atmp2000 ) , cons ( make_list_char ( 95 ) , cons ( make_list_char ( 95 ) , cons ( make_list ( tmp [ 3 ] ) , make_list ( make_char ( 34 ) ) ) ) ) ) ) ) ) ) ) ;
}
}
}
}
...
tmp [ 1 ] = list_prefix ( tmp [ 0 ] ) ;
if ( term_equal ( list_last ( tmp [ 0 ] ) , make_char ( 34 ) ) ) {
FUNC_EXIT ( ( * ef1 ) ( lf2 ( cons ( make_list ( tmp [ 1 ] ) , cons ( make_list ( atmp2000 ) , cons ( make_list_char ( 95 ) , cons ( make_list_char ( 95 ) , make_list ( atmp100 ) ) ) ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf3 ( lf_AUX_MuASF_Basics21_1sym , arg0 , arg1 , arg2 ) ) ;
}
}
