...
lf_AUX_Substitution4_1sym= ATmakeSymbol( "prod(id(\"Substitution\"),w(\"\"),[l(\"substitute\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Substitution4_1sym);
register_prod( ATparse( "prod(id(\"Substitution\"),w(\"\"),[l(\"substitute\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)") , lf_AUX_Substitution4_1 , lf_AUX_Substitution4_1sym);
}
