...
static ATerm lf_AUX_Make_Assign_Conds_C5_1 ( ATerm arg1 ) ;
...
lf_AUX_Make_Assign_Conds_C5_1sym = ATmakeSymbol ( "prod(id(\"Make-Assign-Conds-C\"),w(\"\"),[l(\"make-mc-rule\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Rule\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Rule\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Make-Assign-Conds-C\"),w(\"\"),[l(\"make-mc-rule\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Rule\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Rule\"),w(\"\"),no-attrs)" ) , lf_AUX_Make_Assign_Conds_C5_1 , lf_AUX_Make_Assign_Conds_C5_1sym ) ;
...
ef7 = lookup_func ( ATreadFromString ( "prod(id(\"Make-Assign-Conds-C\"),w(\"\"),[l(\"make-mc-conds\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Cond\"),w(\"\"),ql(\"&\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CList-VarEnv\"),w(\"\"),no-attrs)" ) ) ;
ef7sym = lookup_sym ( ATreadFromString ( "prod(id(\"Make-Assign-Conds-C\"),w(\"\"),[l(\"make-mc-conds\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Cond\"),w(\"\"),ql(\"&\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CList-VarEnv\"),w(\"\"),no-attrs)" ) ) ;
...
ATerm lf_AUX_Make_Assign_Conds_C5_1 ( ATerm arg0 ) {
{
ATerm tmp [ 5 ] ;
FUNC_ENTRY ( lf_AUX_Make_Assign_Conds_C5_1sym , ATmakeAppl ( lf_AUX_Make_Assign_Conds_C5_1sym , arg0 ) ) ;
...
tmp [ 0 ] = ( * ef3 ) ( atmp01 , ( constant0 ? constant0 : ( constant0 = ( * ef4 ) ( ( * ef5 ) ( ( * ef6 ) ( lf3 ( make_list ( make_char ( 49 ) ) ) ) ) , lf4 ( make_list ( null ( ) ) ) ) ) ) ) ;
...
FUNC_EXIT ( arg0 ) ;
FUNC_EXIT ( make_nf1 ( lf_AUX_Make_Assign_Conds_C5_1sym , arg0 ) ) ;
}
}
