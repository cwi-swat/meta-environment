#include "support.h"
static Symbol lf_AUX_Make_Assign_Conds_C8_2sym;
static ATerm lf_AUX_Make_Assign_Conds_C8_2( ATerm arg1 , ATerm arg2);
static Symbol ef1sym;
static funcptr ef1;
static Symbol ef2sym;
static funcptr ef2;
static Symbol lf_AUX_Make_Assign_Conds_C8_1sym;
static ATerm lf_AUX_Make_Assign_Conds_C8_1( ATerm arg1);
void register_AUX_Make_Assign_Conds_C8( ) {
lf_AUX_Make_Assign_Conds_C8_2sym= ATmakeSymbol( "prod(id(\"Make-Assign-Conds-C\"),w(\"\"),[l(\"make-mc-conds\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Cond\"),w(\"\"),ql(\"&\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CList-VarEnv\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Make_Assign_Conds_C8_2sym);
lf_AUX_Make_Assign_Conds_C8_1sym= ATmakeSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Make_Assign_Conds_C8_1sym);
register_prod( ATparse( "listtype(sort(\"Cond\"),ql(\"&\"))") , lf_AUX_Make_Assign_Conds_C8_1 , lf_AUX_Make_Assign_Conds_C8_1sym);
register_prod( ATparse( "prod(id(\"Make-Assign-Conds-C\"),w(\"\"),[l(\"make-mc-conds\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Cond\"),w(\"\"),ql(\"&\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CList-VarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Make_Assign_Conds_C8_2 , lf_AUX_Make_Assign_Conds_C8_2sym);
}
...
void init_AUX_Make_Assign_Conds_C8( ) {
}
...
tmp[ 3]= arg_0( tmp[ 2]);
tmp[ 4]= arg_1( tmp[ 2]);
if( check_sym( tmp[ 3] , lf_AUX_Make_Assign_Conds_C8_1sym)) {
tmp[ 5]= arg_0( tmp[ 3]);
if( is_single_element( tmp[ 5])) {
tmp[ 6]= list_head( tmp[ 5]);
tmp[ 7]= lf_AUX_Make_Assign_Conds_C8_2( lf_AUX_Make_Assign_Conds_C8_1( make_list( tmp[ 1])) , tmp[ 4]);
