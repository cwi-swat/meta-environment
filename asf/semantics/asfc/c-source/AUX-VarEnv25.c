...
static Symbol lf_AUX_VarEnv25_2_recursivesym ;
...
if ( check_sym ( tmp [ 4 ] , lf3sym ) ) {
( tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ) ;
FUNC_EXIT ( lf_AUX_VarEnv25_2_recursive ( arg0 , make_list ( tmp [ 1 ] ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_VarEnv25_2_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 34 ] ;
FUNC_ENTRY ( lf_AUX_VarEnv25_2_recursivesym , ATmakeAppl ( lf_AUX_VarEnv25_2_recursivesym , arg0 , arg1 ) ) ;
{
ATerm ltmp [ 2 ] ;
lbl_lf_AUX_VarEnv25_2_recursive : ltmp [ 0 ] = arg0 ;
( ltmp [ 1 ] = arg1 ) ;
{
ATerm atmp10 = arg1 ;
if ( not_empty_list ( atmp10 ) ) {
...
goto lbl_lf_AUX_VarEnv25_2_recursive ;
}
}
}
}
FUNC_EXIT ( make_nf2 ( lf_AUX_VarEnv25_2_recursivesym , ltmp [ 0 ] , lf_AUX_VarEnv25_1 ( ltmp [ 1 ] ) ) ) ;
}
}
}
