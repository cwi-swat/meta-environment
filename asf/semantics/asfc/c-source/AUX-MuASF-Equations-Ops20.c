...
lf_AUX_MuASF_Equations_Ops20_1sym = ATmakeSymbol ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[ql(\"make-ignored-funid\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"prefer\")],w(\"\"),l(\"}\")))"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Equations_Ops20_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[ql(\"make-ignored-funid\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"prefer\")],w(\"\"),l(\"}\")))" ) , lf_AUX_MuASF_Equations_Ops20_1 , lf_AUX_MuASF_Equations_Ops20_1sym ) ;
...
{
ATerm tmp [ 5 ] ;
FUNC_ENTRY ( lf_AUX_MuASF_Equations_Ops20_1sym , ATmakeAppl ( lf_AUX_MuASF_Equations_Ops20_1sym , arg0 ) ) ;
...
FUNC_EXIT ( ( * ef1 ) ( lf2 ( cons ( make_list_char ( 34 ) , cons ( make_list_char ( 123 ) , cons ( make_list ( tmp [ 4 ] ) , ( ATerm ) ATmakeList ( 10 , char_table [ 45 ] , char_table [ 105 ] , char_table [ 103 ] , char_table [ 110 ] , char_table [ 111 ] , char_table [ 114 ] , char_table [ 101 ] , char_table [ 100 ] , char_table [ 125 ] , char_table [ 34 ] ) ) ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf1 ( lf_AUX_MuASF_Equations_Ops20_1sym , arg0 ) ) ;
}
}
