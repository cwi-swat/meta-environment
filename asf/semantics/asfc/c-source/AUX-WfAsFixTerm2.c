#include "support.h"
static Symbol lf_AUX_WfAsFixTerm2_1sym;
static ATerm lf_AUX_WfAsFixTerm2_1( ATerm arg1 , ATerm arg2);
...
lf_AUX_WfAsFixTerm2_1sym= ATmakeSymbol( "prod(id(\"WfAsFixTerm\"),w(\"\"),[l(\"eq-asfix-type\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_WfAsFixTerm2_1sym);
register_prod( ATparse( "prod(id(\"WfAsFixTerm\"),w(\"\"),[l(\"eq-asfix-type\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_WfAsFixTerm2_1 , lf_AUX_WfAsFixTerm2_1sym);
}
...
void init_AUX_WfAsFixTerm2( ) {
ATprotect( & constant0);
ATprotect( & constant1);
ATprotect( & constant2);
ATprotect( & constant3);
}
ATerm lf_AUX_WfAsFixTerm2_1( ATerm arg0 , ATerm arg1) {
...
return lf_AUX_WfAsFixTerm2_1( ( * ef7)( ( constant0? constant0: ( constant0= ( * ef11)( ))) , ( * ef9)( ( * ef3)( ( * ef10)( ( * ef12)( atmp01000))))) , arg1);
}
}
}
}
...
{
ATerm atmp01000= arg_0( atmp0100);
return lf_AUX_WfAsFixTerm2_1( ( * ef7)( ( constant0? constant0: ( constant0= ( * ef11)( ))) , ( * ef9)( ( * ef3)( ( * ef10)( atmp01000)))) , arg1);
}
}
}
}
...
return lf_AUX_WfAsFixTerm2_1( atmp0000 , atmp1000);
}
}
}
}
...
return ( * ef18)( lf_AUX_WfAsFixTerm2_1( atmp0000 , atmp1000) , lf_AUX_WfAsFixTerm2_1( ( * ef15)( ( * ef16)( atmp0001)) , ( * ef15)( ( * ef16)( atmp1001))));
}
}
}
}
...
{
ATerm atmp11000= arg_0( atmp1100);
return lf_AUX_WfAsFixTerm2_1( arg0 , ( * ef7)( ( constant0? constant0: ( constant0= ( * ef11)( ))) , ( * ef9)( ( * ef3)( ( * ef10)( ( * ef12)( atmp11000))))));
}
}
}
}
...
{
ATerm atmp11000= arg_0( atmp1100);
return lf_AUX_WfAsFixTerm2_1( arg0 , ( * ef7)( ( constant0? constant0: ( constant0= ( * ef11)( ))) , ( * ef9)( ( * ef3)( ( * ef10)( atmp11000)))));
}
}
}
}
