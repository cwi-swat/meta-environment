...
lf_AUX_WfAsFixTerm2_1sym= ATmakeSymbol( "prod(id(\"WfAsFixTerm\"),w(\"\"),[l(\"asfix-type-of\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_WfAsFixTerm2_1sym);
register_prod( ATparse( "prod(id(\"WfAsFixTerm\"),w(\"\"),[l(\"asfix-type-of\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)") , lf_AUX_WfAsFixTerm2_1 , lf_AUX_WfAsFixTerm2_1sym);
}
...
if( term_equal( ( * ef20)( ( * ef13)( ( * ef13)( tmp[ 0] , ( constant2? constant2: ( constant2= ( * ef14)( )))) , ( constant4? constant4: ( constant4= ( * ef21)( )))) , lf_AUX_WfAsFixTerm2_1( ( * ef13)( tmp[ 0] , ( constant5? constant5: ( constant5= ( * ef22)( )))))) , ( constant3? constant3: ( constant3= ( * ef19)( ))))) {
