...
lf_AUX_Rules2C_Aux23_2sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-first-cond-and-add-env\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-first-cond-and-add-env\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux23_2 , lf_AUX_Rules2C_Aux23_2sym);
...
tmp[ 11]= lf_AUX_Rules2C_Aux23_2( lf_AUX_Rules2C_Aux23_1( make_list( tmp[ 1])) , arg1);
if( check_sym( tmp[ 11] , ef1sym)) {
tmp[ 12]= arg_0( tmp[ 11]);
if( check_sym( tmp[ 12] , lf_AUX_Rules2C_Aux23_1sym)) {
tmp[ 13]= arg_0( tmp[ 12]);
return ( * ef1)( lf_AUX_Rules2C_Aux23_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 7])) , lf4( make_list( tmp[ 10])) , tmp[ 4] , ( * ef3)( tmp[ 5] , arg1) , ( * ef3)( tmp[ 6] , arg1))) , make_list( tmp[ 13]))));
}
}
}
}
