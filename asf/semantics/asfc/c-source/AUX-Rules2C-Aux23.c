...
lf_AUX_Rules2C_Aux23_2sym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux23_2 , lf_AUX_Rules2C_Aux23_2sym ) ;
...
{
ATerm tmp [ 15 ] ;
FUNC_ENTRY ( lf_AUX_Rules2C_Aux23_2sym , ATmakeAppl ( lf_AUX_Rules2C_Aux23_2sym , arg0 ) ) ;
...
tmp [ 12 ] = lf_AUX_Rules2C_Aux23_2 ( lf_AUX_Rules2C_Aux23_1 ( make_list ( tmp [ 1 ] ) ) ) ;
if ( check_sym ( tmp [ 12 ] , ef1sym ) ) {
tmp [ 13 ] = arg_0 ( tmp [ 12 ] ) ;
if ( check_sym ( tmp [ 13 ] , lf_AUX_Rules2C_Aux23_1sym ) ) {
tmp [ 14 ] = arg_0 ( tmp [ 13 ] ) ;
FUNC_EXIT ( ( * ef1 ) ( lf_AUX_Rules2C_Aux23_1 ( cons ( make_list ( ( * ef2 ) ( lf3 ( make_list ( tmp [ 11 ] ) ) , lf4 ( make_list ( tmp [ 9 ] ) ) , tmp [ 4 ] , tmp [ 5 ] , tmp [ 6 ] , tmp [ 7 ] ) ) , make_list ( tmp [ 14 ] ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT_CONST ( constant0 , ( * ef1 ) ( lf_AUX_Rules2C_Aux23_1 ( make_list ( null ( ) ) ) ) ) ;
}
}
}
FUNC_EXIT ( make_nf1 ( lf_AUX_Rules2C_Aux23_2sym , arg0 ) ) ;
}
}
ATerm lf_AUX_Rules2C_Aux23_1 ( ATerm arg0 ) {
CONS_ENTRY ( lf_AUX_Rules2C_Aux23_1sym , ATmakeAppl ( lf_AUX_Rules2C_Aux23_1sym , arg0 ) ) ;
CONS_EXIT ( make_nf1 ( lf_AUX_Rules2C_Aux23_1sym , arg0 ) ) ;
}
