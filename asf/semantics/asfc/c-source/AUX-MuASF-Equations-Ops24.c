...
static Symbol lf_AUX_MuASF_Equations_Ops24_1sym ;
static ATerm lf_AUX_MuASF_Equations_Ops24_1 ( ATerm arg1 ) ;
...
static funcptr ef3 ;
void register_AUX_MuASF_Equations_Ops24 ( ) {
lf_AUX_MuASF_Equations_Ops24_1sym = ATmakeSymbol ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[l(\"is-quoted-funid\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Equations_Ops24_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[l(\"is-quoted-funid\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Equations_Ops24_1 , lf_AUX_MuASF_Equations_Ops24_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_MuASF_Equations_Ops24 ( ) {
...
void init_AUX_MuASF_Equations_Ops24 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_MuASF_Equations_Ops24_1 ( ATerm arg0 ) {
{
ATerm tmp [ 2 ] ;
FUNC_ENTRY ( lf_AUX_MuASF_Equations_Ops24_1sym , ATmakeAppl ( lf_AUX_MuASF_Equations_Ops24_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_MuASF_Equations_Ops24_1sym , arg0 ) ) ;
}
}
