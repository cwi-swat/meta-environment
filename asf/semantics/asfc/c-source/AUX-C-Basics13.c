#include "support.h"
static asymbol * lf_AUX_C_Basics13_1sym;
static aterm * lf_AUX_C_Basics13_1( aterm * arg1 , aterm * arg2);
...
lf_AUX_C_Basics13_1sym= TmkSymbol( "prod(id(\"C-Basics\"),w(\"\"),[l(\"contains-unprotect\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Expression\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"contains-unprotect\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_C_Basics13_1 , lf_AUX_C_Basics13_1sym);
...
ef12= lookup_func( TmakeSimple( & local , "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Statement-list\"),w(\"\"),sort(\"Statement\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),no-attrs)"));
ef12sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Statement-list\"),w(\"\"),sort(\"Statement\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),no-attrs)"));
}
aterm * lf_AUX_C_Basics13_1( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[11];
...
if( check_sym( atmp1000 , ef6sym)) {
{
aterm * atmp10000= arg_0( atmp1000);
if( check_sym( atmp10000 , ef7sym)) {
{
aterm * atmp100000= arg_0( atmp10000);
if( check_sym( atmp100000 , ef8sym)) {
{
aterm * atmp1000000= arg_0( atmp100000);
if( check_sym( atmp1000000 , ef9sym)) {
{
...
if( check_sym( atmp100001 , ef10sym)) {
{
...
tmp[ 10]= m_list_head( atmp10000100);
if( m_term_equal( arg0 , tmp[ 10])) {
t_unprotect( arg0);
t_unprotect( arg1);
t_unprotect( tmp[ 0]);
t_unprotect( tmp[ 1]);
...
if( check_sym( atmp101001 , ef10sym)) {
{
...
tmp[ 10]= m_list_head( atmp10100100);
if( m_term_equal( arg0 , tmp[ 10])) {
t_unprotect( arg0);
t_unprotect( arg1);
t_unprotect( tmp[ 0]);
...
t_protect( atmp100);
t_unprotect( arg1);
return lf_AUX_C_Basics13_1( arg0 , ( * ef3)( atmp100));
}
}
}
}
...
return make_nf2( lf_AUX_C_Basics13_1sym , arg0 , arg1);
}
}
