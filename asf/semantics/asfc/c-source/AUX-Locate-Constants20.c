...
static ATerm lf_AUX_Locate_Constants20_2 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
lf_AUX_Locate_Constants20_2sym = ATmakeSymbol ( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"add-to-ce-pairs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CEEI-tuple\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"add-to-ce-pairs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CEEI-tuple\"),w(\"\"),no-attrs)" ) , lf_AUX_Locate_Constants20_2 , lf_AUX_Locate_Constants20_2sym ) ;
...
ATerm lf_AUX_Locate_Constants20_2 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 15 ] ;
PROF ( prof_lf_AUX_Locate_Constants20_2 ) ;
if ( check_sym ( arg1 , lf_AUX_Locate_Constants20_1sym ) ) {
{
...
tmp [ 7 ] = lf_AUX_Locate_Constants20_2 ( arg0 , lf_AUX_Locate_Constants20_1 ( make_list ( tmp [ 1 ] ) ) , arg2 ) ;
if ( check_sym ( tmp [ 7 ] , ef1sym ) ) {
tmp [ 8 ] = arg_0 ( tmp [ 7 ] ) ;
tmp [ 9 ] = arg_1 ( tmp [ 7 ] ) ;
tmp [ 10 ] = arg_2 ( tmp [ 7 ] ) ;
if ( check_sym ( tmp [ 8 ] , lf_AUX_Locate_Constants20_1sym ) ) {
tmp [ 11 ] = arg_0 ( tmp [ 8 ] ) ;
...
tmp [ 14 ] = arg_0 ( tmp [ 13 ] ) ;
return ( * ef1 ) ( lf_AUX_Locate_Constants20_1 ( cons ( make_list ( ( * ef2 ) ( ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 6 ] ) ) ) , tmp [ 3 ] ) ) , make_list ( tmp [ 11 ] ) ) ) , ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 14 ] ) ) ) , tmp [ 10 ] ) ;
}
}
}
}
...
return ( * ef1 ) ( lf_AUX_Locate_Constants20_1 ( cons ( make_list ( ( * ef2 ) ( ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 6 ] ) ) ) , arg0 ) ) , make_list ( tmp [ 1 ] ) ) ) , ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 6 ] ) ) ) , arg2 ) ;
}
}
}
}
...
tmp [ 2 ] = arg_0 ( tmp [ 1 ] ) ;
tmp [ 3 ] = ( * ef8 ) ( arg2 ) ;
tmp [ 4 ] = ( * ef9 ) ( lf3 ( cons ( ( constant0 ? constant0 : ( constant0 = make_list ( make_char ( 99 ) ) ) ) , cons ( ( constant1 ? constant1 : ( constant1 = make_list ( make_char ( 111 ) ) ) ) , cons ( ( constant2 ? constant2 : ( constant2 = make_list ( make_char ( 110 ) ) ) ) , cons ( ( constant3 ? constant3 : ( constant3 = make_list ( make_char ( 115 ) ) ) ) , cons ( ( constant4 ? constant4 : ( constant4 = make_list ( make_char ( 116 ) ) ) ) , cons ( ( constant5 ? constant5 : ( constant5 = make_list ( make_char ( 97 ) ) ) ) , cons ( ( constant2 ? constant2 : ( constant2 = make_list ( make_char ( 110 ) ) ) ) , cons ( ( constant4 ? constant4 : ( constant4 = make_list ( make_char ( 116 ) ) ) ) , make_list ( tmp [ 2 ] ) ) ) ) ) ) ) ) ) ) ) ;
return ( * ef1 ) ( lf_AUX_Locate_Constants20_1 ( make_list ( ( * ef2 ) ( ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 4 ] ) ) ) , arg0 ) ) ) , ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( tmp [ 4 ] ) ) ) , tmp [ 3 ] ) ;
}
}
}
}
...
return make_nf3 ( lf_AUX_Locate_Constants20_2sym , arg0 , arg1 , arg2 ) ;
}
}
ATerm lf_AUX_Locate_Constants20_1 ( ATerm arg0 ) {
PROF ( prof_lf_AUX_Locate_Constants20_1 ) ;
return make_nf1 ( lf_AUX_Locate_Constants20_1sym , arg0 ) ;
}
