...
static ATerm lf_AUX_Locate_Constants20_1( ATerm arg1 , ATerm arg2);
...
lf_AUX_Locate_Constants20_1sym= ATmakeSymbol( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"compose-list-of-chars\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"compose-list-of-chars\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)") , lf_AUX_Locate_Constants20_1 , lf_AUX_Locate_Constants20_1sym);
...
ef7= lookup_func( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Identifier\"),w(\"\"),ql(\")\"),w(\"\"),sort(\"Primary-expression\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Cast-expression\"),w(\"\"),no-attrs)"));
ef7sym= lookup_sym( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Identifier\"),w(\"\"),ql(\")\"),w(\"\"),sort(\"Primary-expression\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Cast-expression\"),w(\"\"),no-attrs)"));
...
ef12= lookup_func( ATreadFromString( "prod(id(\"caller\"),w(\"\"),[l(\"aint\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AInt\"),w(\"\"),no-attrs)"));
ef12sym= lookup_sym( ATreadFromString( "prod(id(\"caller\"),w(\"\"),[l(\"aint\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AInt\"),w(\"\"),no-attrs)"));
}
...
ATerm lf_AUX_Locate_Constants20_1( ATerm arg0 , ATerm arg1) {
{
ATerm tmp[27];
PROF( prof_lf_AUX_Locate_Constants20_1);
...
return ( * ef1)( ( * ef7)( ( constant0? constant0: ( constant0= ( * ef5)( lf2( (ATerm) ATmakeList( 5 , char_table[ 65] , char_table[ 84] , char_table[ 101] , char_table[ 114] , char_table[ 109]))))) , ( * ef3)( ( constant1? constant1: ( constant1= ( * ef4)( ( * ef5)( lf2( (ATerm) ATmakeList( 10 , char_table[ 65] , char_table[ 84] , char_table[ 109] , char_table[ 97] , char_table[ 107] , char_table[ 101] , char_table[ 76] , char_table[ 105] , char_table[ 115] , char_table[ 116])))))) , ( * ef6)( lf3( cons( ( constant2? constant2: ( constant2= make_list( ( * ef1)( ( * ef2)( ( * ef8)( ( * ef9)( lf2( make_list( make_char( 50)))))))))) , cons( make_list( ( * ef1)( ( * ef2)( ( * ef10)( ( constant3? constant3: ( constant3= ( * ef4)( ( * ef5)( lf2( (ATerm) ATmakeList( 10 , char_table[ 99] , char_table[ 104] , char_table[ 97] , char_table[ 114] , char_table[ 95] , char_table[ 116] , char_table[ 97] , char_table[ 98] , char_table[ 108] , char_table[ 101])))))) , arg0)))) , make_list( ( * ef1)( ( * ef2)( ( * ef10)( ( constant3? constant3: ( constant3= ( * ef4)( ( * ef5)( lf2( (ATerm) ATmakeList( 10 , char_table[ 99] , char_table[ 104] , char_table[ 97] , char_table[ 114] , char_table[ 95] , char_table[ 116] , char_table[ 97] , char_table[ 98] , char_table[ 108] , char_table[ 101])))))) , tmp[ 26])))))))))));
}
}
}
}
...
tmp[ 19]= arg_0( tmp[ 18]);
tmp[ 20]= ( * ef11)( ( * ef12)( lf2( make_list( tmp[ 19]))));
if( check_sym( tmp[ 20] , ef12sym)) {
tmp[ 21]= arg_0( tmp[ 20]);
if( check_sym( tmp[ 21] , lf2sym)) {
tmp[ 22]= arg_0( tmp[ 21]);
return ( * ef1)( ( * ef7)( ( constant0? constant0: ( constant0= ( * ef5)( lf2( (ATerm) ATmakeList( 5 , char_table[ 65] , char_table[ 84] , char_table[ 101] , char_table[ 114] , char_table[ 109]))))) , ( * ef3)( ( constant1? constant1: ( constant1= ( * ef4)( ( * ef5)( lf2( (ATerm) ATmakeList( 10 , char_table[ 65] , char_table[ 84] , char_table[ 109] , char_table[ 97] , char_table[ 107] , char_table[ 101] , char_table[ 76] , char_table[ 105] , char_table[ 115] , char_table[ 116])))))) , ( * ef6)( lf3( cons( make_list( ( * ef1)( ( * ef2)( ( * ef8)( ( * ef9)( lf2( make_list( tmp[ 22]))))))) , cons( make_list( ( * ef1)( ( * ef2)( ( * ef10)( ( constant3? constant3: ( constant3= ( * ef4)( ( * ef5)( lf2( (ATerm) ATmakeList( 10 , char_table[ 99] , char_table[ 104] , char_table[ 97] , char_table[ 114] , char_table[ 95] , char_table[ 116] , char_table[ 97] , char_table[ 98] , char_table[ 108] , char_table[ 101])))))) , arg0)))) , make_list( tmp[ 14]))))))));
}
}
}
}
...
return ( * ef1)( ( * ef2)( ( * ef3)( ( constant4? constant4: ( constant4= ( * ef4)( ( * ef5)( lf2( (ATerm) ATmakeList( 4 , char_table[ 99] , char_table[ 111] , char_table[ 110] , char_table[ 115])))))) , ( * ef6)( lf3( cons( make_list( ( * ef1)( ( * ef2)( ( * ef3)( ( constant5? constant5: ( constant5= ( * ef4)( ( * ef5)( lf2( (ATerm) ATmakeList( 14 , char_table[ 109] , char_table[ 97] , char_table[ 107] , char_table[ 101] , char_table[ 95] , char_table[ 108] , char_table[ 105] , char_table[ 115] , char_table[ 116] , char_table[ 95] , char_table[ 99] , char_table[ 104] , char_table[ 97] , char_table[ 114])))))) , ( * ef6)( lf3( make_list( arg0))))))) , make_list( arg1)))))));
}
}
