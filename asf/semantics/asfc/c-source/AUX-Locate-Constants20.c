...
ef20 = lookup_func ( ATreadFromString ( "prod(id(\"GEN-LexConsFuncs\"),w(\"\"),[ql(\"integer-constant\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Integer-constant\"),w(\"\"),no-attrs)" ) ) ;
ef20sym = lookup_sym ( ATreadFromString ( "prod(id(\"GEN-LexConsFuncs\"),w(\"\"),[ql(\"integer-constant\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Integer-constant\"),w(\"\"),no-attrs)" ) ) ;
...
FUNC_EXIT ( ( * ef5 ) ( lf3 ( make_list ( null ( ) ) ) , ( * ef6 ) ( make_nf1 ( ef7sym , lf4 ( cons ( make_list ( tmp [ 21 ] ) , make_list ( ( * ef8 ) ( make_nf1 ( ef9sym , lf5 ( make_list ( ( * ef11 ) ( ( * ef12 ) ( lf6 ( ( ATerm ) ATmakeList ( 10 , char_table [ 65 ] , char_table [ 84 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 109 ] , char_table [ 84 ] , char_table [ 97 ] , char_table [ 98 ] , char_table [ 108 ] , char_table [ 101 ] ) ) ) ) ) ) ) , ( * ef13 ) ( tmp [ 6 ] ) ) ) ) ) ) ) , ( * ef14 ) ( make_nf1 ( ef15sym , lf7 ( cons ( make_list ( tmp [ 24 ] ) , make_list ( ( * ef16 ) ( ( * ef2 ) ( ( * ef3 ) ( ( * ef17 ) ( ( * ef4 ) ( ( * ef12 ) ( lf6 ( ( ATerm ) ATmakeList ( 12 , char_table [ 99 ] , char_table [ 114 ] , char_table [ 101 ] , char_table [ 97 ] , char_table [ 116 ] , char_table [ 101 ] , char_table [ 95 ] , char_table [ 116 ] , char_table [ 97 ] , char_table [ 98 ] , char_table [ 108 ] , char_table [ 101 ] ) ) ) ) , make_nf1 ( ef18sym , lf8 ( cons ( make_list ( ( * ef2 ) ( ( * ef3 ) ( ( * ef4 ) ( tmp [ 6 ] ) ) ) ) , make_list ( ( * ef2 ) ( ( * ef3 ) ( ( * ef19 ) ( ( * ef20 ) ( lf6 ( make_list ( make_char ( 48 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
}
}
}
}
