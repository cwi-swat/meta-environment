#include "support.h"
static Symbol lf_AUX_C_Basics12_2sym;
static ATerm lf_AUX_C_Basics12_2( ATerm arg1 , ATerm arg2);
...
lf_AUX_C_Basics12_2sym= ATmakeSymbol( "prod(id(\"C-Basics\"),w(\"\"),[l(\"get-funid\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_C_Basics12_2sym);
lf_AUX_C_Basics12_1sym= ATmakeSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_C_Basics12_1sym);
register_prod( ATparse( "listtype(sort(\"NamePair\"),ql(\",\"))") , lf_AUX_C_Basics12_1 , lf_AUX_C_Basics12_1sym);
register_prod( ATparse( "prod(id(\"C-Basics\"),w(\"\"),[l(\"get-funid\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)") , lf_AUX_C_Basics12_2 , lf_AUX_C_Basics12_2sym);
}
...
ATerm lf_AUX_C_Basics12_2( ATerm arg0 , ATerm arg1) {
{
ATerm tmp[4];
PROF( prof_lf_AUX_C_Basics12_2);
if( check_sym( arg1 , lf_AUX_C_Basics12_1sym)) {
{
...
tmp[ 2]= ( * ef4)( tmp[ 0]);
tmp[ 3]= ( * ef5)( tmp[ 2] , lf_AUX_C_Basics12_1( make_list( atmp10)));
return tmp[ 3];
}
...
return make_nf2( lf_AUX_C_Basics12_2sym , arg0 , arg1);
}
}
ATerm lf_AUX_C_Basics12_1( ATerm arg0) {
PROF( prof_lf_AUX_C_Basics12_1);
return make_nf1( lf_AUX_C_Basics12_1sym , arg0);
}
