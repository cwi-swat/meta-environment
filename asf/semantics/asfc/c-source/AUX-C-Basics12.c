#include "support.h"
static asymbol * lf_AUX_C_Basics12_1sym;
static aterm * lf_AUX_C_Basics12_1( aterm * arg1 , aterm * arg2);
...
lf_AUX_C_Basics12_1sym= TmkSymbol( "prod(id(\"C-Basics\"),w(\"\"),[l(\"contains-protect\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Expression\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"contains-protect\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_C_Basics12_1 , lf_AUX_C_Basics12_1sym);
...
aterm * lf_AUX_C_Basics12_1( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[9];
PROF( prof_lf_AUX_C_Basics12_1);
...
t_protect( atmp100);
t_unprotect( arg1);
return lf_AUX_C_Basics12_1( arg0 , ( * ef3)( atmp100));
}
}
}
}
...
return make_nf2( lf_AUX_C_Basics12_1sym , arg0 , arg1);
}
}
