...
lf_AUX_Locate_Constants15_1sym = ATmakeSymbol ( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"is-exit-func\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"is-exit-func\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_Locate_Constants15_1 , lf_AUX_Locate_Constants15_1sym ) ;
...
{
ATerm tmp [ 10 ] ;
FUNC_ENTRY ( lf_AUX_Locate_Constants15_1sym , ATmakeAppl ( lf_AUX_Locate_Constants15_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Locate_Constants15_1sym , arg0 ) ) ;
}
}
