...
static ATerm lf_AUX_MuASF2C2_1 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
lf_AUX_MuASF2C2_1sym = ATmakeSymbol ( "prod(id(\"MuASF2C\"),w(\"\"),[l(\"muASF2C-internal\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Module\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CProgram\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"MuASF2C\"),w(\"\"),[l(\"muASF2C-internal\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Module\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CProgram\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF2C2_1 , lf_AUX_MuASF2C2_1sym ) ;
...
ef9 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"rulesopt2cfuncs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"RulesOpt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FT-tuple\"),w(\"\"),no-attrs)" ) ) ;
ef9sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"rulesopt2cfuncs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"RulesOpt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FT-tuple\"),w(\"\"),no-attrs)" ) ) ;
...
ATerm lf_AUX_MuASF2C2_1 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 9 ] ;
FUNC_ENTRY ( lf_AUX_MuASF2C2_1sym , ATmakeAppl ( lf_AUX_MuASF2C2_1sym , arg0 , arg1 , arg2 ) ) ;
...
( tmp [ 0 ] = ( * ef7 ) ( arg0 , atmp11 , arg2 ) ) ;
if ( check_sym ( tmp [ 0 ] , ef8sym ) ) {
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
( tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ) ;
if ( check_sym ( tmp [ 1 ] , lf3sym ) ) {
( tmp [ 3 ] = arg_0 ( tmp [ 1 ] ) ) ;
( tmp [ 4 ] = ( * ef9 ) ( arg0 , lf3 ( make_list ( tmp [ 3 ] ) ) , atmp12 , arg2 ) ) ;
...
FUNC_EXIT ( ( * ef2 ) ( ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( lf2 ( ( ATerm ) ATmakeList ( 15 , char_table [ 34 ] , char_table [ 97 ] , char_table [ 115 ] , char_table [ 99 ] , char_table [ 45 ] , char_table [ 115 ] , char_table [ 117 ] , char_table [ 112 ] , char_table [ 112 ] , char_table [ 111 ] , char_table [ 114 ] , char_table [ 116 ] , char_table [ 46 ] , char_table [ 104 ] , char_table [ 34 ] ) ) ) ) ) , ( * ef6 ) ( ( * ef6 ) ( tmp [ 2 ] , tmp [ 6 ] ) , tmp [ 8 ] ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf3 ( lf_AUX_MuASF2C2_1sym , arg0 , arg1 , arg2 ) ) ;
}
}
