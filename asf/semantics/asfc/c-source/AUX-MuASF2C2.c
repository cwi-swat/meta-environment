...
static ATerm lf_AUX_MuASF2C2_1( ATerm arg1 , ATerm arg2);
...
lf_AUX_MuASF2C2_1sym= ATmakeSymbol( "prod(id(\"MuASF2C\"),w(\"\"),[l(\"muASF2C\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Module\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CProgram\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"MuASF2C\"),w(\"\"),[l(\"muASF2C\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Module\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CProgram\"),w(\"\"),no-attrs)") , lf_AUX_MuASF2C2_1 , lf_AUX_MuASF2C2_1sym);
...
ATerm lf_AUX_MuASF2C2_1( ATerm arg0 , ATerm arg1) {
{
ATerm tmp[10];
...
tmp[ 9]= ( * ef11)( atmp00 , tmp[ 6]);
return ( * ef2)( ( constant0? constant0: ( constant0= ( * ef3)( ( * ef4)( ( * ef5)( lf2( (ATerm) ATmakeList( 11 , char_table[ 34] , char_table[ 115] , char_table[ 117] , char_table[ 112] , char_table[ 112] , char_table[ 111] , char_table[ 114] , char_table[ 116] , char_table[ 46] , char_table[ 104] , char_table[ 34]))))))) , ( * ef6)( ( * ef6)( tmp[ 2] , tmp[ 9]) , tmp[ 8]));
}
}
}
}
...
return make_nf2( lf_AUX_MuASF2C2_1sym , arg0 , arg1);
}
}
