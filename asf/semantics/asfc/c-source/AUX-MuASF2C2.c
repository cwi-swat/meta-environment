...
ef9 = lookup_func ( ATreadFromString ( "prod(id(\"Make-Left-Linear\"),w(\"\"),[l(\"make-left-linear\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Module\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Module\"),w(\"\"),no-attrs)" ) ) ;
ef9sym = lookup_sym ( ATreadFromString ( "prod(id(\"Make-Left-Linear\"),w(\"\"),[l(\"make-left-linear\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Module\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Module\"),w(\"\"),no-attrs)" ) ) ;
}
...
{
ATerm tmp [ 2 ] ;
FUNC_ENTRY ( lf_AUX_MuASF2C2_1sym , ATmakeAppl ( lf_AUX_MuASF2C2_1sym , arg0 ) ) ;
...
tmp [ 1 ] = ( * ef9 ) ( ( * ef1 ) ( ( * ef2 ) ( lf2 ( make_list ( atmp0000 ) ) ) , atmp01 , atmp02 ) ) ;
FUNC_EXIT ( ( * ef3 ) ( tmp [ 1 ] , tmp [ 0 ] ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf1 ( lf_AUX_MuASF2C2_1sym , arg0 ) ) ;
}
}
