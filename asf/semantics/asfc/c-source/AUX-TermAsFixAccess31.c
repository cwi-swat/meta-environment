...
static Symbol lf_AUX_TermAsFixAccess31_1sym ;
static ATerm lf_AUX_TermAsFixAccess31_1 ( ATerm arg1 ) ;
...
static funcptr ef17 ;
void register_AUX_TermAsFixAccess31 ( ) {
lf_AUX_TermAsFixAccess31_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-constructor-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess31_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-constructor-attr-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess31_1 , lf_AUX_TermAsFixAccess31_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess31 ( ) {
...
void init_AUX_TermAsFixAccess31 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess31_1 ( ATerm arg0 ) {
{
ATerm tmp [ 46 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess31_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess31_1sym , arg0 ) ) ;
...
if ( term_equal ( list_head ( tmp [ 6 ] ) , make_char ( 83 ) ) ) {
( tmp [ 7 ] = list_tail ( tmp [ 6 ] ) ) ;
if ( not_empty_list ( tmp [ 7 ] ) ) {
if ( term_equal ( list_head ( tmp [ 7 ] ) , make_char ( 100 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 14 ] ) , make_char ( 97 ) ) ) {
( tmp [ 15 ] = list_tail ( tmp [ 14 ] ) ) ;
if ( not_empty_list ( tmp [ 15 ] ) ) {
if ( term_equal ( list_head ( tmp [ 15 ] ) , make_char ( 120 ) ) ) {
...
( tmp [ 17 ] = list_tail ( atmp0110100000 ) ) ;
...
( tmp [ 18 ] = list_tail ( atmp01110000100000 ) ) ;
...
if ( term_equal ( list_head ( tmp [ 35 ] ) , make_char ( 65 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 40 ] ) , make_char ( 98 ) ) ) {
( tmp [ 41 ] = list_tail ( tmp [ 40 ] ) ) ;
if ( not_empty_list ( tmp [ 41 ] ) ) {
if ( term_equal ( list_head ( tmp [ 41 ] ) , make_char ( 117 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 43 ] ) , make_char ( 101 ) ) ) {
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess31_1sym , arg0 ) ) ;
}
}
