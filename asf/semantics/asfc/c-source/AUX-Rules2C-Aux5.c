...
return ( * ef3)( lf4( make_list( ( * ef4)( tmp[ 0] , ( * ef5)( ( * ef6)( ( * ef7)( ( * ef8)( lf3( cons( ( constant0? constant0: ( constant0= make_list_char( 97))) , cons( ( constant1? constant1: ( constant1= make_list_char( 114))) , cons( ( constant2? constant2: ( constant2= make_list_char( 103))) , make_list( atmp1000)))))))))))));
}
}
}
}
...
return ( * ef9)( ( * ef3)( lf4( make_list( ( * ef4)( tmp[ 0] , ( * ef5)( ( * ef6)( ( * ef7)( ( * ef8)( lf3( cons( ( constant0? constant0: ( constant0= make_list_char( 97))) , cons( ( constant1? constant1: ( constant1= make_list_char( 114))) , cons( ( constant2? constant2: ( constant2= make_list_char( 103))) , make_list( tmp[ 4]))))))))))))) , tmp[ 5]);
}
}
}
}
