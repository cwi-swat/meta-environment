...
lf_AUX_Rules2C_Aux5_2sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"funargs2cexp\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-env\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"funargs2cexp\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-env\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux5_2 , lf_AUX_Rules2C_Aux5_2sym);
...
ef8= lookup_func( ATreadFromString( "prod(id(\"C-Basics\"),w(\"\"),[sort(\"C-env\"),w(\"\"),ql(\"++\"),w(\"\"),sort(\"C-env\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-env\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))"));
ef8sym= lookup_sym( ATreadFromString( "prod(id(\"C-Basics\"),w(\"\"),[sort(\"C-env\"),w(\"\"),ql(\"++\"),w(\"\"),sort(\"C-env\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-env\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))"));
...
return ( * ef2)( lf4( make_list( ( * ef3)( tmp[ 0] , ( * ef4)( ( * ef5)( ( * ef6)( ( * ef7)( lf3( cons( ( constant0? constant0: ( constant0= make_list_char( 97))) , cons( ( constant1? constant1: ( constant1= make_list_char( 114))) , cons( ( constant2? constant2: ( constant2= make_list_char( 103))) , make_list( atmp100)))))))))))));
}
}
}
}
...
tmp[ 3]= arg_0( tmp[ 2]);
tmp[ 4]= lf_AUX_Rules2C_Aux5_2( lf_AUX_Rules2C_Aux5_1( make_list( tmp[ 1])) , ( * ef9)( arg1));
return ( * ef8)( ( * ef2)( lf4( make_list( ( * ef3)( tmp[ 0] , ( * ef4)( ( * ef5)( ( * ef6)( ( * ef7)( lf3( cons( ( constant0? constant0: ( constant0= make_list_char( 97))) , cons( ( constant1? constant1: ( constant1= make_list_char( 114))) , cons( ( constant2? constant2: ( constant2= make_list_char( 103))) , make_list( tmp[ 3]))))))))))))) , tmp[ 4]);
}
}
}
}
