...
lf_AUX_Rules2C_Aux5_2sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-c-expression\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"
 , 3 , ATtrue);
ATprotectSymbol( lf_AUX_Rules2C_Aux5_2sym);
lf4sym= ATmakeSymbol( "listtype(sort(\"Expression\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf4sym);
lf_AUX_Rules2C_Aux5_1sym= ATmakeSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Rules2C_Aux5_1sym);
lf3sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf3sym);
register_prod( ATparse( "listtype(sort(\"NamePair\"),ql(\",\"))") , lf_AUX_Rules2C_Aux5_1 , lf_AUX_Rules2C_Aux5_1sym);
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-c-expression\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux5_2 , lf_AUX_Rules2C_Aux5_2sym);
...
tmp[ 1]= ( * ef9)( arg0);
return ( * ef1)( ( * ef2)( ( * ef3)( ( constant1? constant1: ( constant1= ( * ef4)( ( * ef5)( lf3( (ATerm) ATmakeList( 7 , char_table[ 105] , char_table[ 115] , char_table[ 95] , char_table[ 99] , char_table[ 104] , char_table[ 97] , char_table[ 114])))))) , ( * ef6)( lf4( cons( make_list( arg1) , make_list( tmp[ 1])))))));
}
if( term_equal( tmp[ 0] , ( constant2? constant2: ( constant2= ( * ef10)( ))))) {
tmp[ 1]= ( * ef11)( ( * ef12)( arg0) , lf_AUX_Rules2C_Aux5_1( make_list( atmp20)));
if( check_sym( tmp[ 1] , ef13sym)) {
tmp[ 2]= arg_0( tmp[ 1]);
if( check_sym( tmp[ 2] , lf3sym)) {
tmp[ 3]= arg_0( tmp[ 2]);
return ( * ef1)( ( * ef2)( ( * ef3)( ( constant3? constant3: ( constant3= ( * ef4)( ( * ef5)( lf3( (ATerm) ATmakeList( 9 , char_table[ 99] , char_table[ 104] , char_table[ 101] , char_table[ 99] , char_table[ 107] , char_table[ 95] , char_table[ 115] , char_table[ 121] , char_table[ 109])))))) , ( * ef6)( lf4( cons( make_list( arg1) , make_list( ( * ef1)( ( * ef2)( ( * ef4)( ( * ef5)( lf3( cons( make_list( tmp[ 3]) , ( constant4? constant4: ( constant4= (ATerm) ATmakeList( 3 , char_table[ 115] , char_table[ 121] , char_table[ 109]))))))))))))))));
}
}
}
}
