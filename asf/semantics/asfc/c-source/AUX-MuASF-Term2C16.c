#include  "support.h"
static Symbol lf_AUX_MuASF_Term2C16_2sym ;
static ATerm lf_AUX_MuASF_Term2C16_2 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
static funcptr ef8 ;
static Symbol lf_AUX_MuASF_Term2C16_1sym ;
static ATerm lf_AUX_MuASF_Term2C16_1 ( ATerm arg1 ) ;
void register_AUX_MuASF_Term2C16 ( ) {
lf_AUX_MuASF_Term2C16_2sym = ATmakeSymbol ( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"unquote-plain-argument\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Term2C16_2sym ) ;
lf4sym = ATmakeSymbol ( "listtype(sort(\"Expression\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf4sym ) ;
lf3sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf3sym ) ;
lf_AUX_MuASF_Term2C16_1sym = ATmakeSymbol ( "listtype(sort(\"NamePair\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Term2C16_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"NamePair\"),ql(\",\"))" ) , lf_AUX_MuASF_Term2C16_1 , lf_AUX_MuASF_Term2C16_1sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"unquote-plain-argument\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Term2C16_2 , lf_AUX_MuASF_Term2C16_2sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf3 , lf3sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Expression\"),ql(\",\"))" ) , lf4 , lf4sym ) ;
}
void resolve_AUX_MuASF_Term2C16 ( ) {
...
ef7 = lookup_func ( ATreadFromString ( "prod(id(\"VarEnv\"),w(\"\"),[l(\"is-protected\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
ef7sym = lookup_sym ( ATreadFromString ( "prod(id(\"VarEnv\"),w(\"\"),[l(\"is-protected\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
...
ATerm lf_AUX_MuASF_Term2C16_2 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 3 ] ;
PROF ( prof_lf_AUX_MuASF_Term2C16_2 ) ;
...
if ( check_sym ( arg2 , lf_AUX_MuASF_Term2C16_1sym ) ) {
{
...
if ( term_equal ( ( * ef7 ) ( arg1 , lf_AUX_MuASF_Term2C16_1 ( make_list ( atmp20 ) ) ) , ( constant0 ? constant0 : ( constant0 = ( * ef8 ) ( ) ) ) ) ) {
return ( * ef1 ) ( ( * ef2 ) ( ( * ef5 ) ( ( constant1 ? constant1 : ( constant1 = ( * ef3 ) ( ( * ef4 ) ( lf3 ( ( ATerm ) ATmakeList ( 7 , char_table [ 117 ] , char_table [ 110 ] , char_table [ 113 ] , char_table [ 117 ] , char_table [ 111 ] , char_table [ 116 ] , char_table [ 101 ] ) ) ) ) ) ) , ( * ef6 ) ( lf4 ( make_list ( ( * ef1 ) ( ( * ef2 ) ( ( * ef3 ) ( ( * ef4 ) ( lf3 ( cons ( ( constant2 ? constant2 : ( constant2 = make_list_char ( 97 ) ) ) , cons ( ( constant3 ? constant3 : ( constant3 = make_list_char ( 114 ) ) ) , cons ( ( constant4 ? constant4 : ( constant4 = make_list_char ( 103 ) ) ) , make_list ( tmp [ 2 ] ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
}
}
}
}
...
return make_nf3 ( lf_AUX_MuASF_Term2C16_2sym , arg0 , arg1 , arg2 ) ;
}
}
ATerm lf_AUX_MuASF_Term2C16_1 ( ATerm arg0 ) {
PROF ( prof_lf_AUX_MuASF_Term2C16_1 ) ;
return make_nf1 ( lf_AUX_MuASF_Term2C16_1sym , arg0 ) ;
}
