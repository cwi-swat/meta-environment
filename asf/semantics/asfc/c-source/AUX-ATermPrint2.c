...
lf_AUX_ATermPrint2_1sym= ATmakeSymbol( "prod(id(\"ATermPrint\"),w(\"\"),[l(\"print-trms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerms\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_ATermPrint2_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"ATermPrint\"),w(\"\"),[l(\"print-trms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerms\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)") , lf_AUX_ATermPrint2_1 , lf_AUX_ATermPrint2_1sym);
...
return ( * ef4)( ( * ef4)( ( * ef2)( atmp00) , ( constant0? constant0: ( constant0= ( * ef5)( lf2( (ATerm) ATmakeList( 3 , char_table[ 34] , char_table[ 44] , char_table[ 34])))))) , lf_AUX_ATermPrint2_1( atmp01));
}
}
}
