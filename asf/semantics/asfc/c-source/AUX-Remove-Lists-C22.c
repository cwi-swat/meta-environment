#include "support.h"
static asymbol * lf_AUX_Remove_Lists_C22_2sym;
...
static funcptr ef1;
static asymbol * lf_AUX_Remove_Lists_C22_1sym;
...
lf_AUX_Remove_Lists_C22_2sym= TmkSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-double-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf4sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf_AUX_Remove_Lists_C22_1sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"Term\"),ql(\",\"))") , lf_AUX_Remove_Lists_C22_1 , lf_AUX_Remove_Lists_C22_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-double-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C22_2 , lf_AUX_Remove_Lists_C22_2sym);
...
ef8= lookup_func( TmakeSimple( & local , "prod(id(\"Remove-Lists-Aux\"),w(\"\"),[l(\"make-new-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Cond\"),w(\"\"),no-attrs)"));
ef8sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Remove-Lists-Aux\"),w(\"\"),[l(\"make-new-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Cond\"),w(\"\"),no-attrs)"));
...
ef17= lookup_func( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
ef17sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
}
...
t_unprotect( tmp[ 12]);
t_unprotect( tmp[ 19]);
return ( * ef1)( lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 20])))) , lf3( cons( make_list( ( * ef4)( ( * ef5)( ( * ef6)( lf4( cons( make_list( make_char( 110)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 112)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 121)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , make_list( make_char( 116))))))))))))))))) , lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 20]))))) , ( * ef7)( ( * ef6)( lf4( make_list( make_char( 116))))))) , cons( make_list( ( * ef8)( ( * ef5)( ( * ef6)( lf4( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 104)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 97)) , make_list( make_char( 100)))))))))))) , lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 20]))))) , tmp[ 10])) , cons( make_list( tmp[ 9]) , cons( make_list( ( * ef4)( ( * ef5)( ( * ef6)( lf4( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 97)) , cons( make_list( make_char( 105)) , make_list( make_char( 108)))))))))))) , lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 20]))))) , ( * ef2)( ( * ef3)( tmp[ 21])))) , cons( make_list( ( * ef4)( ( * ef5)( ( * ef6)( lf4( cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 110)) , cons( make_list( make_char( 103)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 110)) , make_list( make_char( 116)))))))))))))))))))) , lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 21]))))) , ( * ef7)( ( * ef6)( lf4( make_list( make_char( 116))))))) , cons( make_list( ( * ef8)( ( * ef5)( ( * ef6)( lf4( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 104)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 97)) , make_list( make_char( 100)))))))))))) , lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 21]))))) , tmp[ 18])) , make_list( tmp[ 17])))))))) , tmp[ 22]);
}
}
}
}
...
t_unprotect( tmp[ 12]);
t_unprotect( tmp[ 19]);
return ( * ef1)( lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 20])))) , lf3( cons( make_list( ( * ef4)( ( * ef5)( ( * ef6)( lf4( cons( make_list( make_char( 110)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 112)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 121)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , make_list( make_char( 116))))))))))))))))) , lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 20]))))) , ( * ef7)( ( * ef6)( lf4( make_list( make_char( 116))))))) , cons( make_list( ( * ef8)( ( * ef5)( ( * ef6)( lf4( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 104)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 97)) , make_list( make_char( 100)))))))))))) , lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 20]))))) , tmp[ 10])) , cons( make_list( tmp[ 9]) , cons( make_list( ( * ef4)( ( * ef5)( ( * ef6)( lf4( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 97)) , cons( make_list( make_char( 105)) , make_list( make_char( 108)))))))))))) , lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 20]))))) , tmp[ 18])) , make_list( tmp[ 17])))))) , tmp[ 21]);
}
}
}
}
...
t_unprotect( tmp[ 11]);
t_unprotect( tmp[ 18]);
return ( * ef1)( lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 19])))) , lf3( cons( make_list( ( * ef4)( ( * ef5)( ( * ef6)( lf4( cons( make_list( make_char( 110)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 112)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 121)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , make_list( make_char( 116))))))))))))))))) , lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 19]))))) , ( * ef7)( ( * ef6)( lf4( make_list( make_char( 116))))))) , cons( make_list( ( * ef4)( ( * ef5)( ( * ef6)( lf4( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 112)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 102)) , cons( make_list( make_char( 105)) , make_list( make_char( 120)))))))))))))) , lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 19]))))) , tmp[ 10])) , cons( make_list( tmp[ 9]) , cons( make_list( ( * ef8)( ( * ef5)( ( * ef6)( lf4( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 97)) , cons( make_list( make_char( 115)) , make_list( make_char( 116)))))))))))) , lf_AUX_Remove_Lists_C22_1( make_list( ( * ef2)( ( * ef3)( tmp[ 19]))))) , tmp[ 17])) , make_list( tmp[ 16])))))) , tmp[ 20]);
}
}
}
}
