#include "support.h"
static asymbol * lf_AUX_VarEnv7_1sym;
static aterm * lf_AUX_VarEnv7_1( aterm * arg1);
...
lf_AUX_VarEnv7_1sym= TmkSymbol( "prod(id(\"VarEnv\"),w(\"\"),[l(\"gen-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"VarEnv\"),w(\"\"),[l(\"gen-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)") , lf_AUX_VarEnv7_1 , lf_AUX_VarEnv7_1sym);
...
aterm * lf_AUX_VarEnv7_1( aterm * arg0) {
...
return make_nf1( lf_AUX_VarEnv7_1sym , arg0);
}
