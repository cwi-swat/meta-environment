...
static Symbol lf_AUX_TermAsFixAccess37_1sym ;
static ATerm lf_AUX_TermAsFixAccess37_1 ( ATerm arg1 ) ;
...
static funcptr ef17 ;
void register_AUX_TermAsFixAccess37 ( ) {
lf_AUX_TermAsFixAccess37_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-assoc-assoc-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess37_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-assoc-assoc-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess37_1 , lf_AUX_TermAsFixAccess37_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess37 ( ) {
...
void init_AUX_TermAsFixAccess37 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess37_1 ( ATerm arg0 ) {
{
ATerm tmp [ 47 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess37_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess37_1sym , arg0 ) ) ;
...
( tmp [ 27 ] = list_tail ( atmp011110100000 ) ) ;
...
( tmp [ 28 ] = list_tail ( atmp0111110100000 ) ) ;
...
( tmp [ 31 ] = list_tail ( atmp01111110100000 ) ) ;
...
( tmp [ 32 ] = list_tail ( atmp011111110100000 ) ) ;
if ( not_empty_list ( tmp [ 32 ] ) ) {
if ( term_equal ( list_head ( tmp [ 32 ] ) , make_char ( 65 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 36 ] ) , make_char ( 99 ) ) ) {
( tmp [ 37 ] = list_tail ( tmp [ 36 ] ) ) ;
if ( not_empty_list ( tmp [ 37 ] ) ) {
if ( term_equal ( list_head ( tmp [ 37 ] ) , make_char ( 105 ) ) ) {
( tmp [ 38 ] = list_tail ( tmp [ 37 ] ) ) ;
if ( not_empty_list ( tmp [ 38 ] ) ) {
if ( term_equal ( list_head ( tmp [ 38 ] ) , make_char ( 97 ) ) ) {
( tmp [ 39 ] = list_tail ( tmp [ 38 ] ) ) ;
if ( not_empty_list ( tmp [ 39 ] ) ) {
if ( term_equal ( list_head ( tmp [ 39 ] ) , make_char ( 116 ) ) ) {
( tmp [ 40 ] = list_tail ( tmp [ 39 ] ) ) ;
if ( not_empty_list ( tmp [ 40 ] ) ) {
if ( term_equal ( list_head ( tmp [ 40 ] ) , make_char ( 105 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 44 ] ) , make_char ( 121 ) ) ) {
...
( tmp [ 46 ] = list_tail ( atmp0111111110100000 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess37_1sym , arg0 ) ) ;
}
}
