...
t_protect( arg3);
t_protect( tmp[ 15]);
tmp[ 16]= ( * ef8)( lf_AUX_MuASF_Conds2C3_1( cons( make_list( ( * ef1)( lf4( make_list( tmp[ 7])) , lf5( cons( make_list( ( * ef2)( tmp[ 11] , tmp[ 12])) , make_list( tmp[ 10]))) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 1]))) , lf_AUX_MuASF_Conds2C3_1( make_list( null( ))) , arg1 , lf_AUX_MuASF_Conds2C3_2( make_list( atmp20)) , arg3 , tmp[ 15]);
...
t_protect( arg1);
t_protect( atmp20);
tmp[ 15]= ( * ef12)( ( * ef9)( ) , tmp[ 11] , tmp[ 5] , tmp[ 6] , ( * ef13)( arg3) , tmp[ 14] , arg1 , lf_AUX_MuASF_Conds2C3_2( make_list( atmp20)));
...
tmp[ 20]= arg_0( tmp[ 19]);
if( m_is_single_element( tmp[ 20])) {
tmp[ 21]= m_list_head( tmp[ 20]);
t_protect( tmp[ 14]);
t_protect( arg1);
...
t_protect( tmp[ 18]);
t_protect( tmp[ 14]);
tmp[ 23]= ( * ef8)( lf_AUX_MuASF_Conds2C3_1( cons( make_list( ( * ef1)( lf4( make_list( tmp[ 7])) , lf5( cons( make_list( ( * ef2)( tmp[ 11] , tmp[ 12])) , make_list( tmp[ 10]))) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 1]))) , lf_AUX_MuASF_Conds2C3_1( make_list( null( ))) , tmp[ 22] , lf_AUX_MuASF_Conds2C3_2( make_list( atmp20)) , tmp[ 18] , tmp[ 14]);
