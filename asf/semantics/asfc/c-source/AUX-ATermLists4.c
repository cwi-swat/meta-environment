...
static ATerm lf_AUX_ATermLists4_1( ATerm arg1);
...
lf_AUX_ATermLists4_1sym= ATmakeSymbol( "prod(id(\"ATermLists\"),w(\"\"),[l(\"aterm-list\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_ATermLists4_1sym);
register_prod( ATparse( "prod(id(\"ATermLists\"),w(\"\"),[l(\"aterm-list\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)") , lf_AUX_ATermLists4_1 , lf_AUX_ATermLists4_1sym);
}
...
ATerm lf_AUX_ATermLists4_1( ATerm arg0) {
...
return make_nf1( lf_AUX_ATermLists4_1sym , arg0);
}
