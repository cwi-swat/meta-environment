...
static Symbol lf_AUX_TermAsFix2Sign26_2sym ;
...
static ATerm lf_AUX_TermAsFix2Sign26_1 ( ATerm arg1 ) ;
void register_AUX_TermAsFix2Sign26 ( ) {
lf_AUX_TermAsFix2Sign26_2sym = ATmakeSymbol ( "prod(id(\"TermAsFix2Sign\"),w(\"\"),[sort(\"Term\"),w(\"\"),ql(\"++del\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFix2Sign26_2sym ) ;
lf3sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf3sym ) ;
lf_AUX_TermAsFix2Sign26_1sym = ATmakeSymbol ( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFix2Sign26_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"Term\"),ql(\",\"))" ) , lf_AUX_TermAsFix2Sign26_1 , lf_AUX_TermAsFix2Sign26_1sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFix2Sign\"),w(\"\"),[sort(\"Term\"),w(\"\"),ql(\"++del\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFix2Sign26_2 , lf_AUX_TermAsFix2Sign26_2sym ) ;
...
ATerm lf_AUX_TermAsFix2Sign26_2 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 21 ] ;
...
if ( check_sym ( atmp01 , lf_AUX_TermAsFix2Sign26_1sym ) ) {
{
...
( tmp [ 12 ] = arg_0 ( tmp [ 11 ] ) ) ;
if ( check_sym ( tmp [ 10 ] , lf_AUX_TermAsFix2Sign26_1sym ) ) {
( tmp [ 13 ] = arg_0 ( tmp [ 10 ] ) ) ;
...
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_TermAsFix2Sign26_1 ( cons ( make_list ( arg0 ) , make_list ( atmp10 ) ) ) ) ) ;
}
}
FUNC_EXIT ( make_nf2 ( lf_AUX_TermAsFix2Sign26_2sym , arg0 , arg1 ) ) ;
}
}
ATerm lf_AUX_TermAsFix2Sign26_1 ( ATerm arg0 ) {
CONS_ENTRY ( lf_AUX_TermAsFix2Sign26_1sym , ATmakeAppl ( lf_AUX_TermAsFix2Sign26_1sym , arg0 ) ) ;
CONS_EXIT ( make_nf1 ( lf_AUX_TermAsFix2Sign26_1sym , arg0 ) ) ;
}
