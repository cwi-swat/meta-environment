...
static ATerm lf_AUX_Remove_Lists_Aux5_1 ( ATerm arg1 ) ;
...
lf_AUX_Remove_Lists_Aux5_1sym = ATmakeSymbol ( "prod(id(\"Remove-Lists-Aux\"),w(\"\"),[l(\"is-plus-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Remove_Lists_Aux5_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Remove-Lists-Aux\"),w(\"\"),[l(\"is-plus-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_Remove_Lists_Aux5_1 , lf_AUX_Remove_Lists_Aux5_1sym ) ;
}
...
ATerm lf_AUX_Remove_Lists_Aux5_1 ( ATerm arg0 ) {
FUNC_ENTRY ( lf_AUX_Remove_Lists_Aux5_1sym , ATmakeAppl ( lf_AUX_Remove_Lists_Aux5_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Remove_Lists_Aux5_1sym , arg0 ) ) ;
}
