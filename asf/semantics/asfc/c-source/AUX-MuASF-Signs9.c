...
lf_AUX_MuASF_Signs9_1sym= ATmakeSymbol( "prod(id(\"MuASF-Signs\"),w(\"\"),[l(\"make-new-funcdef\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"MuASF-Signs\"),w(\"\"),[l(\"make-new-funcdef\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Signs9_1 , lf_AUX_MuASF_Signs9_1sym);
...
return ( * ef2)( arg1 , ( constant0? constant0: ( constant0= lf3( make_list( ( * ef3)( ))))));
}
if( not_empty_list( atmp010)) {
tmp[ 0]= list_head( atmp010);
tmp[ 1]= list_tail( atmp010);
if( not_empty_list( tmp[ 1])) {
tmp[ 2]= lf_AUX_MuASF_Signs9_1( ( * ef1)( atmp00 , lf2( make_list( tmp[ 1]))) , arg1);
