#include "support.h"
static asymbol * lf_AUX_MuASF_Sign2C7_1sym;
...
lf_AUX_MuASF_Sign2C7_1sym= TmkSymbol( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[l(\"modname2rname\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Identifier\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Sign2C\"),w(\"\"),[l(\"modname2rname\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Identifier\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Sign2C7_1 , lf_AUX_MuASF_Sign2C7_1sym);
...
t_unprotect( arg0);
t_unprotect( tmp[ 0]);
return ( * ef2)( lf2( cons( make_list( make_char( 114)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 118)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 95)) , make_list( tmp[ 3])))))))))));
}
}
}
t_unprotect( tmp[ 0]);
