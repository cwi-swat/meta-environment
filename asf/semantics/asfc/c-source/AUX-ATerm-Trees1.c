...
return ( constant0 ? constant0 : ( constant0 = make_nf0 ( lf_AUX_ATerm_Trees1_5sym ) ) ) ;
}
ATerm lf_AUX_ATerm_Trees1_4 ( ) {
PROF ( prof_lf_AUX_ATerm_Trees1_4 ) ;
return ( constant1 ? constant1 : ( constant1 = make_nf0 ( lf_AUX_ATerm_Trees1_4sym ) ) ) ;
}
ATerm lf_AUX_ATerm_Trees1_3 ( ) {
PROF ( prof_lf_AUX_ATerm_Trees1_3 ) ;
return ( constant2 ? constant2 : ( constant2 = make_nf0 ( lf_AUX_ATerm_Trees1_3sym ) ) ) ;
}
ATerm lf_AUX_ATerm_Trees1_2 ( ) {
PROF ( prof_lf_AUX_ATerm_Trees1_2 ) ;
return ( constant3 ? constant3 : ( constant3 = make_nf0 ( lf_AUX_ATerm_Trees1_2sym ) ) ) ;
}
ATerm lf_AUX_ATerm_Trees1_1 ( ) {
PROF ( prof_lf_AUX_ATerm_Trees1_1 ) ;
return ( constant4 ? constant4 : ( constant4 = make_nf0 ( lf_AUX_ATerm_Trees1_1sym ) ) ) ;
}
