#include  "support.h"
static Symbol lf_AUX_AsFix2Sign_C9_1sym ;
...
lf_AUX_AsFix2Sign_C9_1sym = ATmakeSymbol ( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"cffuncs2sign\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FNT-tuple\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_AsFix2Sign_C9_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"FuncDef\"),ql(\";\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"cffuncs2sign\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FNT-tuple\"),w(\"\"),no-attrs)" ) , lf_AUX_AsFix2Sign_C9_1 , lf_AUX_AsFix2Sign_C9_1sym ) ;
...
void init_AUX_AsFix2Sign_C9 ( ) {
}
ATerm lf_AUX_AsFix2Sign_C9_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 14 ] ;
FUNC_ENTRY ( lf_AUX_AsFix2Sign_C9_1sym , ATmakeAppl ( lf_AUX_AsFix2Sign_C9_1sym , arg0 , arg1 ) ) ;
if ( check_sym ( arg0 , ef1sym ) ) {
FUNC_EXIT ( ( * ef2 ) ( ( * ef3 ) ( lf2 ( make_list ( null ( ) ) ) ) , arg1 ) ) ;
}
...
tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ;
tmp [ 6 ] = lf_AUX_AsFix2Sign_C9_1 ( tmp [ 0 ] , tmp [ 3 ] ) ;
...
FUNC_EXIT ( make_nf2 ( lf_AUX_AsFix2Sign_C9_1sym , arg0 , arg1 ) ) ;
}
}
