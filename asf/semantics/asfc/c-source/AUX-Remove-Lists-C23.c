...
lf_AUX_Remove_Lists_C23_2sym= ATmakeSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-multiple-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-multiple-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C23_2 , lf_AUX_Remove_Lists_C23_2sym);
...
ef14= lookup_func( ATreadFromString( "prod(id(\"VarEnv\"),w(\"\"),[l(\"put-int\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),no-attrs)"));
ef14sym= lookup_sym( ATreadFromString( "prod(id(\"VarEnv\"),w(\"\"),[l(\"put-int\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),no-attrs)"));
...
ef16= lookup_func( ATreadFromString( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
ef16sym= lookup_sym( ATreadFromString( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
...
ef18= lookup_func( ATreadFromString( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-no-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
ef18sym= lookup_sym( ATreadFromString( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-no-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
}
...
tmp[ 35]= arg_0( tmp[ 34]);
return ( * ef3)( lf_AUX_Remove_Lists_C23_1( make_list( ( * ef4)( ( * ef5)( tmp[ 25])))) , lf4( cons( make_list( ( * ef6)( ( * ef1)( ( constant1? constant1: ( constant1= ( * ef2)( lf3( (ATerm) ATmakeList( 14 , char_table[ 110] , char_table[ 111] , char_table[ 116] , char_table[ 45] , char_table[ 101] , char_table[ 109] , char_table[ 112] , char_table[ 116] , char_table[ 121] , char_table[ 45] , char_table[ 108] , char_table[ 105] , char_table[ 115] , char_table[ 116]))))) , lf_AUX_Remove_Lists_C23_1( make_list( ( * ef4)( ( * ef5)( tmp[ 25]))))) , ( constant2? constant2: ( constant2= ( * ef7)( ( * ef2)( lf3( make_list( make_char( 116))))))))) , cons( make_list( ( * ef8)( ( * ef1)( ( constant3? constant3: ( constant3= ( * ef2)( lf3( (ATerm) ATmakeList( 9 , char_table[ 108] , char_table[ 105] , char_table[ 115] , char_table[ 116] , char_table[ 45] , char_table[ 104] , char_table[ 101] , char_table[ 97] , char_table[ 100]))))) , lf_AUX_Remove_Lists_C23_1( make_list( ( * ef4)( ( * ef5)( tmp[ 25]))))) , tmp[ 23])) , cons( make_list( tmp[ 22]) , cons( make_list( ( * ef6)( ( * ef1)( ( constant4? constant4: ( constant4= ( * ef2)( lf3( (ATerm) ATmakeList( 9 , char_table[ 108] , char_table[ 105] , char_table[ 115] , char_table[ 116] , char_table[ 45] , char_table[ 116] , char_table[ 97] , char_table[ 105] , char_table[ 108]))))) , lf_AUX_Remove_Lists_C23_1( make_list( ( * ef4)( ( * ef5)( tmp[ 25]))))) , ( * ef4)( ( * ef5)( tmp[ 35])))) , make_list( tmp[ 32])))))) , tmp[ 30]);
}
}
}
}
...
tmp[ 20]= ( * ef18)( lf_AUX_Remove_Lists_C23_1( make_list( ( * ef1)( ( constant6? constant6: ( constant6= ( * ef2)( lf3( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))))) , lf_AUX_Remove_Lists_C23_1( cons( make_list( tmp[ 13]) , make_list( tmp[ 15])))))) , tmp[ 19]);
