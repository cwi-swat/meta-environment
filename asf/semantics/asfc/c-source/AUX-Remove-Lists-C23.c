#include "support.h"
static asymbol * lf_AUX_Remove_Lists_C23_2sym;
static aterm * lf_AUX_Remove_Lists_C23_2( aterm * arg1 , aterm * arg2);
...
static aterm * lf_AUX_Remove_Lists_C23_1( aterm * arg1);
...
lf_AUX_Remove_Lists_C23_2sym= TmkSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-multiple-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf_AUX_Remove_Lists_C23_1sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
lf4sym= TmkSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"Term\"),ql(\",\"))") , lf_AUX_Remove_Lists_C23_1 , lf_AUX_Remove_Lists_C23_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-multiple-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C23_2 , lf_AUX_Remove_Lists_C23_2sym);
...
ef14= lookup_func( TmakeSimple( & local , "prod(id(\"VarEnv\"),w(\"\"),[l(\"put-int\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),no-attrs)"));
ef14sym= lookup_sym( TmakeSimple( & local , "prod(id(\"VarEnv\"),w(\"\"),[l(\"put-int\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),no-attrs)"));
...
ef16= lookup_func( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
ef16sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-lhs-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
...
ef18= lookup_func( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-no-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
ef18sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-no-list-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"));
}
aterm * lf_AUX_Remove_Lists_C23_2( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[36];
PROF( prof_lf_AUX_Remove_Lists_C23_2);
if( check_sym( arg0 , lf_AUX_Remove_Lists_C23_1sym)) {
{
...
tmp[ 4]= arg_0( tmp[ 3]);
{
if( check_sym( tmp[ 2] , lf_AUX_Remove_Lists_C23_1sym)) {
tmp[ 5]= arg_0( tmp[ 2]);
{
...
tmp[ 19]= arg_1( tmp[ 17]);
tmp[ 20]= arg_2( tmp[ 17]);
if( check_sym( tmp[ 18] , lf_AUX_Remove_Lists_C23_1sym)) {
tmp[ 21]= arg_0( tmp[ 18]);
...
t_protect( tmp[ 15]);
t_protect( tmp[ 26]);
tmp[ 27]= ( * ef16)( lf_AUX_Remove_Lists_C23_1( make_list( tmp[ 15])) , tmp[ 26]);
if( check_sym( tmp[ 27] , ef3sym)) {
tmp[ 28]= arg_0( tmp[ 27]);
tmp[ 29]= arg_1( tmp[ 27]);
tmp[ 30]= arg_2( tmp[ 27]);
if( check_sym( tmp[ 28] , lf_AUX_Remove_Lists_C23_1sym)) {
tmp[ 31]= arg_0( tmp[ 28]);
if( check_sym( tmp[ 29] , lf4sym)) {
tmp[ 32]= arg_0( tmp[ 29]);
if( m_is_single_element( tmp[ 31])) {
tmp[ 33]= m_list_head( tmp[ 31]);
...
t_unprotect( tmp[ 27]);
t_unprotect( tmp[ 33]);
return ( * ef3)( lf_AUX_Remove_Lists_C23_1( make_list( ( * ef4)( ( * ef5)( tmp[ 25])))) , lf4( cons( make_list( ( * ef6)( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 110)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 112)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 121)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , make_list( make_char( 116))))))))))))))))) , lf_AUX_Remove_Lists_C23_1( make_list( ( * ef4)( ( * ef5)( tmp[ 25]))))) , ( * ef7)( ( * ef2)( lf3( make_list( make_char( 116))))))) , cons( make_list( ( * ef8)( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 104)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 97)) , make_list( make_char( 100)))))))))))) , lf_AUX_Remove_Lists_C23_1( make_list( ( * ef4)( ( * ef5)( tmp[ 25]))))) , tmp[ 23])) , cons( make_list( tmp[ 22]) , cons( make_list( ( * ef6)( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 97)) , cons( make_list( make_char( 105)) , make_list( make_char( 108)))))))))))) , lf_AUX_Remove_Lists_C23_1( make_list( ( * ef4)( ( * ef5)( tmp[ 25]))))) , ( * ef4)( ( * ef5)( tmp[ 35])))) , make_list( tmp[ 32])))))) , tmp[ 30]);
}
}
t_unprotect( tmp[ 33]);
}
...
t_protect( tmp[ 15]);
t_protect( tmp[ 19]);
tmp[ 20]= ( * ef18)( lf_AUX_Remove_Lists_C23_1( make_list( ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))) , lf_AUX_Remove_Lists_C23_1( cons( make_list( tmp[ 13]) , make_list( tmp[ 15])))))) , tmp[ 19]);
if( check_sym( tmp[ 20] , ef3sym)) {
tmp[ 21]= arg_0( tmp[ 20]);
tmp[ 22]= arg_1( tmp[ 20]);
tmp[ 23]= arg_2( tmp[ 20]);
if( check_sym( tmp[ 21] , lf_AUX_Remove_Lists_C23_1sym)) {
tmp[ 24]= arg_0( tmp[ 21]);
if( check_sym( tmp[ 22] , lf4sym)) {
tmp[ 25]= arg_0( tmp[ 22]);
if( m_is_single_element( tmp[ 24])) {
tmp[ 26]= m_list_head( tmp[ 24]);
...
t_unprotect( tmp[ 20]);
t_unprotect( tmp[ 26]);
return ( * ef3)( lf_AUX_Remove_Lists_C23_1( make_list( ( * ef4)( ( * ef5)( tmp[ 28])))) , lf4( make_list( tmp[ 25])) , tmp[ 23]);
}
}
t_unprotect( tmp[ 26]);
}
...
return make_nf2( lf_AUX_Remove_Lists_C23_2sym , arg0 , arg1);
}
}
...
aterm * lf_AUX_Remove_Lists_C23_1( aterm * arg0) {
PROF( prof_lf_AUX_Remove_Lists_C23_1);
return make_nf1( lf_AUX_Remove_Lists_C23_1sym , arg0);
}
