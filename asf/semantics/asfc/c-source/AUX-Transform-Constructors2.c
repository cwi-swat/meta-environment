...
static Symbol lf_AUX_Transform_Constructors2_3_recursivesym ;
static ATerm lf_AUX_Transform_Constructors2_3_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Transform_Constructors2_3_recursivesym = ATmakeSymbol ( "prod(id(\"Transform-Constructors\"),w(\"\"),[ql(\"transform-constructor-terms-in-rules\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Transform_Constructors2_3_recursivesym ) ;
lf_AUX_Transform_Constructors2_3sym = ATmakeSymbol ( "prod(id(\"Transform-Constructors\"),w(\"\"),[ql(\"transform-constructor-terms-in-rules\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleList\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Transform-Constructors\"),w(\"\"),[ql(\"transform-constructor-terms-in-rules\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleList\"),w(\"\"),no-attrs)" ) , lf_AUX_Transform_Constructors2_3_recursive , lf_AUX_Transform_Constructors2_3_recursivesym ) ;
}
...
( tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf_AUX_Transform_Constructors2_1 ( cons ( make_list ( tmp [ 2 ] ) , make_list ( tmp [ 5 ] ) ) ) ) ) ;
}
}
}
else {
FUNC_EXIT_CONST ( constant0 , make_nf1 ( ef1sym , lf_AUX_Transform_Constructors2_1 ( make_list ( null ( ) ) ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_Transform_Constructors2_3_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 6 ] ;
FUNC_ENTRY ( lf_AUX_Transform_Constructors2_3_recursivesym , ATmakeAppl ( lf_AUX_Transform_Constructors2_3_recursivesym , arg0 , arg1 ) ) ;
{
ATerm atmp00 = arg0 ;
if ( check_sym ( arg1 , lf_AUX_Transform_Constructors2_2sym ) ) {
{
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Transform_Constructors2_3_recursivesym , lf_AUX_Transform_Constructors2_1 ( arg0 ) , arg1 ) ) ;
}
}
