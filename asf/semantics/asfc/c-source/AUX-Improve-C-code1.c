...
static ATerm lf_AUX_Improve_C_code1_2 ( ) ;
...
lf_AUX_Improve_C_code1_2sym = ATmakeSymbol ( "prod(id(\"Improve-C-code\"),w(\"\"),[ql(\"0\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TagId\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"reject\")],w(\"\"),l(\"}\")))" , 0 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Improve-C-code\"),w(\"\"),[ql(\"0\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TagId\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"reject\")],w(\"\"),l(\"}\")))" ) , lf_AUX_Improve_C_code1_2 , lf_AUX_Improve_C_code1_2sym ) ;
}
void resolve_AUX_Improve_C_code1 ( ) {
}
void init_AUX_Improve_C_code1 ( ) {
}
ATerm lf_AUX_Improve_C_code1_2 ( ) {
CONS_ENTRY ( lf_AUX_Improve_C_code1_2sym , ATmakeAppl0 ( lf_AUX_Improve_C_code1_2sym ) ) ;
CONS_EXIT ( make_nf0 ( lf_AUX_Improve_C_code1_2sym ) ) ;
}
