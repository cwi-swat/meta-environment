...
ef19 = lookup_func ( ATreadFromString ( "prod(id(\"C\"),w(\"\"),[iter-sep(l(\"{\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"Argument-expression-list\"),w(\"\"),no-attrs)" ) ) ;
ef19sym = lookup_sym ( ATreadFromString ( "prod(id(\"C\"),w(\"\"),[iter-sep(l(\"{\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"Argument-expression-list\"),w(\"\"),no-attrs)" ) ) ;
...
( tmp [ 11 ] = ( * ef13 ) ( ( * ef14 ) ( lf5 ( make_list ( ( * ef15 ) ( ( * ef16 ) ( tmp [ 6 ] , ( * ef5 ) ( ( * ef6 ) ( ( * ef17 ) ( ( * ef7 ) ( ( * ef18 ) ( lf6 ( ( ATerm ) ATmakeList ( 5 , char_table [ 97 ] , char_table [ 114 ] , char_table [ 103 ] , char_table [ 95 ] , char_table [ 48 ] ) ) ) ) , ( * ef19 ) ( lf7 ( make_list ( tmp [ 5 ] ) ) ) ) ) ) ) ) ) ) ) ) ) ;
