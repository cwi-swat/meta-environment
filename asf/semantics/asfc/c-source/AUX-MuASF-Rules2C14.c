...
static aterm * lf_AUX_MuASF_Rules2C14_3( aterm * arg1 , aterm * arg2 , aterm * arg3 , aterm * arg4 , aterm * arg5 , aterm * arg6);
...
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"assign-cond2cstats\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SlI-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Rules2C14_3 , lf_AUX_MuASF_Rules2C14_3sym);
...
arena local;
TinitArena( NULL , & local);
ef1= lookup_func( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"conds2cstats\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SlI-tuple\"),w(\"\"),no-attrs)"));
ef1sym= lookup_sym( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"conds2cstats\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SlI-tuple\"),w(\"\"),no-attrs)"));
...
ef15= lookup_func( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"make-c-expression\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"));
ef15sym= lookup_sym( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"make-c-expression\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"));
ef16= lookup_func( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"cterms2cstats\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"DCAS-tuple\"),w(\"\"),no-attrs)"));
ef16sym= lookup_sym( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"cterms2cstats\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"DCAS-tuple\"),w(\"\"),no-attrs)"));
ef17= lookup_func( TmakeSimple( & local , "prod(id(\"caller\"),w(\"\"),[l(\"aint\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AInt\"),w(\"\"),no-attrs)"));
ef17sym= lookup_sym( TmakeSimple( & local , "prod(id(\"caller\"),w(\"\"),[l(\"aint\"),w(\"\"),ql(\"(\"),w(\"\"),iter(sort(\"CHAR\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AInt\"),w(\"\"),no-attrs)"));
ef18= lookup_func( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"DCAS-tuple\"),w(\"\"),no-attrs)"));
ef18sym= lookup_sym( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"DCAS-tuple\"),w(\"\"),no-attrs)"));
ef19= lookup_func( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)"));
ef19sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)"));
ef20= lookup_func( TmakeSimple( & local , "prod(id(\"ANumerals\"),w(\"\"),[l(\"gtr\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AInt\"),w(\"\"),no-attrs)"));
ef20sym= lookup_sym( TmakeSimple( & local , "prod(id(\"ANumerals\"),w(\"\"),[l(\"gtr\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AInt\"),w(\"\"),no-attrs)"));
}
aterm * lf_AUX_MuASF_Rules2C14_3( aterm * arg0 , aterm * arg1 , aterm * arg2 , aterm * arg3 , aterm * arg4 , aterm * arg5) {
{
aterm * tmp[38];
...
if( check_sym( arg1 , lf_AUX_MuASF_Rules2C14_1sym)) {
{
...
t_protect( tmp[ 7]);
tmp[ 14]= list_tail( tmp[ 7]);
t_protect( atmp00);
tmp[ 15]= list_tail( atmp00);
t_protect( tmp[ 11]);
t_protect( arg5);
t_protect( arg3);
tmp[ 16]= ( * ef15)( tmp[ 11] , arg5 , arg3);
t_protect( tmp[ 13]);
t_protect( arg5);
t_protect( arg2);
t_protect( arg4);
tmp[ 17]= ( * ef16)( lf7( make_list( tmp[ 13])) , arg5 , arg2 , arg4 , ( * ef17)( lf8( make_list( make_char( 48)))));
...
t_protect( tmp[ 5]);
t_protect( tmp[ 15]);
tmp[ 22]= ( * ef6)( ( * ef2)( lf4( make_list( tmp[ 6])) , lf5( cons( make_list( ( * ef3)( tmp[ 9] , ( * ef12)( tmp[ 11] , lf7( make_list( tmp[ 13]))))) , make_list( tmp[ 14]))) , tmp[ 3] , tmp[ 4] , tmp[ 5]) , lf_AUX_MuASF_Rules2C14_1( make_list( tmp[ 15])));
if( check_sym( tmp[ 22] , ef7sym)) {
tmp[ 23]= arg_0( tmp[ 22]);
tmp[ 24]= arg_1( tmp[ 22]);
if( check_sym( tmp[ 23] , lf_AUX_MuASF_Rules2C14_1sym)) {
tmp[ 25]= arg_0( tmp[ 23]);
if( check_sym( tmp[ 24] , lf_AUX_MuASF_Rules2C14_1sym)) {
tmp[ 26]= arg_0( tmp[ 24]);
t_protect( tmp[ 25]);
t_protect( tmp[ 19]);
tmp[ 27]= ( * ef8)( lf_AUX_MuASF_Rules2C14_1( make_list( tmp[ 25])) , tmp[ 19]);
if( check_sym( tmp[ 27] , ef11sym)) {
tmp[ 28]= arg_0( tmp[ 27]);
if( check_sym( tmp[ 28] , lf_AUX_MuASF_Rules2C14_1sym)) {
tmp[ 29]= arg_0( tmp[ 28]);
t_protect( tmp[ 29]);
t_protect( tmp[ 21]);
t_protect( arg3);
t_protect( tmp[ 20]);
tmp[ 30]= ( * ef1)( lf_AUX_MuASF_Rules2C14_1( make_list( tmp[ 29])) , tmp[ 21] , arg3 , tmp[ 20]);
...
t_protect( tmp[ 18]);
t_protect( tmp[ 31]);
tmp[ 33]= ( * ef19)( tmp[ 16] , ( * ef14)( tmp[ 18] , tmp[ 31]));
t_protect( tmp[ 26]);
t_protect( arg1);
t_protect( arg2);
t_protect( arg3);
t_protect( arg4);
t_protect( arg5);
tmp[ 34]= lf_AUX_MuASF_Rules2C14_3( lf_AUX_MuASF_Rules2C14_1( make_list( tmp[ 26])) , arg1 , arg2 , arg3 , arg4 , arg5);
if( check_sym( tmp[ 34] , ef13sym)) {
tmp[ 35]= arg_0( tmp[ 34]);
tmp[ 36]= arg_1( tmp[ 34]);
t_protect( tmp[ 32]);
t_protect( tmp[ 36]);
tmp[ 37]= ( * ef20)( tmp[ 32] , tmp[ 36]);
t_protect( tmp[ 35]);
t_unprotect( arg0);
t_unprotect( arg1);
t_unprotect( arg2);
...
t_protect( tmp[ 5]);
t_protect( tmp[ 12]);
tmp[ 13]= ( * ef6)( ( * ef2)( lf4( make_list( tmp[ 6])) , lf5( cons( make_list( ( * ef3)( tmp[ 9] , tmp[ 10])) , make_list( tmp[ 11]))) , tmp[ 3] , tmp[ 4] , tmp[ 5]) , lf_AUX_MuASF_Rules2C14_1( make_list( tmp[ 12])));
if( check_sym( tmp[ 13] , ef7sym)) {
tmp[ 14]= arg_0( tmp[ 13]);
tmp[ 15]= arg_1( tmp[ 13]);
if( check_sym( tmp[ 14] , lf_AUX_MuASF_Rules2C14_1sym)) {
tmp[ 16]= arg_0( tmp[ 14]);
if( check_sym( tmp[ 15] , lf_AUX_MuASF_Rules2C14_1sym)) {
tmp[ 17]= arg_0( tmp[ 15]);
t_protect( tmp[ 16]);
t_protect( tmp[ 10]);
t_protect( arg5);
tmp[ 18]= ( * ef8)( lf_AUX_MuASF_Rules2C14_1( make_list( tmp[ 16])) , ( * ef9)( lf6( make_list( ( * ef10)( tmp[ 10] , arg5)))));
if( check_sym( tmp[ 18] , ef11sym)) {
tmp[ 19]= arg_0( tmp[ 18]);
if( check_sym( tmp[ 19] , lf_AUX_MuASF_Rules2C14_1sym)) {
tmp[ 20]= arg_0( tmp[ 19]);
t_protect( tmp[ 17]);
t_protect( atmp10);
t_protect( tmp[ 20]);
...
t_unprotect( tmp[ 13]);
t_unprotect( tmp[ 18]);
return lf_AUX_MuASF_Rules2C14_3( lf_AUX_MuASF_Rules2C14_1( make_list( tmp[ 17])) , lf_AUX_MuASF_Rules2C14_1( cons( make_list( atmp10) , make_list( tmp[ 20]))) , arg2 , arg3 , arg4 , arg5);
}
}
t_unprotect( tmp[ 18]);
}
...
t_unprotect( arg0);
t_unprotect( arg5);
return ( * ef1)( arg1 , arg2 , arg3 , arg4);
}
}
}
}
...
return make_nf6( lf_AUX_MuASF_Rules2C14_3sym , arg0 , arg1 , arg2 , arg3 , arg4 , arg5);
}
}
