#include  "support.h"
static Symbol lf_AUX_MuASF_Term2C15_1sym ;
static ATerm lf_AUX_MuASF_Term2C15_1 ( ATerm arg1 ) ;
...
static funcptr ef3 ;
void register_AUX_MuASF_Term2C15 ( ) {
lf_AUX_MuASF_Term2C15_1sym = ATmakeSymbol ( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"is-special-name\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Identifier\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Term2C15_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF-Term2C\"),w(\"\"),[l(\"is-special-name\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Identifier\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Term2C15_1 , lf_AUX_MuASF_Term2C15_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_MuASF_Term2C15 ( ) {
...
void init_AUX_MuASF_Term2C15 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_MuASF_Term2C15_1 ( ATerm arg0 ) {
{
ATerm tmp [ 9 ] ;
PROF ( prof_lf_AUX_MuASF_Term2C15_1 ) ;
