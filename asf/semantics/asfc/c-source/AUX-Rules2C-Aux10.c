...
lf_AUX_Rules2C_Aux10_2sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux10_2 , lf_AUX_Rules2C_Aux10_2sym);
...
tmp[ 9]= lf_AUX_Rules2C_Aux10_2( lf_AUX_Rules2C_Aux10_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 9] , ef1sym)) {
tmp[ 10]= arg_0( tmp[ 9]);
tmp[ 11]= arg_1( tmp[ 9]);
if( check_sym( tmp[ 10] , lf_AUX_Rules2C_Aux10_1sym)) {
tmp[ 12]= arg_0( tmp[ 10]);
if( check_sym( tmp[ 11] , lf_AUX_Rules2C_Aux10_1sym)) {
tmp[ 13]= arg_0( tmp[ 11]);
return ( * ef1)( lf_AUX_Rules2C_Aux10_1( make_list( tmp[ 12])) , lf_AUX_Rules2C_Aux10_1( cons( make_list( ( * ef2)( ( constant0? constant0: ( constant0= lf3( make_list( null( ))))) , lf4( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 13]))));
}
}
}
}
...
tmp[ 17]= arg_0( tmp[ 16]);
tmp[ 18]= ( * ef7)( tmp[ 15]);
tmp[ 19]= ( * ef8)( tmp[ 18] , lf_AUX_Rules2C_Aux10_1( make_list( tmp[ 1])));
...
tmp[ 25]= arg_0( tmp[ 22]);
return ( * ef1)( lf_AUX_Rules2C_Aux10_1( cons( make_list( ( * ef2)( lf3( cons( make_list( ( * ef10)( lf3( cons( make_list( ( * ef3)( tmp[ 15] , lf5( make_list( tmp[ 17])))) , make_list( tmp[ 14]))))) , make_list( tmp[ 10]))) , lf4( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 23]))) , lf_AUX_Rules2C_Aux10_1( make_list( tmp[ 24])));
}
}
}
}
...
tmp[ 15]= ( * ef7)( tmp[ 11]);
tmp[ 16]= ( * ef8)( tmp[ 15] , lf_AUX_Rules2C_Aux10_1( make_list( tmp[ 1])));
...
tmp[ 22]= arg_0( tmp[ 19]);
return ( * ef1)( lf_AUX_Rules2C_Aux10_1( cons( make_list( ( * ef2)( lf3( cons( make_list( ( * ef3)( tmp[ 11] , lf5( make_list( tmp[ 13])))) , make_list( tmp[ 10]))) , lf4( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 20]))) , lf_AUX_Rules2C_Aux10_1( make_list( tmp[ 21])));
}
}
}
}
...
tmp[ 15]= lf_AUX_Rules2C_Aux10_2( lf_AUX_Rules2C_Aux10_1( make_list( tmp[ 1])));
...
if( check_sym( tmp[ 17] , lf_AUX_Rules2C_Aux10_1sym)) {
tmp[ 19]= arg_0( tmp[ 17]);
return ( * ef1)( lf_AUX_Rules2C_Aux10_1( make_list( tmp[ 18])) , lf_AUX_Rules2C_Aux10_1( cons( make_list( ( * ef2)( lf3( cons( make_list( ( * ef3)( tmp[ 11] , lf5( make_list( tmp[ 13])))) , make_list( tmp[ 10]))) , lf4( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 19]))));
}
}
}
}
...
return ( constant3? constant3: ( constant3= ( * ef1)( lf_AUX_Rules2C_Aux10_1( make_list( null( ))) , lf_AUX_Rules2C_Aux10_1( make_list( null( ))))));
}
}
}
return make_nf1( lf_AUX_Rules2C_Aux10_2sym , arg0);
}
}
