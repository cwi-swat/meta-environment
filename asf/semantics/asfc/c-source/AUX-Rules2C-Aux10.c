...
( tmp [ 11 ] = arg_0 ( tmp [ 9 ] ) ) ;
FUNC_EXIT ( ( * ef1 ) ( lf_AUX_Rules2C_Aux10_1 ( make_list ( tmp [ 10 ] ) ) , lf_AUX_Rules2C_Aux10_1 ( cons ( make_list ( ( * ef4 ) ( make_nf1 ( ef5sym , lf3 ( make_list ( tmp [ 6 ] ) ) ) , tmp [ 3 ] , tmp [ 4 ] ) ) , make_list ( tmp [ 11 ] ) ) ) ) ) ;
}
}
}
}
...
if ( check_sym ( tmp [ 9 ] , lf_AUX_Rules2C_Aux10_1sym ) ) {
( tmp [ 11 ] = arg_0 ( tmp [ 9 ] ) ) ;
FUNC_EXIT ( ( * ef1 ) ( lf_AUX_Rules2C_Aux10_1 ( cons ( make_list ( ( * ef6 ) ( make_nf1 ( ef5sym , lf3 ( make_list ( tmp [ 6 ] ) ) ) , tmp [ 3 ] , tmp [ 4 ] ) ) , make_list ( tmp [ 10 ] ) ) ) , lf_AUX_Rules2C_Aux10_1 ( make_list ( tmp [ 11 ] ) ) ) ) ;
}
}
}
}
