...
static Symbol lf_AUX_Rules2C_Aux10_2_recursivesym ;
static ATerm lf_AUX_Rules2C_Aux10_2_recursive ( ATerm arg1 ) ;
...
lf_AUX_Rules2C_Aux10_2_recursivesym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-on-defaults\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleListPair\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Rules2C_Aux10_2_recursivesym ) ;
lf_AUX_Rules2C_Aux10_2sym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-on-defaults\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleListPair\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-on-defaults\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleListPair\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux10_2 , lf_AUX_Rules2C_Aux10_2sym ) ;
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-on-defaults\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleListPair\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux10_2_recursive , lf_AUX_Rules2C_Aux10_2_recursivesym ) ;
...
ef3 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleListPair\"),w(\"\"),no-attrs)" ) ) ;
ef3sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleListPair\"),w(\"\"),no-attrs)" ) ) ;
...
( tmp [ 8 ] = arg_0 ( tmp [ 6 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Rules2C_Aux10_1 ( make_list ( tmp [ 7 ] ) ) , lf_AUX_Rules2C_Aux10_1 ( cons ( make_list ( ( * ef6 ) ( tmp [ 2 ] , tmp [ 3 ] ) ) , make_list ( tmp [ 8 ] ) ) ) ) ) ;
}
}
}
}
...
( tmp [ 11 ] = arg_0 ( tmp [ 9 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Rules2C_Aux10_1 ( cons ( make_list ( ( * ef1 ) ( make_nf1 ( ef2sym , lf3 ( make_list ( tmp [ 6 ] ) ) ) , tmp [ 3 ] , tmp [ 4 ] ) ) , make_list ( tmp [ 10 ] ) ) ) , lf_AUX_Rules2C_Aux10_1 ( make_list ( tmp [ 11 ] ) ) ) ) ;
}
}
}
}
...
if ( check_sym ( tmp [ 9 ] , lf_AUX_Rules2C_Aux10_1sym ) ) {
( tmp [ 11 ] = arg_0 ( tmp [ 9 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Rules2C_Aux10_1 ( make_list ( tmp [ 10 ] ) ) , lf_AUX_Rules2C_Aux10_1 ( cons ( make_list ( ( * ef4 ) ( make_nf1 ( ef2sym , lf3 ( make_list ( tmp [ 6 ] ) ) ) , tmp [ 3 ] , tmp [ 4 ] ) ) , make_list ( tmp [ 11 ] ) ) ) ) ) ;
}
}
}
}
...
if ( check_sym ( tmp [ 6 ] , lf_AUX_Rules2C_Aux10_1sym ) ) {
( tmp [ 8 ] = arg_0 ( tmp [ 6 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( lf_AUX_Rules2C_Aux10_1 ( cons ( make_list ( ( * ef5 ) ( tmp [ 2 ] , tmp [ 3 ] ) ) , make_list ( tmp [ 7 ] ) ) ) , lf_AUX_Rules2C_Aux10_1 ( make_list ( tmp [ 8 ] ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT_CONST ( constant0 , ( * ef3 ) ( lf_AUX_Rules2C_Aux10_1 ( make_list ( null ( ) ) ) , lf_AUX_Rules2C_Aux10_1 ( make_list ( null ( ) ) ) ) ) ;
}
}
}
...
ATerm lf_AUX_Rules2C_Aux10_2_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 12 ] ;
FUNC_ENTRY ( lf_AUX_Rules2C_Aux10_2_recursivesym , ATmakeAppl ( lf_AUX_Rules2C_Aux10_2_recursivesym , arg0 ) ) ;
{
ATerm atmp00 = arg0 ;
if ( not_empty_list ( atmp00 ) ) {
( tmp [ 0 ] = list_head ( atmp00 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Rules2C_Aux10_2_recursivesym , lf_AUX_Rules2C_Aux10_1 ( arg0 ) ) ) ;
}
}
