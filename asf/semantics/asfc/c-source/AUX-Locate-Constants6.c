...
static Symbol lf_AUX_Locate_Constants6_1_recursivesym ;
static ATerm lf_AUX_Locate_Constants6_1_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Locate_Constants6_1_recursivesym = ATmakeSymbol ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-statlist\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CESLI-tuple\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Locate_Constants6_1_recursivesym ) ;
lf_AUX_Locate_Constants6_1sym = ATmakeSymbol ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-statlist\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CESLI-tuple\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-statlist\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CESLI-tuple\"),w(\"\"),no-attrs)" ) , lf_AUX_Locate_Constants6_1 , lf_AUX_Locate_Constants6_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-statlist\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CESLI-tuple\"),w(\"\"),no-attrs)" ) , lf_AUX_Locate_Constants6_1_recursive , lf_AUX_Locate_Constants6_1_recursivesym ) ;
...
ef5 = lookup_func ( ATreadFromString ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-stat\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CESI-tuple\"),w(\"\"),no-attrs)" ) ) ;
ef5sym = lookup_sym ( ATreadFromString ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-stat\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CESI-tuple\"),w(\"\"),no-attrs)" ) ) ;
...
( tmp [ 2 ] = lf_AUX_Locate_Constants6_1 ( make_nf1 ( ef1sym , lf2 ( make_list ( tmp [ 0 ] ) ) ) , ( * ef2 ) ( lf3 ( make_list ( atmp100 ) ) , atmp11 ) ) ) ;
...
( tmp [ 14 ] = arg_0 ( tmp [ 11 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( lf3 ( make_list ( tmp [ 14 ] ) ) , ( * ef4 ) ( make_nf1 ( ef1sym , lf2 ( cons ( make_list ( tmp [ 9 ] ) , make_list ( tmp [ 12 ] ) ) ) ) ) , tmp [ 13 ] ) ) ;
}
}
}
}
...
ATerm lf_AUX_Locate_Constants6_1_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 15 ] ;
FUNC_ENTRY ( lf_AUX_Locate_Constants6_1_recursivesym , ATmakeAppl ( lf_AUX_Locate_Constants6_1_recursivesym , arg0 , arg1 ) ) ;
{
ATerm atmp00 = arg0 ;
{
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Locate_Constants6_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) , arg1 ) ) ;
}
}
