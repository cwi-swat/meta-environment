...
static ATerm lf_AUX_Improve_C_code5_1 ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Improve_C_code5_1sym = ATmakeSymbol ( "prod(id(\"Improve-C-code\"),w(\"\"),[ql(\"improve-stats\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Argument-expression-list\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Improve-C-code\"),w(\"\"),[ql(\"improve-stats\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Argument-expression-list\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)" ) , lf_AUX_Improve_C_code5_1 , lf_AUX_Improve_C_code5_1sym ) ;
...
ATerm lf_AUX_Improve_C_code5_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 12 ] ;
FUNC_ENTRY ( lf_AUX_Improve_C_code5_1sym , ATmakeAppl ( lf_AUX_Improve_C_code5_1sym , arg0 , arg1 ) ) ;
...
tmp [ 1 ] = ( * ef3 ) ( tmp [ 0 ] , ( constant0 ? constant0 : ( constant0 = ( * ef2 ) ( lf3 ( make_list ( null ( ) ) ) ) ) ) , ( * ef2 ) ( lf3 ( make_list ( atmp100 ) ) ) ) ;
...
tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ;
tmp [ 5 ] = ( * ef3 ) ( tmp [ 0 ] , ( * ef2 ) ( lf3 ( make_list ( tmp [ 4 ] ) ) ) , ( * ef2 ) ( lf3 ( make_list ( atmp100 ) ) ) ) ;
...
tmp [ 9 ] = arg_0 ( tmp [ 8 ] ) ;
tmp [ 10 ] = lf_AUX_Improve_C_code5_1 ( ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) , ( * ef6 ) ( ( * ef2 ) ( lf3 ( make_list ( atmp100 ) ) ) , ( * ef2 ) ( lf3 ( make_list ( tmp [ 9 ] ) ) ) ) ) ;
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Improve_C_code5_1sym , arg0 , arg1 ) ) ;
}
}
