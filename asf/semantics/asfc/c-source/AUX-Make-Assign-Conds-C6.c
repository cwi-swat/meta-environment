#include "support.h"
static Symbol lf_AUX_Make_Assign_Conds_C6_2sym;
static ATerm lf_AUX_Make_Assign_Conds_C6_2( ATerm arg1 , ATerm arg2);
static Symbol ef1sym;
static funcptr ef1;
static Symbol lf_AUX_Make_Assign_Conds_C6_1sym;
static ATerm lf_AUX_Make_Assign_Conds_C6_1( ATerm arg1);
void register_AUX_Make_Assign_Conds_C6( ) {
lf_AUX_Make_Assign_Conds_C6_2sym= ATmakeSymbol( "prod(id(\"Make-Assign-Conds-C\"),w(\"\"),[l(\"inspect-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Make_Assign_Conds_C6_2sym);
lf_AUX_Make_Assign_Conds_C6_1sym= ATmakeSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Make_Assign_Conds_C6_1sym);
register_prod( ATparse( "listtype(sort(\"Term\"),ql(\",\"))") , lf_AUX_Make_Assign_Conds_C6_1 , lf_AUX_Make_Assign_Conds_C6_1sym);
register_prod( ATparse( "prod(id(\"Make-Assign-Conds-C\"),w(\"\"),[l(\"inspect-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Make_Assign_Conds_C6_2 , lf_AUX_Make_Assign_Conds_C6_2sym);
}
...
void init_AUX_Make_Assign_Conds_C6( ) {
}
