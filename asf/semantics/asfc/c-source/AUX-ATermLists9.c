#include "support.h"
static Symbol lf_AUX_ATermLists9_1sym;
...
lf_AUX_ATermLists9_1sym= ATmakeSymbol( "prod(id(\"ATermLists\"),w(\"\"),[l(\"index\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Num\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_ATermLists9_1sym);
register_prod( ATparse( "prod(id(\"ATermLists\"),w(\"\"),[l(\"index\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Num\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)") , lf_AUX_ATermLists9_1 , lf_AUX_ATermLists9_1sym);
}
...
return lf_AUX_ATermLists9_1( ( * ef1)( atmp001) , atmp10);
}
}
}
}
...
return make_nf2( lf_AUX_ATermLists9_1sym , arg0 , arg1);
}
