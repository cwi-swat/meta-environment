...
static aterm * lf_AUX_Remove_Lists_C17_1( aterm * arg1 , aterm * arg2);
...
lf_AUX_Remove_Lists_C17_1sym= TmkSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C17_1 , lf_AUX_Remove_Lists_C17_1sym);
...
aterm * lf_AUX_Remove_Lists_C17_1( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[3];
...
return make_nf2( lf_AUX_Remove_Lists_C17_1sym , arg0 , arg1);
}
}
