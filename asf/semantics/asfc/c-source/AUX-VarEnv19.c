...
lf_AUX_VarEnv19_1sym = ATmakeSymbol ( "prod(id(\"VarEnv\"),w(\"\"),[ql(\"ntl-lookup\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"VarEnv\"),w(\"\"),[ql(\"ntl-lookup\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)" ) , lf_AUX_VarEnv19_1 , lf_AUX_VarEnv19_1sym ) ;
...
( tmp [ 2 ] = arg_0 ( tmp [ 1 ] ) ) ;
FUNC_EXIT ( ( * ef3 ) ( ( * ef4 ) ( lf4 ( cons ( make_list_char ( 108 ) , cons ( make_list_char ( 102 ) , make_list ( tmp [ 2 ] ) ) ) ) ) , ( * ef1 ) ( lf2 ( make_list ( ( * ef2 ) ( arg0 , ( * ef4 ) ( lf4 ( cons ( make_list_char ( 108 ) , cons ( make_list_char ( 102 ) , make_list ( tmp [ 2 ] ) ) ) ) ) , lf3 ( make_list ( null ( ) ) ) ) ) ) , atmp11 , atmp12 , ( * ef5 ) ( atmp13 ) ) ) ) ;
}
}
}
}
