#include "support.h"
static Symbol lf_AUX_MuASF_Sign2C9_2sym;
static ATerm lf_AUX_MuASF_Sign2C9_2( ATerm arg1);
...
lf_AUX_MuASF_Sign2C9_2sym= ATmakeSymbol( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[l(\"namepairs2lstats\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_MuASF_Sign2C9_2sym);
lf_AUX_MuASF_Sign2C9_1sym= ATmakeSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_MuASF_Sign2C9_1sym);
register_prod( ATparse( "listtype(sort(\"NamePair\"),ql(\",\"))") , lf_AUX_MuASF_Sign2C9_1 , lf_AUX_MuASF_Sign2C9_1sym);
register_prod( ATparse( "prod(id(\"MuASF-Sign2C\"),w(\"\"),[l(\"namepairs2lstats\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Sign2C9_2 , lf_AUX_MuASF_Sign2C9_2sym);
}
...
ATerm lf_AUX_MuASF_Sign2C9_2( ATerm arg0) {
{
ATerm tmp[2];
PROF( prof_lf_AUX_MuASF_Sign2C9_2);
if( check_sym( arg0 , lf_AUX_MuASF_Sign2C9_1sym)) {
{
...
return ( * ef3)( lf_AUX_MuASF_Sign2C9_2( lf_AUX_MuASF_Sign2C9_1( make_list( tmp[ 0]))) , ( * ef2)( tmp[ 1]));
}
}
else {
...
return make_nf1( lf_AUX_MuASF_Sign2C9_2sym , arg0);
}
}
