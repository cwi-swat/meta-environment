#include "support.h"
static asymbol * lf_AUX_Trans_Set_Pats3_2sym;
static aterm * lf_AUX_Trans_Set_Pats3_2( aterm * arg1 , aterm * arg2 , aterm * arg3 , aterm * arg4 , aterm * arg5);
...
static funcptr ef4;
static asymbol * lf_AUX_Trans_Set_Pats3_1sym;
...
lf_AUX_Trans_Set_Pats3_2sym= TmkSymbol( "prod(id(\"Trans-Set-Pats\"),w(\"\"),[l(\"transform-set-lhs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Cond\"),w(\"\"),ql(\"&\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf4sym= TmkSymbol( "listtype(sort(\"FuncDef\"),ql(\";\"))" , SYM_STRING);
lf5sym= TmkSymbol( "listtype(sort(\"Rule\"),ql(\";\"))" , SYM_STRING);
lf_AUX_Trans_Set_Pats3_1sym= TmkSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , SYM_STRING);
lf6sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"Cond\"),ql(\"&\"))") , lf_AUX_Trans_Set_Pats3_1 , lf_AUX_Trans_Set_Pats3_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[l(\"transform-set-lhs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Cond\"),w(\"\"),ql(\"&\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTuple\"),w(\"\"),no-attrs)") , lf_AUX_Trans_Set_Pats3_2 , lf_AUX_Trans_Set_Pats3_2sym);
...
ef10= lookup_func( TmakeSimple( & local , "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[sort(\"Term\"),w(\"\"),ql(\"=\"),w(\"\"),sort(\"Term\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Rule\"),w(\"\"),no-attrs)"));
ef10sym= lookup_sym( TmakeSimple( & local , "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[sort(\"Term\"),w(\"\"),ql(\"=\"),w(\"\"),sort(\"Term\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Rule\"),w(\"\"),no-attrs)"));
...
ef12= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[l(\"set-pattern\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"SPatType\"),w(\"\"),l(\",\"),w(\"\"),sort(\"TermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)"));
ef12sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[l(\"set-pattern\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"SPatType\"),w(\"\"),l(\",\"),w(\"\"),sort(\"TermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)"));
ef13= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"init-lhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef13sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"init-lhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
...
ef15= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"init-cond\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef15sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"init-cond\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef16= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"init-new\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef16sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"init-new\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
...
ef19= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"def-lhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef19sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"def-lhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef20= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"def-rhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef20sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"def-rhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef21= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r1-lhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef21sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r1-lhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef22= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r1-rhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef22sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r1-rhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef23= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r2-lhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef23sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r2-lhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef24= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r2-rhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef24sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r2-rhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef25= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r3-lhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef25sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r3-lhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef26= lookup_func( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r3-rhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
ef26sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Trans-Set-Pats\"),w(\"\"),[ql(\"r3-rhs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SPatType\"),w(\"\"),no-attrs)"));
}
aterm * lf_AUX_Trans_Set_Pats3_2( aterm * arg0 , aterm * arg1 , aterm * arg2 , aterm * arg3 , aterm * arg4) {
{
aterm * tmp[38];
...
t_protect( atmp210);
t_protect( arg4);
tmp[ 0]= ( * ef12)( ( * ef13)( ) , ( * ef14)( lf3( make_list( atmp210))) , arg4);
...
t_protect( atmp210);
t_protect( arg4);
tmp[ 3]= ( * ef12)( ( * ef15)( ) , ( * ef14)( lf3( make_list( atmp210))) , arg4);
...
t_protect( atmp210);
t_protect( arg4);
tmp[ 6]= ( * ef12)( ( * ef16)( ) , ( * ef14)( lf3( make_list( atmp210))) , arg4);
...
t_protect( tmp[ 11]);
t_protect( arg0);
tmp[ 12]= ( * ef18)( ( * ef1)( atmp20 , lf3( cons( make_list( atmp210) , cons( make_list( ( * ef7)( ( * ef8)( tmp[ 11]))) , make_list( ( * ef7)( ( * ef8)( tmp[ 11]))))))) , arg0);
t_protect( atmp210);
t_protect( arg4);
tmp[ 13]= ( * ef12)( ( * ef19)( ) , ( * ef14)( lf3( make_list( atmp210))) , arg4);
...
t_protect( atmp210);
t_protect( arg4);
tmp[ 16]= ( * ef12)( ( * ef20)( ) , ( * ef14)( lf3( make_list( atmp210))) , arg4);
...
t_protect( atmp210);
t_protect( arg4);
tmp[ 19]= ( * ef12)( ( * ef21)( ) , ( * ef14)( lf3( make_list( atmp210))) , arg4);
if( check_sym( tmp[ 19] , ef14sym)) {
tmp[ 20]= arg_0( tmp[ 19]);
...
t_protect( atmp210);
t_protect( arg4);
tmp[ 22]= ( * ef12)( ( * ef22)( ) , ( * ef14)( lf3( make_list( atmp210))) , arg4);
...
t_protect( atmp210);
t_protect( arg4);
tmp[ 26]= ( * ef12)( ( * ef23)( ) , ( * ef14)( lf3( make_list( atmp210))) , arg4);
if( check_sym( tmp[ 26] , ef14sym)) {
tmp[ 27]= arg_0( tmp[ 26]);
...
t_protect( atmp210);
t_protect( arg4);
tmp[ 29]= ( * ef12)( ( * ef24)( ) , ( * ef14)( lf3( make_list( atmp210))) , arg4);
if( check_sym( tmp[ 29] , ef14sym)) {
tmp[ 30]= arg_0( tmp[ 29]);
...
t_protect( atmp210);
t_protect( arg4);
tmp[ 32]= ( * ef12)( ( * ef25)( ) , ( * ef14)( lf3( make_list( atmp210))) , arg4);
if( check_sym( tmp[ 32] , ef14sym)) {
tmp[ 33]= arg_0( tmp[ 32]);
if( check_sym( tmp[ 33] , lf3sym)) {
tmp[ 34]= arg_0( tmp[ 33]);
t_protect( tmp[ 34]);
if( not_empty_list( tmp[ 34])) {
t_protect( atmp210);
t_protect( arg4);
tmp[ 35]= ( * ef12)( ( * ef26)( ) , ( * ef14)( lf3( make_list( atmp210))) , arg4);
if( check_sym( tmp[ 35] , ef14sym)) {
tmp[ 36]= arg_0( tmp[ 35]);
...
t_unprotect( tmp[ 32]);
t_unprotect( tmp[ 35]);
return ( * ef2)( lf4( make_list( tmp[ 12])) , lf5( cons( make_list( ( * ef3)( ( * ef4)( lf_AUX_Trans_Set_Pats3_1( make_list( ( * ef5)( ( * ef1)( arg0 , lf3( make_list( tmp[ 5]))) , ( * ef1)( ( * ef6)( lf6( cons( make_list( make_char( 111)) , make_list( make_char( 107))))) , lf3( make_list( ( * ef7)( ( * ef8)( tmp[ 11]))))))))) , ( * ef1)( atmp20 , lf3( make_list( tmp[ 2]))) , ( * ef7)( ( * ef8)( tmp[ 11])))) , cons( make_list( ( * ef3)( ( * ef4)( arg1) , ( * ef1)( arg0 , lf3( make_list( tmp[ 8]))) , ( * ef1)( ( * ef6)( lf6( cons( make_list( make_char( 111)) , make_list( make_char( 107))))) , lf3( make_list( arg3))))) , cons( make_list( ( * ef9)( ( * ef1)( arg0 , lf3( make_list( tmp[ 15]))) , ( * ef1)( arg0 , lf3( make_list( tmp[ 18]))))) , cons( make_list( ( * ef10)( ( * ef1)( arg0 , lf3( make_list( tmp[ 21]))) , tmp[ 25])) , cons( make_list( ( * ef10)( ( * ef1)( arg0 , lf3( make_list( tmp[ 28]))) , ( * ef1)( arg0 , lf3( make_list( tmp[ 31]))))) , make_list( ( * ef10)( ( * ef1)( arg0 , lf3( make_list( tmp[ 34]))) , ( * ef1)( arg0 , lf3( make_list( tmp[ 37]))))))))))) , ( * ef11)( ( * ef11)( arg4)));
}
}
}
t_unprotect( tmp[ 35]);
...
return make_nf5( lf_AUX_Trans_Set_Pats3_2sym , arg0 , arg1 , arg2 , arg3 , arg4);
}
}
