#include  "support.h"
static Symbol lf_AUX_ANumerals2_1sym ;
static ATerm lf_AUX_ANumerals2_1 ( ATerm arg1 ) ;
...
lf_AUX_ANumerals2_1sym = ATmakeSymbol ( "prod(id(\"ANumerals\"),w(\"\"),[l(\"succ\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntCon\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ANumerals2_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"ANumerals\"),w(\"\"),[l(\"succ\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"IntCon\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IntCon\"),w(\"\"),no-attrs)" ) , lf_AUX_ANumerals2_1 , lf_AUX_ANumerals2_1sym ) ;
...
void init_AUX_ANumerals2 ( ) {
ATprotect ( & constant0 ) ;
}
ATerm lf_AUX_ANumerals2_1 ( ATerm arg0 ) {
{
ATerm tmp [ 2 ] ;
FUNC_ENTRY ( lf_AUX_ANumerals2_1sym , ATmakeAppl ( lf_AUX_ANumerals2_1sym , arg0 ) ) ;
tmp [ 0 ] = ( * ef1 ) ( ( constant0 ? constant0 : ( constant0 = ( * ef2 ) ( ( * ef3 ) ( ( * ef4 ) ( lf2 ( make_list ( make_char ( 49 ) ) ) ) ) ) ) ) , ( * ef2 ) ( arg0 ) ) ;
if ( check_sym ( tmp [ 0 ] , ef2sym ) ) {
tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ;
FUNC_EXIT ( tmp [ 1 ] ) ;
}
FUNC_EXIT ( make_nf1 ( lf_AUX_ANumerals2_1sym , arg0 ) ) ;
}
}
