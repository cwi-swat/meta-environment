...
static Symbol lf_AUX_AsFix_Basics11_1sym ;
static ATerm lf_AUX_AsFix_Basics11_1 ( ATerm arg1 ) ;
...
void register_AUX_AsFix_Basics11 ( ) {
lf_AUX_AsFix_Basics11_1sym = ATmakeSymbol ( "prod(id(\"AsFix-Basics\"),w(\"\"),[l(\"char2id\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Literal\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_AsFix_Basics11_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"AsFix-Basics\"),w(\"\"),[l(\"char2id\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Literal\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)" ) , lf_AUX_AsFix_Basics11_1 , lf_AUX_AsFix_Basics11_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_AsFix_Basics11 ( ) {
...
void init_AUX_AsFix_Basics11 ( ) {
ATprotect ( & constant0 ) ;
}
ATerm lf_AUX_AsFix_Basics11_1 ( ATerm arg0 ) {
{
ATerm tmp [ 3 ] ;
FUNC_ENTRY ( lf_AUX_AsFix_Basics11_1sym , ATmakeAppl ( lf_AUX_AsFix_Basics11_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_AsFix_Basics11_1sym , arg0 ) ) ;
}
}
