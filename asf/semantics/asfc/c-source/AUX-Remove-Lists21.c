...
lf_AUX_Remove_Lists21_1sym = ATmakeSymbol ( "prod(id(\"Remove-Lists\"),w(\"\"),[ql(\"transform-rhs-list-var\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Remove-Lists\"),w(\"\"),[ql(\"transform-rhs-list-var\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)" ) , lf_AUX_Remove_Lists21_1 , lf_AUX_Remove_Lists21_1sym ) ;
...
( tmp [ 0 ] = ( * ef7 ) ( arg0 ) ) ;
FUNC_EXIT ( ( * ef1 ) ( lf2 ( make_list ( ( * ef2 ) ( ( * ef4 ) ( tmp [ 0 ] ) ) ) ) , lf3 ( make_list ( null ( ) ) ) , arg1 ) ) ;
}
}
}
{
