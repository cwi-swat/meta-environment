...
lf_AUX_Check_List_Pats28_1sym= ATmakeSymbol( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"contains-no-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"contains-no-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_Check_List_Pats28_1 , lf_AUX_Check_List_Pats28_1sym);
...
{
ATerm tmp[11];
PROF( prof_lf_AUX_Check_List_Pats28_1);
...
return lf_AUX_Check_List_Pats28_1( tmp[ 9]);
}
}
}
}
...
if( term_equal( ( * ef3)( arg0) , ( constant1? constant1: ( constant1= ( * ef4)( ))))) {
return ( * ef1)( ( * ef2)( arg0));
}
return make_nf1( lf_AUX_Check_List_Pats28_1sym , arg0);
}
}
