...
static Symbol lf_AUX_Rules2C_Aux19_2_recursivesym ;
static ATerm lf_AUX_Rules2C_Aux19_2_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Rules2C_Aux19_2_recursivesym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-conds-on-second-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Rules2C_Aux19_2_recursivesym ) ;
lf_AUX_Rules2C_Aux19_2sym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-conds-on-second-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-conds-on-second-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux19_2 , lf_AUX_Rules2C_Aux19_2sym ) ;
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"select-conds-on-second-term\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux19_2_recursive , lf_AUX_Rules2C_Aux19_2_recursivesym ) ;
...
FUNC_EXIT_CONST ( constant0 , ( * ef2 ) ( lf_AUX_Rules2C_Aux19_1 ( make_list ( null ( ) ) ) , lf_AUX_Rules2C_Aux19_1 ( make_list ( null ( ) ) ) ) ) ;
}
else {
...
( tmp [ 35 ] = arg_0 ( tmp [ 33 ] ) ) ;
FUNC_EXIT ( ( * ef2 ) ( lf_AUX_Rules2C_Aux19_1 ( cons ( make_list ( ( * ef1 ) ( lf3 ( make_list ( tmp [ 8 ] ) ) , lf4 ( cons ( make_list ( ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( lf5 ( ( ATerm ) ATmakeList ( 10 , char_table [ 116 ] , char_table [ 101 ] , char_table [ 114 ] , char_table [ 109 ] , char_table [ 95 ] , char_table [ 101 ] , char_table [ 113 ] , char_table [ 117 ] , char_table [ 97 ] , char_table [ 108 ] ) ) ) , lf6 ( cons ( make_list ( tmp [ 28 ] ) , make_list ( arg0 ) ) ) ) , tmp [ 13 ] ) ) , make_list ( tmp [ 11 ] ) ) ) , tmp [ 4 ] , tmp [ 5 ] , tmp [ 6 ] , tmp [ 7 ] ) ) , make_list ( tmp [ 34 ] ) ) ) , lf_AUX_Rules2C_Aux19_1 ( make_list ( tmp [ 35 ] ) ) ) ) ;
}
}
}
}
...
( tmp [ 14 ] = arg_0 ( tmp [ 12 ] ) ) ;
FUNC_EXIT ( ( * ef2 ) ( lf_AUX_Rules2C_Aux19_1 ( make_list ( tmp [ 13 ] ) ) , lf_AUX_Rules2C_Aux19_1 ( cons ( make_list ( ( * ef1 ) ( lf3 ( make_list ( tmp [ 8 ] ) ) , lf4 ( make_list ( tmp [ 9 ] ) ) , tmp [ 4 ] , tmp [ 5 ] , tmp [ 6 ] , tmp [ 7 ] ) ) , make_list ( tmp [ 14 ] ) ) ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_Rules2C_Aux19_2_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 36 ] ;
FUNC_ENTRY ( lf_AUX_Rules2C_Aux19_2_recursivesym , ATmakeAppl ( lf_AUX_Rules2C_Aux19_2_recursivesym , arg0 , arg1 ) ) ;
{
ATerm atmp10 = arg1 ;
if ( ! not_empty_list ( atmp10 ) ) {
FUNC_EXIT_CONST ( constant0 , ( * ef2 ) ( lf_AUX_Rules2C_Aux19_1 ( make_list ( null ( ) ) ) , lf_AUX_Rules2C_Aux19_1 ( make_list ( null ( ) ) ) ) ) ;
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Rules2C_Aux19_2_recursivesym , arg0 , lf_AUX_Rules2C_Aux19_1 ( arg1 ) ) ) ;
}
}
