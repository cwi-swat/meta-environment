...
lf_AUX_Rules2C_Aux19_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-first-cond-and-add-env\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"remove-first-cond-and-add-env\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux19_2 , lf_AUX_Rules2C_Aux19_2sym);
...
t_protect( tmp[ 10]);
t_protect( arg1);
tmp[ 11]= lf_AUX_Rules2C_Aux19_2( lf_AUX_Rules2C_Aux19_1( make_list( tmp[ 10])) , arg1);
...
t_unprotect( tmp[ 10]);
t_unprotect( tmp[ 11]);
return ( * ef1)( lf_AUX_Rules2C_Aux19_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 6])) , lf4( make_list( tmp[ 9])) , tmp[ 3] , ( * ef3)( tmp[ 4] , arg1) , ( * ef3)( tmp[ 5] , arg1))) , make_list( tmp[ 13]))));
}
}
t_unprotect( tmp[ 11]);
t_unprotect( tmp[ 10]);
...
return make_nf2( lf_AUX_Rules2C_Aux19_2sym , arg0 , arg1);
}
}
