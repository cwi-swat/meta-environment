...
static aterm * lf_AUX_MuASF_Basics18_1( aterm * arg1 , aterm * arg2);
...
lf_AUX_MuASF_Basics18_1sym= TmkSymbol( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"make-new-args\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"TermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"make-new-args\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"TermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Basics18_1 , lf_AUX_MuASF_Basics18_1sym);
...
aterm * lf_AUX_MuASF_Basics18_1( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[5];
...
t_protect( tmp[ 1]);
t_protect( arg1);
tmp[ 2]= lf_AUX_MuASF_Basics18_1( ( * ef1)( lf2( make_list( tmp[ 1]))) , ( * ef3)( arg1));
...
return make_nf2( lf_AUX_MuASF_Basics18_1sym , arg0 , arg1);
}
}
