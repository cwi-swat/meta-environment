#include  "support.h"
static Symbol lf_AUX_MuASF_Signs11_2sym ;
static ATerm lf_AUX_MuASF_Signs11_2 ( ATerm arg1 , ATerm arg2 ) ;
...
static ATerm lf_AUX_MuASF_Signs11_1 ( ATerm arg1 ) ;
void register_AUX_MuASF_Signs11 ( ) {
lf_AUX_MuASF_Signs11_2sym = ATmakeSymbol ( "prod(id(\"MuASF-Signs\"),w(\"\"),[l(\"addto-sign\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"SignatureOpt\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SignatureOpt\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Signs11_2sym ) ;
lf_AUX_MuASF_Signs11_1sym = ATmakeSymbol ( "listtype(sort(\"FuncDef\"),ql(\";\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Signs11_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"FuncDef\"),ql(\";\"))" ) , lf_AUX_MuASF_Signs11_1 , lf_AUX_MuASF_Signs11_1sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF-Signs\"),w(\"\"),[l(\"addto-sign\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"SignatureOpt\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SignatureOpt\"),w(\"\"),no-attrs)" ) , lf_AUX_MuASF_Signs11_2 , lf_AUX_MuASF_Signs11_2sym ) ;
}
...
if ( check_sym ( atmp000 , lf_AUX_MuASF_Signs11_1sym ) ) {
{
...
if ( not_empty_list ( atmp10 ) ) {
tmp [ 0 ] = ( * ef4 ) ( ( * ef3 ) ( lf_AUX_MuASF_Signs11_1 ( make_list ( atmp0000 ) ) ) , ( * ef3 ) ( lf_AUX_MuASF_Signs11_1 ( make_list ( atmp10 ) ) ) ) ;
