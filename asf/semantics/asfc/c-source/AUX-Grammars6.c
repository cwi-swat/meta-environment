...
static Symbol lf_AUX_Grammars6_1_recursivesym ;
static ATerm lf_AUX_Grammars6_1_recursive ( ATerm arg1 ) ;
...
lf_AUX_Grammars6_1_recursivesym = ATmakeSymbol ( "prod(id(\"Grammars\"),w(\"\"),[ql(\"norm\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Symbols\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Grammars6_1_recursivesym ) ;
lf_AUX_Grammars6_1sym = ATmakeSymbol ( "prod(id(\"Grammars\"),w(\"\"),[ql(\"norm\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Symbols\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Grammars6_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"Symbol\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Grammars\"),w(\"\"),[ql(\"norm\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Symbols\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)" ) , lf_AUX_Grammars6_1 , lf_AUX_Grammars6_1sym ) ;
register_prod ( ATparse ( "prod(id(\"Grammars\"),w(\"\"),[ql(\"norm\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Symbols\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Symbols\"),w(\"\"),no-attrs)" ) , lf_AUX_Grammars6_1_recursive , lf_AUX_Grammars6_1_recursivesym ) ;
...
if ( not_empty_list ( tmp [ 0 ] ) ) {
FUNC_EXIT ( ( * ef2 ) ( lf_AUX_Grammars6_1_recursive ( slice ( atmp0000 [ 0 ] , atmp0000 [ 1 ] ) ) , ( * ef2 ) ( make_nf1 ( ef1sym , lf2 ( make_list ( ( * ef3 ) ( ( * ef4 ) ( ) ) ) ) ) , lf_AUX_Grammars6_1_recursive ( tmp [ 0 ] ) ) ) ) ;
}
...
ATerm lf_AUX_Grammars6_1_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 1 ] ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Grammars6_1_recursivesym , ( * ef1 ) ( lf2 ( arg0 ) ) ) ) ;
}
}
