#include "support.h"
static Symbol lf_AUX_ATermPrint1_1sym;
...
lf_AUX_ATermPrint1_1sym= ATmakeSymbol( "prod(id(\"ATermPrint\"),w(\"\"),[l(\"print\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_ATermPrint1_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"ATermPrint\"),w(\"\"),[l(\"print\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)") , lf_AUX_ATermPrint1_1 , lf_AUX_ATermPrint1_1sym);
...
return ( * ef106)( ( * ef106)( ( * ef106)( lf_AUX_ATermPrint1_1( ( * ef1)( atmp00)) , ( constant106? constant106: ( constant106= ( * ef3)( lf2( (ATerm) ATmakeList( 3 , char_table[ 34] , char_table[ 40] , char_table[ 34])))))) , ( * ef107)( atmp01)) , ( constant107? constant107: ( constant107= ( * ef3)( lf2( (ATerm) ATmakeList( 3 , char_table[ 34] , char_table[ 41] , char_table[ 34]))))));
}
}
}
