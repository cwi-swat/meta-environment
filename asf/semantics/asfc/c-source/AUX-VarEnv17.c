...
static ATerm lf_AUX_VarEnv17_1( ATerm arg1 , ATerm arg2);
...
lf_AUX_VarEnv17_1sym= ATmakeSymbol( "prod(id(\"VarEnv\"),w(\"\"),[l(\"ntl-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"VarEnv\"),w(\"\"),[l(\"ntl-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)") , lf_AUX_VarEnv17_1 , lf_AUX_VarEnv17_1sym);
...
ATerm lf_AUX_VarEnv17_1( ATerm arg0 , ATerm arg1) {
{
ATerm tmp[12];
...
tmp[ 4]= lf_AUX_VarEnv17_1( arg0 , ( * ef1)( lf2( make_list( tmp[ 1])) , atmp11 , atmp12 , atmp13));
...
return make_nf2( lf_AUX_VarEnv17_1sym , arg0 , arg1);
}
}
