#include "support.h"
static Symbol lf_AUX_Remove_Lists_C3_2sym;
static ATerm lf_AUX_Remove_Lists_C3_2( ATerm arg1 , ATerm arg2);
...
lf_AUX_Remove_Lists_C3_2sym= ATmakeSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"rem-lists-from-rules\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTuple\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Remove_Lists_C3_2sym);
lf_AUX_Remove_Lists_C3_1sym= ATmakeSymbol( "listtype(sort(\"Rule\"),ql(\";\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Remove_Lists_C3_1sym);
lf3sym= ATmakeSymbol( "listtype(sort(\"FuncDef\"),ql(\";\"))" , 1 , ATtrue);
ATprotectSymbol( lf3sym);
register_prod( ATparse( "listtype(sort(\"Rule\"),ql(\";\"))") , lf_AUX_Remove_Lists_C3_1 , lf_AUX_Remove_Lists_C3_1sym);
register_prod( ATparse( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"rem-lists-from-rules\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncRuleTuple\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C3_2 , lf_AUX_Remove_Lists_C3_2sym);
...
ATerm lf_AUX_Remove_Lists_C3_2( ATerm arg0 , ATerm arg1) {
{
ATerm tmp[17];
PROF( prof_lf_AUX_Remove_Lists_C3_2);
if( check_sym( arg0 , lf_AUX_Remove_Lists_C3_1sym)) {
{
...
tmp[ 6]= arg_0( tmp[ 3]);
if( check_sym( tmp[ 4] , lf_AUX_Remove_Lists_C3_1sym)) {
tmp[ 7]= arg_0( tmp[ 4]);
tmp[ 8]= lf_AUX_Remove_Lists_C3_2( lf_AUX_Remove_Lists_C3_1( make_list( tmp[ 1])) , tmp[ 5]);
...
tmp[ 12]= arg_0( tmp[ 9]);
if( check_sym( tmp[ 10] , lf_AUX_Remove_Lists_C3_1sym)) {
tmp[ 13]= arg_0( tmp[ 10]);
...
tmp[ 16]= arg_0( tmp[ 15]);
return ( * ef1)( lf3( make_list( tmp[ 16])) , lf_AUX_Remove_Lists_C3_1( cons( make_list( tmp[ 7]) , make_list( tmp[ 13]))) , tmp[ 11]);
}
}
}
}
...
return ( * ef1)( ( constant0? constant0: ( constant0= lf3( make_list( null( ))))) , ( constant1? constant1: ( constant1= lf_AUX_Remove_Lists_C3_1( make_list( null( ))))) , arg1);
}
}
}
return make_nf2( lf_AUX_Remove_Lists_C3_2sym , arg0 , arg1);
}
}
