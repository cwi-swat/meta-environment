...
lf_AUX_Rules2C_Aux14_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-same-rhs-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-same-rhs-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux14_2 , lf_AUX_Rules2C_Aux14_2sym);
...
tmp[ 2]= m_list_head( atmp10);
tmp[ 3]= m_list_tail( atmp10);
...
t_unprotect( tmp[ 13]);
t_unprotect( tmp[ 17]);
return ( * ef1)( lf_AUX_Rules2C_Aux14_1( make_list( tmp[ 20])) , lf_AUX_Rules2C_Aux14_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 11])) , lf4( cons( make_list( ( * ef3)( tmp[ 4] , tmp[ 16])) , make_list( tmp[ 14]))) , tmp[ 8] , tmp[ 9] , tmp[ 10])) , make_list( tmp[ 21]))));
}
}
}
t_unprotect( tmp[ 17]);
...
tmp[ 22]= arg_0( tmp[ 20]);
tmp[ 23]= arg_1( tmp[ 20]);
if( m_term_equal( tmp[ 11] , tmp[ 22])) {
if( m_term_equal( tmp[ 12] , tmp[ 23])) {
t_protect( arg0);
t_protect( tmp[ 1]);
...
t_unprotect( arg1);
return ( * ef1)( lf_AUX_Rules2C_Aux14_1( make_list( arg0)) , lf_AUX_Rules2C_Aux14_1( make_list( null( ))));
}
}
}
