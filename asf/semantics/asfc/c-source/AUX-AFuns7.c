#include "support.h"
static asymbol * lf_AUX_AFuns7_1sym;
...
lf_AUX_AFuns7_1sym= TmkSymbol( "prod(id(\"AFuns\"),w(\"\"),[l(\"for-all1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"AFuns\"),w(\"\"),[l(\"for-all1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_AFuns7_1 , lf_AUX_AFuns7_1sym);
}
