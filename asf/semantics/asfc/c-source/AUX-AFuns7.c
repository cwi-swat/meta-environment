...
static ATerm lf_AUX_AFuns7_1( ATerm arg1 , ATerm arg2);
...
lf_AUX_AFuns7_1sym= ATmakeSymbol( "prod(id(\"AFuns\"),w(\"\"),[l(\"for-all1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_AFuns7_1sym);
register_prod( ATparse( "prod(id(\"AFuns\"),w(\"\"),[l(\"for-all1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_AFuns7_1 , lf_AUX_AFuns7_1sym);
}
...
ATerm lf_AUX_AFuns7_1( ATerm arg0 , ATerm arg1) {
...
return ( * ef4)( ( * ef5)( arg0 , ( * ef6)( ( * ef7)( arg1))) , lf_AUX_AFuns7_1( arg0 , ( * ef8)( arg1)));
}
}
return make_nf2( lf_AUX_AFuns7_1sym , arg0 , arg1);
}
