#include "support.h"
static Symbol lf_AUX_AFuns7_1sym;
static ATerm lf_AUX_AFuns7_1( ATerm arg1 , ATerm arg2 , ATerm arg3);
...
static funcptr ef10;
void register_AUX_AFuns7( ) {
lf_AUX_AFuns7_1sym= ATmakeSymbol( "prod(id(\"AFuns\"),w(\"\"),[l(\"replace\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 3 , ATtrue);
ATprotectSymbol( lf_AUX_AFuns7_1sym);
register_prod( ATparse( "prod(id(\"AFuns\"),w(\"\"),[l(\"replace\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)") , lf_AUX_AFuns7_1 , lf_AUX_AFuns7_1sym);
}
void resolve_AUX_AFuns7( ) {
...
void init_AUX_AFuns7( ) {
}
ATerm lf_AUX_AFuns7_1( ATerm arg0 , ATerm arg1 , ATerm arg2) {
{
ATerm tmp[3];
PROF( prof_lf_AUX_AFuns7_1);
...
tmp[ 0]= lf_AUX_AFuns7_1( arg0 , ( * ef3)( ( * ef4)( atmp11)) , arg2);
...
return ( * ef3)( ( * ef6)( ( * ef4)( ( * ef2)( lf_AUX_AFuns7_1( arg0 , ( * ef7)( ( * ef4)( atmp100)) , arg2))) , ( * ef8)( lf_AUX_AFuns7_1( arg0 , ( * ef3)( ( * ef9)( ( * ef4)( atmp100))) , arg2))));
}
}
}
}
...
{
ATerm atmp11= arg_1( arg1);
return ( * ef10)( atmp10 , lf_AUX_AFuns7_1( arg0 , atmp11 , arg2));
}
}
}
return arg1;
