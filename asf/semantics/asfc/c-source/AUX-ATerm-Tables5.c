...
lf_AUX_ATerm_Tables5_1sym = ATmakeSymbol ( "prod(id(\"ATerm-Tables\"),w(\"\"),[ql(\"cput\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ATerm_Tables5_1sym ) ;
register_prod ( ATparse ( "prod(id(\"ATerm-Tables\"),w(\"\"),[ql(\"cput\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)" ) , lf_AUX_ATerm_Tables5_1 , lf_AUX_ATerm_Tables5_1sym ) ;
}
...
if ( check_sym ( atmp1001 , ef8sym ) ) {
{
ATerm atmp10010 = arg_0 ( atmp1001 ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef8 ) ( arg1 ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( ( * ef2 ) ( ( * ef3 ) ( arg0 ) , lf_AUX_ATerm_Tables5_1 ( ( * ef4 ) ( arg0 ) , arg1 ) ) ) ;
}
}
