...
ef7 = lookup_func ( ATreadFromString ( "prod(id(\"Optimize-MuASF\"),w(\"\"),[ql(\"remove-emb-arg\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Embedding\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)" ) ) ;
ef7sym = lookup_sym ( ATreadFromString ( "prod(id(\"Optimize-MuASF\"),w(\"\"),[ql(\"remove-emb-arg\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"Embedding\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)" ) ) ;
}
...
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( make_list ( ( * ef7 ) ( tmp [ 0 ] , atmp10 ) ) ) ) ) ;
}
}
}
...
if ( is_single_element ( atmp110000 ) ) {
if ( term_equal ( list_head ( atmp110000 ) , make_char ( 48 ) ) ) {
FUNC_EXIT ( make_nf1 ( ef1sym , lf2 ( cons ( make_list ( ( * ef7 ) ( tmp [ 0 ] , atmp10 ) ) , make_list ( tmp [ 1 ] ) ) ) ) ) ;
}
}
}
}
...
( tmp [ 2 ] = lf_AUX_Optimize_MuASF17_1_recursive ( make_list ( tmp [ 1 ] ) , ( * ef2 ) ( atmp10 , ( * ef6 ) ( ( * ef3 ) ( atmp110 ) , ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( lf3 ( make_list ( make_char ( 49 ) ) ) ) ) ) ) ) ) ) ;
( tmp [ 3 ] = arg_0 ( tmp [ 2 ] ) ) ;
( tmp [ 4 ] = arg_0 ( tmp [ 3 ] ) ) ;
