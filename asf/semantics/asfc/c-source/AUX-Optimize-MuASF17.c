...
lf_AUX_Optimize_MuASF17_1sym = ATmakeSymbol ( "prod(id(\"Optimize-MuASF\"),w(\"\"),[ql(\"remove-emb-args\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"TermList\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"EmbeddingAt\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
FUNC_EXIT ( ( * ef1 ) ( lf2 ( make_list ( ( * ef6 ) ( tmp [ 0 ] , atmp10 ) ) ) ) ) ;
}
}
}
}
...
( tmp [ 2 ] = lf_AUX_Optimize_MuASF17_1 ( ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) , ( * ef2 ) ( atmp10 , ( * ef7 ) ( ( * ef3 ) ( atmp110 ) , ( * ef3 ) ( ( * ef4 ) ( ( * ef5 ) ( lf3 ( make_list ( make_char ( 49 ) ) ) ) ) ) ) ) ) ) ;
