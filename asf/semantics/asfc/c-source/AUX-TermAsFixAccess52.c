#include  "support.h"
static Symbol lf_AUX_TermAsFixAccess52_1sym ;
static ATerm lf_AUX_TermAsFixAccess52_1 ( ATerm arg1 ) ;
...
lf_AUX_TermAsFixAccess52_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"term-get-symbol-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess52_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"term-get-symbol-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess52_1 , lf_AUX_TermAsFixAccess52_1sym ) ;
...
void init_AUX_TermAsFixAccess52 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
ATprotect ( & constant2 ) ;
ATprotect ( & constant3 ) ;
}
ATerm lf_AUX_TermAsFixAccess52_1 ( ATerm arg0 ) {
{
ATerm tmp [ 34 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess52_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess52_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess52_1sym , arg0 ) ) ;
}
}
