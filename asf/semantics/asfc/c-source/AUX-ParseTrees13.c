#include "support.h"
static asymbol * lf_AUX_ParseTrees13_1sym;
static aterm * lf_AUX_ParseTrees13_1( aterm * arg1 , aterm * arg2 , aterm * arg3);
...
lf_AUX_ParseTrees13_1sym= TmkSymbol( "prod(id(\"ParseTrees\"),w(\"\"),[sort(\"ATerm\"),w(\"\"),ql(\"[<\"),w(\"\"),sort(\"AFun\"),w(\"\"),ql(\":=\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"ParseTrees\"),w(\"\"),[sort(\"ATerm\"),w(\"\"),ql(\"[<\"),w(\"\"),sort(\"AFun\"),w(\"\"),ql(\":=\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)") , lf_AUX_ParseTrees13_1 , lf_AUX_ParseTrees13_1sym);
}
...
ef7= lookup_func( TmakeSimple( & local , "prod(id(\"Numerals\"),w(\"\"),[l(\"decr\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Num\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Num\"),w(\"\"),no-attrs)"));
ef7sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Numerals\"),w(\"\"),[l(\"decr\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Num\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Num\"),w(\"\"),no-attrs)"));
...
aterm * lf_AUX_ParseTrees13_1( aterm * arg0 , aterm * arg1 , aterm * arg2) {
{
aterm * tmp[3];
...
t_protect( atmp01);
t_unprotect( arg0);
return ( * ef1)( atmp00 , lf_AUX_ParseTrees13_1( atmp01 , arg1 , arg2));
}
}
}
...
return make_nf3( lf_AUX_ParseTrees13_1sym , arg0 , arg1 , arg2);
}
}
