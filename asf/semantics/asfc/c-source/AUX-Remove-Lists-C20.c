...
lf_AUX_Remove_Lists_C20_1sym= ATmakeSymbol( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-rhs-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Remove-Lists-C\"),w(\"\"),[l(\"transform-rhs-list-var\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"IntVarEnv\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term-CList-VarEnv\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_C20_1 , lf_AUX_Remove_Lists_C20_1sym);
...
tmp[ 0]= ( * ef7)( arg0);
return ( * ef3)( lf2( make_list( ( * ef1)( ( * ef4)( tmp[ 0])))) , ( constant1? constant1: ( constant1= lf3( make_list( null( ))))) , arg1);
}
}
}
{
...
return ( * ef3)( lf2( make_list( arg0)) , ( constant1? constant1: ( constant1= lf3( make_list( null( ))))) , arg1);
}
}
