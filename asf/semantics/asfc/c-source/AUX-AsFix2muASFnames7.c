...
lf_AUX_AsFix2muASFnames7_1sym= ATmakeSymbol( "prod(id(\"AsFix2muASFnames\"),w(\"\"),[l(\"avar2muvar\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Var\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_AsFix2muASFnames7_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"AsFix2muASFnames\"),w(\"\"),[l(\"avar2muvar\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Var\"),w(\"\"),no-attrs)") , lf_AUX_AsFix2muASFnames7_1 , lf_AUX_AsFix2muASFnames7_1sym);
...
ef3= lookup_func( ATreadFromString( "prod(id(\"AsFixParseTrees\"),w(\"\"),[ql(\"sym\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
ef3sym= lookup_sym( ATreadFromString( "prod(id(\"AsFixParseTrees\"),w(\"\"),[ql(\"sym\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
...
ef7= lookup_func( ATreadFromString( "prod(id(\"AsFixParseTrees\"),w(\"\"),[ql(\"name\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
ef7sym= lookup_sym( ATreadFromString( "prod(id(\"AsFixParseTrees\"),w(\"\"),[ql(\"name\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
...
ef10= lookup_func( ATreadFromString( "prod(id(\"ParseTrees\"),w(\"\"),[ql(\"iter\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
ef10sym= lookup_sym( ATreadFromString( "prod(id(\"ParseTrees\"),w(\"\"),[ql(\"iter\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
...
ef12= lookup_func( ATreadFromString( "prod(id(\"ParseTrees\"),w(\"\"),[ql(\"l\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
ef12sym= lookup_sym( ATreadFromString( "prod(id(\"ParseTrees\"),w(\"\"),[ql(\"l\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
...
tmp[ 2]= ( * ef2)( tmp[ 0] , ( constant2? constant2: ( constant2= ( * ef10)( ))));
if( term_equal( tmp[ 2] , ( constant3? constant3: ( constant3= ( * ef11)( ( * ef12)( ) , ( * ef13)( ( * ef14)( ( * ef15)( ( * ef16)( lf2( (ATerm) ATmakeList( 3 , char_table[ 34] , char_table[ 43] , char_table[ 34]))))))))))) {
tmp[ 3]= ( * ef6)( ( * ef2)( arg0 , ( constant4? constant4: ( constant4= ( * ef7)( )))));
return ( * ef8)( tmp[ 3]);
}
if( term_equal( tmp[ 2] , ( constant5? constant5: ( constant5= ( * ef11)( ( * ef12)( ) , ( * ef13)( ( * ef14)( ( * ef15)( ( * ef16)( lf2( (ATerm) ATmakeList( 3 , char_table[ 34] , char_table[ 42] , char_table[ 34]))))))))))) {
tmp[ 3]= ( * ef6)( ( * ef2)( arg0 , ( constant4? constant4: ( constant4= ( * ef7)( )))));
return ( * ef17)( tmp[ 3]);
}
}
tmp[ 2]= ( constant2? constant2: ( constant2= ( * ef10)( )));
if( term_equal( tmp[ 1] , tmp[ 2])) {
tmp[ 3]= ( * ef2)( tmp[ 0] , ( constant2? constant2: ( constant2= ( * ef10)( ))));
if( term_equal( tmp[ 3] , ( constant5? constant5: ( constant5= ( * ef11)( ( * ef12)( ) , ( * ef13)( ( * ef14)( ( * ef15)( ( * ef16)( lf2( (ATerm) ATmakeList( 3 , char_table[ 34] , char_table[ 42] , char_table[ 34]))))))))))) {
tmp[ 4]= ( * ef6)( ( * ef2)( arg0 , ( constant4? constant4: ( constant4= ( * ef7)( )))));
return ( * ef17)( tmp[ 4]);
}
if( term_equal( tmp[ 3] , ( constant3? constant3: ( constant3= ( * ef11)( ( * ef12)( ) , ( * ef13)( ( * ef14)( ( * ef15)( ( * ef16)( lf2( (ATerm) ATmakeList( 3 , char_table[ 34] , char_table[ 43] , char_table[ 34]))))))))))) {
tmp[ 4]= ( * ef6)( ( * ef2)( arg0 , ( constant4? constant4: ( constant4= ( * ef7)( )))));
return ( * ef8)( tmp[ 4]);
}
}
if( term_equal( tmp[ 1] , ( constant6? constant6: ( constant6= ( * ef5)( ))))) {
tmp[ 3]= ( * ef6)( ( * ef2)( arg0 , ( constant4? constant4: ( constant4= ( * ef7)( )))));
return ( * ef1)( tmp[ 3]);
}
