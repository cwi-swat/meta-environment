...
static ATerm lf_AUX_MuASF_Rules2C3_1( ATerm arg1 , ATerm arg2 , ATerm arg3);
...
lf_AUX_MuASF_Rules2C3_1sym= ATmakeSymbol( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"funargs2cstats\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Argument-expression-list\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SlI-tuple\"),w(\"\"),no-attrs)"
 , 3 , ATtrue);
...
register_prod( ATparse( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"funargs2cstats\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Argument-expression-list\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SlI-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Rules2C3_1 , lf_AUX_MuASF_Rules2C3_1sym);
...
ef7= lookup_func( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[l(\"return\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\";\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement\"),w(\"\"),no-attrs)"));
ef7sym= lookup_sym( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[l(\"return\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\";\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement\"),w(\"\"),no-attrs)"));
...
ATerm lf_AUX_MuASF_Rules2C3_1( ATerm arg0 , ATerm arg1 , ATerm arg2) {
{
ATerm tmp[2];
...
if( term_equal( list_head( atmp200) , make_char( 48))) {
return ( * ef4)( ( * ef5)( ( * ef6)( ( * ef7)( ( * ef8)( ( * ef9)( ( * ef10)( ( constant0? constant0: ( constant0= ( * ef11)( ( * ef12)( lf2( (ATerm) ATmakeList( 8 , char_table[ 109] , char_table[ 97] , char_table[ 107] , char_table[ 101] , char_table[ 95] , char_table[ 110] , char_table[ 102] , char_table[ 48])))))) , ( * ef2)( lf3( make_list( ( * ef8)( ( * ef9)( ( * ef11)( ( * ef12)( lf2( cons( make_list( atmp000) , ( constant1? constant1: ( constant1= (ATerm) ATmakeList( 3 , char_table[ 115] , char_table[ 121] , char_table[ 109])))))))))))))))))) , ( constant2? constant2: ( constant2= ( * ef3)( lf2( make_list( make_char( 48)))))));
}
}
}
}
...
{
ATerm atmp200= arg_0( atmp20);
tmp[ 0]= ( * ef13)( ( * ef2)( lf3( make_list( ( * ef8)( ( * ef9)( ( * ef11)( ( * ef12)( lf2( cons( make_list( atmp000) , ( constant3? constant3: ( constant3= cons( make_list( make_char( 115)) , cons( make_list( make_char( 121)) , make_list( make_char( 109))))))))))))))) , arg1);
tmp[ 1]= ( * ef5)( ( * ef6)( ( * ef7)( ( * ef8)( ( * ef9)( ( * ef10)( ( * ef11)( ( * ef12)( lf2( cons( ( constant4? constant4: ( constant4= make_list( make_char( 109)))) , cons( ( constant5? constant5: ( constant5= make_list( make_char( 97)))) , cons( ( constant6? constant6: ( constant6= make_list( make_char( 107)))) , cons( ( constant7? constant7: ( constant7= make_list( make_char( 101)))) , cons( ( constant8? constant8: ( constant8= make_list( make_char( 95)))) , cons( ( constant9? constant9: ( constant9= make_list( make_char( 110)))) , cons( ( constant10? constant10: ( constant10= make_list( make_char( 102)))) , make_list( atmp200))))))))))) , tmp[ 0]))))));
return ( * ef4)( tmp[ 1] , ( constant2? constant2: ( constant2= ( * ef3)( lf2( make_list( make_char( 48)))))));
}
}
}
}
...
return make_nf3( lf_AUX_MuASF_Rules2C3_1sym , arg0 , arg1 , arg2);
}
}
