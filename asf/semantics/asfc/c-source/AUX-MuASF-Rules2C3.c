...
tmp [ 0 ] = ( * ef11 ) ( lf_AUX_MuASF_Rules2C3_1 ( make_list ( atmp10 ) ) , ( constant0 ? constant0 : ( constant0 = ( * ef12 ) ( ( * ef13 ) ( lf3 ( make_list ( make_char ( 48 ) ) ) ) ) ) ) ) ;
...
tmp [ 6 ] = arg_0 ( tmp [ 5 ] ) ;
tmp [ 7 ] = ( * ef15 ) ( ( * ef10 ) ( lf5 ( make_list ( ( * ef5 ) ( ( * ef6 ) ( ( * ef8 ) ( ( * ef9 ) ( lf3 ( cons ( make_list ( atmp000 ) , ( constant1 ? constant1 : ( constant1 = cons ( make_list ( make_char ( 115 ) ) , cons ( make_list ( make_char ( 121 ) ) , make_list ( make_char ( 109 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) , tmp [ 1 ] ) ;
