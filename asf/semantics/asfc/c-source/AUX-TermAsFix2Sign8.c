...
ef2 = lookup_func ( ATreadFromString ( "prod(id(\"TermAsFix2Sign\"),w(\"\"),[sort(\"Term\"),w(\"\"),ql(\"++del\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)" ) ) ;
ef2sym = lookup_sym ( ATreadFromString ( "prod(id(\"TermAsFix2Sign\"),w(\"\"),[sort(\"Term\"),w(\"\"),ql(\"++del\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)" ) ) ;
...
( tmp [ 3 ] = arg_0 ( tmp [ 2 ] ) ) ;
FUNC_EXIT ( ( * ef2 ) ( tmp [ 0 ] , lf2 ( make_list ( tmp [ 3 ] ) ) ) ) ;
}
}
}
}
...
{
ATerm atmp00 = arg_0 ( arg0 ) ;
FUNC_EXIT ( make_nf1 ( ef4sym , lf2 ( make_list ( ( * ef3 ) ( atmp00 ) ) ) ) ) ;
}
}
