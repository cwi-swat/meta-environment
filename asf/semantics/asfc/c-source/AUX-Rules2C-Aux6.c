...
static aterm * lf_AUX_Rules2C_Aux6_2( aterm * arg1 , aterm * arg2);
...
lf_AUX_Rules2C_Aux6_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-c-expression\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FV-Path\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf5sym= TmkSymbol( "listtype(sort(\"Expression\"),ql(\",\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"AInt\"),ql(\",\"))" , SYM_STRING);
lf_AUX_Rules2C_Aux6_1sym= TmkSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , SYM_STRING);
lf4sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"NamePair\"),ql(\",\"))") , lf_AUX_Rules2C_Aux6_1 , lf_AUX_Rules2C_Aux6_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-c-expression\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FV-Path\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux6_2 , lf_AUX_Rules2C_Aux6_2sym);
...
aterm * lf_AUX_Rules2C_Aux6_2( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[4];
...
if( check_sym( arg1 , lf_AUX_Rules2C_Aux6_1sym)) {
{
...
t_protect( atmp000);
t_protect( atmp10);
tmp[ 1]= ( * ef13)( ( * ef2)( atmp000) , lf_AUX_Rules2C_Aux6_1( make_list( atmp10)));
...
return make_nf2( lf_AUX_Rules2C_Aux6_2sym , arg0 , arg1);
}
}
