#include "support.h"
static asymbol * lf_AUX_Rules2C_Aux24_2sym;
static aterm * lf_AUX_Rules2C_Aux24_2( aterm * arg1 , aterm * arg2);
...
lf_AUX_Rules2C_Aux24_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"add-env\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"FV-Path\"),ql(\",\"))" , SYM_STRING);
lf4sym= TmkSymbol( "listtype(sort(\"Cond\"),ql(\"&\"))" , SYM_STRING);
lf_AUX_Rules2C_Aux24_1sym= TmkSymbol( "listtype(sort(\"C-Rule\"),ql(\";\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"C-Rule\"),ql(\";\"))") , lf_AUX_Rules2C_Aux24_1 , lf_AUX_Rules2C_Aux24_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"add-env\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux24_2 , lf_AUX_Rules2C_Aux24_2sym);
...
aterm * lf_AUX_Rules2C_Aux24_2( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[12];
PROF( prof_lf_AUX_Rules2C_Aux24_2);
...
t_protect( tmp[ 1]);
t_protect( arg1);
tmp[ 9]= lf_AUX_Rules2C_Aux24_2( lf_AUX_Rules2C_Aux24_1( make_list( tmp[ 1])) , arg1);
if( check_sym( tmp[ 9] , ef1sym)) {
tmp[ 10]= arg_0( tmp[ 9]);
if( check_sym( tmp[ 10] , lf_AUX_Rules2C_Aux24_1sym)) {
tmp[ 11]= arg_0( tmp[ 10]);
t_protect( tmp[ 7]);
t_protect( tmp[ 8]);
t_protect( tmp[ 4]);
...
t_unprotect( tmp[ 1]);
t_unprotect( tmp[ 9]);
return ( * ef1)( lf_AUX_Rules2C_Aux24_1( cons( make_list( ( * ef2)( lf3( make_list( tmp[ 7])) , lf4( make_list( tmp[ 8])) , tmp[ 4] , ( * ef3)( tmp[ 5] , arg1) , ( * ef3)( tmp[ 6] , arg1))) , make_list( tmp[ 11]))));
}
}
t_unprotect( tmp[ 9]);
}
...
t_unprotect( arg0);
t_unprotect( arg1);
return ( * ef1)( lf_AUX_Rules2C_Aux24_1( make_list( null( ))));
}
}
}
return make_nf2( lf_AUX_Rules2C_Aux24_2sym , arg0 , arg1);
}
}
