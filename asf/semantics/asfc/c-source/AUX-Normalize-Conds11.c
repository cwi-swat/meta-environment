#include "support.h"
static asymbol * lf_AUX_Normalize_Conds11_1sym;
static aterm * lf_AUX_Normalize_Conds11_1( aterm * arg1 , aterm * arg2);
...
lf_AUX_Normalize_Conds11_1sym= TmkSymbol( "prod(id(\"Normalize-Conds\"),w(\"\"),[l(\"normalize-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TC-tuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Normalize-Conds\"),w(\"\"),[l(\"normalize-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TC-tuple\"),w(\"\"),no-attrs)") , lf_AUX_Normalize_Conds11_1 , lf_AUX_Normalize_Conds11_1sym);
...
ef15= lookup_func( TmakeSimple( & local , "prod(id(\"Normalize-Conds\"),w(\"\"),[l(\"normalize-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TC-tuple\"),w(\"\"),no-attrs)"));
ef15sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Normalize-Conds\"),w(\"\"),[l(\"normalize-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TC-tuple\"),w(\"\"),no-attrs)"));
}
aterm * lf_AUX_Normalize_Conds11_1( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[11];
PROF( prof_lf_AUX_Normalize_Conds11_1);
...
tmp[ 0]= ( * ef13)( atmp00);
t_protect( tmp[ 0]);
if( term_equal( tmp[ 0] , ( * ef14)( ))) {
if( check_sym( arg1 , ef6sym)) {
tmp[ 1]= arg_0( arg1);
if( check_sym( tmp[ 1] , lf4sym)) {
tmp[ 2]= arg_0( tmp[ 1]);
t_protect( tmp[ 2]);
tmp[ 3]= ( * ef7)( ( * ef8)( ( * ef9)( lf4( cons( make_list( make_char( 67)) , cons( make_list( make_char( 86)) , make_list( tmp[ 2])))))));
t_protect( atmp010);
t_protect( arg1);
...
return make_nf2( lf_AUX_Normalize_Conds11_1sym , arg0 , arg1);
}
}
