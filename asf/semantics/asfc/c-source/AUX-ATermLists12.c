#include "support.h"
static Symbol lf_AUX_ATermLists12_1sym;
static ATerm lf_AUX_ATermLists12_1( ATerm arg1 , ATerm arg2);
...
lf_AUX_ATermLists12_1sym= ATmakeSymbol( "prod(id(\"ATermLists\"),w(\"\"),[l(\"delete\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_ATermLists12_1sym);
register_prod( ATparse( "prod(id(\"ATermLists\"),w(\"\"),[l(\"delete\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)") , lf_AUX_ATermLists12_1 , lf_AUX_ATermLists12_1sym);
}
...
void init_AUX_ATermLists12( ) {
}
ATerm lf_AUX_ATermLists12_1( ATerm arg0 , ATerm arg1) {
PROF( prof_lf_AUX_ATermLists12_1);
if( check_sym( arg0 , ef1sym)) {
return arg0;
}
return ( * ef2)( ( * ef3)( ( * ef4)( arg0) , arg1) , ( * ef5)( arg0) , ( * ef6)( ( * ef7)( ( * ef8)( ( * ef4)( arg0))) , lf_AUX_ATermLists12_1( ( * ef5)( arg0) , arg1)));
}
