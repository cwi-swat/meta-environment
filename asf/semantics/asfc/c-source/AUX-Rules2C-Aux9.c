...
lf_AUX_Rules2C_Aux9_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux9_2 , lf_AUX_Rules2C_Aux9_2sym);
...
ef8= lookup_func( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListTriple\"),w(\"\"),no-attrs)"));
ef8sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-ofs-first-arg\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListTriple\"),w(\"\"),no-attrs)"));
ef9= lookup_func( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListTriple\"),w(\"\"),no-attrs)"));
ef9sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleListTriple\"),w(\"\"),no-attrs)"));
ef10= lookup_func( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FV-Path\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FV-Path\"),w(\"\"),no-attrs)"));
ef10sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"FV-Path\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FV-Path\"),w(\"\"),no-attrs)"));
}
...
t_protect( tmp[ 8]);
tmp[ 9]= lf_AUX_Rules2C_Aux9_2( lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 8])));
...
t_unprotect( tmp[ 8]);
t_unprotect( tmp[ 9]);
return ( * ef1)( lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 12])) , lf_AUX_Rules2C_Aux9_1( cons( make_list( ( * ef2)( lf3( make_list( null( ))) , lf4( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 13]))));
}
}
}
t_unprotect( tmp[ 9]);
...
t_protect( tmp[ 13]);
tmp[ 15]= lf_AUX_Rules2C_Aux9_2( lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 13])));
...
t_unprotect( tmp[ 14]);
t_unprotect( tmp[ 15]);
return ( * ef1)( lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 18])) , lf_AUX_Rules2C_Aux9_1( cons( make_list( ( * ef2)( lf3( cons( make_list( ( * ef3)( tmp[ 9] , lf5( make_list( tmp[ 11])))) , make_list( tmp[ 12]))) , lf4( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 19]))));
}
}
}
t_unprotect( tmp[ 15]);
...
t_protect( tmp[ 15]);
t_protect( tmp[ 13]);
tmp[ 16]= ( * ef8)( tmp[ 15] , lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 13])));
...
t_unprotect( tmp[ 15]);
t_unprotect( tmp[ 16]);
return ( * ef1)( lf_AUX_Rules2C_Aux9_1( cons( make_list( ( * ef2)( lf3( cons( make_list( ( * ef3)( tmp[ 9] , lf5( make_list( tmp[ 11])))) , make_list( tmp[ 12]))) , lf4( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 20]))) , lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 21])));
}
}
}
}
...
t_protect( tmp[ 18]);
t_protect( tmp[ 17]);
tmp[ 19]= ( * ef8)( tmp[ 18] , lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 17])));
...
t_unprotect( tmp[ 18]);
t_unprotect( tmp[ 19]);
return ( * ef1)( lf_AUX_Rules2C_Aux9_1( cons( make_list( ( * ef2)( lf3( cons( make_list( ( * ef10)( lf3( cons( make_list( ( * ef3)( tmp[ 12] , lf5( make_list( tmp[ 14])))) , make_list( tmp[ 15]))))) , make_list( tmp[ 16]))) , lf4( make_list( tmp[ 7])) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 23]))) , lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 24])));
}
}
}
}
...
t_unprotect( arg0);
return ( * ef1)( lf_AUX_Rules2C_Aux9_1( make_list( null( ))) , lf_AUX_Rules2C_Aux9_1( make_list( null( ))));
}
}
}
