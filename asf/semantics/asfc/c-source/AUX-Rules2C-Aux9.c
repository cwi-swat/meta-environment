...
lf_AUX_Rules2C_Aux9_2sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-defaults\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleListPair\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"select-on-defaults\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleListPair\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux9_2 , lf_AUX_Rules2C_Aux9_2sym);
...
ef2= lookup_func( ATreadFromString( "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[sort(\"Term\"),w(\"\"),ql(\"=\"),w(\"\"),sort(\"Term\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Rule\"),w(\"\"),no-attrs)"));
ef2sym= lookup_sym( ATreadFromString( "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[sort(\"Term\"),w(\"\"),ql(\"=\"),w(\"\"),sort(\"Term\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Rule\"),w(\"\"),no-attrs)"));
...
tmp[ 7]= lf_AUX_Rules2C_Aux9_2( lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 7] , ef1sym)) {
tmp[ 8]= arg_0( tmp[ 7]);
tmp[ 9]= arg_1( tmp[ 7]);
if( check_sym( tmp[ 8] , lf_AUX_Rules2C_Aux9_1sym)) {
tmp[ 10]= arg_0( tmp[ 8]);
if( check_sym( tmp[ 9] , lf_AUX_Rules2C_Aux9_1sym)) {
tmp[ 11]= arg_0( tmp[ 9]);
return ( * ef1)( lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 10])) , lf_AUX_Rules2C_Aux9_1( cons( make_list( ( * ef4)( ( * ef5)( lf3( make_list( tmp[ 6]))) , tmp[ 3] , tmp[ 4])) , make_list( tmp[ 11]))));
}
}
}
}
...
if( check_sym( tmp[ 9] , lf_AUX_Rules2C_Aux9_1sym)) {
tmp[ 11]= arg_0( tmp[ 9]);
return ( * ef1)( lf_AUX_Rules2C_Aux9_1( cons( make_list( ( * ef6)( ( * ef5)( lf3( make_list( tmp[ 6]))) , tmp[ 3] , tmp[ 4])) , make_list( tmp[ 10]))) , lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 11])));
}
}
}
}
...
tmp[ 2]= arg_0( tmp[ 0]);
tmp[ 3]= arg_1( tmp[ 0]);
tmp[ 4]= lf_AUX_Rules2C_Aux9_2( lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 1])));
if( check_sym( tmp[ 4] , ef1sym)) {
tmp[ 5]= arg_0( tmp[ 4]);
tmp[ 6]= arg_1( tmp[ 4]);
if( check_sym( tmp[ 5] , lf_AUX_Rules2C_Aux9_1sym)) {
tmp[ 7]= arg_0( tmp[ 5]);
if( check_sym( tmp[ 6] , lf_AUX_Rules2C_Aux9_1sym)) {
tmp[ 8]= arg_0( tmp[ 6]);
return ( * ef1)( lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 7])) , lf_AUX_Rules2C_Aux9_1( cons( make_list( ( * ef2)( tmp[ 2] , tmp[ 3])) , make_list( tmp[ 8]))));
}
}
}
}
...
if( check_sym( tmp[ 6] , lf_AUX_Rules2C_Aux9_1sym)) {
tmp[ 8]= arg_0( tmp[ 6]);
return ( * ef1)( lf_AUX_Rules2C_Aux9_1( cons( make_list( ( * ef3)( tmp[ 2] , tmp[ 3])) , make_list( tmp[ 7]))) , lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 8])));
}
}
}
}
