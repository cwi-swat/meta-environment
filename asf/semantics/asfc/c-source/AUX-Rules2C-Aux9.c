...
t_unprotect( tmp[ 1]);
t_unprotect( tmp[ 9]);
return ( * ef1)( lf_AUX_Rules2C_Aux9_1( make_list( tmp[ 12])) , lf_AUX_Rules2C_Aux9_1( cons( make_list( ( * ef2)( lf3( make_list( null( ))) , lf4( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 13]))));
}
}
}
t_unprotect( tmp[ 9]);
