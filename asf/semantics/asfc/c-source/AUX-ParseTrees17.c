...
static ATerm lf_AUX_ParseTrees17_1( ATerm arg1);
...
lf_AUX_ParseTrees17_1sym= ATmakeSymbol( "prod(id(\"ParseTrees\"),w(\"\"),[l(\"pp\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_ParseTrees17_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"ParseTrees\"),w(\"\"),[l(\"pp\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)") , lf_AUX_ParseTrees17_1 , lf_AUX_ParseTrees17_1sym);
...
ATerm lf_AUX_ParseTrees17_1( ATerm arg0) {
...
return lf_AUX_ParseTrees17_1( atmp010);
}
}
}
}
...
return ( * ef8)( lf_AUX_ParseTrees17_1( atmp0000) , lf_AUX_ParseTrees17_1( ( * ef5)( ( * ef6)( atmp0001))));
}
}
}
{
...
{
ATerm atmp0000= arg_0( atmp000);
return lf_AUX_ParseTrees17_1( atmp0000);
}
}
}
}
...
{
ATerm atmp01= arg_1( arg0);
return ( * ef8)( ( * ef8)( lf_AUX_ParseTrees17_1( atmp00) , ( constant1? constant1: ( constant1= ( * ef10)( lf2( (ATerm) ATmakeList( 4 , char_table[ 34] , char_table[ 58] , char_table[ 58] , char_table[ 34])))))) , lf_AUX_ParseTrees17_1( atmp01));
}
}
}
return make_nf1( lf_AUX_ParseTrees17_1sym , arg0);
}
