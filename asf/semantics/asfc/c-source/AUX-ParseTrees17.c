...
static ATerm lf_AUX_ParseTrees17_1 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
lf_AUX_ParseTrees17_1sym = ATmakeSymbol ( "prod(id(\"ParseTrees\"),w(\"\"),[sort(\"ATerm\"),w(\"\"),ql(\"[>\"),w(\"\"),sort(\"AFun\"),w(\"\"),ql(\":=\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ParseTrees17_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"ParseTrees\"),w(\"\"),[sort(\"ATerm\"),w(\"\"),ql(\"[>\"),w(\"\"),sort(\"AFun\"),w(\"\"),ql(\":=\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\"]\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)" ) , lf_AUX_ParseTrees17_1 , lf_AUX_ParseTrees17_1sym ) ;
...
ATerm lf_AUX_ParseTrees17_1 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 3 ] ;
FUNC_ENTRY ( lf_AUX_ParseTrees17_1sym , ATmakeAppl ( lf_AUX_ParseTrees17_1sym , arg0 , arg1 , arg2 ) ) ;
...
FUNC_EXIT ( make_nf3 ( lf_AUX_ParseTrees17_1sym , arg0 , arg1 , arg2 ) ) ;
}
}
