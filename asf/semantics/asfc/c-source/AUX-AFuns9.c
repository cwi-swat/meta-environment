...
lf_AUX_AFuns9_1sym= ATmakeSymbol( "prod(id(\"AFuns\"),w(\"\"),[l(\"for-some1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_AFuns9_1sym);
register_prod( ATparse( "prod(id(\"AFuns\"),w(\"\"),[l(\"for-some1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_AFuns9_1 , lf_AUX_AFuns9_1sym);
}
...
return ( * ef4)( ( * ef5)( arg0 , ( * ef6)( ( * ef7)( arg1))) , lf_AUX_AFuns9_1( arg0 , ( * ef8)( arg1)));
}
}
