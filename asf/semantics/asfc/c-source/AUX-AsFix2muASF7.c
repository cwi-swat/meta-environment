...
static Symbol lf_AUX_AsFix2muASF7_1sym ;
static ATerm lf_AUX_AsFix2muASF7_1 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
void register_AUX_AsFix2muASF7 ( ) {
lf_AUX_AsFix2muASF7_1sym = ATmakeSymbol ( "prod(id(\"AsFix2muASF\"),w(\"\"),[l(\"aterm2muasf\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncTermTableTuple\"),w(\"\"),no-attrs)"
 , 3 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_AsFix2muASF7_1sym ) ;
...
register_prod ( ATparse ( "prod(id(\"AsFix2muASF\"),w(\"\"),[l(\"aterm2muasf\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncTermTableTuple\"),w(\"\"),no-attrs)" ) , lf_AUX_AsFix2muASF7_1 , lf_AUX_AsFix2muASF7_1sym ) ;
...
ef7 = lookup_func ( ATreadFromString ( "prod(id(\"AsFix2muASF\"),w(\"\"),[l(\"args2muasf\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncTermTableTuple\"),w(\"\"),no-attrs)" ) ) ;
ef7sym = lookup_sym ( ATreadFromString ( "prod(id(\"AsFix2muASF\"),w(\"\"),[l(\"args2muasf\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncTermTableTuple\"),w(\"\"),no-attrs)" ) ) ;
...
ef25 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[l(\"make-list-func\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)" ) ) ;
ef25sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[l(\"make-list-func\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)" ) ) ;
...
ef30 = lookup_func ( ATreadFromString ( "prod(id(\"AsFix2muASF\"),w(\"\"),[l(\"listargs2muasf\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncTermTableTuple\"),w(\"\"),no-attrs)" ) ) ;
ef30sym = lookup_sym ( ATreadFromString ( "prod(id(\"AsFix2muASF\"),w(\"\"),[l(\"listargs2muasf\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncTermTableTuple\"),w(\"\"),no-attrs)" ) ) ;
...
ATerm lf_AUX_AsFix2muASF7_1 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 23 ] ;
FUNC_ENTRY ( lf_AUX_AsFix2muASF7_1sym , ATmakeAppl ( lf_AUX_AsFix2muASF7_1sym , arg0 , arg1 , arg2 ) ) ;
if ( check_sym ( arg0 , ef1sym ) ) {
( tmp [ 0 ] = ( * ef5 ) ( arg1 ) ) ;
FUNC_EXIT ( ( * ef2 ) ( lf2 ( make_list ( null ( ) ) ) , ( * ef3 ) ( lf3 ( make_list ( ( * ef4 ) ( tmp [ 0 ] ) ) ) ) , arg2 ) ) ;
}
if ( check_sym ( arg0 , ef6sym ) ) {
( tmp [ 0 ] = ( * ef8 ) ( arg1 , lf4 ( make_list ( ( * ef9 ) ( ) ) ) ) ) ;
( tmp [ 1 ] = ( * ef10 ) ( tmp [ 0 ] ) ) ;
if ( term_equal ( tmp [ 1 ] , ( constant0 ? constant0 : ( constant0 = ( * ef11 ) ( ) ) ) ) ) {
( tmp [ 2 ] = ( * ef8 ) ( arg1 , lf4 ( make_list ( ( * ef12 ) ( ) ) ) ) ) ;
...
( tmp [ 2 ] = ( * ef16 ) ( tmp [ 0 ] ) ) ;
( tmp [ 3 ] = ( * ef8 ) ( tmp [ 0 ] , lf4 ( make_list ( ( * ef17 ) ( ) ) ) ) ) ;
( tmp [ 4 ] = ( * ef18 ) ( tmp [ 3 ] ) ) ;
...
( tmp [ 8 ] = arg_0 ( tmp [ 7 ] ) ) ;
( tmp [ 9 ] = arg_1 ( tmp [ 7 ] ) ) ;
( tmp [ 10 ] = ( * ef8 ) ( arg1 , lf4 ( make_list ( ( * ef12 ) ( ) ) ) ) ) ;
...
( tmp [ 0 ] = ( * ef8 ) ( arg1 , lf4 ( make_list ( ( * ef26 ) ( ) ) ) ) ) ;
( tmp [ 1 ] = ( * ef27 ) ( tmp [ 0 ] ) ) ;
( tmp [ 2 ] = ( * ef28 ) ( tmp [ 1 ] , arg2 ) ) ;
if ( check_sym ( tmp [ 2 ] , ef20sym ) ) {
( tmp [ 3 ] = arg_0 ( tmp [ 2 ] ) ) ;
( tmp [ 4 ] = arg_1 ( tmp [ 2 ] ) ) ;
( tmp [ 5 ] = ( * ef8 ) ( arg1 , lf4 ( make_list ( ( * ef29 ) ( ) ) ) ) ) ;
...
( tmp [ 13 ] = arg_0 ( tmp [ 12 ] ) ) ;
( tmp [ 14 ] = ( * ef31 ) ( tmp [ 1 ] , ( * ef3 ) ( lf3 ( make_list ( ( * ef32 ) ( ( * ef33 ) ( lf5 ( ( ATerm ) ATmakeList ( 4 , char_table [ 110 ] , char_table [ 117 ] , char_table [ 108 ] , char_table [ 108 ] ) ) ) ) ) ) ) ) ) ;
...
if ( term_equal ( ( * ef8 ) ( arg1 , ( constant2 ? constant2 : ( constant2 = lf4 ( make_list ( ( * ef26 ) ( ) ) ) ) ) ) , ( constant3 ? constant3 : ( constant3 = ( * ef35 ) ( ( * ef36 ) ( ) , ( * ef37 ) ( ( * ef38 ) ( ( * ef39 ) ( ( * ef40 ) ( lf5 ( ( ATerm ) ATmakeList ( 6 , char_table [ 34 ] , char_table [ 67 ] , char_table [ 72 ] , char_table [ 65 ] , char_table [ 82 ] , char_table [ 34 ] ) ) ) ) ) ) ) ) ) ) ) {
( tmp [ 0 ] = ( * ef8 ) ( arg1 , lf4 ( make_list ( ( * ef41 ) ( ) ) ) ) ) ;
...
( tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ) ;
( tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ) ;
if ( term_equal ( tmp [ 1 ] , ( constant4 ? constant4 : ( constant4 = ( * ef36 ) ( ) ) ) ) ) {
...
( tmp [ 6 ] = ( * ef8 ) ( arg1 , lf4 ( make_list ( ( * ef41 ) ( ) ) ) ) ) ;
if ( check_sym ( tmp [ 6 ] , ef38sym ) ) {
( tmp [ 7 ] = arg_0 ( tmp [ 6 ] ) ) ;
if ( check_sym ( tmp [ 7 ] , ef39sym ) ) {
( tmp [ 8 ] = arg_0 ( tmp [ 7 ] ) ) ;
( tmp [ 9 ] = ( * ef33 ) ( lf5 ( ( ATerm ) ATmakeList ( 18 , char_table [ 34 ] , char_table [ 123 ] , char_table [ 115 ] , char_table [ 111 ] , char_table [ 114 ] , char_table [ 116 ] , char_table [ 40 ] , char_table [ 92 ] , char_table [ 34 ] , char_table [ 67 ] , char_table [ 72 ] , char_table [ 65 ] , char_table [ 82 ] , char_table [ 92 ] , char_table [ 34 ] , char_table [ 41 ] , char_table [ 125 ] , char_table [ 34 ] ) ) ) ) ;
( tmp [ 10 ] = ( * ef28 ) ( tmp [ 9 ] , arg2 ) ) ;
if ( check_sym ( tmp [ 10 ] , ef20sym ) ) {
( tmp [ 11 ] = arg_0 ( tmp [ 10 ] ) ) ;
( tmp [ 12 ] = arg_1 ( tmp [ 10 ] ) ) ;
( tmp [ 13 ] = ( * ef31 ) ( tmp [ 9 ] , ( * ef3 ) ( lf3 ( make_list ( ( * ef32 ) ( ( * ef33 ) ( lf5 ( ( ATerm ) ATmakeList ( 4 , char_table [ 110 ] , char_table [ 117 ] , char_table [ 108 ] , char_table [ 108 ] ) ) ) ) ) ) ) ) ) ;
( tmp [ 14 ] = ( * ef44 ) ( tmp [ 5 ] ) ) ;
( tmp [ 15 ] = ( * ef45 ) ( tmp [ 14 ] , tmp [ 12 ] ) ) ;
if ( check_sym ( tmp [ 15 ] , ef20sym ) ) {
( tmp [ 16 ] = arg_0 ( tmp [ 15 ] ) ) ;
( tmp [ 17 ] = arg_1 ( tmp [ 15 ] ) ) ;
( tmp [ 18 ] = ( * ef21 ) ( tmp [ 16 ] , ( * ef3 ) ( lf3 ( make_list ( ( * ef32 ) ( ( * ef33 ) ( lf5 ( ( ATerm ) ATmakeList ( 4 , char_table [ 110 ] , char_table [ 117 ] , char_table [ 108 ] , char_table [ 108 ] ) ) ) ) ) ) ) ) ) ;
( tmp [ 19 ] = ( * ef46 ) ( tmp [ 8 ] ) ) ;
...
FUNC_EXIT ( make_nf3 ( lf_AUX_AsFix2muASF7_1sym , arg0 , arg1 , arg2 ) ) ;
}
}
