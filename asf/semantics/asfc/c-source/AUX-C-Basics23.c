...
static funcptr ef4;
static asymbol * new__1__lf_AUX_C_Basics23_1sym;
static aterm * new__1__lf_AUX_C_Basics23_1( aterm * arg1);
...
new__1__lf_AUX_C_Basics23_1sym= TmkSymbol( "new__1__lf_AUX_C_Basics23_1" , SYM_STRING);
...
aterm * new__1__lf_AUX_C_Basics23_1( aterm * arg0) {
{
aterm * tmp[2];
PROF( prof_new__1__lf_AUX_C_Basics23_1);
...
return make_nf1( new__1__lf_AUX_C_Basics23_1sym , arg0);
}
}
...
t_protect( tmp[ 3]);
if( term_equal( ( * ef1)( lf2( make_list( tmp[ 3]))) , ( * ef5)( ))) {
t_unprotect( arg0);
t_unprotect( tmp[ 0]);
t_unprotect( tmp[ 1]);
t_unprotect( tmp[ 2]);
...
t_unprotect( arg0);
t_unprotect( tmp[ 0]);
return new__1__lf_AUX_C_Basics23_1( ( * ef1)( lf2( cons( make_list( make_char( 39)) , make_list( tmp[ 1])))));
}
t_unprotect( tmp[ 0]);
}
}
