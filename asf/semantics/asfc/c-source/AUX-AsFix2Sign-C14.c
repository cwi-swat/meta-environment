...
static Symbol lf_AUX_AsFix2Sign_C14_1sym ;
static ATerm lf_AUX_AsFix2Sign_C14_1 ( ATerm arg1 , ATerm arg2 ) ;
...
void register_AUX_AsFix2Sign_C14 ( ) {
lf_AUX_AsFix2Sign_C14_1sym = ATmakeSymbol ( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"cfelem2args\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncTermTableTuple\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_AsFix2Sign_C14_1sym ) ;
...
register_prod ( ATparse ( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"cfelem2args\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncTermTableTuple\"),w(\"\"),no-attrs)" ) , lf_AUX_AsFix2Sign_C14_1 , lf_AUX_AsFix2Sign_C14_1sym ) ;
...
void resolve_AUX_AsFix2Sign_C14 ( ) {
...
void init_AUX_AsFix2Sign_C14 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
ATprotect ( & constant2 ) ;
}
ATerm lf_AUX_AsFix2Sign_C14_1 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 9 ] ;
FUNC_ENTRY ( lf_AUX_AsFix2Sign_C14_1sym , ATmakeAppl ( lf_AUX_AsFix2Sign_C14_1sym , arg0 , arg1 ) ) ;
...
tmp [ 0 ] = ( * ef13 ) ( arg0 ) ;
if ( term_equal ( tmp [ 0 ] , ( constant1 ? constant1 : ( constant1 = ( * ef19 ) ( ) ) ) ) ) {
...
if ( term_equal ( tmp [ 0 ] , ( constant2 ? constant2 : ( constant2 = ( * ef14 ) ( ) ) ) ) ) {
tmp [ 1 ] = ( constant0 ? constant0 : ( constant0 = ( * ef10 ) ( ( * ef11 ) ( ( * ef12 ) ( lf4 ( make_list ( make_char ( 49 ) ) ) ) ) ) ) ) ;
if ( check_sym ( tmp [ 1 ] , ef8sym ) ) {
tmp [ 2 ] = arg_0 ( tmp [ 1 ] ) ;
if ( check_sym ( tmp [ 2 ] , ef9sym ) ) {
...
FUNC_EXIT ( make_nf2 ( lf_AUX_AsFix2Sign_C14_1sym , arg0 , arg1 ) ) ;
}
}
