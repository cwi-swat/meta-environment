#include "support.h"
static Symbol lf_AUX_AFuns11_1sym;
static ATerm lf_AUX_AFuns11_1( ATerm arg1 , ATerm arg2);
...
static funcptr ef2;
void register_AUX_AFuns11( ) {
lf_AUX_AFuns11_1sym= ATmakeSymbol( "prod(id(\"AFuns\"),w(\"\"),[l(\"map1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_AFuns11_1sym);
register_prod( ATparse( "prod(id(\"AFuns\"),w(\"\"),[l(\"map1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)") , lf_AUX_AFuns11_1 , lf_AUX_AFuns11_1sym);
}
void resolve_AUX_AFuns11( ) {
...
ef3= lookup_func( ATreadFromString( "prod(id(\"ATermLists\"),w(\"\"),[sort(\"ATermList\"),w(\"\"),ql(\"++\"),w(\"\"),sort(\"ATermList\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"right\")],w(\"\"),l(\"}\")))"));
ef3sym= lookup_sym( ATreadFromString( "prod(id(\"ATermLists\"),w(\"\"),[sort(\"ATermList\"),w(\"\"),ql(\"++\"),w(\"\"),sort(\"ATermList\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"right\")],w(\"\"),l(\"}\")))"));
...
void init_AUX_AFuns11( ) {
}
ATerm lf_AUX_AFuns11_1( ATerm arg0 , ATerm arg1) {
PROF( prof_lf_AUX_AFuns11_1);
...
return ( * ef3)( ( * ef2)( ( * ef4)( ( * ef5)( arg0 , ( * ef4)( ( * ef6)( arg1))))) , lf_AUX_AFuns11_1( arg0 , ( * ef7)( arg1)));
}
}
return make_nf2( lf_AUX_AFuns11_1sym , arg0 , arg1);
}
