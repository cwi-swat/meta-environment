...
t_protect( atmp30);
t_protect( arg4);
tmp[ 1]= ( * ef3)( tmp[ 0] , arg1 , arg2 , lf_AUX_MuASF_Rules2C15_2( make_list( atmp30)) , arg4);
...
t_protect( atmp30);
t_protect( arg4);
tmp[ 2]= ( * ef3)( tmp[ 0] , arg1 , arg2 , lf_AUX_MuASF_Rules2C15_2( make_list( atmp30)) , arg4);
...
t_protect( atmp30);
t_protect( tmp[ 5]);
tmp[ 6]= lf_AUX_MuASF_Rules2C15_3( lf_AUX_MuASF_Rules2C15_1( make_list( tmp[ 1])) , arg1 , arg2 , lf_AUX_MuASF_Rules2C15_2( make_list( atmp30)) , tmp[ 5]);
