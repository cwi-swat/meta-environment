...
static ATerm lf_AUX_MuASF_Equations_Ops25_1 ( ATerm arg1 , ATerm arg2 , ATerm arg3 ) ;
...
lf_AUX_MuASF_Equations_Ops25_1sym = ATmakeSymbol ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[ql(\"prefix-id\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"prefer\")],w(\"\"),l(\"}\")))"
 , 3 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_MuASF_Equations_Ops25_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[ql(\"prefix-id\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"IntCon\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"prefer\")],w(\"\"),l(\"}\")))" ) , lf_AUX_MuASF_Equations_Ops25_1 , lf_AUX_MuASF_Equations_Ops25_1sym ) ;
...
ATerm lf_AUX_MuASF_Equations_Ops25_1 ( ATerm arg0 , ATerm arg1 , ATerm arg2 ) {
{
ATerm tmp [ 7 ] ;
FUNC_ENTRY ( lf_AUX_MuASF_Equations_Ops25_1sym , ATmakeAppl ( lf_AUX_MuASF_Equations_Ops25_1sym , arg0 , arg1 , arg2 ) ) ;
...
FUNC_EXIT ( make_nf3 ( lf_AUX_MuASF_Equations_Ops25_1sym , arg0 , arg1 , arg2 ) ) ;
}
}
