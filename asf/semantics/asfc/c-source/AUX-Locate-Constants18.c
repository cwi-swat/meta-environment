...
static ATerm lf_AUX_Locate_Constants18_2( ATerm arg1);
...
lf_AUX_Locate_Constants18_2sym= ATmakeSymbol( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"make-stats-function\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"make-stats-function\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)") , lf_AUX_Locate_Constants18_2 , lf_AUX_Locate_Constants18_2sym);
...
ef8= lookup_func( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Declaration-specifiers\"),w(\"\"),sort(\"Declarator\"),w(\"\"),ql(\"=\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\";\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration\"),w(\"\"),no-attrs)"));
ef8sym= lookup_sym( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Declaration-specifiers\"),w(\"\"),sort(\"Declarator\"),w(\"\"),ql(\"=\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\";\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration\"),w(\"\"),no-attrs)"));
...
ef19= lookup_func( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Unary-operator\"),w(\"\"),sort(\"Expression\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"));
ef19sym= lookup_sym( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Unary-operator\"),w(\"\"),sort(\"Expression\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"));
ef20= lookup_func( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[ql(\"&\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Unary-operator\"),w(\"\"),no-attrs)"));
ef20sym= lookup_sym( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[ql(\"&\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Unary-operator\"),w(\"\"),no-attrs)"));
ef21= lookup_func( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Declaration-list\"),w(\"\"),sort(\"Declaration\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list\"),w(\"\"),no-attrs)"));
ef21sym= lookup_sym( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Declaration-list\"),w(\"\"),sort(\"Declaration\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list\"),w(\"\"),no-attrs)"));
ef22= lookup_func( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Statement-list\"),w(\"\"),sort(\"Statement\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),no-attrs)"));
ef22sym= lookup_sym( ATreadFromString( "prod(id(\"Pure-C\"),w(\"\"),[sort(\"Statement-list\"),w(\"\"),sort(\"Statement\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list\"),w(\"\"),no-attrs)"));
}
...
ATerm lf_AUX_Locate_Constants18_2( ATerm arg0) {
{
ATerm tmp[14];
PROF( prof_lf_AUX_Locate_Constants18_2);
if( check_sym( arg0 , lf_AUX_Locate_Constants18_1sym)) {
{
...
tmp[ 5]= arg_0( tmp[ 4]);
return ( * ef5)( ( constant0? constant0: ( constant0= lf3( make_list( null( ))))) , ( * ef6)( ( * ef7)( ( * ef8)( ( constant1? constant1: ( constant1= ( * ef9)( lf4( cons( make_list( ( * ef10)( )) , make_list( ( * ef11)( ( * ef12)( lf5( (ATerm) ATmakeList( 5 , char_table[ 65] , char_table[ 84] , char_table[ 101] , char_table[ 114] , char_table[ 109])))))))))) , ( * ef13)( tmp[ 5]) , ( constant2? constant2: ( constant2= ( * ef2)( ( * ef3)( ( * ef4)( ( * ef12)( lf5( (ATerm) ATmakeList( 4 , char_table[ 78] , char_table[ 85] , char_table[ 76] , char_table[ 76]))))))))))) , ( * ef14)( ( * ef15)( ( * ef16)( ( * ef2)( ( * ef3)( ( * ef17)( ( constant3? constant3: ( constant3= ( * ef4)( ( * ef12)( lf5( (ATerm) ATmakeList( 9 , char_table[ 65] , char_table[ 84] , char_table[ 112] , char_table[ 114] , char_table[ 111] , char_table[ 116] , char_table[ 101] , char_table[ 99] , char_table[ 116])))))) , ( * ef18)( lf6( make_list( ( * ef19)( ( constant4? constant4: ( constant4= ( * ef20)( ))) , ( * ef2)( ( * ef3)( ( * ef4)( tmp[ 5]))))))))))))));
}
}
}
}
...
tmp[ 6]= arg_0( tmp[ 5]);
tmp[ 7]= lf_AUX_Locate_Constants18_2( lf_AUX_Locate_Constants18_1( make_list( tmp[ 0])));
...
return ( * ef5)( ( constant0? constant0: ( constant0= lf3( make_list( null( ))))) , ( * ef6)( ( * ef21)( tmp[ 12] , ( * ef8)( ( constant1? constant1: ( constant1= ( * ef9)( lf4( cons( make_list( ( * ef10)( )) , make_list( ( * ef11)( ( * ef12)( lf5( (ATerm) ATmakeList( 5 , char_table[ 65] , char_table[ 84] , char_table[ 101] , char_table[ 114] , char_table[ 109])))))))))) , ( * ef13)( tmp[ 6]) , ( constant2? constant2: ( constant2= ( * ef2)( ( * ef3)( ( * ef4)( ( * ef12)( lf5( (ATerm) ATmakeList( 4 , char_table[ 78] , char_table[ 85] , char_table[ 76] , char_table[ 76]))))))))))) , ( * ef14)( ( * ef22)( tmp[ 13] , ( * ef16)( ( * ef2)( ( * ef3)( ( * ef17)( ( constant3? constant3: ( constant3= ( * ef4)( ( * ef12)( lf5( (ATerm) ATmakeList( 9 , char_table[ 65] , char_table[ 84] , char_table[ 112] , char_table[ 114] , char_table[ 111] , char_table[ 116] , char_table[ 101] , char_table[ 99] , char_table[ 116])))))) , ( * ef18)( lf6( make_list( ( * ef19)( ( constant4? constant4: ( constant4= ( * ef20)( ))) , ( * ef2)( ( * ef3)( ( * ef4)( tmp[ 6]))))))))))))));
}
}
}
}
...
return make_nf1( lf_AUX_Locate_Constants18_2sym , arg0);
}
}
...
PROF( prof_lf_AUX_Locate_Constants18_1);
return make_nf1( lf_AUX_Locate_Constants18_1sym , arg0);
}
