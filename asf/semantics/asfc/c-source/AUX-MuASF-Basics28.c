...
lf_AUX_MuASF_Basics28_1sym= TmkSymbol( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"deslashed-lit2str\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Literal\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"deslashed-lit2str\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Literal\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Basics28_1 , lf_AUX_MuASF_Basics28_1sym);
...
t_unprotect( tmp[ 4]);
t_unprotect( tmp[ 5]);
return ( * ef5)( ( * ef3)( lf2( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))) , lf3( cons( make_list( ( * ef2)( ( * ef3)( lf2( cons( make_list( make_char( 92)) , make_list( make_char( 92))))))) , make_list( lf_AUX_MuASF_Basics28_1( ( * ef1)( lf2( cons( make_list( make_char( 34)) , cons( make_list( tmp[ 6]) , make_list( make_char( 34)))))))))));
}
}
t_unprotect( tmp[ 6]);
}
...
tmp[ 5]= make_char( 34);
if( m_term_equal( tmp[ 4] , tmp[ 5])) {
tmp[ 6]= m_list_tail( tmp[ 3]);
{
if( m_not_empty_list( tmp[ 6])) {
t_protect( tmp[ 6]);
...
t_unprotect( tmp[ 5]);
t_unprotect( tmp[ 6]);
return ( * ef5)( ( * ef3)( lf2( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))) , lf3( cons( make_list( ( * ef2)( ( * ef3)( lf2( cons( make_list( make_char( 39)) , make_list( make_char( 34))))))) , make_list( lf_AUX_MuASF_Basics28_1( ( * ef1)( lf2( cons( make_list( make_char( 34)) , cons( make_list( tmp[ 7]) , make_list( make_char( 34)))))))))));
}
}
t_unprotect( tmp[ 7]);
}
...
tmp[ 3]= m_list_head( tmp[ 1]);
tmp[ 4]= m_list_tail( tmp[ 1]);
...
t_unprotect( tmp[ 0]);
t_unprotect( tmp[ 2]);
return ( * ef5)( ( * ef3)( lf2( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))) , lf3( cons( make_list( ( * ef4)( ( * ef1)( lf2( cons( make_list( make_char( 34)) , cons( make_list( tmp[ 1]) , make_list( make_char( 34)))))))) , make_list( lf_AUX_MuASF_Basics28_1( ( * ef1)( lf2( cons( make_list( make_char( 34)) , cons( make_list( tmp[ 3]) , make_list( make_char( 34)))))))))));
}
}
t_unprotect( tmp[ 3]);
}
