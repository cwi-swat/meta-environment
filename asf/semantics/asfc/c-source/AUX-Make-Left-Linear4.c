...
static Symbol lf_AUX_Make_Left_Linear4_2_recursivesym ;
...
lf_AUX_Make_Left_Linear4_2_recursivesym = ATmakeSymbol ( "prod(id(\"Make-Left-Linear\"),w(\"\"),[ql(\"make-l-l-rules\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"VarEnv\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleList\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Make_Left_Linear4_2_recursivesym ) ;
lf_AUX_Make_Left_Linear4_2sym = ATmakeSymbol ( "prod(id(\"Make-Left-Linear\"),w(\"\"),[ql(\"make-l-l-rules\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"VarEnv\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleList\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Make-Left-Linear\"),w(\"\"),[ql(\"make-l-l-rules\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"VarEnv\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"RuleList\"),w(\"\"),no-attrs)" ) , lf_AUX_Make_Left_Linear4_2_recursive , lf_AUX_Make_Left_Linear4_2_recursivesym ) ;
}
...
FUNC_EXIT ( make_nf1 ( ef1sym , lf_AUX_Make_Left_Linear4_1 ( cons ( make_list ( tmp [ 2 ] ) , make_list ( tmp [ 5 ] ) ) ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_Make_Left_Linear4_2_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 6 ] ;
