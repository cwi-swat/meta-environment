...
lf_AUX_ParseTrees10_1sym= ATmakeSymbol( "prod(id(\"ParseTrees\"),w(\"\"),[l(\"named-elem\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 3 , ATtrue);
ATprotectSymbol( lf_AUX_ParseTrees10_1sym);
register_prod( ATparse( "prod(id(\"ParseTrees\"),w(\"\"),[l(\"named-elem\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AFun\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)") , lf_AUX_ParseTrees10_1 , lf_AUX_ParseTrees10_1sym);
}
...
return lf_AUX_ParseTrees10_1( arg0 , ( * ef3)( atmp101) , ( * ef3)( atmp201));
}
}
}
}
