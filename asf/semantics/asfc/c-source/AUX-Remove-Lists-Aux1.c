#include "support.h"
static Symbol lf_AUX_Remove_Lists_Aux1_1sym;
static ATerm lf_AUX_Remove_Lists_Aux1_1( ATerm arg1);
...
static funcptr ef5;
void register_AUX_Remove_Lists_Aux1( ) {
lf_AUX_Remove_Lists_Aux1_1sym= ATmakeSymbol( "prod(id(\"Remove-Lists-Aux\"),w(\"\"),[l(\"get-last-element\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Remove_Lists_Aux1_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
lf3sym= ATmakeSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf3sym);
register_prod( ATparse( "prod(id(\"Remove-Lists-Aux\"),w(\"\"),[l(\"get-last-element\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)") , lf_AUX_Remove_Lists_Aux1_1 , lf_AUX_Remove_Lists_Aux1_1sym);
register_prod( ATparse( "listtype(sort(\"CHAR\"))") , lf2 , lf2sym);
register_prod( ATparse( "listtype(sort(\"Term\"),ql(\",\"))") , lf3 , lf3sym);
}
void resolve_AUX_Remove_Lists_Aux1( ) {
...
void init_AUX_Remove_Lists_Aux1( ) {
ATprotect( & constant0);
ATprotect( & constant1);
}
ATerm lf_AUX_Remove_Lists_Aux1_1( ATerm arg0) {
{
ATerm tmp[11];
PROF( prof_lf_AUX_Remove_Lists_Aux1_1);
...
return lf_AUX_Remove_Lists_Aux1_1( tmp[ 9]);
}
}
}
}
...
return make_nf1( lf_AUX_Remove_Lists_Aux1_1sym , arg0);
}
}
