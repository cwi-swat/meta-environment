...
ef23= lookup_func( ATreadFromString( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"list\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
ef23sym= lookup_sym( ATreadFromString( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"list\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
...
ef27= lookup_func( ATreadFromString( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"elems\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
ef27sym= lookup_sym( ATreadFromString( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"elems\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
...
ef32= lookup_func( ATreadFromString( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"lex\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
ef32sym= lookup_sym( ATreadFromString( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"lex\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
...
ef34= lookup_func( ATreadFromString( "prod(id(\"ParseTree-Constructors\"),w(\"\"),[ql(\"sort\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
ef34sym= lookup_sym( ATreadFromString( "prod(id(\"ParseTree-Constructors\"),w(\"\"),[ql(\"sort\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
...
ef39= lookup_func( ATreadFromString( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"name\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
ef39sym= lookup_sym( ATreadFromString( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"name\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"));
...
tmp[ 4]= arg_0( tmp[ 3]);
tmp[ 5]= arg_1( tmp[ 3]);
tmp[ 6]= ( * ef6)( arg1 , ( constant4? constant4: ( constant4= lf4( make_list( ( * ef13)( ))))));
...
tmp[ 3]= arg_0( tmp[ 2]);
tmp[ 4]= arg_1( tmp[ 2]);
tmp[ 5]= ( * ef6)( arg1 , ( constant6? constant6: ( constant6= lf4( make_list( ( * ef27)( ))))));
...
tmp[ 13]= arg_0( tmp[ 12]);
tmp[ 14]= ( * ef29)( tmp[ 1] , ( constant7? constant7: ( constant7= ( * ef3)( lf3( make_list( ( * ef30)( ( * ef31)( lf5( cons( make_list( make_char( 110)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 108)) , make_list( make_char( 108))))))))))))));
...
if( term_equal( ( * ef6)( arg1 , ( constant0? constant0: ( constant0= lf4( make_list( ( * ef7)( )))))) , ( constant8? constant8: ( constant8= ( * ef33)( ( * ef34)( ) , ( * ef35)( ( * ef36)( ( * ef37)( ( * ef38)( lf5( (ATerm) ATmakeList( 6 , char_table[ 34] , char_table[ 67] , char_table[ 72] , char_table[ 65] , char_table[ 82] , char_table[ 34]))))))))))) {
tmp[ 0]= ( * ef6)( arg1 , ( constant9? constant9: ( constant9= lf4( make_list( ( * ef39)( ))))));
...
tmp[ 5]= arg_0( tmp[ 4]);
if( ! term_equal( tmp[ 5] , ( * ef38)( lf5( cons( make_list( make_char( 34)) , cons( make_list( make_char( 67)) , cons( make_list( make_char( 72)) , cons( make_list( make_char( 65)) , cons( make_list( make_char( 82)) , make_list( make_char( 34))))))))))) {
tmp[ 6]= ( * ef6)( arg1 , ( constant9? constant9: ( constant9= lf4( make_list( ( * ef39)( ))))));
if( check_sym( tmp[ 6] , ef36sym)) {
tmp[ 7]= arg_0( tmp[ 6]);
if( check_sym( tmp[ 7] , ef37sym)) {
tmp[ 8]= arg_0( tmp[ 7]);
tmp[ 9]= ( constant11? constant11: ( constant11= ( * ef31)( lf5( cons( make_list( make_char( 34)) , cons( make_list( make_char( 123)) , cons( make_list( make_char( 115)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 116)) , cons( make_list( make_char( 40)) , cons( make_list( make_char( 92)) , cons( make_list( make_char( 34)) , cons( make_list( make_char( 67)) , cons( make_list( make_char( 72)) , cons( make_list( make_char( 65)) , cons( make_list( make_char( 82)) , cons( make_list( make_char( 92)) , cons( make_list( make_char( 34)) , cons( make_list( make_char( 41)) , cons( make_list( make_char( 125)) , make_list( make_char( 34)))))))))))))))))))))));
tmp[ 10]= ( * ef26)( tmp[ 9] , arg2);
if( check_sym( tmp[ 10] , ef19sym)) {
tmp[ 11]= arg_0( tmp[ 10]);
tmp[ 12]= arg_1( tmp[ 10]);
tmp[ 13]= ( * ef29)( tmp[ 9] , ( constant7? constant7: ( constant7= ( * ef3)( lf3( make_list( ( * ef30)( ( * ef31)( lf5( cons( make_list( make_char( 110)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 108)) , make_list( make_char( 108))))))))))))));
tmp[ 14]= ( * ef42)( tmp[ 5]);
tmp[ 15]= ( * ef18)( tmp[ 14] , tmp[ 12]);
if( check_sym( tmp[ 15] , ef19sym)) {
tmp[ 16]= arg_0( tmp[ 15]);
tmp[ 17]= arg_1( tmp[ 15]);
tmp[ 18]= ( * ef20)( tmp[ 16] , ( constant7? constant7: ( constant7= ( * ef3)( lf3( make_list( ( * ef30)( ( * ef31)( lf5( cons( make_list( make_char( 110)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 108)) , make_list( make_char( 108))))))))))))));
tmp[ 19]= ( * ef43)( tmp[ 8]);
