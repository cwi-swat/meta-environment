...
ef8 = lookup_func ( ATreadFromString ( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"appl\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) ) ;
ef8sym = lookup_sym ( ATreadFromString ( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"appl\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) ) ;
...
ef13 = lookup_func ( ATreadFromString ( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"args\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) ) ;
ef13sym = lookup_sym ( ATreadFromString ( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"args\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) ) ;
...
ef18 = lookup_func ( ATreadFromString ( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"attrs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) ) ;
ef18sym = lookup_sym ( ATreadFromString ( "prod(id(\"AsFix-Constructors\"),w(\"\"),[ql(\"attrs\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) ) ;
ef19 = lookup_func ( ATreadFromString ( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"attrs2terms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)" ) ) ;
ef19sym = lookup_sym ( ATreadFromString ( "prod(id(\"AsFix2Sign-C\"),w(\"\"),[l(\"attrs2terms\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)" ) ) ;
ef20 = lookup_func ( ATreadFromString ( "prod(id(\"VarEnv\"),w(\"\"),[l(\"nt-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"TermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)" ) ) ;
ef20sym = lookup_sym ( ATreadFromString ( "prod(id(\"VarEnv\"),w(\"\"),[l(\"nt-lookup\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"TermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)" ) ) ;
ef21 = lookup_func ( ATreadFromString ( "prod(id(\"VarEnv\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)" ) ) ;
ef21sym = lookup_sym ( ATreadFromString ( "prod(id(\"VarEnv\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"NameTable\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"IdTablePair\"),w(\"\"),no-attrs)" ) ) ;
ef22 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Signs\"),w(\"\"),[l(\"make-external-funcdef\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"TermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)" ) ) ;
ef22sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Signs\"),w(\"\"),[l(\"make-external-funcdef\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"TermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),no-attrs)" ) ) ;
ef23 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Signs\"),w(\"\"),[sort(\"FuncDefList\"),w(\"\"),ql(\"++_ss\"),w(\"\"),sort(\"FuncDefList\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDefList\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))" ) ) ;
ef23sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Signs\"),w(\"\"),[sort(\"FuncDefList\"),w(\"\"),ql(\"++_ss\"),w(\"\"),sort(\"FuncDefList\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDefList\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))" ) ) ;
ef24 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDefList\"),w(\"\"),no-attrs)" ) ) ;
ef24sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[iter-sep(l(\"{\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"FuncDefList\"),w(\"\"),no-attrs)" ) ) ;
...
ef26 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"make-list-func\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)" ) ) ;
ef26sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"make-list-func\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)" ) ) ;
...
tmp [ 0 ] = ( * ef5 ) ( arg1 ) ;
tmp [ 1 ] = ( * ef6 ) ( arg1 , ( constant0 ? constant0 : ( constant0 = lf4 ( make_list ( ( * ef7 ) ( ) ) ) ) ) ) ;
return ( * ef2 ) ( ( constant1 ? constant1 : ( constant1 = lf2 ( make_list ( null ( ) ) ) ) ) , ( * ef3 ) ( lf3 ( make_list ( ( * ef4 ) ( tmp [ 0 ] ) ) ) ) , arg2 ) ;
}
if ( check_sym ( arg0 , ef8sym ) ) {
tmp [ 0 ] = ( * ef6 ) ( arg1 , ( constant2 ? constant2 : ( constant2 = lf4 ( make_list ( ( * ef10 ) ( ) ) ) ) ) ) ;
tmp [ 1 ] = ( * ef11 ) ( tmp [ 0 ] ) ;
if ( term_equal ( tmp [ 1 ] , ( constant3 ? constant3 : ( constant3 = ( * ef12 ) ( ) ) ) ) ) {
tmp [ 2 ] = ( * ef6 ) ( arg1 , ( constant4 ? constant4 : ( constant4 = lf4 ( make_list ( ( * ef13 ) ( ) ) ) ) ) ) ;
...
tmp [ 2 ] = ( * ef17 ) ( tmp [ 0 ] ) ;
tmp [ 3 ] = ( * ef6 ) ( tmp [ 0 ] , ( constant6 ? constant6 : ( constant6 = lf4 ( make_list ( ( * ef18 ) ( ) ) ) ) ) ) ;
tmp [ 4 ] = ( * ef19 ) ( tmp [ 3 ] ) ;
if ( check_sym ( tmp [ 4 ] , ef3sym ) ) {
tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ;
if ( check_sym ( tmp [ 5 ] , lf3sym ) ) {
tmp [ 6 ] = arg_0 ( tmp [ 5 ] ) ;
tmp [ 7 ] = ( * ef20 ) ( tmp [ 2 ] , ( * ef3 ) ( lf3 ( make_list ( tmp [ 6 ] ) ) ) , arg2 ) ;
if ( check_sym ( tmp [ 7 ] , ef21sym ) ) {
tmp [ 8 ] = arg_0 ( tmp [ 7 ] ) ;
tmp [ 9 ] = arg_1 ( tmp [ 7 ] ) ;
tmp [ 10 ] = ( * ef6 ) ( arg1 , ( constant4 ? constant4 : ( constant4 = lf4 ( make_list ( ( * ef13 ) ( ) ) ) ) ) ) ;
if ( check_sym ( tmp [ 10 ] , ef14sym ) ) {
tmp [ 11 ] = arg_0 ( tmp [ 10 ] ) ;
tmp [ 12 ] = ( * ef9 ) ( tmp [ 11 ] , tmp [ 9 ] ) ;
...
tmp [ 18 ] = arg_0 ( tmp [ 17 ] ) ;
tmp [ 19 ] = ( * ef22 ) ( tmp [ 8 ] , ( * ef3 ) ( lf3 ( make_list ( tmp [ 18 ] ) ) ) ) ;
tmp [ 20 ] = ( * ef23 ) ( ( * ef24 ) ( lf2 ( make_list ( tmp [ 19 ] ) ) ) , ( * ef24 ) ( lf2 ( make_list ( tmp [ 16 ] ) ) ) ) ;
if ( check_sym ( tmp [ 20 ] , ef24sym ) ) {
tmp [ 21 ] = arg_0 ( tmp [ 20 ] ) ;
if ( check_sym ( tmp [ 21 ] , lf2sym ) ) {
tmp [ 22 ] = arg_0 ( tmp [ 21 ] ) ;
return ( * ef2 ) ( lf2 ( make_list ( tmp [ 22 ] ) ) , ( * ef3 ) ( lf3 ( make_list ( ( * ef15 ) ( tmp [ 8 ] , lf3 ( make_list ( tmp [ 18 ] ) ) ) ) ) ) , tmp [ 15 ] ) ;
}
}
}
}
...
tmp [ 0 ] = ( * ef6 ) ( arg1 , ( constant0 ? constant0 : ( constant0 = lf4 ( make_list ( ( * ef7 ) ( ) ) ) ) ) ) ;
tmp [ 1 ] = ( * ef27 ) ( tmp [ 0 ] ) ;
tmp [ 2 ] = ( * ef28 ) ( tmp [ 1 ] , arg2 ) ;
if ( check_sym ( tmp [ 2 ] , ef21sym ) ) {
tmp [ 3 ] = arg_0 ( tmp [ 2 ] ) ;
tmp [ 4 ] = arg_1 ( tmp [ 2 ] ) ;
tmp [ 5 ] = ( * ef6 ) ( arg1 , ( constant7 ? constant7 : ( constant7 = lf4 ( make_list ( ( * ef29 ) ( ) ) ) ) ) ) ;
...
tmp [ 13 ] = arg_0 ( tmp [ 12 ] ) ;
tmp [ 14 ] = ( * ef31 ) ( tmp [ 1 ] , ( constant8 ? constant8 : ( constant8 = ( * ef3 ) ( lf3 ( make_list ( ( * ef32 ) ( ( * ef33 ) ( lf5 ( cons ( make_list ( make_char ( 110 ) ) , cons ( make_list ( make_char ( 117 ) ) , cons ( make_list ( make_char ( 108 ) ) , make_list ( make_char ( 108 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
tmp [ 15 ] = ( * ef23 ) ( ( * ef24 ) ( lf2 ( make_list ( tmp [ 14 ] ) ) ) , ( * ef24 ) ( lf2 ( make_list ( tmp [ 11 ] ) ) ) ) ;
if ( check_sym ( tmp [ 15 ] , ef24sym ) ) {
tmp [ 16 ] = arg_0 ( tmp [ 15 ] ) ;
if ( check_sym ( tmp [ 16 ] , lf2sym ) ) {
tmp [ 17 ] = arg_0 ( tmp [ 16 ] ) ;
return ( * ef2 ) ( lf2 ( make_list ( tmp [ 17 ] ) ) , ( * ef3 ) ( lf3 ( make_list ( ( * ef26 ) ( tmp [ 1 ] , lf3 ( make_list ( tmp [ 13 ] ) ) ) ) ) ) , tmp [ 10 ] ) ;
}
}
}
}
...
if ( term_equal ( ( * ef6 ) ( arg1 , ( constant0 ? constant0 : ( constant0 = lf4 ( make_list ( ( * ef7 ) ( ) ) ) ) ) ) , ( constant9 ? constant9 : ( constant9 = ( * ef35 ) ( ( * ef36 ) ( ) , ( * ef37 ) ( ( * ef38 ) ( ( * ef39 ) ( ( * ef40 ) ( lf5 ( ( ATerm ) ATmakeList ( 6 , char_table [ 34 ] , char_table [ 67 ] , char_table [ 72 ] , char_table [ 65 ] , char_table [ 82 ] , char_table [ 34 ] ) ) ) ) ) ) ) ) ) ) ) {
tmp [ 0 ] = ( * ef6 ) ( arg1 , ( constant10 ? constant10 : ( constant10 = lf4 ( make_list ( ( * ef41 ) ( ) ) ) ) ) ) ;
...
tmp [ 1 ] = arg_0 ( tmp [ 0 ] ) ;
tmp [ 2 ] = arg_1 ( tmp [ 0 ] ) ;
if ( term_equal ( tmp [ 1 ] , ( constant11 ? constant11 : ( constant11 = ( * ef36 ) ( ) ) ) ) ) {
...
tmp [ 6 ] = ( * ef6 ) ( arg1 , ( constant10 ? constant10 : ( constant10 = lf4 ( make_list ( ( * ef41 ) ( ) ) ) ) ) ) ;
if ( check_sym ( tmp [ 6 ] , ef38sym ) ) {
tmp [ 7 ] = arg_0 ( tmp [ 6 ] ) ;
if ( check_sym ( tmp [ 7 ] , ef39sym ) ) {
tmp [ 8 ] = arg_0 ( tmp [ 7 ] ) ;
tmp [ 9 ] = ( constant12 ? constant12 : ( constant12 = ( * ef33 ) ( lf5 ( cons ( make_list ( make_char ( 34 ) ) , cons ( make_list ( make_char ( 123 ) ) , cons ( make_list ( make_char ( 115 ) ) , cons ( make_list ( make_char ( 111 ) ) , cons ( make_list ( make_char ( 114 ) ) , cons ( make_list ( make_char ( 116 ) ) , cons ( make_list ( make_char ( 40 ) ) , cons ( make_list ( make_char ( 92 ) ) , cons ( make_list ( make_char ( 34 ) ) , cons ( make_list ( make_char ( 67 ) ) , cons ( make_list ( make_char ( 72 ) ) , cons ( make_list ( make_char ( 65 ) ) , cons ( make_list ( make_char ( 82 ) ) , cons ( make_list ( make_char ( 92 ) ) , cons ( make_list ( make_char ( 34 ) ) , cons ( make_list ( make_char ( 41 ) ) , cons ( make_list ( make_char ( 125 ) ) , make_list ( make_char ( 34 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
tmp [ 10 ] = ( * ef28 ) ( tmp [ 9 ] , arg2 ) ;
if ( check_sym ( tmp [ 10 ] , ef21sym ) ) {
tmp [ 11 ] = arg_0 ( tmp [ 10 ] ) ;
tmp [ 12 ] = arg_1 ( tmp [ 10 ] ) ;
tmp [ 13 ] = ( * ef31 ) ( tmp [ 9 ] , ( constant8 ? constant8 : ( constant8 = ( * ef3 ) ( lf3 ( make_list ( ( * ef32 ) ( ( * ef33 ) ( lf5 ( cons ( make_list ( make_char ( 110 ) ) , cons ( make_list ( make_char ( 117 ) ) , cons ( make_list ( make_char ( 108 ) ) , make_list ( make_char ( 108 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
tmp [ 14 ] = ( * ef44 ) ( tmp [ 5 ] ) ;
tmp [ 15 ] = ( * ef45 ) ( tmp [ 14 ] , tmp [ 12 ] ) ;
if ( check_sym ( tmp [ 15 ] , ef21sym ) ) {
tmp [ 16 ] = arg_0 ( tmp [ 15 ] ) ;
tmp [ 17 ] = arg_1 ( tmp [ 15 ] ) ;
tmp [ 18 ] = ( * ef22 ) ( tmp [ 16 ] , ( constant8 ? constant8 : ( constant8 = ( * ef3 ) ( lf3 ( make_list ( ( * ef32 ) ( ( * ef33 ) ( lf5 ( cons ( make_list ( make_char ( 110 ) ) , cons ( make_list ( make_char ( 117 ) ) , cons ( make_list ( make_char ( 108 ) ) , make_list ( make_char ( 108 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ;
tmp [ 19 ] = ( * ef46 ) ( tmp [ 8 ] ) ;
return ( * ef2 ) ( lf2 ( cons ( make_list ( tmp [ 13 ] ) , make_list ( tmp [ 18 ] ) ) ) , ( * ef3 ) ( lf3 ( make_list ( ( * ef43 ) ( tmp [ 16 ] , lf3 ( make_list ( ( * ef43 ) ( tmp [ 9 ] , lf3 ( make_list ( tmp [ 19 ] ) ) ) ) ) ) ) ) ) , tmp [ 17 ] ) ;
}
}
}
}
...
return ( * ef2 ) ( ( constant1 ? constant1 : ( constant1 = lf2 ( make_list ( null ( ) ) ) ) ) , ( constant13 ? constant13 : ( constant13 = ( * ef3 ) ( lf3 ( make_list ( null ( ) ) ) ) ) ) , arg2 ) ;
}
}
