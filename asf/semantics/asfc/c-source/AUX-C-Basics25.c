...
static aterm * lf_AUX_C_Basics25_11( aterm * arg1 , aterm * arg2);
static asymbol * lf_AUX_C_Basics25_13sym;
static aterm * lf_AUX_C_Basics25_13( aterm * arg1);
static asymbol * lf_AUX_C_Basics25_12sym;
static aterm * lf_AUX_C_Basics25_12( aterm * arg1);
static asymbol * lf_AUX_C_Basics25_14sym;
static aterm * lf_AUX_C_Basics25_14( aterm * arg1 , aterm * arg2);
...
lf_AUX_C_Basics25_12sym= TmkSymbol( "listtype(sort(\"EI-pair\"),ql(\",\"))" , SYM_STRING);
lf_AUX_C_Basics25_14sym= TmkSymbol( "prod(id(\"C-Basics\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Parameter-list\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"PA-tuple\"),w(\"\"),no-attrs)" , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"EI-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"A-set\"),w(\"\"),no-attrs)") , lf_AUX_C_Basics25_13 , lf_AUX_C_Basics25_13sym);
register_prod( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[ql(\"(\"),w(\"\"),sort(\"Parameter-list\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"PA-tuple\"),w(\"\"),no-attrs)") , lf_AUX_C_Basics25_14 , lf_AUX_C_Basics25_14sym);
}
void resolve_AUX_C_Basics25( ) {
arena local;
TinitArena( NULL , & local);
}
aterm * lf_AUX_C_Basics25_14( aterm * arg0 , aterm * arg1) {
PROF( prof_lf_AUX_C_Basics25_14);
return make_nf2( lf_AUX_C_Basics25_14sym , arg0 , arg1);
}
aterm * lf_AUX_C_Basics25_12( aterm * arg0) {
PROF( prof_lf_AUX_C_Basics25_12);
return make_nf1( lf_AUX_C_Basics25_12sym , arg0);
}
aterm * lf_AUX_C_Basics25_13( aterm * arg0) {
PROF( prof_lf_AUX_C_Basics25_13);
return make_nf1( lf_AUX_C_Basics25_13sym , arg0);
}
aterm * lf_AUX_C_Basics25_11( aterm * arg0 , aterm * arg1) {
PROF( prof_lf_AUX_C_Basics25_11);
return make_nf2( lf_AUX_C_Basics25_11sym , arg0 , arg1);
}
aterm * lf_AUX_C_Basics25_10( aterm * arg0) {
