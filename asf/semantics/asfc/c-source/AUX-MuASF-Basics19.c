...
static aterm * lf_AUX_MuASF_Basics19_2( aterm * arg1);
...
lf_AUX_MuASF_Basics19_2sym= TmkSymbol( "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"make-list-args\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"make-list-args\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Term\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Basics19_2 , lf_AUX_MuASF_Basics19_2sym);
...
aterm * lf_AUX_MuASF_Basics19_2( aterm * arg0) {
{
aterm * tmp[3];
PROF( prof_lf_AUX_MuASF_Basics19_2);
if( check_sym( arg0 , lf_AUX_MuASF_Basics19_1sym)) {
{
...
t_protect( tmp[ 1]);
tmp[ 2]= lf_AUX_MuASF_Basics19_2( lf_AUX_MuASF_Basics19_1( make_list( tmp[ 1])));
t_unprotect( arg0);
t_unprotect( tmp[ 1]);
return ( * ef1)( ( * ef2)( lf3( cons( make_list( make_char( 99)) , cons( make_list( make_char( 111)) , cons( make_list( make_char( 110)) , make_list( make_char( 115))))))) , lf_AUX_MuASF_Basics19_1( cons( make_list( tmp[ 0]) , make_list( tmp[ 2]))));
}
t_unprotect( tmp[ 1]);
t_unprotect( tmp[ 0]);
}
...
return make_nf1( lf_AUX_MuASF_Basics19_2sym , arg0);
}
}
