...
{
ATerm tmp [ 6 ] ;
FUNC_ENTRY ( lf_AUX_Remove_Lists_Aux10_2sym , ATmakeAppl ( lf_AUX_Remove_Lists_Aux10_2sym , arg0 ) ) ;
if ( check_sym ( arg0 , lf_AUX_Remove_Lists_Aux10_1sym ) ) {
{
ATerm atmp00 = arg_0 ( arg0 ) ;
if ( is_single_element ( atmp00 ) ) {
tmp [ 0 ] = list_head ( atmp00 ) ;
FUNC_EXIT ( ( * ef1 ) ( lf_AUX_Remove_Lists_Aux10_1 ( make_list ( ( * ef2 ) ( tmp [ 0 ] ) ) ) ) ) ;
}
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Remove_Lists_Aux10_2sym , arg0 ) ) ;
}
}
