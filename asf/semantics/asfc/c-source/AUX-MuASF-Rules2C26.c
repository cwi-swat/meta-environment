#include "support.h"
static asymbol * lf_AUX_MuASF_Rules2C26_2sym;
static aterm * lf_AUX_MuASF_Rules2C26_2( aterm * arg1 , aterm * arg2);
static asymbol * ef7sym;
static funcptr ef7;
static asymbol * lf_AUX_MuASF_Rules2C26_1sym;
static aterm * lf_AUX_MuASF_Rules2C26_1( aterm * arg1);
...
void register_AUX_MuASF_Rules2C26( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_MuASF_Rules2C26_2sym= TmkSymbol( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"sigargs2cbuild\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"SigArg\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf_AUX_MuASF_Rules2C26_1sym= TmkSymbol( "listtype(sort(\"SigArg\"),ql(\",\"))" , SYM_STRING);
lf4sym= TmkSymbol( "listtype(sort(\"Expression\"),ql(\",\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"SigArg\"),ql(\",\"))") , lf_AUX_MuASF_Rules2C26_1 , lf_AUX_MuASF_Rules2C26_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"sigargs2cbuild\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"SigArg\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Rules2C26_2 , lf_AUX_MuASF_Rules2C26_2sym);
...
void resolve_AUX_MuASF_Rules2C26( ) {
arena local;
TinitArena( NULL , & local);
...
aterm * lf_AUX_MuASF_Rules2C26_2( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[9];
PROF( prof_lf_AUX_MuASF_Rules2C26_2);
if( check_sym( arg0 , lf_AUX_MuASF_Rules2C26_1sym)) {
{
...
t_protect( tmp[ 1]);
t_protect( arg1);
tmp[ 2]= lf_AUX_MuASF_Rules2C26_2( lf_AUX_MuASF_Rules2C26_1( make_list( tmp[ 1])) , ( * ef8)( arg1));
...
return make_nf2( lf_AUX_MuASF_Rules2C26_2sym , arg0 , arg1);
}
}
...
aterm * lf_AUX_MuASF_Rules2C26_1( aterm * arg0) {
PROF( prof_lf_AUX_MuASF_Rules2C26_1);
return make_nf1( lf_AUX_MuASF_Rules2C26_1sym , arg0);
}
