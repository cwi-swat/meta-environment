...
static Symbol lf_AUX_VarEnv24_2_recursivesym ;
static ATerm lf_AUX_VarEnv24_2_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_VarEnv24_2_recursivesym = ATmakeSymbol ( "prod(id(\"VarEnv\"),w(\"\"),[ql(\"is-constructor\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_VarEnv24_2_recursivesym ) ;
lf_AUX_VarEnv24_2sym = ATmakeSymbol ( "prod(id(\"VarEnv\"),w(\"\"),[ql(\"is-constructor\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"VarEnv\"),w(\"\"),[ql(\"is-constructor\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_VarEnv24_2 , lf_AUX_VarEnv24_2sym ) ;
register_prod ( ATparse ( "prod(id(\"VarEnv\"),w(\"\"),[ql(\"is-constructor\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_VarEnv24_2_recursive , lf_AUX_VarEnv24_2_recursivesym ) ;
...
if ( term_equal ( ( * ef3 ) ( lf4 ( make_list ( tmp [ 34 ] ) ) ) , ( * ef3 ) ( lf4 ( make_list ( tmp [ 37 ] ) ) ) ) ) {
FUNC_EXIT_CONST ( constant0 , ( * ef4 ) ( ) ) ;
}
}
}
...
if ( check_sym ( tmp [ 4 ] , lf3sym ) ) {
( tmp [ 5 ] = arg_0 ( tmp [ 4 ] ) ) ;
FUNC_EXIT ( lf_AUX_VarEnv24_2_recursive ( arg0 , make_list ( tmp [ 1 ] ) ) ) ;
}
}
}
}
...
ATerm lf_AUX_VarEnv24_2_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 38 ] ;
FUNC_ENTRY ( lf_AUX_VarEnv24_2_recursivesym , ATmakeAppl ( lf_AUX_VarEnv24_2_recursivesym , arg0 , arg1 ) ) ;
{
ATerm ltmp [ 2 ] ;
lbl_lf_AUX_VarEnv24_2_recursive : ltmp [ 0 ] = arg0 ;
( ltmp [ 1 ] = arg1 ) ;
{
ATerm atmp10 = arg1 ;
if ( not_empty_list ( atmp10 ) ) {
...
goto lbl_lf_AUX_VarEnv24_2_recursive ;
}
}
}
}
FUNC_EXIT ( make_nf2 ( lf_AUX_VarEnv24_2_recursivesym , ltmp [ 0 ] , lf_AUX_VarEnv24_1 ( ltmp [ 1 ] ) ) ) ;
}
}
}
