...
lf_AUX_Literals2_1sym= ATmakeSymbol( "prod(id(\"Literals\"),w(\"\"),[l(\"escape\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Literal\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Literals2_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"Literals\"),w(\"\"),[l(\"escape\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Literal\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Literal\"),w(\"\"),no-attrs)") , lf_AUX_Literals2_1 , lf_AUX_Literals2_1sym);
...
return ( * ef2)( ( constant1? constant1: ( constant1= ( * ef1)( lf2( (ATerm) ATmakeList( 4 , char_table[ 34] , char_table[ 92] , char_table[ 34] , char_table[ 34]))))) , lf_AUX_Literals2_1( ( * ef1)( lf2( cons( ( constant2? constant2: ( constant2= make_list_char( 34))) , cons( make_list( tmp[ 4]) , ( constant3? constant3: ( constant3= make_list( make_char( 34))))))))));
}
}
}
...
tmp[ 4]= list_prefix( tmp[ 3]);
if( term_equal( list_last( tmp[ 3]) , make_char( 34))) {
return ( * ef2)( ( constant4? constant4: ( constant4= ( * ef1)( lf2( (ATerm) ATmakeList( 4 , char_table[ 34] , char_table[ 92] , char_table[ 92] , char_table[ 34]))))) , lf_AUX_Literals2_1( ( * ef1)( lf2( cons( ( constant2? constant2: ( constant2= make_list_char( 34))) , cons( make_list( tmp[ 4]) , ( constant3? constant3: ( constant3= make_list( make_char( 34))))))))));
}
}
}
}
...
return ( * ef2)( ( * ef1)( lf2( cons( ( constant2? constant2: ( constant2= make_list_char( 34))) , cons( make_list( tmp[ 1]) , ( constant3? constant3: ( constant3= make_list( make_char( 34)))))))) , lf_AUX_Literals2_1( ( * ef1)( lf2( cons( ( constant2? constant2: ( constant2= make_list_char( 34))) , cons( make_list( tmp[ 3]) , ( constant3? constant3: ( constant3= make_list( make_char( 34))))))))));
}
}
}
}
