...
static asymbol * new__1__lf_AUX_Literals2_1sym;
static aterm * new__1__lf_AUX_Literals2_1( aterm * arg1);
...
new__1__lf_AUX_Literals2_1sym= TmkSymbol( "new__1__lf_AUX_Literals2_1" , SYM_STRING);
...
aterm * new__1__lf_AUX_Literals2_1( aterm * arg0) {
{
aterm * tmp[4];
PROF( prof_new__1__lf_AUX_Literals2_1);
...
return make_nf1( new__1__lf_AUX_Literals2_1sym , arg0);
}
}
...
t_unprotect( tmp[ 0]);
t_unprotect( tmp[ 2]);
return new__1__lf_AUX_Literals2_1( ( * ef1)( lf2( cons( make_list( make_char( 34)) , cons( make_list( tmp[ 1]) , cons( make_list( tmp[ 3]) , make_list( make_char( 34))))))));
}
t_unprotect( tmp[ 3]);
}
t_unprotect( tmp[ 2]);
