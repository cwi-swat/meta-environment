#include "support.h"
static asymbol * lf_AUX_MuASF_Rules2C18_3sym;
...
static funcptr ef25;
static asymbol * lf_AUX_MuASF_Rules2C18_2sym;
...
static funcptr ef34;
static asymbol * lf_AUX_MuASF_Rules2C18_1sym;
static aterm * lf_AUX_MuASF_Rules2C18_1( aterm * arg1);
void register_AUX_MuASF_Rules2C18( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_MuASF_Rules2C18_3sym= TmkSymbol( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"find-common-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SRI-tuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf_AUX_MuASF_Rules2C18_2sym= TmkSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , SYM_STRING);
...
lf_AUX_MuASF_Rules2C18_1sym= TmkSymbol( "listtype(sort(\"C-Rule\"),ql(\";\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"C-Rule\"),ql(\";\"))") , lf_AUX_MuASF_Rules2C18_1 , lf_AUX_MuASF_Rules2C18_1sym);
register_prod( TmakeSimple( & local , "listtype(sort(\"NamePair\"),ql(\",\"))") , lf_AUX_MuASF_Rules2C18_2 , lf_AUX_MuASF_Rules2C18_2sym);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"find-common-terms\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SRI-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Rules2C18_3 , lf_AUX_MuASF_Rules2C18_3sym);
...
ef5= lookup_func( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"second-term-common\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SRI-tuple\"),w(\"\"),no-attrs)"));
ef5sym= lookup_sym( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"second-term-common\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SRI-tuple\"),w(\"\"),no-attrs)"));
...
{
aterm * tmp[61];
PROF( prof_lf_AUX_MuASF_Rules2C18_3);
...
t_protect( tmp[ 35]);
t_protect( tmp[ 39]);
tmp[ 41]= ( * ef9)( tmp[ 35] , lf_AUX_MuASF_Rules2C18_1( make_list( tmp[ 39])));
if( check_sym( tmp[ 41] , ef10sym)) {
tmp[ 42]= arg_0( tmp[ 41]);
tmp[ 43]= arg_1( tmp[ 41]);
{
if( check_sym( tmp[ 42] , lf_AUX_MuASF_Rules2C18_1sym)) {
tmp[ 44]= arg_0( tmp[ 42]);
{
if( check_sym( tmp[ 43] , lf_AUX_MuASF_Rules2C18_1sym)) {
tmp[ 45]= arg_0( tmp[ 43]);
{
t_protect( tmp[ 44]);
...
t_unprotect( tmp[ 40]);
t_unprotect( tmp[ 41]);
return ( * ef5)( lf_AUX_MuASF_Rules2C18_1( cons( make_list( ( * ef1)( lf4( make_list( tmp[ 6])) , lf5( cons( make_list( ( * ef2)( ( * ef3)( ( * ef4)( lf6( cons( make_list( make_char( 116)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 113)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 97)) , make_list( make_char( 108))))))))))))) , lf7( cons( make_list( tmp[ 35]) , make_list( tmp[ 37])))) , tmp[ 10])) , make_list( tmp[ 38]))) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 39]))) , arg1 , arg2 , arg3);
}
else {
t_protect( arg3);
...
t_protect( arg1);
t_protect( arg2);
tmp[ 48]= ( * ef24)( ( * ef8)( ) , tmp[ 35] , tmp[ 4] , tmp[ 5] , ( * ef25)( arg3) , tmp[ 46] , arg1 , arg2);
...
t_protect( tmp[ 5]);
t_protect( tmp[ 44]);
tmp[ 58]= ( * ef31)( tmp[ 57] , ( * ef32)( lf9( make_list( ( * ef33)( tmp[ 57] , tmp[ 46])))) , lf_AUX_MuASF_Rules2C18_1( cons( make_list( ( * ef1)( lf4( make_list( tmp[ 6])) , lf5( cons( make_list( ( * ef2)( ( * ef3)( ( * ef4)( lf6( cons( make_list( make_char( 116)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 113)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 97)) , make_list( make_char( 108))))))))))))) , lf7( cons( make_list( tmp[ 35]) , make_list( tmp[ 37])))) , tmp[ 10])) , make_list( tmp[ 38]))) , tmp[ 3] , tmp[ 4] , tmp[ 5])) , make_list( tmp[ 44]))));
if( check_sym( tmp[ 58] , ef34sym)) {
tmp[ 59]= arg_0( tmp[ 58]);
if( check_sym( tmp[ 59] , lf_AUX_MuASF_Rules2C18_1sym)) {
tmp[ 60]= arg_0( tmp[ 59]);
t_protect( tmp[ 60]);
...
return make_nf4( lf_AUX_MuASF_Rules2C18_3sym , arg0 , arg1 , arg2 , arg3);
}
}
aterm * lf_AUX_MuASF_Rules2C18_1( aterm * arg0) {
PROF( prof_lf_AUX_MuASF_Rules2C18_1);
return make_nf1( lf_AUX_MuASF_Rules2C18_1sym , arg0);
}
...
PROF( prof_lf_AUX_MuASF_Rules2C18_2);
return make_nf1( lf_AUX_MuASF_Rules2C18_2sym , arg0);
}
