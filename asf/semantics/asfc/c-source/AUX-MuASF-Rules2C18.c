...
ef12 = lookup_func ( ATreadFromString ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[ql(\"is-ignored-funid\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"prefer\")],w(\"\"),l(\"}\")))" ) ) ;
ef12sym = lookup_sym ( ATreadFromString ( "prod(id(\"MuASF-Equations-Ops\"),w(\"\"),[ql(\"is-ignored-funid\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"prefer\")],w(\"\"),l(\"}\")))" ) ) ;
...
ef14 = lookup_func ( ATreadFromString ( "prod(id(\"C\"),w(\"\"),[sort(\"Cast-expression\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)" ) ) ;
ef14sym = lookup_sym ( ATreadFromString ( "prod(id(\"C\"),w(\"\"),[sort(\"Cast-expression\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)" ) ) ;
ef15 = lookup_func ( ATreadFromString ( "prod(id(\"C\"),w(\"\"),[sort(\"Primary-expression\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Cast-expression\"),w(\"\"),no-attrs)" ) ) ;
ef15sym = lookup_sym ( ATreadFromString ( "prod(id(\"C\"),w(\"\"),[sort(\"Primary-expression\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Cast-expression\"),w(\"\"),no-attrs)" ) ) ;
...
ef17 = lookup_func ( ATreadFromString ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"make-atmp\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"IntCon\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Identifier\"),w(\"\"),no-attrs)" ) ) ;
ef17sym = lookup_sym ( ATreadFromString ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"make-atmp\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"IntCon\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Identifier\"),w(\"\"),no-attrs)" ) ) ;
...
ef25 = lookup_func ( ATreadFromString ( "prod(id(\"ATerm-Booleans\"),w(\"\"),[ql(\"true\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
ef25sym = lookup_sym ( ATreadFromString ( "prod(id(\"ATerm-Booleans\"),w(\"\"),[ql(\"true\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) ) ;
}
...
( tmp [ 2 ] = ( * ef7 ) ( lf_AUX_MuASF_Rules2C18_1 ( cons ( make_list ( tmp [ 0 ] ) , make_list ( tmp [ 1 ] ) ) ) ) ) ;
...
( tmp [ 7 ] = ( * ef4 ) ( lf_AUX_MuASF_Rules2C18_1 ( make_list ( tmp [ 5 ] ) ) , arg1 , lf_AUX_MuASF_Rules2C18_2 ( make_list ( atmp20 ) ) , arg3 ) ) ;
if ( check_sym ( tmp [ 7 ] , ef5sym ) ) {
( tmp [ 8 ] = arg_0 ( tmp [ 7 ] ) ) ;
( tmp [ 9 ] = arg_1 ( tmp [ 7 ] ) ) ;
( tmp [ 10 ] = arg_2 ( tmp [ 7 ] ) ) ;
( tmp [ 11 ] = ( * ef9 ) ( lf_AUX_MuASF_Rules2C18_1 ( make_list ( tmp [ 5 ] ) ) ) ) ;
...
( tmp [ 16 ] = ( * ef12 ) ( tmp [ 14 ] ) ) ;
if ( term_equal ( tmp [ 16 ] , ( constant0 ? constant0 : ( constant0 = ( * ef25 ) ( ) ) ) ) ) {
( tmp [ 17 ] = ( * ef14 ) ( ( * ef15 ) ( ( * ef16 ) ( ( * ef17 ) ( lf4 ( make_list ( tmp [ 15 ] ) ) ) ) ) ) ) ;
...
( tmp [ 19 ] = arg_0 ( tmp [ 18 ] ) ) ;
( tmp [ 20 ] = arg_1 ( tmp [ 18 ] ) ) ;
( tmp [ 21 ] = ( * ef18 ) ( make_nf1 ( ef19sym , lf5 ( make_list ( ( * ef20 ) ( ( * ef21 ) ( arg1 , tmp [ 17 ] ) ) ) ) ) ) ) ;
( tmp [ 22 ] = ( * ef6 ) ( tmp [ 21 ] , tmp [ 19 ] ) ) ;
( tmp [ 23 ] = ( * ef3 ) ( tmp [ 8 ] , tmp [ 9 ] ) ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef6 ) ( tmp [ 23 ] , tmp [ 22 ] ) , tmp [ 20 ] ) ) ;
}
}
if ( term_equal ( tmp [ 16 ] , ( constant1 ? constant1 : ( constant1 = ( * ef13 ) ( ) ) ) ) ) {
( tmp [ 17 ] = ( * ef14 ) ( ( * ef15 ) ( ( * ef16 ) ( ( * ef17 ) ( lf4 ( make_list ( tmp [ 15 ] ) ) ) ) ) ) ) ;
( tmp [ 18 ] = lf_AUX_MuASF_Rules2C18_3 ( lf_AUX_MuASF_Rules2C18_1 ( make_list ( tmp [ 6 ] ) ) , arg1 , lf_AUX_MuASF_Rules2C18_2 ( make_list ( atmp20 ) ) , tmp [ 10 ] ) ) ;
if ( check_sym ( tmp [ 18 ] , ef1sym ) ) {
( tmp [ 19 ] = arg_0 ( tmp [ 18 ] ) ) ;
( tmp [ 20 ] = arg_1 ( tmp [ 18 ] ) ) ;
( tmp [ 21 ] = ( * ef18 ) ( make_nf1 ( ef19sym , lf5 ( make_list ( ( * ef20 ) ( ( * ef21 ) ( arg1 , ( * ef14 ) ( ( * ef15 ) ( ( * ef22 ) ( ( * ef16 ) ( ( * ef23 ) ( lf6 ( ( ATerm ) ATmakeList ( 5 , char_table [ 97 ] , char_table [ 114 ] , char_table [ 103 ] , char_table [ 95 ] , char_table [ 48 ] ) ) ) ) , make_nf1 ( ef24sym , lf7 ( make_list ( tmp [ 17 ] ) ) ) ) ) ) ) ) ) ) ) ) ) ;
( tmp [ 22 ] = ( * ef6 ) ( tmp [ 21 ] , tmp [ 19 ] ) ) ;
( tmp [ 23 ] = ( * ef3 ) ( tmp [ 8 ] , tmp [ 9 ] ) ) ;
FUNC_EXIT ( ( * ef1 ) ( ( * ef6 ) ( tmp [ 23 ] , tmp [ 22 ] ) , tmp [ 20 ] ) ) ;
}
...
( tmp [ 0 ] = list_head ( atmp00 ) ) ;
( tmp [ 1 ] = ( * ef4 ) ( lf_AUX_MuASF_Rules2C18_1 ( make_list ( tmp [ 0 ] ) ) , arg1 , lf_AUX_MuASF_Rules2C18_2 ( make_list ( atmp20 ) ) , arg3 ) ) ;
