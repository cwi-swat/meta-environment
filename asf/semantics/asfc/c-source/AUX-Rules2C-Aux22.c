...
static Symbol lf_AUX_Rules2C_Aux22_2_recursivesym ;
static ATerm lf_AUX_Rules2C_Aux22_2_recursive ( ATerm arg1 ) ;
...
lf_AUX_Rules2C_Aux22_2_recursivesym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"remove-ofs-first-arg\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Rules2C_Aux22_2_recursivesym ) ;
lf_AUX_Rules2C_Aux22_2sym = ATmakeSymbol ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"remove-ofs-first-arg\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)" , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"remove-ofs-first-arg\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux22_2 , lf_AUX_Rules2C_Aux22_2sym ) ;
register_prod ( ATparse ( "prod(id(\"Rules2C-Aux\"),w(\"\"),[ql(\"remove-ofs-first-arg\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"C-RuleList\"),w(\"\"),no-attrs)" ) , lf_AUX_Rules2C_Aux22_2_recursive , lf_AUX_Rules2C_Aux22_2_recursivesym ) ;
...
( tmp [ 21 ] = arg_0 ( tmp [ 20 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf_AUX_Rules2C_Aux22_1 ( cons ( make_list ( ( * ef2 ) ( lf3 ( cons ( make_list ( tmp [ 15 ] ) , make_list ( tmp [ 11 ] ) ) ) , lf5 ( make_list ( tmp [ 9 ] ) ) , tmp [ 4 ] , tmp [ 5 ] , tmp [ 6 ] , tmp [ 7 ] ) ) , make_list ( tmp [ 21 ] ) ) ) ) ) ;
}
}
}
}
...
( tmp [ 17 ] = arg_0 ( tmp [ 16 ] ) ) ;
FUNC_EXIT ( make_nf1 ( ef1sym , lf_AUX_Rules2C_Aux22_1 ( cons ( make_list ( ( * ef2 ) ( lf3 ( make_list ( tmp [ 11 ] ) ) , lf5 ( make_list ( tmp [ 9 ] ) ) , tmp [ 4 ] , tmp [ 5 ] , tmp [ 6 ] , tmp [ 7 ] ) ) , make_list ( tmp [ 17 ] ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT_CONST ( constant0 , make_nf1 ( ef1sym , lf_AUX_Rules2C_Aux22_1 ( make_list ( null ( ) ) ) ) ) ;
}
}
}
...
ATerm lf_AUX_Rules2C_Aux22_2_recursive ( ATerm arg0 ) {
{
ATerm tmp [ 22 ] ;
FUNC_ENTRY ( lf_AUX_Rules2C_Aux22_2_recursivesym , ATmakeAppl ( lf_AUX_Rules2C_Aux22_2_recursivesym , arg0 ) ) ;
{
ATerm atmp00 = arg0 ;
if ( not_empty_list ( atmp00 ) ) {
( tmp [ 0 ] = list_head ( atmp00 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Rules2C_Aux22_2_recursivesym , lf_AUX_Rules2C_Aux22_1 ( arg0 ) ) ) ;
}
}
