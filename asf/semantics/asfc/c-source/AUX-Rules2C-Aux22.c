#include "support.h"
static asymbol * lf_AUX_Rules2C_Aux22_2sym;
static aterm * lf_AUX_Rules2C_Aux22_2( aterm * arg1 , aterm * arg2);
...
lf_AUX_Rules2C_Aux22_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-select-stat\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"AInt\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
lf_AUX_Rules2C_Aux22_1sym= TmkSymbol( "listtype(sort(\"AInt\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"AInt\"),ql(\",\"))") , lf_AUX_Rules2C_Aux22_1 , lf_AUX_Rules2C_Aux22_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"make-select-stat\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"AInt\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux22_2 , lf_AUX_Rules2C_Aux22_2sym);
...
aterm * lf_AUX_Rules2C_Aux22_2( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[7];
PROF( prof_lf_AUX_Rules2C_Aux22_2);
if( check_sym( arg0 , ef2sym)) {
if( check_sym( arg1 , lf_AUX_Rules2C_Aux22_1sym)) {
{
...
t_protect( tmp[ 0]);
t_protect( tmp[ 1]);
tmp[ 4]= ( * ef16)( lf_AUX_Rules2C_Aux22_1( cons( make_list( tmp[ 0]) , make_list( tmp[ 1]))));
t_protect( tmp[ 0]);
tmp[ 5]= ( * ef17)( lf_AUX_Rules2C_Aux22_1( make_list( tmp[ 0])));
t_protect( tmp[ 3]);
t_unprotect( arg0);
t_unprotect( arg1);
t_unprotect( tmp[ 0]);
...
return make_nf2( lf_AUX_Rules2C_Aux22_2sym , arg0 , arg1);
}
}
aterm * lf_AUX_Rules2C_Aux22_1( aterm * arg0) {
PROF( prof_lf_AUX_Rules2C_Aux22_1);
return make_nf1( lf_AUX_Rules2C_Aux22_1sym , arg0);
}
