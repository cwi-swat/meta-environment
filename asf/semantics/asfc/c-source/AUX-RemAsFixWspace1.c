#include "support.h"
static Symbol lf_AUX_RemAsFixWspace1_1sym;
...
lf_AUX_RemAsFixWspace1_1sym= ATmakeSymbol( "prod(id(\"RemAsFixWspace\"),w(\"\"),[l(\"remove-all-ws\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_RemAsFixWspace1_1sym);
register_prod( ATparse( "prod(id(\"RemAsFixWspace\"),w(\"\"),[l(\"remove-all-ws\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)") , lf_AUX_RemAsFixWspace1_1 , lf_AUX_RemAsFixWspace1_1sym);
}
