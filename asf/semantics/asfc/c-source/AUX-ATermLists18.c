#include "support.h"
static Symbol lf_AUX_ATermLists18_1sym;
static ATerm lf_AUX_ATermLists18_1( ATerm arg1 , ATerm arg2 , ATerm arg3);
...
static funcptr ef5;
void register_AUX_ATermLists18( ) {
lf_AUX_ATermLists18_1sym= ATmakeSymbol( "prod(id(\"ATermLists\"),w(\"\"),[l(\"inter1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)"
 , 3 , ATtrue);
ATprotectSymbol( lf_AUX_ATermLists18_1sym);
register_prod( ATparse( "prod(id(\"ATermLists\"),w(\"\"),[l(\"inter1\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATermList\"),w(\"\"),no-attrs)") , lf_AUX_ATermLists18_1 , lf_AUX_ATermLists18_1sym);
}
void resolve_AUX_ATermLists18( ) {
...
void init_AUX_ATermLists18( ) {
}
ATerm lf_AUX_ATermLists18_1( ATerm arg0 , ATerm arg1 , ATerm arg2) {
PROF( prof_lf_AUX_ATermLists18_1);
...
return ( * ef2)( ( * ef3)( ( * ef4)( arg0) , arg1) , lf_AUX_ATermLists18_1( ( * ef5)( arg0) , ( * ef6)( arg1 , ( * ef4)( arg0)) , ( * ef7)( ( * ef8)( ( * ef9)( ( * ef4)( arg0))) , arg2)) , lf_AUX_ATermLists18_1( ( * ef5)( arg0) , arg1 , arg2));
}
