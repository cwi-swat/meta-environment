...
static Symbol lf_AUX_TermAsFixAccess45_1sym ;
static ATerm lf_AUX_TermAsFixAccess45_1 ( ATerm arg1 ) ;
...
static funcptr ef17 ;
void register_AUX_TermAsFixAccess45 ( ) {
lf_AUX_TermAsFixAccess45_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-iter-star-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess45_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-iter-star-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess45_1 , lf_AUX_TermAsFixAccess45_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess45 ( ) {
...
void init_AUX_TermAsFixAccess45 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess45_1 ( ATerm arg0 ) {
{
ATerm tmp [ 43 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess45_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess45_1sym , arg0 ) ) ;
...
if ( term_equal ( list_head ( tmp [ 28 ] ) , make_char ( 42 ) ) ) {
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess45_1sym , arg0 ) ) ;
}
}
