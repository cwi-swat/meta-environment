#include "support.h"
static asymbol * lf_AUX_MuASF_Signs3_1sym;
static aterm * lf_AUX_MuASF_Signs3_1( aterm * arg1);
...
lf_AUX_MuASF_Signs3_1sym= TmkSymbol( "prod(id(\"MuASF-Signs\"),w(\"\"),[l(\"is-external-ssfuncdef\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Signs\"),w(\"\"),[l(\"is-external-ssfuncdef\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FuncDef\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Signs3_1 , lf_AUX_MuASF_Signs3_1sym);
...
aterm * lf_AUX_MuASF_Signs3_1( aterm * arg0) {
{
aterm * tmp[11];
PROF( prof_lf_AUX_MuASF_Signs3_1);
...
if( m_is_single_element( atmp0100)) {
...
if( m_is_single_element( atmp0200)) {
tmp[ 0]= m_list_head( atmp0200);
if( check_sym( tmp[ 0] , ef3sym)) {
tmp[ 1]= arg_0( tmp[ 0]);
if( check_sym( tmp[ 1] , ef4sym)) {
tmp[ 2]= arg_0( tmp[ 1]);
