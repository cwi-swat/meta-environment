#include "support.h"
static Symbol lf_AUX_Integers14_1sym;
...
lf_AUX_Integers14_1sym= ATmakeSymbol( "prod(id(\"Integers\"),w(\"\"),[sort(\"NAT\"),w(\"\"),ql(\"-//\"),w(\"\"),sort(\"NAT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"NAT\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Integers14_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"Integers\"),w(\"\"),[sort(\"NAT\"),w(\"\"),ql(\"-//\"),w(\"\"),sort(\"NAT\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"NAT\"),w(\"\"),no-attrs)") , lf_AUX_Integers14_1 , lf_AUX_Integers14_1sym);
...
return ( constant0? constant0: ( constant0= ( * ef1)( ( * ef2)( lf2( make_list( make_char( 49)))))));
}
}
}
tmp[ 1]= make_char( 51);
...
return ( constant1? constant1: ( constant1= ( * ef1)( ( * ef2)( lf2( make_list( make_char( 50)))))));
}
}
}
tmp[ 2]= make_char( 52);
...
return ( constant2? constant2: ( constant2= ( * ef1)( ( * ef2)( lf2( make_list( make_char( 51)))))));
}
...
return ( constant3? constant3: ( constant3= ( * ef1)( ( * ef2)( lf2( make_list( make_char( 52)))))));
}
...
return ( constant4? constant4: ( constant4= ( * ef1)( ( * ef2)( lf2( make_list( make_char( 53)))))));
}
...
return ( constant5? constant5: ( constant5= ( * ef1)( ( * ef2)( lf2( make_list( make_char( 54)))))));
}
...
return ( constant6? constant6: ( constant6= ( * ef1)( ( * ef2)( lf2( make_list( make_char( 55)))))));
}
...
return ( constant7? constant7: ( constant7= ( * ef1)( ( * ef2)( lf2( make_list( make_char( 56)))))));
}
...
return ( constant8? constant8: ( constant8= ( * ef1)( ( * ef2)( lf2( make_list( make_char( 48)))))));
}
...
if( term_equal( tmp[ 3] , make_char( 49))) {
return ( constant9? constant9: ( constant9= ( * ef1)( ( * ef2)( lf2( make_list( make_char( 57)))))));
}
}
}
}
