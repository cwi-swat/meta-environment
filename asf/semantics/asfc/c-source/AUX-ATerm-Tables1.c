...
lf_AUX_ATerm_Tables1_1sym = ATmakeSymbol ( "prod(id(\"ATerm-Tables\"),w(\"\"),[ql(\"deff\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)"
 , 0 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ATerm_Tables1_1sym ) ;
lf_AUX_ATerm_Tables1_2sym = ATmakeSymbol ( "prod(id(\"ATerm-Tables\"),w(\"\"),[ql(\"cputf\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" , 0 , ATtrue ) ;
...
lf_AUX_ATerm_Tables1_4sym = ATmakeSymbol ( "prod(id(\"ATerm-Tables\"),w(\"\"),[ql(\"egetf\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" , 0 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ATerm_Tables1_4sym ) ;
lf_AUX_ATerm_Tables1_5sym = ATmakeSymbol ( "prod(id(\"ATerm-Tables\"),w(\"\"),[ql(\"getf\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" , 0 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ATerm_Tables1_5sym ) ;
register_prod ( ATparse ( "prod(id(\"ATerm-Tables\"),w(\"\"),[ql(\"deff\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) , lf_AUX_ATerm_Tables1_1 , lf_AUX_ATerm_Tables1_1sym ) ;
register_prod ( ATparse ( "prod(id(\"ATerm-Tables\"),w(\"\"),[ql(\"cputf\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) , lf_AUX_ATerm_Tables1_2 , lf_AUX_ATerm_Tables1_2sym ) ;
...
register_prod ( ATparse ( "prod(id(\"ATerm-Tables\"),w(\"\"),[ql(\"egetf\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) , lf_AUX_ATerm_Tables1_4 , lf_AUX_ATerm_Tables1_4sym ) ;
register_prod ( ATparse ( "prod(id(\"ATerm-Tables\"),w(\"\"),[ql(\"getf\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) , lf_AUX_ATerm_Tables1_5 , lf_AUX_ATerm_Tables1_5sym ) ;
}
