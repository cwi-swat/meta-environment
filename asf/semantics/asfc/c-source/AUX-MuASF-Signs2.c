...
lf_AUX_MuASF_Signs2_1sym= ATmakeSymbol( "prod(id(\"MuASF-Signs\"),w(\"\"),[sort(\"FuncDef\"),w(\"\"),ql(\"in_ss\"),w(\"\"),sort(\"FuncDefList\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_MuASF_Signs2_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"FuncDef\"),ql(\";\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"MuASF-Signs\"),w(\"\"),[sort(\"FuncDef\"),w(\"\"),ql(\"in_ss\"),w(\"\"),sort(\"FuncDefList\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Signs2_1 , lf_AUX_MuASF_Signs2_1sym);
