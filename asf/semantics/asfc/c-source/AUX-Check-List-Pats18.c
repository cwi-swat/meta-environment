...
lf_AUX_Check_List_Pats18_1sym= TmkSymbol( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"contains-set-pattern\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"contains-set-pattern\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_Check_List_Pats18_1 , lf_AUX_Check_List_Pats18_1sym);
...
ef4= lookup_func( TmakeSimple( & local , "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"is-list-elem-list-elem-list\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
ef4sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"is-list-elem-list-elem-list\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
...
t_protect( atmp00);
if( term_equal( ( * ef3)( atmp00) , ( * ef2)( ))) {
t_protect( atmp010);
if( term_equal( ( * ef4)( lf2( make_list( atmp010))) , ( * ef2)( ))) {
t_unprotect( arg0);
return ( * ef2)( );
}
}
...
t_protect( atmp00);
if( term_equal( ( * ef3)( atmp00) , ( * ef5)( ))) {
t_protect( tmp[ 0]);
if( term_equal( lf_AUX_Check_List_Pats18_1( tmp[ 0]) , ( * ef2)( ))) {
t_unprotect( arg0);
t_unprotect( tmp[ 0]);
return ( * ef2)( );
}
