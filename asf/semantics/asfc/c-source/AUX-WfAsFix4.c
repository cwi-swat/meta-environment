...
lf_AUX_WfAsFix4_1sym= ATmakeSymbol( "prod(id(\"WfAsFix\"),w(\"\"),[l(\"expand-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_WfAsFix4_1sym);
register_prod( ATparse( "prod(id(\"WfAsFix\"),w(\"\"),[l(\"expand-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)") , lf_AUX_WfAsFix4_1 , lf_AUX_WfAsFix4_1sym);
}
