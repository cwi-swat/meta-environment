#include "support.h"
static Symbol lf_AUX_Check_List_Pats20_2sym;
...
lf_AUX_Check_List_Pats20_2sym= ATmakeSymbol( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"are-lhs-args\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Check_List_Pats20_2sym);
lf_AUX_Check_List_Pats20_1sym= ATmakeSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Check_List_Pats20_1sym);
register_prod( ATparse( "listtype(sort(\"Term\"),ql(\",\"))") , lf_AUX_Check_List_Pats20_1 , lf_AUX_Check_List_Pats20_1sym);
register_prod( ATparse( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"are-lhs-args\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_Check_List_Pats20_2 , lf_AUX_Check_List_Pats20_2sym);
}
...
if( term_equal( lf_AUX_Check_List_Pats20_2( arg0 , lf_AUX_Check_List_Pats20_1( make_list( tmp[ 1]))) , ( constant1? constant1: ( constant1= ( * ef3)( ))))) {
return ( constant0? constant0: ( constant0= ( * ef1)( )));
}
}
if( term_equal( tmp[ 2] , ( constant1? constant1: ( constant1= ( * ef3)( ))))) {
if( term_equal( lf_AUX_Check_List_Pats20_2( arg0 , lf_AUX_Check_List_Pats20_1( make_list( tmp[ 1]))) , ( constant0? constant0: ( constant0= ( * ef1)( ))))) {
return ( constant0? constant0: ( constant0= ( * ef1)( )));
}
}
}
