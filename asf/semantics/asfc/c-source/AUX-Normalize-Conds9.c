...
static ATerm lf_AUX_Normalize_Conds9_1( ATerm arg1 , ATerm arg2);
...
lf_AUX_Normalize_Conds9_1sym= ATmakeSymbol( "prod(id(\"Normalize-Conds\"),w(\"\"),[l(\"normalize-list-in-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Cond\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TC-tuple\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Normalize-Conds\"),w(\"\"),[l(\"normalize-list-in-cond\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Cond\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TC-tuple\"),w(\"\"),no-attrs)") , lf_AUX_Normalize_Conds9_1 , lf_AUX_Normalize_Conds9_1sym);
...
ATerm lf_AUX_Normalize_Conds9_1( ATerm arg0 , ATerm arg1) {
{
ATerm tmp[6];
...
return make_nf2( lf_AUX_Normalize_Conds9_1sym , arg0 , arg1);
}
}
