...
static ATerm lf_AUX_Locate_Constants17_2 ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Locate_Constants17_2sym = ATmakeSymbol ( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"make-init-function\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"make-init-function\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)" ) , lf_AUX_Locate_Constants17_2 , lf_AUX_Locate_Constants17_2sym ) ;
...
ATerm lf_AUX_Locate_Constants17_2 ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 6 ] ;
PROF ( prof_lf_AUX_Locate_Constants17_2 ) ;
if ( check_sym ( arg1 , lf_AUX_Locate_Constants17_1sym ) ) {
{
ATerm atmp10 = arg_0 ( arg1 ) ;
tmp [ 0 ] = ( * ef11 ) ( arg0 ) ;
tmp [ 1 ] = ( * ef12 ) ( lf_AUX_Locate_Constants17_1 ( make_list ( atmp10 ) ) ) ;
...
return make_nf2 ( lf_AUX_Locate_Constants17_2sym , arg0 , arg1 ) ;
}
}
