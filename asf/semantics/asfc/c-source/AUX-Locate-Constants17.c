...
lf_AUX_Locate_Constants17_1sym = ATmakeSymbol ( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"modname2iname\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Identifier\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Locate_Constants17_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"modname2iname\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Identifier\"),w(\"\"),no-attrs)" ) , lf_AUX_Locate_Constants17_1 , lf_AUX_Locate_Constants17_1sym ) ;
...
{
ATerm tmp [ 4 ] ;
FUNC_ENTRY ( lf_AUX_Locate_Constants17_1sym , ATmakeAppl ( lf_AUX_Locate_Constants17_1sym , arg0 ) ) ;
...
( tmp [ 3 ] = arg_0 ( tmp [ 2 ] ) ) ;
FUNC_EXIT ( ( * ef2 ) ( lf2 ( cons ( make_list_char ( 105 ) , cons ( make_list_char ( 110 ) , cons ( make_list_char ( 105 ) , cons ( make_list_char ( 116 ) , cons ( make_list_char ( 95 ) , make_list ( tmp [ 3 ] ) ) ) ) ) ) ) ) ) ;
}
}
}
}
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Locate_Constants17_1sym , arg0 ) ) ;
}
}
