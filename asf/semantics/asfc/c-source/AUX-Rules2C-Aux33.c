#include "support.h"
static asymbol * lf_AUX_Rules2C_Aux33_2sym;
static aterm * lf_AUX_Rules2C_Aux33_2( aterm * arg1 , aterm * arg2);
...
static funcptr ef6;
static asymbol * lf_AUX_Rules2C_Aux33_1sym;
static aterm * lf_AUX_Rules2C_Aux33_1( aterm * arg1);
void register_AUX_Rules2C_Aux33( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_Rules2C_Aux33_2sym= TmkSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"add-to-set\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"AInt\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"A-set\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"EI-pair\"),ql(\",\"))" , SYM_STRING);
lf4sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
lf_AUX_Rules2C_Aux33_1sym= TmkSymbol( "listtype(sort(\"AInt\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"AInt\"),ql(\",\"))") , lf_AUX_Rules2C_Aux33_1 , lf_AUX_Rules2C_Aux33_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"add-to-set\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"AInt\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"A-set\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux33_2 , lf_AUX_Rules2C_Aux33_2sym);
...
aterm * lf_AUX_Rules2C_Aux33_2( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[3];
...
t_protect( tmp[ 0]);
t_protect( tmp[ 1]);
tmp[ 2]= ( * ef6)( lf_AUX_Rules2C_Aux33_1( cons( make_list( tmp[ 0]) , make_list( tmp[ 1]))));
t_protect( atmp100);
t_unprotect( arg0);
t_unprotect( arg1);
t_unprotect( tmp[ 0]);
...
return make_nf2( lf_AUX_Rules2C_Aux33_2sym , arg0 , arg1);
}
}
