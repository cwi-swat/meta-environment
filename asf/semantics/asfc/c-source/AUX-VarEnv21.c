...
static Symbol lf_AUX_VarEnv21_2_recursivesym ;
static ATerm lf_AUX_VarEnv21_2_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
ATerm lf_AUX_VarEnv21_2_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 6 ] ;
FUNC_ENTRY ( lf_AUX_VarEnv21_2_recursivesym , ATmakeAppl ( lf_AUX_VarEnv21_2_recursivesym , arg0 , arg1 ) ) ;
{
ATerm ltmp [ 2 ] ;
...
goto lbl_lf_AUX_VarEnv21_2_recursive ;
}
else {
FUNC_EXIT ( tmp [ 3 ] ) ;
}
...
FUNC_EXIT ( make_nf2 ( lf_AUX_VarEnv21_2_recursivesym , ltmp [ 0 ] , lf_AUX_VarEnv21_1 ( ltmp [ 1 ] ) ) ) ;
}
}
}
