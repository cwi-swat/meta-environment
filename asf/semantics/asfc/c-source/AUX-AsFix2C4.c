#include "support.h"
static asymbol * lf_AUX_AsFix2C4_1sym;
static aterm * lf_AUX_AsFix2C4_1( aterm * arg1);
...
static funcptr ef6;
void register_AUX_AsFix2C4( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_AsFix2C4_1sym= TmkSymbol( "prod(id(\"AsFix2C\"),w(\"\"),[l(\"asfix2muasf3\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Module\"),w(\"\"),no-attrs)"
 , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"AsFix2C\"),w(\"\"),[l(\"asfix2muasf3\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Module\"),w(\"\"),no-attrs)") , lf_AUX_AsFix2C4_1 , lf_AUX_AsFix2C4_1sym);
}
void resolve_AUX_AsFix2C4( ) {
arena local;
TinitArena( NULL , & local);
...
aterm * lf_AUX_AsFix2C4_1( aterm * arg0) {
{
aterm * tmp[7];
PROF( prof_lf_AUX_AsFix2C4_1);
t_protect( arg0);
tmp[ 0]= ( * ef1)( arg0);
...
t_unprotect( tmp[ 0]);
return make_nf1( lf_AUX_AsFix2C4_1sym , arg0);
}
}
