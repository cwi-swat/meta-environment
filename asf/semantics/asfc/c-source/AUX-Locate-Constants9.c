...
static Symbol lf_AUX_Locate_Constants9_2_recursivesym ;
static ATerm lf_AUX_Locate_Constants9_2_recursive ( ATerm arg1 , ATerm arg2 ) ;
...
lf_AUX_Locate_Constants9_2_recursivesym = ATmakeSymbol ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-expressions\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CEELI-tuple\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_Locate_Constants9_2_recursivesym ) ;
lf_AUX_Locate_Constants9_2sym = ATmakeSymbol ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-expressions\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CEELI-tuple\"),w(\"\"),no-attrs)" , 2 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-expressions\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CEELI-tuple\"),w(\"\"),no-attrs)" ) , lf_AUX_Locate_Constants9_2 , lf_AUX_Locate_Constants9_2sym ) ;
register_prod ( ATparse ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-expressions\"),w(\"\"),ql(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CEELI-tuple\"),w(\"\"),no-attrs)" ) , lf_AUX_Locate_Constants9_2_recursive , lf_AUX_Locate_Constants9_2_recursivesym ) ;
...
ef4 = lookup_func ( ATreadFromString ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-expression\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CEEI-tuple\"),w(\"\"),no-attrs)" ) ) ;
ef4sym = lookup_sym ( ATreadFromString ( "prod(id(\"Locate-Constants\"),w(\"\"),[ql(\"locate-constants-in-expression\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"CEI-tuple\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"CEEI-tuple\"),w(\"\"),no-attrs)" ) ) ;
...
( tmp [ 13 ] = arg_0 ( tmp [ 12 ] ) ) ;
FUNC_EXIT ( ( * ef2 ) ( lf3 ( make_list ( tmp [ 11 ] ) ) , make_nf1 ( ef3sym , lf_AUX_Locate_Constants9_1 ( cons ( make_list ( tmp [ 4 ] ) , make_list ( tmp [ 13 ] ) ) ) ) , tmp [ 10 ] ) ) ;
}
}
}
}
...
ATerm lf_AUX_Locate_Constants9_2_recursive ( ATerm arg0 , ATerm arg1 ) {
{
ATerm tmp [ 14 ] ;
FUNC_ENTRY ( lf_AUX_Locate_Constants9_2_recursivesym , ATmakeAppl ( lf_AUX_Locate_Constants9_2_recursivesym , arg0 , arg1 ) ) ;
{
ATerm atmp00 = arg0 ;
if ( check_sym ( arg1 , ef1sym ) ) {
{
...
FUNC_EXIT ( make_nf2 ( lf_AUX_Locate_Constants9_2_recursivesym , lf_AUX_Locate_Constants9_1 ( arg0 ) , arg1 ) ) ;
}
}
