...
static Symbol lf_AUX_TermAsFixAccess44_1sym ;
static ATerm lf_AUX_TermAsFixAccess44_1 ( ATerm arg1 ) ;
...
static funcptr ef17 ;
void register_AUX_TermAsFixAccess44 ( ) {
lf_AUX_TermAsFixAccess44_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-iter-plus-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess44_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-iter-plus-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess44_1 , lf_AUX_TermAsFixAccess44_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess44 ( ) {
...
void init_AUX_TermAsFixAccess44 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess44_1 ( ATerm arg0 ) {
{
ATerm tmp [ 43 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess44_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess44_1sym , arg0 ) ) ;
...
if ( check_sym ( atmp011100011 , ef5sym ) ) {
{
...
if ( term_equal ( list_head ( tmp [ 21 ] ) , make_char ( 121 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 23 ] ) , make_char ( 98 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 28 ] ) , make_char ( 43 ) ) ) {
...
( tmp [ 30 ] = list_tail ( atmp011110100000 ) ) ;
...
( tmp [ 31 ] = list_tail ( atmp0111110100000 ) ) ;
if ( not_empty_list ( tmp [ 31 ] ) ) {
if ( term_equal ( list_head ( tmp [ 31 ] ) , make_char ( 45 ) ) ) {
( tmp [ 32 ] = list_tail ( tmp [ 31 ] ) ) ;
if ( not_empty_list ( tmp [ 32 ] ) ) {
if ( term_equal ( list_head ( tmp [ 32 ] ) , make_char ( 62 ) ) ) {
...
( tmp [ 34 ] = list_tail ( atmp01111110100000 ) ) ;
...
( tmp [ 35 ] = list_tail ( atmp011111110100000 ) ) ;
if ( not_empty_list ( tmp [ 35 ] ) ) {
if ( term_equal ( list_head ( tmp [ 35 ] ) , make_char ( 83 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 37 ] ) , make_char ( 109 ) ) ) {
( tmp [ 38 ] = list_tail ( tmp [ 37 ] ) ) ;
if ( not_empty_list ( tmp [ 38 ] ) ) {
if ( term_equal ( list_head ( tmp [ 38 ] ) , make_char ( 98 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 40 ] ) , make_char ( 108 ) ) ) {
...
( tmp [ 42 ] = list_tail ( atmp0111111110100000 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess44_1sym , arg0 ) ) ;
}
}
