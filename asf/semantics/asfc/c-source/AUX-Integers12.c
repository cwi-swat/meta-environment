...
static ATerm lf_AUX_Integers12_1( ATerm arg1);
...
lf_AUX_Integers12_1sym= ATmakeSymbol( "prod(id(\"Integers\"),w(\"\"),[l(\"succ\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"INT\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Integers12_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
register_prod( ATparse( "prod(id(\"Integers\"),w(\"\"),[l(\"succ\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"INT\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"INT\"),w(\"\"),no-attrs)") , lf_AUX_Integers12_1 , lf_AUX_Integers12_1sym);
...
ATerm lf_AUX_Integers12_1( ATerm arg0) {
