#include  "support.h"
static Symbol lf_AUX_ATerm_Tables2_1sym ;
static ATerm lf_AUX_ATerm_Tables2_1 ( ATerm arg1 , ATerm arg2 ) ;
...
static funcptr ef2 ;
void register_AUX_ATerm_Tables2 ( ) {
lf_AUX_ATerm_Tables2_1sym = ATmakeSymbol ( "prod(id(\"ATerm-Tables\"),w(\"\"),[l(\"get\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ATerm_Tables2_1sym ) ;
register_prod ( ATparse ( "prod(id(\"ATerm-Tables\"),w(\"\"),[l(\"get\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ATerm\"),w(\"\"),no-attrs)" ) , lf_AUX_ATerm_Tables2_1 , lf_AUX_ATerm_Tables2_1sym ) ;
}
void resolve_AUX_ATerm_Tables2 ( ) {
...
FUNC_EXIT ( make_nf2 ( lf_AUX_ATerm_Tables2_1sym , ltmp [ 0 ] , ltmp [ 1 ] ) ) ;
}
}
}
