#include "support.h"
static asymbol * lf_AUX_MuASF_Rules2C24_2sym;
static aterm * lf_AUX_MuASF_Rules2C24_2( aterm * arg1 , aterm * arg2 , aterm * arg3 , aterm * arg4 , aterm * arg5 , aterm * arg6 , aterm * arg7 , aterm * arg8);
...
static asymbol * lf_AUX_MuASF_Rules2C24_1sym;
static aterm * lf_AUX_MuASF_Rules2C24_1( aterm * arg1);
static asymbol * ef4sym;
static funcptr ef4;
void register_AUX_MuASF_Rules2C24( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_MuASF_Rules2C24_2sym= TmkSymbol( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"term2carg2\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
...
lf_AUX_MuASF_Rules2C24_1sym= TmkSymbol( "listtype(sort(\"NamePair\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "listtype(sort(\"NamePair\"),ql(\",\"))") , lf_AUX_MuASF_Rules2C24_1 , lf_AUX_MuASF_Rules2C24_1sym);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"term2carg2\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Rules2C24_2 , lf_AUX_MuASF_Rules2C24_2sym);
...
void resolve_AUX_MuASF_Rules2C24( ) {
arena local;
TinitArena( NULL , & local);
...
ef18= lookup_func( TmakeSimple( & local , "prod(id(\"Booleans\"),w(\"\"),[l(\"false\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
ef18sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Booleans\"),w(\"\"),[l(\"false\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
ef19= lookup_func( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"get-funid\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)"));
ef19sym= lookup_sym( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"get-funid\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FunId\"),w(\"\"),no-attrs)"));
ef20= lookup_func( TmakeSimple( & local , "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"get-funargs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)"));
ef20sym= lookup_sym( TmakeSimple( & local , "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"get-funargs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)"));
ef21= lookup_func( TmakeSimple( & local , "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)"));
ef21sym= lookup_sym( TmakeSimple( & local , "prod(id(\"MuASF-SingleSorted\"),w(\"\"),[iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\"))],w(\"\"),l(\"->\"),w(\"\"),sort(\"TermList\"),w(\"\"),no-attrs)"));
ef22= lookup_func( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"make-call-id\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Primary-expression\"),w(\"\"),no-attrs)"));
ef22sym= lookup_sym( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"make-call-id\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Primary-expression\"),w(\"\"),no-attrs)"));
ef23= lookup_func( TmakeSimple( & local , "prod(id(\"Pure-C\"),w(\"\"),[],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)"));
ef23sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Pure-C\"),w(\"\"),[],w(\"\"),l(\"->\"),w(\"\"),sort(\"Statement-list-opt\"),w(\"\"),no-attrs)"));
...
ef25= lookup_func( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"is-char\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
ef25sym= lookup_sym( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"is-char\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
ef26= lookup_func( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"translate-char\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"));
ef26sym= lookup_sym( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"translate-char\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"));
ef27= lookup_func( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"make-c-temp\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Primary-expression\"),w(\"\"),no-attrs)"));
ef27sym= lookup_sym( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"make-c-temp\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Primary-expression\"),w(\"\"),no-attrs)"));
ef28= lookup_func( TmakeSimple( & local , "prod(id(\"Booleans\"),w(\"\"),[sort(\"Bool\"),w(\"\"),ql(\"\\\\\\\\/\"),w(\"\"),sort(\"Bool\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))"));
ef28sym= lookup_sym( TmakeSimple( & local , "prod(id(\"Booleans\"),w(\"\"),[sort(\"Bool\"),w(\"\"),ql(\"\\\\\\\\/\"),w(\"\"),sort(\"Bool\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),attrs(l(\"{\"),w(\"\"),[l(\"left\")],w(\"\"),l(\"}\")))"));
ef29= lookup_func( TmakeSimple( & local , "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"is-list-funid\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
ef29sym= lookup_sym( TmakeSimple( & local , "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"is-list-funid\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
ef30= lookup_func( TmakeSimple( & local , "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"is-cons\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
ef30sym= lookup_sym( TmakeSimple( & local , "prod(id(\"MuASF-Basics\"),w(\"\"),[l(\"is-cons\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
...
ef32= lookup_func( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"terms2cargs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)"));
ef32sym= lookup_sym( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"terms2cargs\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Bool\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"+\")),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)"));
}
aterm * lf_AUX_MuASF_Rules2C24_2( aterm * arg0 , aterm * arg1 , aterm * arg2 , aterm * arg3 , aterm * arg4 , aterm * arg5 , aterm * arg6 , aterm * arg7) {
{
aterm * tmp[28];
PROF( prof_lf_AUX_MuASF_Rules2C24_2);
if( check_sym( arg0 , ef11sym)) {
if( check_sym( arg7 , lf_AUX_MuASF_Rules2C24_1sym)) {
{
...
tmp[ 1]= ( * ef10)( arg1);
t_protect( tmp[ 1]);
if( term_equal( tmp[ 1] , ( * ef18)( ))) {
t_protect( arg1);
tmp[ 2]= ( * ef24)( arg1);
t_protect( tmp[ 2]);
tmp[ 3]= ( * ef30)( ( * ef31)( tmp[ 2]));
t_protect( tmp[ 3]);
t_protect( arg0);
...
t_protect( arg6);
t_protect( arg7);
tmp[ 8]= ( * ef32)( arg0 , lf5( make_list( tmp[ 7])) , arg2 , arg3 , arg4 , arg5 , arg6 , arg7);
...
t_unprotect( tmp[ 5]);
t_unprotect( tmp[ 8]);
return ( * ef4)( ( * ef5)( lf4( make_list( ( * ef1)( ( * ef17)( tmp[ 4] , tmp[ 9]))))) , tmp[ 10] , tmp[ 11]);
}
t_unprotect( tmp[ 8]);
}
}
...
t_protect( arg6);
t_protect( arg7);
tmp[ 4]= lf_AUX_MuASF_Rules2C24_2( ( * ef18)( ) , arg1 , arg2 , arg3 , arg4 , arg5 , arg6 , arg7);
...
t_unprotect( tmp[ 3]);
t_unprotect( tmp[ 4]);
return ( * ef4)( ( * ef5)( lf4( make_list( ( * ef1)( ( * ef17)( ( * ef2)( ( * ef3)( lf3( cons( make_list( make_char( 109)) , cons( make_list( make_char( 97)) , cons( make_list( make_char( 107)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 95)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , make_list( make_char( 116))))))))))))) , tmp[ 5]))))) , tmp[ 6] , tmp[ 7]);
}
t_unprotect( tmp[ 4]);
}
t_unprotect( tmp[ 3]);
...
t_unprotect( tmp[ 1]);
t_unprotect( tmp[ 2]);
return ( * ef4)( ( * ef5)( lf4( make_list( ( * ef1)( ( * ef17)( ( * ef2)( ( * ef3)( lf3( cons( make_list( make_char( 109)) , cons( make_list( make_char( 97)) , cons( make_list( make_char( 107)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 95)) , cons( make_list( make_char( 108)) , cons( make_list( make_char( 105)) , cons( make_list( make_char( 115)) , make_list( make_char( 116))))))))))))) , ( * ef5)( lf4( make_list( tmp[ 3])))))))) , tmp[ 4] , arg4);
}
t_unprotect( tmp[ 2]);
}
t_unprotect( tmp[ 1]);
...
aterm * atmp70= arg_0( arg7);
t_protect( atmp50000);
if( not_empty_list( atmp50000)) {
t_protect( atmp50000);
tmp[ 0]= list_head( atmp50000);
t_protect( tmp[ 0]);
if( term_equal( tmp[ 0] , make_char( 114))) {
t_protect( atmp50000);
tmp[ 1]= list_tail( atmp50000);
t_protect( tmp[ 1]);
...
t_protect( arg1);
t_protect( arg7);
tmp[ 12]= ( * ef19)( arg1 , arg7);
{
t_protect( tmp[ 12]);
tmp[ 13]= ( * ef22)( tmp[ 12]);
t_protect( arg1);
tmp[ 14]= ( * ef20)( arg1);
if( check_sym( tmp[ 14] , ef21sym)) {
tmp[ 15]= arg_0( tmp[ 14]);
...
t_protect( arg4);
tmp[ 17]= ( * ef1)( ( * ef27)( arg4));
t_protect( arg1);
tmp[ 18]= ( * ef24)( arg1);
t_protect( tmp[ 18]);
t_protect( tmp[ 18]);
tmp[ 19]= ( * ef28)( ( * ef29)( tmp[ 18]) , ( * ef30)( ( * ef31)( tmp[ 18])));
t_protect( tmp[ 19]);
t_protect( tmp[ 16]);
t_protect( arg2);
t_protect( arg3);
...
t_protect( arg6);
t_protect( arg7);
tmp[ 20]= ( * ef32)( tmp[ 19] , lf5( make_list( tmp[ 16])) , arg2 , arg3 , arg4 , tmp[ 17] , arg6 , arg7);
...
t_unprotect( tmp[ 13]);
t_protect( arg1);
if( term_equal( ( * ef20)( arg1) , ( * ef21)( lf5( make_list( null( )))))) {
t_protect( tmp[ 12]);
tmp[ 13]= ( * ef22)( tmp[ 12]);
t_protect( arg6);
tmp[ 14]= ( * ef15)( arg6);
...
tmp[ 2]= ( * ef20)( arg1);
t_protect( tmp[ 2]);
if( term_equal( tmp[ 2] , ( * ef21)( lf5( make_list( null( )))))) {
t_protect( arg1);
tmp[ 3]= ( * ef24)( arg1);
t_protect( tmp[ 3]);
if( term_equal( ( * ef25)( tmp[ 3]) , ( * ef11)( ))) {
t_protect( tmp[ 3]);
tmp[ 4]= ( * ef26)( tmp[ 3]);
t_unprotect( arg0);
t_unprotect( arg1);
...
t_unprotect( tmp[ 2]);
t_unprotect( tmp[ 3]);
return ( * ef4)( ( * ef5)( lf4( make_list( ( * ef1)( ( * ef17)( ( * ef2)( ( * ef3)( lf3( cons( make_list( make_char( 109)) , cons( make_list( make_char( 97)) , cons( make_list( make_char( 107)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 95)) , cons( make_list( make_char( 99)) , cons( make_list( make_char( 104)) , cons( make_list( make_char( 97)) , make_list( make_char( 114))))))))))))) , ( * ef5)( lf4( make_list( tmp[ 4])))))))) , ( * ef23)( ) , arg4);
}
t_unprotect( tmp[ 3]);
t_protect( arg1);
t_protect( arg7);
tmp[ 3]= ( * ef19)( arg1 , arg7);
t_protect( tmp[ 3]);
t_protect( arg0);
if( term_equal( ( * ef25)( tmp[ 3]) , arg0)) {
t_protect( tmp[ 3]);
tmp[ 4]= ( * ef22)( tmp[ 3]);
t_unprotect( arg0);
t_unprotect( arg1);
...
t_unprotect( tmp[ 2]);
t_unprotect( tmp[ 3]);
return ( * ef4)( ( * ef5)( lf4( make_list( ( * ef1)( ( * ef17)( tmp[ 4] , ( * ef5)( lf4( make_list( null( ))))))))) , ( * ef23)( ) , arg4);
}
t_unprotect( tmp[ 3]);
}
t_protect( arg1);
...
t_protect( tmp[ 3]);
t_protect( tmp[ 3]);
tmp[ 9]= ( * ef28)( ( * ef29)( tmp[ 3]) , ( * ef30)( ( * ef31)( tmp[ 3])));
t_protect( tmp[ 9]);
t_protect( tmp[ 8]);
t_protect( arg2);
t_protect( arg3);
...
t_protect( arg6);
t_protect( arg7);
tmp[ 10]= ( * ef32)( tmp[ 9] , lf5( make_list( tmp[ 8])) , arg2 , arg3 , arg4 , arg5 , arg6 , arg7);
...
return make_nf8( lf_AUX_MuASF_Rules2C24_2sym , arg0 , arg1 , arg2 , arg3 , arg4 , arg5 , arg6 , arg7);
}
}
aterm * lf_AUX_MuASF_Rules2C24_1( aterm * arg0) {
PROF( prof_lf_AUX_MuASF_Rules2C24_1);
return make_nf1( lf_AUX_MuASF_Rules2C24_1sym , arg0);
}
