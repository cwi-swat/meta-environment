...
static ATerm lf_AUX_Check_List_Pats10_1 ( ATerm arg1 ) ;
...
lf_AUX_Check_List_Pats10_1sym = ATmakeSymbol ( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"is-list-list-elem-list\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
...
register_prod ( ATparse ( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"is-list-list-elem-list\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_Check_List_Pats10_1 , lf_AUX_Check_List_Pats10_1sym ) ;
...
ATerm lf_AUX_Check_List_Pats10_1 ( ATerm arg0 ) {
{
ATerm tmp [ 28 ] ;
FUNC_ENTRY ( lf_AUX_Check_List_Pats10_1sym , ATmakeAppl ( lf_AUX_Check_List_Pats10_1sym , arg0 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_Check_List_Pats10_1sym , arg0 ) ) ;
}
}
