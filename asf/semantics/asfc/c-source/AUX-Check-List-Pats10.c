#include "support.h"
static Symbol lf_AUX_Check_List_Pats10_1sym;
static ATerm lf_AUX_Check_List_Pats10_1( ATerm arg1 , ATerm arg2);
...
static funcptr ef6;
void register_AUX_Check_List_Pats10( ) {
lf_AUX_Check_List_Pats10_1sym= ATmakeSymbol( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"contains-lhs-pattern\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Check_List_Pats10_1sym);
lf2sym= ATmakeSymbol( "listtype(sort(\"CHAR\"))" , 1 , ATtrue);
ATprotectSymbol( lf2sym);
lf3sym= ATmakeSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf3sym);
register_prod( ATparse( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"contains-lhs-pattern\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_Check_List_Pats10_1 , lf_AUX_Check_List_Pats10_1sym);
register_prod( ATparse( "listtype(sort(\"CHAR\"))") , lf2 , lf2sym);
register_prod( ATparse( "listtype(sort(\"Term\"),ql(\",\"))") , lf3 , lf3sym);
}
void resolve_AUX_Check_List_Pats10( ) {
...
ef3= lookup_func( ATreadFromString( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"is-list-elem-list-elem-list\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
ef3sym= lookup_sym( ATreadFromString( "prod(id(\"Check-List-Pats\"),w(\"\"),[l(\"is-list-elem-list-elem-list\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"));
...
void init_AUX_Check_List_Pats10( ) {
ATprotect( & constant0);
ATprotect( & constant1);
}
ATerm lf_AUX_Check_List_Pats10_1( ATerm arg0 , ATerm arg1) {
{
ATerm tmp[5];
PROF( prof_lf_AUX_Check_List_Pats10_1);
...
if( term_equal( ( * ef4)( atmp10) , ( constant0? constant0: ( constant0= ( * ef5)( ))))) {
return ( * ef3)( tmp[ 4]);
}
}
}
...
return lf_AUX_Check_List_Pats10_1( arg0 , tmp[ 0]);
}
}
}
}
