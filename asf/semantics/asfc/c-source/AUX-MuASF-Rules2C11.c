...
return ( * ef2 ) ( lf_AUX_MuASF_Rules2C11_1 ( cons ( make_list ( ( * ef1 ) ( ( constant1 ? constant1 : ( constant1 = lf4 ( make_list ( null ( ) ) ) ) ) , lf5 ( make_list ( tmp [ 9 ] ) ) , tmp [ 4 ] , tmp [ 5 ] , tmp [ 6 ] , tmp [ 7 ] ) ) , make_list ( tmp [ 1 ] ) ) ) , lf_AUX_MuASF_Rules2C11_2 ( make_list ( atmp10 ) ) , arg2 ) ;
}
