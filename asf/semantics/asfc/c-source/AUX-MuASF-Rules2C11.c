...
lf_AUX_MuASF_Rules2C11_3sym= ATmakeSymbol( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"asfrules2cstats2\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SlI-tuple\"),w(\"\"),no-attrs)"
 , 3 , ATtrue);
...
register_prod( ATparse( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"asfrules2cstats2\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"C-Rule\"),w(\"\"),ql(\";\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"NamePair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"SlI-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Rules2C11_3 , lf_AUX_MuASF_Rules2C11_3sym);
...
tmp[ 11]= arg_0( tmp[ 10]);
return ( * ef2)( lf_AUX_MuASF_Rules2C11_1( cons( make_list( ( * ef1)( ( constant0? constant0: ( constant0= lf4( make_list( null( ))))) , lf5( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 11]))) , lf_AUX_MuASF_Rules2C11_2( make_list( atmp10)) , arg2);
}
}
}
...
tmp[ 15]= arg_0( tmp[ 14]);
return ( * ef2)( lf_AUX_MuASF_Rules2C11_1( cons( make_list( ( * ef1)( ( constant0? constant0: ( constant0= lf4( make_list( null( ))))) , lf5( make_list( tmp[ 8])) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 15]))) , lf_AUX_MuASF_Rules2C11_2( make_list( atmp10)) , arg2);
}
}
}
}
...
if( term_equal( ( * ef7)( lf_AUX_MuASF_Rules2C11_1( cons( make_list( tmp[ 0]) , make_list( tmp[ 1])))) , ( constant1? constant1: ( constant1= ( * ef8)( ))))) {
if( term_equal( ( * ef9)( lf_AUX_MuASF_Rules2C11_1( cons( make_list( tmp[ 0]) , make_list( tmp[ 1])))) , ( constant1? constant1: ( constant1= ( * ef8)( ))))) {
...
tmp[ 9]= arg_0( tmp[ 7]);
return ( * ef6)( lf_AUX_MuASF_Rules2C11_1( make_list( tmp[ 8])) , lf_AUX_MuASF_Rules2C11_1( make_list( tmp[ 9])) , lf_AUX_MuASF_Rules2C11_2( make_list( atmp10)) , arg2);
}
}
}
}
