...
static aterm * lf_AUX_MuASF_Rules2C11_1( aterm * arg1 , aterm * arg2);
...
lf_AUX_MuASF_Rules2C11_1sym= TmkSymbol( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"funargs2cbuild\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"EI-pair\"),ql(\",\"))" , SYM_STRING);
lf3sym= TmkSymbol( "listtype(sort(\"Expression\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"funargs2cbuild\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"A-set\"),w(\"\"),l(\",\"),w(\"\"),sort(\"AInt\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"ADS-tuple\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Rules2C11_1 , lf_AUX_MuASF_Rules2C11_1sym);
...
aterm * lf_AUX_MuASF_Rules2C11_1( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[9];
...
t_protect( tmp[ 3]);
t_protect( arg1);
tmp[ 4]= lf_AUX_MuASF_Rules2C11_1( ( * ef1)( lf2( make_list( tmp[ 3]))) , ( * ef6)( arg1));
...
return make_nf2( lf_AUX_MuASF_Rules2C11_1sym , arg0 , arg1);
}
}
