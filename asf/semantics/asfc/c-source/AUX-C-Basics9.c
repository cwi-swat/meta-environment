...
register_prod ( ATparse ( "prod(id(\"C-Basics\"),w(\"\"),[ql(\"celookup\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"E-tuple\"),w(\"\"),no-attrs)" ) , lf_AUX_C_Basics9_1 , lf_AUX_C_Basics9_1sym ) ;
