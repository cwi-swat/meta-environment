#include "support.h"
static asymbol * lf_AUX_C_Basics15_1sym;
static aterm * lf_AUX_C_Basics15_1( aterm * arg1 , aterm * arg2);
...
lf_AUX_C_Basics15_1sym= TmkSymbol( "prod(id(\"C-Basics\"),w(\"\"),[l(\"cecontains\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"TE-pair\"),ql(\",\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"C-Basics\"),w(\"\"),[l(\"cecontains\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\",\"),w(\"\"),sort(\"C-env\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_C_Basics15_1 , lf_AUX_C_Basics15_1sym);
...
aterm * lf_AUX_C_Basics15_1( aterm * arg0 , aterm * arg1) {
{
aterm * tmp[4];
...
t_unprotect( arg1);
t_unprotect( tmp[ 0]);
return lf_AUX_C_Basics15_1( arg0 , ( * ef1)( lf2( make_list( tmp[ 1]))));
}
else {
t_unprotect( arg0);
t_unprotect( arg1);
...
return make_nf2( lf_AUX_C_Basics15_1sym , arg0 , arg1);
}
}
