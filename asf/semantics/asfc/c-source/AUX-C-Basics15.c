...
lf_AUX_C_Basics15_1sym = ATmakeSymbol ( "prod(id(\"C-Basics\"),w(\"\"),[l(\"make-c-name\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Identifier\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_C_Basics15_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"C-Basics\"),w(\"\"),[l(\"make-c-name\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"FunId\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Identifier\"),w(\"\"),no-attrs)" ) , lf_AUX_C_Basics15_1 , lf_AUX_C_Basics15_1sym ) ;
...
return ( constant0 ? constant0 : ( constant0 = ( * ef2 ) ( lf2 ( make_list ( make_char ( 95 ) ) ) ) ) ) ;
}
...
tmp [ 1 ] = lf_AUX_C_Basics15_1 ( ( * ef1 ) ( lf2 ( make_list ( tmp [ 0 ] ) ) ) ) ;
if ( check_sym ( tmp [ 1 ] , ef2sym ) ) {
tmp [ 2 ] = arg_0 ( tmp [ 1 ] ) ;
if ( check_sym ( tmp [ 2 ] , lf2sym ) ) {
tmp [ 3 ] = arg_0 ( tmp [ 2 ] ) ;
return ( * ef2 ) ( lf2 ( cons ( ( constant1 ? constant1 : ( constant1 = make_list_char ( 95 ) ) ) , make_list ( tmp [ 3 ] ) ) ) ) ;
}
}
}
tmp [ 0 ] = list_head ( atmp000 ) ;
...
if ( ! term_equal ( ( * ef1 ) ( lf2 ( make_list ( tmp [ 0 ] ) ) ) , ( * ef1 ) ( lf2 ( make_list ( make_char ( 45 ) ) ) ) ) ) {
tmp [ 2 ] = lf_AUX_C_Basics15_1 ( ( * ef1 ) ( lf2 ( make_list ( tmp [ 1 ] ) ) ) ) ;
...
return make_nf1 ( lf_AUX_C_Basics15_1sym , arg0 ) ;
}
}
