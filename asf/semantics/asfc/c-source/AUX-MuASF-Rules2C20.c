#include "support.h"
static asymbol * lf_AUX_MuASF_Rules2C20_1sym;
static aterm * lf_AUX_MuASF_Rules2C20_1( aterm * arg1);
...
static funcptr ef4;
void register_AUX_MuASF_Rules2C20( ) {
arena local;
TinitArena( NULL , & local);
lf_AUX_MuASF_Rules2C20_1sym= TmkSymbol( "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"is-boolean-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , SYM_STRING);
lf2sym= TmkSymbol( "listtype(sort(\"CHAR\"))" , SYM_STRING);
register_prod( TmakeSimple( & local , "prod(id(\"MuASF-Rules2C\"),w(\"\"),[l(\"is-boolean-term\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Term\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)") , lf_AUX_MuASF_Rules2C20_1 , lf_AUX_MuASF_Rules2C20_1sym);
register_prod( TmakeSimple( & local , "listtype(sort(\"CHAR\"))") , lf2 , lf2sym);
}
void resolve_AUX_MuASF_Rules2C20( ) {
arena local;
TinitArena( NULL , & local);
...
aterm * lf_AUX_MuASF_Rules2C20_1( aterm * arg0) {
{
aterm * tmp[1];
PROF( prof_lf_AUX_MuASF_Rules2C20_1);
