...
tmp[ 0]= ( * ef3)( lf_AUX_MuASF_Rules2C9_1( make_list( atmp00)));
...
tmp[ 7]= arg_0( tmp[ 5]);
return ( * ef1)( lf4( make_list( tmp[ 6])) , lf4( make_list( tmp[ 7])) , lf_AUX_MuASF_Rules2C9_2( make_list( atmp10)) , ( constant1? constant1: ( constant1= ( * ef2)( lf5( make_list( make_char( 48)))))));
}
}
}
}
