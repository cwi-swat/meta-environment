...
static ATerm lf_AUX_Locate_Constants21_1( ATerm arg1 , ATerm arg2);
...
lf_AUX_Locate_Constants21_1sym= ATmakeSymbol( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"compose-list-of-chars\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"compose-list-of-chars\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\",\"),w(\"\"),sort(\"Expression\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Expression\"),w(\"\"),no-attrs)") , lf_AUX_Locate_Constants21_1 , lf_AUX_Locate_Constants21_1sym);
...
ATerm lf_AUX_Locate_Constants21_1( ATerm arg0 , ATerm arg1) {
{
ATerm tmp[27];
