#include "support.h"
static Symbol lf_AUX_Locate_Constants16_2sym;
static ATerm lf_AUX_Locate_Constants16_2( ATerm arg1 , ATerm arg2);
...
lf_AUX_Locate_Constants16_2sym= ATmakeSymbol( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"make-init-function\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Locate_Constants16_2sym);
...
lf_AUX_Locate_Constants16_1sym= ATmakeSymbol( "listtype(sort(\"CE-pair\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Locate_Constants16_1sym);
lf5sym= ATmakeSymbol( "listtype(sort(\"FuncDef\"),ql(\";\"))" , 1 , ATtrue);
ATprotectSymbol( lf5sym);
register_prod( ATparse( "listtype(sort(\"CE-pair\"),ql(\",\"))") , lf_AUX_Locate_Constants16_1 , lf_AUX_Locate_Constants16_1sym);
register_prod( ATparse( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"make-init-function\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ModId\"),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Declaration-list-opt\"),w(\"\"),no-attrs)") , lf_AUX_Locate_Constants16_2 , lf_AUX_Locate_Constants16_2sym);
...
ATerm lf_AUX_Locate_Constants16_2( ATerm arg0 , ATerm arg1) {
{
ATerm tmp[6];
PROF( prof_lf_AUX_Locate_Constants16_2);
if( check_sym( arg1 , lf_AUX_Locate_Constants16_1sym)) {
{
ATerm atmp10= arg_0( arg1);
tmp[ 0]= ( * ef11)( arg0);
tmp[ 1]= ( * ef12)( lf_AUX_Locate_Constants16_1( make_list( atmp10)));
...
return make_nf2( lf_AUX_Locate_Constants16_2sym , arg0 , arg1);
}
}
