...
static ATerm lf_AUX_Locate_Constants16_2( ATerm arg1);
...
lf_AUX_Locate_Constants16_2sym= ATmakeSymbol( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"make-statements-function\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)"
 , 1 , ATtrue);
...
register_prod( ATparse( "prod(id(\"Locate-Constants\"),w(\"\"),[l(\"make-statements-function\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"CE-pair\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"FTS-tuple\"),w(\"\"),no-attrs)") , lf_AUX_Locate_Constants16_2 , lf_AUX_Locate_Constants16_2sym);
...
ATerm lf_AUX_Locate_Constants16_2( ATerm arg0) {
{
ATerm tmp[7];
PROF( prof_lf_AUX_Locate_Constants16_2);
if( check_sym( arg0 , lf_AUX_Locate_Constants16_1sym)) {
{
ATerm atmp00= arg_0( arg0);
if( not_empty_list( atmp00)) {
tmp[ 0]= ( * ef6)( lf_AUX_Locate_Constants16_1( make_list( atmp00)));
...
return make_nf1( lf_AUX_Locate_Constants16_2sym , arg0);
}
}
