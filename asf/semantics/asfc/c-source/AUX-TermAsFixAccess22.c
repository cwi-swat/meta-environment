...
static Symbol lf_AUX_TermAsFixAccess22_1sym ;
static ATerm lf_AUX_TermAsFixAccess22_1 ( ATerm arg1 ) ;
...
static funcptr ef17 ;
void register_AUX_TermAsFixAccess22 ( ) {
lf_AUX_TermAsFixAccess22_1sym = ATmakeSymbol ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-symbols-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 1 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_TermAsFixAccess22_1sym ) ;
lf2sym = ATmakeSymbol ( "listtype(sort(\"CHAR\"))" , 1 , ATtrue ) ;
ATprotectSymbol ( lf2sym ) ;
register_prod ( ATparse ( "prod(id(\"TermAsFixAccess\"),w(\"\"),[ql(\"is-symbols-prod\"),w(\"\"),ql(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),ql(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_TermAsFixAccess22_1 , lf_AUX_TermAsFixAccess22_1sym ) ;
register_prod ( ATparse ( "listtype(sort(\"CHAR\"))" ) , lf2 , lf2sym ) ;
}
void resolve_AUX_TermAsFixAccess22 ( ) {
...
ef12 = lookup_func ( ATreadFromString ( "prod(id(\"ParseTree-Constructors\"),w(\"\"),[ql(\"iter\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) ) ;
ef12sym = lookup_sym ( ATreadFromString ( "prod(id(\"ParseTree-Constructors\"),w(\"\"),[ql(\"iter\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"AFun\"),w(\"\"),no-attrs)" ) ) ;
...
void init_AUX_TermAsFixAccess22 ( ) {
ATprotect ( & constant0 ) ;
ATprotect ( & constant1 ) ;
}
ATerm lf_AUX_TermAsFixAccess22_1 ( ATerm arg0 ) {
{
ATerm tmp [ 33 ] ;
FUNC_ENTRY ( lf_AUX_TermAsFixAccess22_1sym , ATmakeAppl ( lf_AUX_TermAsFixAccess22_1sym , arg0 ) ) ;
...
if ( check_sym ( atmp01110000111 , ef5sym ) ) {
{
...
( tmp [ 8 ] = list_tail ( atmp0110100000 ) ) ;
...
( tmp [ 9 ] = list_tail ( atmp0111000010100000 ) ) ;
...
if ( term_equal ( list_head ( tmp [ 12 ] ) , make_char ( 98 ) ) ) {
...
( tmp [ 16 ] = list_tail ( atmp01110000110100000 ) ) ;
...
( tmp [ 17 ] = list_tail ( atmp011100001110100000 ) ) ;
if ( not_empty_list ( tmp [ 17 ] ) ) {
if ( term_equal ( list_head ( tmp [ 17 ] ) , make_char ( 42 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 24 ] ) , make_char ( 83 ) ) ) {
...
if ( term_equal ( list_head ( tmp [ 26 ] ) , make_char ( 109 ) ) ) {
( tmp [ 27 ] = list_tail ( tmp [ 26 ] ) ) ;
if ( not_empty_list ( tmp [ 27 ] ) ) {
if ( term_equal ( list_head ( tmp [ 27 ] ) , make_char ( 98 ) ) ) {
...
( tmp [ 32 ] = list_tail ( atmp0111111110100000 ) ) ;
...
FUNC_EXIT ( make_nf1 ( lf_AUX_TermAsFixAccess22_1sym , arg0 ) ) ;
}
}
