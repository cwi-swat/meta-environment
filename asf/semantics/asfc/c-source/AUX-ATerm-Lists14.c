...
static Symbol lf_AUX_ATerm_Lists14_1sym ;
static ATerm lf_AUX_ATerm_Lists14_1 ( ATerm arg1 , ATerm arg2 ) ;
...
static funcptr ef3 ;
void register_AUX_ATerm_Lists14 ( ) {
lf_AUX_ATerm_Lists14_1sym = ATmakeSymbol ( "prod(id(\"ATerm-Lists\"),w(\"\"),[l(\"for-some\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)"
 , 2 , ATtrue ) ;
ATprotectSymbol ( lf_AUX_ATerm_Lists14_1sym ) ;
register_prod ( ATparse ( "prod(id(\"ATerm-Lists\"),w(\"\"),[l(\"for-some\"),w(\"\"),l(\"(\"),w(\"\"),sort(\"ATerm\"),w(\"\"),l(\",\"),w(\"\"),sort(\"ATermList\"),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"Bool\"),w(\"\"),no-attrs)" ) , lf_AUX_ATerm_Lists14_1 , lf_AUX_ATerm_Lists14_1sym ) ;
}
void resolve_AUX_ATerm_Lists14 ( ) {
