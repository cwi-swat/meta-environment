#include "support.h"
static Symbol lf_AUX_Rules2C_Aux3_3sym;
...
static Symbol lf_AUX_Rules2C_Aux3_2sym;
...
lf_AUX_Rules2C_Aux3_3sym= ATmakeSymbol( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"code-args\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"AInt\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"PathList-Cenv\"),w(\"\"),no-attrs)"
 , 2 , ATtrue);
ATprotectSymbol( lf_AUX_Rules2C_Aux3_3sym);
...
lf_AUX_Rules2C_Aux3_1sym= ATmakeSymbol( "listtype(sort(\"Term\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Rules2C_Aux3_1sym);
lf_AUX_Rules2C_Aux3_2sym= ATmakeSymbol( "listtype(sort(\"AInt\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf_AUX_Rules2C_Aux3_2sym);
lf4sym= ATmakeSymbol( "listtype(sort(\"FV-Path\"),ql(\",\"))" , 1 , ATtrue);
ATprotectSymbol( lf4sym);
register_prod( ATparse( "listtype(sort(\"Term\"),ql(\",\"))") , lf_AUX_Rules2C_Aux3_1 , lf_AUX_Rules2C_Aux3_1sym);
register_prod( ATparse( "listtype(sort(\"AInt\"),ql(\",\"))") , lf_AUX_Rules2C_Aux3_2 , lf_AUX_Rules2C_Aux3_2sym);
register_prod( ATparse( "prod(id(\"Rules2C-Aux\"),w(\"\"),[l(\"code-args\"),w(\"\"),l(\"(\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"Term\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\",\"),w(\"\"),iter-sep(l(\"{\"),w(\"\"),sort(\"AInt\"),w(\"\"),ql(\",\"),w(\"\"),l(\"}\"),w(\"\"),l(\"*\")),w(\"\"),l(\")\")],w(\"\"),l(\"->\"),w(\"\"),sort(\"PathList-Cenv\"),w(\"\"),no-attrs)") , lf_AUX_Rules2C_Aux3_3 , lf_AUX_Rules2C_Aux3_3sym);
...
if( term_equal( ( * ef15)( tmp[ 0]) , ( constant1? constant1: ( constant1= ( * ef16)( lf_AUX_Rules2C_Aux3_1( make_list( null( )))))))) {
...
tmp[ 8]= ( * ef19)( tmp[ 0]);
tmp[ 9]= lf_AUX_Rules2C_Aux3_3( lf_AUX_Rules2C_Aux3_1( make_list( tmp[ 7])) , lf_AUX_Rules2C_Aux3_2( cons( make_list( tmp[ 2]) , cons( make_list( tmp[ 3]) , ( constant2? constant2: ( constant2= make_list( ( * ef20)( lf6( make_list( make_char( 48)))))))))));
...
tmp[ 18]= arg_0( tmp[ 17]);
return ( * ef1)( ( * ef2)( lf4( cons( make_list( ( * ef17)( lf4( cons( make_list( ( * ef4)( ( * ef18)( tmp[ 8]) , lf_AUX_Rules2C_Aux3_2( cons( make_list( tmp[ 2]) , make_list( tmp[ 3]))))) , make_list( tmp[ 13]))))) , make_list( tmp[ 18])))) , ( * ef9)( tmp[ 11] , tmp[ 16]));
}
}
}
}
