...
t_protect( atmp20);
t_protect( arg3);
tmp[ 27]= ( * ef9)( lf_AUX_MuASF_Conds2C1_1( cons( make_list( ( * ef3)( lf4( make_list( tmp[ 7])) , lf5( cons( make_list( ( * ef6)( ( * ef7)( ( * ef8)( lf6( cons( make_list( make_char( 116)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 114)) , cons( make_list( make_char( 109)) , cons( make_list( make_char( 45)) , cons( make_list( make_char( 101)) , cons( make_list( make_char( 113)) , cons( make_list( make_char( 117)) , cons( make_list( make_char( 97)) , make_list( make_char( 108))))))))))))) , lf7( make_list( tmp[ 17]))) , tmp[ 12])) , make_list( tmp[ 10]))) , tmp[ 4] , tmp[ 5] , tmp[ 6])) , make_list( tmp[ 1]))) , arg1 , lf_AUX_MuASF_Conds2C1_2( make_list( atmp20)) , arg3);
...
t_protect( atmp20);
t_protect( arg3);
tmp[ 9]= ( * ef4)( ( * ef5)( ) , tmp[ 4] , tmp[ 5] , tmp[ 6] , arg1 , lf_AUX_MuASF_Conds2C1_2( make_list( atmp20)) , arg3);
