...
public class LibraryPath extends nl.cwi.sen1.configapi.types.Property {
  public LibraryPath(nl.cwi.sen1.configapi.Factory factory, aterm.ATermList annos, aterm.AFun fun, aterm.ATerm[] args) {
  ...
  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof LibraryPath) {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getConfigapiFactory().makeProperty_LibraryPath(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof aterm.ATermAppl)) { 
          throw new RuntimeException("Argument 0 of a LibraryPath should have type str");
        }
        break;
      case 1:
        if (!(arg instanceof aterm.ATermAppl)) { 
          throw new RuntimeException("Argument 1 of a LibraryPath should have type str");
        }
        break;
      default: throw new RuntimeException("LibraryPath does not have an argument at " + i );
    }
