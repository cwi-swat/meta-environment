...
public class ForegroundColor extends nl.cwi.sen1.configapi.types.TextAttribute {
  public ForegroundColor(nl.cwi.sen1.configapi.Factory factory, aterm.ATermList annos, aterm.AFun fun, aterm.ATerm[] args) {
  ...
  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof ForegroundColor) {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getConfigapiFactory().makeTextAttribute_ForegroundColor(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof nl.cwi.sen1.configapi.types.Color)) { 
          throw new RuntimeException("Argument 0 of a ForegroundColor should have type Color");
        }
        break;
      default: throw new RuntimeException("ForegroundColor does not have an argument at " + i );
    }
