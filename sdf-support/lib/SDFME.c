...
SDF_ModuleWord SDF_makeModuleWordLexToCf(SDF_Lexical lex)
{
  return (SDF_ModuleWord)ATmakeTerm(SDF_patternModuleWordLexToCf, lex);
}
...
SDF_ModuleId SDF_makeModuleIdLexToCf(SDF_Lexical lex)
{
  return (SDF_ModuleId)ATmakeTerm(SDF_patternModuleIdLexToCf, lex);
}
...
SDF_Sort SDF_makeSortLexToCf(SDF_Lexical lex)
{
  return (SDF_Sort)ATmakeTerm(SDF_patternSortLexToCf, lex);
}
...
SDF_UQLiteral SDF_makeUQLiteralLexToCf(SDF_Lexical lex)
{
  return (SDF_UQLiteral)ATmakeTerm(SDF_patternUQLiteralLexToCf, lex);
}
...
SDF_Literal SDF_makeLiteralLexToCf(SDF_Lexical lex)
{
  return (SDF_Literal)ATmakeTerm(SDF_patternLiteralLexToCf, lex);
}
...
SDF_NatCon SDF_makeNatConLexToCf(SDF_Lexical lex)
{
  return (SDF_NatCon)ATmakeTerm(SDF_patternNatConLexToCf, lex);
}
...
SDF_AlphaNumericalEscChar SDF_makeAlphaNumericalEscCharLexToCf(SDF_Lexical lex)
{
  return (SDF_AlphaNumericalEscChar)ATmakeTerm(SDF_patternAlphaNumericalEscCharLexToCf, lex);
}
...
SDF_DecimalEscChar SDF_makeDecimalEscCharLexToCf(SDF_Lexical lex)
{
  return (SDF_DecimalEscChar)ATmakeTerm(SDF_patternDecimalEscCharLexToCf, lex);
}
...
SDF_EscChar SDF_makeEscCharLexToCf(SDF_Lexical lex)
{
  return (SDF_EscChar)ATmakeTerm(SDF_patternEscCharLexToCf, lex);
}
...
SDF_LChar SDF_makeLCharLexToCf(SDF_Lexical lex)
{
  return (SDF_LChar)ATmakeTerm(SDF_patternLCharLexToCf, lex);
}
...
SDF_TagId SDF_makeTagIdLexToCf(SDF_Lexical lex)
{
  return (SDF_TagId)ATmakeTerm(SDF_patternTagIdLexToCf, lex);
}
...
SDF_NumChar SDF_makeNumCharLexToCf(SDF_Lexical lex)
{
  return (SDF_NumChar)ATmakeTerm(SDF_patternNumCharLexToCf, lex);
}
...
SDF_ShortChar SDF_makeShortCharLexToCf(SDF_Lexical lex)
{
  return (SDF_ShortChar)ATmakeTerm(SDF_patternShortCharLexToCf, lex);
}
...
SDF_Symbol SDF_getSymbolSymbol(SDF_Symbol arg)
{
  if (SDF_isSymbolCf(arg)) {
    ...
    return (SDF_Symbol)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
  else if (SDF_isSymbolIter(arg)) {
    return (SDF_Symbol)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isSymbolCharClass(arg)) {
    return (SDF_CharClass)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isSymbolSort(arg)) {
    return (SDF_Sort)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isSymbolLit(arg)) {
    return (SDF_Literal)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isGrammarImpSection(arg)) {
    return (SDF_ImpSection)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isGrammarConcGrammars(arg)) {
    return (SDF_Grammar)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isProductionProd(arg)) {
    return (SDF_Symbols)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
ATbool SDF_isModuleWordLexToCf(SDF_ModuleWord arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternModuleWordLexToCf, NULL);
}
...
{
  if (SDF_isModuleWordLexToCf(arg)) {
    return (SDF_Lexical)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }

  ATabort("ModuleWord has no Lex: %t\n", arg);
  return (SDF_Lexical)NULL;
}
...
ATbool SDF_isModuleIdLexToCf(SDF_ModuleId arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternModuleIdLexToCf, NULL);
}
...
{
  if (SDF_isModuleNameUnparameterized(arg)) {
    return (SDF_ModuleId)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
  else if (SDF_isModuleNameParameterized(arg)) {
    return (SDF_ModuleId)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isAttributeAtr(arg)) {
    return (SDF_Associativity)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isImportModule(arg)) {
    return (SDF_ModuleName)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
  else if (SDF_isImportRenamedModule(arg)) {
    return (SDF_ModuleName)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isGroupSimpleGroup(arg)) {
    return (SDF_Production)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isPriorityAssoc(arg)) {
    return (SDF_Group)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
ATbool SDF_isSortLexToCf(SDF_Sort arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternSortLexToCf, NULL);
}
...
ATbool SDF_isUQLiteralLexToCf(SDF_UQLiteral arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternUQLiteralLexToCf, NULL);
}
...
ATbool SDF_isLiteralLexToCf(SDF_Literal arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternLiteralLexToCf, NULL);
}
...
{
  if (SDF_isLiteralUqlit(arg)) {
    return (SDF_UQLiteral)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isLookaheadsSingle(arg)) {
    return (SDF_Lookahead)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isLookaheadsAlt(arg)) {
    return (SDF_Lookaheads)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
ATbool SDF_isNatConLexToCf(SDF_NatCon arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternNatConLexToCf, NULL);
}
...
{
  if (SDF_isIntConNatural(arg)) {
    return (SDF_NatCon)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
  else if (SDF_isIntConPositive(arg)) {
    return (SDF_NatCon)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 2);
  }
...
{
  if (SDF_isCharRangeDefault(arg)) {
    return (SDF_Character)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isCharRangesDefault(arg)) {
    return (SDF_CharRange)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isCharRangesConc(arg)) {
    return (SDF_CharRanges)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
ATbool SDF_isAlphaNumericalEscCharLexToCf(SDF_AlphaNumericalEscChar arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternAlphaNumericalEscCharLexToCf, NULL);
}
...
ATbool SDF_isDecimalEscCharLexToCf(SDF_DecimalEscChar arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternDecimalEscCharLexToCf, NULL);
}
...
ATbool SDF_isEscCharLexToCf(SDF_EscChar arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternEscCharLexToCf, NULL);
}
...
ATbool SDF_isLCharLexToCf(SDF_LChar arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternLCharLexToCf, NULL);
}
...
{
  if (SDF_isATermsAterm(arg)) {
    return (SDF_ATerm)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isAConInt(arg)) {
    return (SDF_IntCon)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isAConReal(arg)) {
    return (SDF_RealCon)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isATermConstant(arg)) {
    return (SDF_ACon)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
  else if (SDF_isATermAnnotatedConstant(arg)) {
    return (SDF_ACon)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isATermList(arg)) {
    return (SDF_ATermList)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
  else if (SDF_isATermAnnotatedList(arg)) {
    return (SDF_ATermList)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isATermFun(arg)) {
    return (SDF_AFun)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
  else if (SDF_isATermAppl(arg)) {
    return (SDF_AFun)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
ATbool SDF_isTagIdLexToCf(SDF_TagId arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternTagIdLexToCf, NULL);
}
...
ATbool SDF_isNumCharLexToCf(SDF_NumChar arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternNumCharLexToCf, NULL);
}
...
ATbool SDF_isShortCharLexToCf(SDF_ShortChar arg)
{
  return ATmatchTerm((ATerm)arg, SDF_patternShortCharLexToCf, NULL);
}
...
{
  if (SDF_isCharacterNumeric(arg)) {
    return (SDF_NumChar)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
...
{
  if (SDF_isCharacterShort(arg)) {
    return (SDF_ShortChar)ATelementAt((ATermList)ATgetArgument((ATermAppl)arg, 1), 0);
  }
