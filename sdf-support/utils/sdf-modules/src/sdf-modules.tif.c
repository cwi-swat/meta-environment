 ...
 * Implementation generated at Thu May 22 12:29:01 2003
 */
...
static char *signature[NR_SIG_ENTRIES] = {
  ...
  "rec-eval(<sdf-modules>,get-imported-modules(<term>))",
...
ATerm sdf_modules_handler(int conn, ATerm term)
{
  ...
  if(ATmatch(term, "rec-eval(get-imported-modules(<term>))", &t0)) {
    return get_imported_modules(conn, t0);
  }
