 ...
 * Implementation generated at Tue May 27 17:06:30 2003
 */
...
static char *signature[NR_SIG_ENTRIES] = {
  ...
  "rec-eval(<sdf-modules>,get-all-needed-modules(<list>,<str>))",
  ...
  "rec-eval(<sdf-modules>,make-sdf-definition(<list>,<str>))",
...
ATerm sdf_modules_handler(int conn, ATerm term)
{
  ...
  if(ATmatch(term, "rec-eval(get-all-needed-modules(<term>,<str>))", &t0, &s0)) {
    return get_all_needed_modules(conn, t0, s0);
  }
  ...
  if(ATmatch(term, "rec-eval(make-sdf-definition(<term>,<str>))", &t0, &s0)) {
    return make_sdf_definition(conn, t0, s0);
  }
