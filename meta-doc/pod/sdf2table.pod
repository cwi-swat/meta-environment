...
B<sdf2table> [-B<bfh>] [-B<i> I<file>] [-B<ln>] [-B<o> I<file>] [-B<tvVx>] 
...
Use the handcrafted -- `fast' -- normalizer.  This is the default.
...
Write output to F<file>.  By default, output goes to stdout.

=item B<-s>

Use the generated -- `slow' -- normalizer.
...
L<sglr>, L<a2toa1>, L<ParseTable-Generator>
