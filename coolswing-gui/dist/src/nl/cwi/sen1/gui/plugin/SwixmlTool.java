  ...
  implements SwixmlTif
{
  ...
  {
    sigTable.add(factory.parse("rec-do(<swixml>,swixml-display(<str>,<str>))"));
  ...
  {
    PswixmlDisplay0 = factory.parse("rec-do(swixml-display(<str>,<str>))");
  ...
  public ATerm handler(ATerm term)
  {
    ...
    result = term.match(PswixmlDisplay0);
    if (result != null) {
      swixmlDisplay((String)result.get(0), (String)result.get(1));
      return null;
    }
