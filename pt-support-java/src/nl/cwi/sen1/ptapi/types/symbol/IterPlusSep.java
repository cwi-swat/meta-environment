...
public class IterPlusSep extends nl.cwi.sen1.ptapi.types.Symbol {
  public IterPlusSep(nl.cwi.sen1.ptapi.Factory factory, aterm.ATermList annos, aterm.AFun fun, aterm.ATerm[] args) {
  ...
  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof IterPlusSep) {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getPtapiFactory().makeSymbol_IterPlusSep(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof nl.cwi.sen1.ptapi.types.Symbol)) { 
          throw new RuntimeException("Argument 0 of a IterPlusSep should have type Symbol");
        }
        break;
      case 1:
        if (!(arg instanceof nl.cwi.sen1.ptapi.types.Symbol)) { 
          throw new RuntimeException("Argument 1 of a IterPlusSep should have type Symbol");
        }
        break;
      default: throw new RuntimeException("IterPlusSep does not have an argument at " + i );
    }
