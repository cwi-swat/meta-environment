...
public class IterPlus extends nl.cwi.sen1.ptapi.types.Symbol {
  public IterPlus(nl.cwi.sen1.ptapi.Factory factory, aterm.ATermList annos, aterm.AFun fun, aterm.ATerm[] args) {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getPtapiFactory().makeSymbol_IterPlus(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof nl.cwi.sen1.ptapi.types.Symbol)) { 
          throw new RuntimeException("Argument 0 of a IterPlus should have type Symbol");
        }
        break;
      default: throw new RuntimeException("IterPlus does not have an argument at " + i );
    }
