...
public class ProcessList extends JPanel implements DebugToolListener {
	private Info info;
...
class AdapterPanel extends JPanel implements DebugAdapterListener {
	private Info info;
	private DebugAdapter adapter;
	private Container processPanel;
	private Map<DebugProcess, Container> processes;
	...
	public AdapterPanel(DebugAdapter adap, ToolManager manager) {
		...
		processes = new HashMap<DebugProcess, Container>();
	...
	// }}}
	// {{{ public void processCreated(DebugAdapter adapter, DebugProcess
	// process)
