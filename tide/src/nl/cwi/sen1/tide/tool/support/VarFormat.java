...
public class VarFormat implements ExprFormat {
	...
	public static ATerm makeExprVar(ATermFactory factory, String var,
			ATerm value, int pos, int line, int column, int length) {
