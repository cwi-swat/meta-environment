...
public class Expr {
	private static final String PATTERN_LOC_LC = "location(lc(<str>,<int>,<int>))";
	private static final String PATTERN_LOC_LINE = "location(line(<str>,<int>))";
	private static final String PATTERN_LOC_AREA = "location(area-in-file(<str>,area(<int>,<int>,<int>,<int>,<int>,<int>)))";
	private static final String PAT_SOURCE_VAR = "source-var(<str>,<int>,<int>,<int>,<str>)";
	private static final String PAT_VARIABLE = "variable(<str>,<term>)";
	private static final String PAT_VAR = "var(<str>,<term>,<int>,<int>,<int>,<int>)";
	private static final String PAT_VAR_UNKNOWN = "var-unknown(<str>)";
	private static final String PAT_ERROR = "error(<str>,<term>)";
	private static final String PAT_SOURCE_PATH = "source-path(<str>)";
	private static final String PAT_SOURCE_LIST = "source-list([<list>])";
	private static final String PAT_STACK_TRACE = "stack([<list>])";
	private static final String PAT_STACK_FRAME = "frame(<int>,<str>,<term>,<term>)";
	...
	public static Expr makeSourceVar(String file, int pos, int linenr, int col,
			String line) {
		return Expr.make(Expr.factory.make(PAT_SOURCE_VAR, file, new Integer(
				pos), new Integer(linenr), new Integer(col), line));
	}
	...
	public String toString() {
		if (isVariable()) {
			...
			return getLocationShortFile() + " " + getLocationStartLine() + ","
					+ getLocationStartColumn() + "-" + getLocationEndLine()
...
class ExprIterator implements Iterator<Expr> {
	private ATerm term;
	...
	public boolean hasNext() {
		if (term == null
				|| (term.getType() == ATerm.LIST && ((ATermList) term)
						.isEmpty())) {
			return false;
		}
